...
// Address:   0x005dde30  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_005dde30 @ 0x005dde30
// Stable ID: aa_005dde30
...
//  - Notable callees: FUN_0057fb80×6, FUN_0057fb40×2, FUN_00456080, FUN_00480c80, FUN_0057fac0, FUN_005dde30.
//  - Return sites: 4.
...

{
  ...
  if (uVar1 != 0) {
    ...
    if (uVar6 < iVar2 + uVar1) {
      ...
      uVar5 = FUN_0057fb80(*(uint32_t /* width from decompiler */ *)(param_1 + 4),param_2,pvVar4,param_1,param_3);

      uVar5 = FUN_0057fb80(param_3,param_4,uVar5,param_1,param_3);

      FUN_0057fb80(param_2,*(uint32_t /* width from decompiler */ *)(param_1 + 8),uVar5,param_1,param_3);
