...
// Address:   0x0045bec0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0045bec0 @ 0x0045bec0
// Stable ID: aa_0045bec0
...

{
  ...
  if ((local_4c == 0x5042414d) || (local_4c == 0x5452414b)) {
    ...
    if ((0 < param_2) && (iVar1 = FUN_0045ec30(), iVar1 == 0)) {
