// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Mission_after_CVOGRegionMissions_0041a630
// -----------------------------------------------------------------------------
// Stable ID: aa_0041a630
// Callee of Named_CalleeOf_Mission_after_CVOGRegionMissions
// Address:   0x0041a630  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0041a630, FUN_0041bbd0.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ * __fastcall Named_CalleeOf_Named_CalleeOf_Mission_after_CVOGRegionMissions_0041a630(uint32_t /* width from decompiler */ param_1,int *param_2)
...

{
  ...
  if ((puVar4 != *(uint32_t /* width from decompiler */ **)(in_EAX + 4)) && ((int)puVar4[3] <= *param_2)) {
