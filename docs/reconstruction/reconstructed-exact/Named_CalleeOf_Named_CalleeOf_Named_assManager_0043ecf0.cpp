// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_assManager_0043ecf0
// -----------------------------------------------------------------------------
// Stable ID: aa_0043ecf0
// Callee of Named_CalleeOf_Named_assManager
// Address:   0x0043ecf0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_assManager_0043ecf0(uint32_t /* width from decompiler */ *param_1)
...

{
  ...
  if (in_EAX != (uint32_t /* width from decompiler */ *)0x0) {
    ...
    *(uint8_t *)(in_EAX + 1) = *(uint8_t *)(param_1 + 1);
