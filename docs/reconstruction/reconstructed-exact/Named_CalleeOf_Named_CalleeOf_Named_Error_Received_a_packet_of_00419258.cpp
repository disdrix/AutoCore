// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Error_Received_a_packet_of_00419258
// -----------------------------------------------------------------------------
// Stable ID: aa_00419258
// Callee of Named_CalleeOf_Named_Error_Received_a_packet_of_unknown_type_d
// Address:   0x00419258  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: LeaveCriticalSection×2, FUN_00419258, InterlockedIncrement.
//  - Return sites: 1.
...
uint8_t Named_CalleeOf_Named_CalleeOf_Named_Error_Received_a_packet_of_00419258(void)
