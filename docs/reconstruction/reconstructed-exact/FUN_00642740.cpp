...
// PURPOSE (auto): Scaffold unit for FUN_00642740 @ 0x00642740
// Stable ID: aa_00642740
...
FUN_00642740(int param_1,uint8_t *param_2,int param_3,uint32_t /* width from decompiler */ param_4,uint32_t /* width from decompiler */ param_5)
