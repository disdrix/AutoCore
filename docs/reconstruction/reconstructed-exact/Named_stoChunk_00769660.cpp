...
//  - Notable callees: vog_LogMessage×2, FUN_00435df0, FUN_00436250, FUN_00767600, FUN_00769660, FUN_0076cec0, isspace.
//  - Strings: ");
    ...
    if (bVar3) {
      ...
      vog_LogMessage("; ",0x2a0,3,
                     ...
                     "; "Expected bool but got \"%s\" in chunk \"%s\""; "C:\\vog\\1_code\\palantir\\arda2\\storage\\stoChunk.cpp".
//  - Return sites: 2.

// =============================================================================
// Named_stoChunk_00769660
// -----------------------------------------------------------------------------
// Stable ID: aa_00769660
// Address:   0x00769660  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ Named_stoChunk_00769660(uint32_t /* width from decompiler */ param_1)
