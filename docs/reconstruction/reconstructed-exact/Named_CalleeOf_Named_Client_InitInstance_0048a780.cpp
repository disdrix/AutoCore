// =============================================================================
// Named_CalleeOf_Named_Client_InitInstance_0048a780
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_Client_InitInstance: callee helper. Evidence string: "SetEffect - ENTER\n". Supports parent flow (not a free-standing entry point). Named_Client_InitInstance (+1 other named callers).
...
HANDLE Named_CalleeOf_Named_Client_InitInstance_0048a780(char *param_1,uint32_t /* width from decompiler */ param_2)
