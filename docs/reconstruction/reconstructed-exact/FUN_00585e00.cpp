...
// FUN_0051aed0 — dual-sealed FUN_0051aed0 (thiscall, RET 8)
extern void FUN_0051aed0(char bPlayAudio, char bForceQuestFx);
extern void Client_SendLogicUiPacket(void *packet);

// float10 modeled as float for port readability; retail returns on x87 ST0.
float __thiscall FUN_00585e00(int this_obj, char skipSideFx)
{
  int *piVar1;
  char cVar2;
  int iVar3;
  ...
  if ((*(int *)(this_obj + 8) != 0) && (cVar2 = FUN_005130e0(1), cVar2 != '\0')) {
    ...
    if (skipSideFx == '\0') {
      ...
      if (((iVar3 != 0) && (piVar1 = *(int **)(iVar3 + 0xe8a0), piVar1 != (int *)0x0)) &&
        ...
        FUN_0051aed0((char)(fVar7 < DAT_00a0f524), (char)uVar10);
      }
      iVar3 = *(int *)(*(int *)(this_obj + 4) + 4);
