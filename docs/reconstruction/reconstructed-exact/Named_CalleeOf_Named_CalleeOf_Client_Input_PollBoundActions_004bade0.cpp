// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_Input_PollBoundActions_004bade0
// -----------------------------------------------------------------------------
// Stable ID: aa_004bade0
// Callee of Named_CalleeOf_Client_Input_PollBoundActions
// Address:   0x004bade0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Client_Input_PollBoundActions_004bade0(int param_1)



{

  *(uint8_t *)(param_1 + 0xe) = 1;
