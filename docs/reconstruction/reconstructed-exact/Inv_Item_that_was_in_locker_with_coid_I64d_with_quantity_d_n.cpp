...
// =============================================================================
// Inv_Item_that_was_in_locker_with_coid_I64d_with_quantity_d_n
// -----------------------------------------------------------------------------
// Purpose:  String-driven human alias for decompiled bulk unit.
//           Primary evidence literal: "Item that was in locker with coid: %I64d 
with quantity: %d 
not found in inventory after randomizat"
//           Behavior is preserved from the FUN_0093bf60 clean capture; this file
...
//           docs/reconstruction/raw/aa_0093bf60_*.md
//           Original Ghidra symbol: FUN_0093bf60
//
// Exactness: Body mirrors reconstructed-exact/FUN_0093bf60*.cpp when present;
...
/*
 * Behavioral notes:
 * String-driven human alias evidence: "Item that was in locker with coid: %I64d 
with quantity: %d 
not found in invent"
 *
...
void Inv_Item_that_was_in_locker_with_coid_I64d_with_quantity_d_n(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ *param_3,uint32_t /* width from decompiler */ param_4,
