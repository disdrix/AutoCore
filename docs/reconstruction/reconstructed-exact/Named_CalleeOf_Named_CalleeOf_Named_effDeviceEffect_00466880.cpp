// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_effDeviceEffect_00466880
// -----------------------------------------------------------------------------
// Stable ID: aa_00466880
// Callee of Named_CalleeOf_Named_effDeviceEffect
// Address:   0x00466880  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00446f30, FUN_00456960, FUN_0045f220, FUN_00466880, _ltoa, _strdup.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_CalleeOf_Named_effDeviceEffect_00466880(int param_1,int param_2)
