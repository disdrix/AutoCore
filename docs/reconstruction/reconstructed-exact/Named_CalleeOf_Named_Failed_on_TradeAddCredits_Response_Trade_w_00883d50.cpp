// =============================================================================
// Named_CalleeOf_Named_Failed_on_TradeAddCredits_Response_Trade_w_00883d50
// -----------------------------------------------------------------------------
// Stable ID: aa_00883d50
// Callee of Named_Failed_on_TradeAddCredits_Response_Trade_window_
...
// PURPOSE (auto): Called from Named_Failed_on_TradeAddCredits_Response_Trade_w: progression/economy helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void Named_CalleeOf_Named_Failed_on_TradeAddCredits_Response_Trade_w_00883d50(char param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3)
