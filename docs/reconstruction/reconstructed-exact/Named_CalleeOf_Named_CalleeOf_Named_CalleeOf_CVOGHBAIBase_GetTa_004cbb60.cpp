// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGHBAIBase_GetTa_004cbb60
// -----------------------------------------------------------------------------
// Stable ID: aa_004cbb60
// Callee of Named_CalleeOf_Named_CalleeOf_CVOGHBAIBase_GetTargetFromAggro
// Address:   0x004cbb60  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_CVOGHBAIBase_GetTargetFromAggro: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~120 non-empty decompiler lines.
//  - Control keywords: if×14, return×2, do×1, goto×1, while×1.
//  - Notable callees: FUN_004192f0×2, FUN_004192a0, FUN_004cbb60, FUN_005a2de0, _CxxThrowException, exception::exception.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGHBAIBase_GetTa_004cbb60(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ *param_4,uint32_t /* width from decompiler */ param_5)
