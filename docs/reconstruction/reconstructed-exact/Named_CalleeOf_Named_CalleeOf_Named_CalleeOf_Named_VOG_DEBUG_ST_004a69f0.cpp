// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST_004a69f0
// -----------------------------------------------------------------------------
// Stable ID: aa_004a69f0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP
// Address:   0x004a69f0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004a6820, FUN_004a69f0.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST_004a69f0(int param_1,uint param_2)
