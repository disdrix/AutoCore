// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGCharacter_Seri_0053a520
// -----------------------------------------------------------------------------
// Stable ID: aa_0053a520
// Callee of Named_CalleeOf_Named_CalleeOf_CVOGCharacter_SerializeCreatePack
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_CVOGCharacter_SerializeCreatePack: packet/network helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGCharacter_Seri_0053a520(int param_1,int param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
