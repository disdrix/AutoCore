// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_006868a0
// -----------------------------------------------------------------------------
// Stable ID: aa_006868a0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO
// Address:   0x006868a0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_006868a0(int param_1,uint8_t param_2)



{

  *(uint8_t *)(*(int *)(param_1 + 0x10) + 0x14) = param_2;
