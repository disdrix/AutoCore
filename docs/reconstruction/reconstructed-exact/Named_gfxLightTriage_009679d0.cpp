...
/*
 * Behavioral notes:
 * String-driven rename evidence: "gfxLightTriage"
 *
...
uint32_t /* width from decompiler */ Named_gfxLightTriage_009679d0(int param_1,int param_2)
