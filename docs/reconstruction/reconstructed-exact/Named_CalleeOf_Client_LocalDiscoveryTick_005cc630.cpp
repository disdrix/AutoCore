// =============================================================================
// Named_CalleeOf_Client_LocalDiscoveryTick_005cc630
// -----------------------------------------------------------------------------
// Stable ID: aa_005cc630
// Callee of Client_LocalDiscoveryTick
...
// PURPOSE (auto): Called from Client_LocalDiscoveryTick: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
uint __fastcall Named_CalleeOf_Client_LocalDiscoveryTick_005cc630(int param_1)
