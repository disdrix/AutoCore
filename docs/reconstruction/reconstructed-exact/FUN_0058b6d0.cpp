...
// PURPOSE (auto): Scaffold unit for FUN_0058b6d0 @ 0x0058b6d0
// Stable ID: aa_0058b6d0
...
uint32_t /* width from decompiler */ FUN_0058b6d0(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3)
