// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGHBAIDriver_DoLogic_005075f0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_CVOGHBAIDriver_DoLogic: drive/input helper. Evidence string: "Crazy null checking on the flipper has failed! v:%u m:%u w:%u f:%u". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: CVOGHBBase_AttachOwnerObject, CVOGHBBase_SetPeriodAndCounter, CVOGHBBase_ctor, FUN_005075f0, FUN_005083f0, FUN_0055fe50, FUN_00600140, FUN_007a4480.
//  - Return sites: 3.
...
uint32_t /* width from decompiler */ * __thiscall Named_CalleeOf_Named_CalleeOf_CVOGHBAIDriver_DoLogic_005075f0(uint32_t /* width from decompiler */ *param_1,int *param_2,uint32_t /* width from decompiler */ param_3)
