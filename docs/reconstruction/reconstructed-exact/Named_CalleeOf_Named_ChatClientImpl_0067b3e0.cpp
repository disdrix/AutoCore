// =============================================================================
// Named_CalleeOf_Named_ChatClientImpl_0067b3e0
// -----------------------------------------------------------------------------
// Stable ID: aa_0067b3e0
// Callee of Named_ChatClientImpl (+1 other named callers)
// Address:   0x0067b3e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0067b3e0, closesocket.
//  - Return sites: 1.
...
void __fastcall Named_CalleeOf_Named_ChatClientImpl_0067b3e0(SOCKET *param_1)
