// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mis_008fee00
// -----------------------------------------------------------------------------
// Stable ID: aa_008fee00
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_createNDUI
// Address:   0x008fee00  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_createNDUI: mission/objective helper. Evidence string: "i_d_body_2d_btn_trim.xml". Supports parent flow (not a free-standing entry point).
// Embedded strings (evidence):
//   - "i_d_body_2d_btn_trim.xml"
...
//  - Control keywords: if×11, do×6, while×6, for×2, return×2.
//  - Notable callees: FUN_004fc4c0, FUN_0079c860, FUN_007b5dd0, FUN_008fc740, FUN_008fd160, FUN_008fee00, __RTDynamicCast, sprintf.
//  - Strings: "i_d_body_2d_btn_trim.xml"; "i_d_body_2d_wnd_trim_icon.xml"; "_0%i_t"; "_%i_t".
//  - Return sites: 2.
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mis_008fee00(int *param_1)
    ...
    if (0 < param_1[0x145]) {
      ...
      if (0 < param_1[0x147]) {
        ...
        do {
          ...
          *(uint32_t /* width from decompiler */ *)(param_1[0x1cf] + iVar11 * 4) = uVar6;
      ...
      if (0 < param_1[0x147]) {
        ...
        do {
          ...
          *(uint32_t /* width from decompiler */ *)(param_1[0x1cb] + iVar11 * 4) = uVar6;
      ...
      if (0 < param_1[0x145]) {
        ...
        do {
          ...
          *(uint8_t *)(*(int *)(iVar11 + piVar3[0x180]) + 3) = 0;
          ...
          if ((iVar7 != 0) && (*(int *)(iVar7 + 0x508) != 0)) {
            ...
            puVar4 = (uint32_t /* width from decompiler */ *)(*(int *)(iVar11 + piVar3[0x180]) + -1);

            do {

              puVar12 = puVar4;

              puVar4 = (uint32_t /* width from decompiler */ *)((int)puVar12 + 1);

            } while (*(char *)((int)puVar12 + 1) != '\0');

            *(uint32_t /* width from decompiler */ *)((int)puVar12 + 1) = DAT_00a2c53c;

            *(uint8_t *)((int)puVar12 + 5) = DAT_00a2c540;
