// =============================================================================
// Named_CalleeOf_Client_DebugListMissionsStatus_00800af0
// -----------------------------------------------------------------------------
// Stable ID: aa_00800af0
// Callee of Client_DebugListMissionsStatus (+1 other named callers)
...
// PURPOSE (auto): Called from Client_DebugListMissionsStatus: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Client_DebugListMissionsStatus (+1 other named callers).
...
void Named_CalleeOf_Client_DebugListMissionsStatus_00800af0(int param_1,int param_2,int param_3,uint32_t /* width from decompiler */ param_4,uint32_t /* width from decompiler */ *param_5)
