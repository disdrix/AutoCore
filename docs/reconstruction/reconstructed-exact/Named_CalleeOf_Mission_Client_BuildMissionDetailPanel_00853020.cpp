// =============================================================================
// Named_CalleeOf_Mission_Client_BuildMissionDetailPanel_00853020
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Mission_Client_BuildMissionDetailPanel: mission/objective helper. Evidence string: ".dds". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Mission_Client_BuildMissionDetailPanel_00853020(int param_1,int param_2,int param_3)
