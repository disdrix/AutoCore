...
// PURPOSE (auto): Scaffold unit for Gfx_NDAssetImage_GetPixel @ 0x00788ee0
// Stable ID: aa_00788ee0
...
//  - Notable callees: CONCAT31, Gfx_NDAssetImage_GetPixel, FUN_007a4480, NDAssetImage::GetPixel.
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "NDAssetImage::GetPixel() - request of pixel [%d,%d] is outside image[%dx%d] or not locked."
 * Domain alias of FUN_00788ee0 (FUN_* retained)
 *
...
uint __thiscall Gfx_NDAssetImage_GetPixel(int param_1,uint param_2,uint param_3)
