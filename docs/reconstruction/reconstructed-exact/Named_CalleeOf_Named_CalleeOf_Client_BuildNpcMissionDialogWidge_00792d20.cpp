// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_BuildNpcMissionDialogWidge_00792d20
// -----------------------------------------------------------------------------
// Stable ID: aa_00792d20
// Callee of Named_CalleeOf_Client_BuildNpcMissionDialogWidgets (+6 other named callers)
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_BuildNpcMissionDialogWidgets: mission/objective helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_CalleeOf_Client_BuildNpcMissionDialogWidgets (+6 other named callers).
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Named_CalleeOf_Client_BuildNpcMissionDialogWidge_00792d20(uint32_t /* width from decompiler */ *param_1)
