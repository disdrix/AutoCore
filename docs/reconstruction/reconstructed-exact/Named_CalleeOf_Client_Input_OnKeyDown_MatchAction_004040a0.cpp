// =============================================================================
// Named_CalleeOf_Client_Input_OnKeyDown_MatchAction_004040a0
// -----------------------------------------------------------------------------
// Stable ID: aa_004040a0
// Callee of Client_Input_OnKeyDown_MatchAction
// Address:   0x004040a0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Client_Input_OnKeyDown_MatchAction_004040a0(uint32_t /* width from decompiler */ param_1,int *param_2)
