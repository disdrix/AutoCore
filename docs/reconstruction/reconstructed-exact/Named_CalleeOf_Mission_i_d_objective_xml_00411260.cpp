// =============================================================================
// Named_CalleeOf_Mission_i_d_objective_xml_00411260
// -----------------------------------------------------------------------------
// Stable ID: aa_00411260
// Callee of Mission_i_d_objective_xml
// Address:   0x00411260  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00411260, InitializeCriticalSection.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Mission_i_d_objective_xml_00411260(uint32_t /* width from decompiler */ *param_1)
