...
// Address:   0x0051fff0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0051fff0 @ 0x0051fff0
// Stable ID: aa_0051fff0
...
//  - Notable callees: FUN_0051fff0, FUN_00609e60.
//  - Return sites: 1.
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_1 + -0xd9c) + 4) + -0xd88 + param_1) = uVar3;
