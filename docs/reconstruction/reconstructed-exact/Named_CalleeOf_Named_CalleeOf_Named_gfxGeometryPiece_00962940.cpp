// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_gfxGeometryPiece_00962940
// -----------------------------------------------------------------------------
...
uint __thiscall Named_CalleeOf_Named_CalleeOf_Named_gfxGeometryPiece_00962940(int *param_1,float param_2,int *param_3,float param_4,float param_5)
...

{
  ...
  while( true ) {
    ...
    if (2 < iVar8) {
      ...
      if ((param_1[2] != 0) && (cVar5 = Named_CalleeOf_Named_CalleeOf_Named_gfxGeometryPiece_00962940(fVar1,piVar2,param_4,param_5), cVar5 != '\0'))
      ...
      if (*(float *)((int)fVar1 + 0x10 + iVar8 * 4) <= g_flZero) {
        ...
        if ((*param_1 != 0) && (param_4 < (float)param_3)) {
          ...
          cVar5 = Named_CalleeOf_Named_CalleeOf_Named_gfxGeometryPiece_00962940(fVar1,piVar2,fVar3,*puVar7);
      ...
      if ((iVar8 != 0) && ((float)param_3 < param_5)) {
        ...
        cVar5 = Named_CalleeOf_Named_CalleeOf_Named_gfxGeometryPiece_00962940(fVar1,piVar2,*puVar7,param_5);
