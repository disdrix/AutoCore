// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_Client_InitI_00805900
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance: callee helper. Evidence string: "CLCDGfx::Initialize(): failed to create compatible DC.\n". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: CLCDGfx::Initialize×4, FUN_007a4480×4, FUN_00805860×4, CreateCompatibleDC, CreateDIBSection, FUN_00805900.
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_Client_InitI_00805900(uint32_t /* width from decompiler */ param_1,int param_2)
