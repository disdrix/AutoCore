// =============================================================================
// Named_CalleeOf_CVOGWaypoint_UpdateState_005d5cc0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from CVOGWaypoint_UpdateState: AI/path helper. Evidence string: "CVOGWaypoint::DoFollowObjectShortcutsUpdate". Supports parent flow (not a free-standing entry point).
...
void __fastcall Named_CalleeOf_CVOGWaypoint_UpdateState_005d5cc0(int param_1)
