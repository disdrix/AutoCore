// =============================================================================
// FUN_004b4620  (twin: ObjectMotion_SlotTick_Inferred.cpp)
// -----------------------------------------------------------------------------
...
// Forward decls — widths from decompiler / sealed peers
...
// float10 return modeled as long double for fidelity notes
...
void __thiscall FUN_004b1100(int *self, int flag, int dirty, float dt);
void __thiscall FUN_004b18f0(int *self, int flag);

// thiscall; ret 8; AL 0|1. param_2 is int flag bit-cast as float in Ghidra.
