...
uint32_t /* width from decompiler */ Auth_AuthClientImpl_00728c20(int param_1,char *param_2,char *param_3,uint32_t /* width from decompiler */ param_4,int param_5)
