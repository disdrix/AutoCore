// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_RecvBroadcast_00573af0
// -----------------------------------------------------------------------------
// Stable ID: aa_00573af0
// Callee of Named_CalleeOf_Client_RecvBroadcast
// Address:   0x00573af0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00573af0, _stricmp.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Named_CalleeOf_Client_RecvBroadcast_00573af0(int param_1,char *param_2)
