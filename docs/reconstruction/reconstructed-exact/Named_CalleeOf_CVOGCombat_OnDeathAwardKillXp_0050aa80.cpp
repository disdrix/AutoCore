// =============================================================================
// Named_CalleeOf_CVOGCombat_OnDeathAwardKillXp_0050aa80
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ Named_CalleeOf_CVOGCombat_OnDeathAwardKillXp_0050aa80(int param_1,int *param_2,RACE_ID_INFERRED param_3,int param_4)
