...
// PURPOSE (auto): Scaffold unit for Inv_Invalid_CBID_bad_item @ 0x005310a0
// Stable ID: aa_005310a0
...
//  - Notable callees: CONCAT31, CVOGReaction_GiveItemByCbid, Client_SendInventoryAddItem, FUN_00512160, FUN_00513e70, Inv_Invalid_CBID_bad_item, FUN_007a4480, d.
//  - Strings: "Invalid CBID: %d (bad item)".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Invalid CBID: %d (bad item)"
 * Domain alias of FUN_005310a0 (FUN_* retained)
 *
...
uint __thiscall Inv_Invalid_CBID_bad_item(int param_1,int param_2)
