// =============================================================================
// Named_CalleeOf_Named_ecc_sys_007715b0
// -----------------------------------------------------------------------------
// Stable ID: aa_007715b0
// Callee of Named_ecc_sys (+1 other named callers)
// Address:   0x007715b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
int __fastcall Named_CalleeOf_Named_ecc_sys_007715b0(uint32_t /* width from decompiler */ param_1,int *param_2)
