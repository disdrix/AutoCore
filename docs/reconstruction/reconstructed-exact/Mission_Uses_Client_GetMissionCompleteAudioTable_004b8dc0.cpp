...
// =============================================================================
// Mission_Uses_Client_GetMissionCompleteAudioTable_004b8dc0
// -----------------------------------------------------------------------------
...
//           Behavior preserved from FUN_004b8dc0 clean capture (not modernized).
//
...
//           docs/reconstruction/raw/aa_004b8dc0_*.md
//           Original Ghidra symbol: FUN_004b8dc0
//
// Exactness: Body mirrors reconstructed-exact/FUN_004b8dc0*.cpp when present.
...
void __thiscall Mission_Uses_Client_GetMissionCompleteAudioTable_004b8dc0(int param_1,char param_2,uint32_t /* width from decompiler */ param_3)
