...
// Address:   0x004deb20  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Domain alias Gfx_NumGfxDebug for FUN_004deb20 @ 0x004deb20
// Stable ID: aa_004deb20
...
//   - "(%d)%d "
//   - "\nNumGfx:%d \n"
//   - "******* Map (%s) loaded in: (%f) sec.\n"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~667 non-empty decompiler lines.
//  - Control keywords: if×52, while×18, do×17, for×10, return×6, goto×6.
//  - Notable callees: FUN_0076c3c0×37, FUN_0076c4a0×14, FUN_0076c4d0×14, sprintf×5, FUN_007a4480×3, CONCAT44×2, CVOGReaction_GiveItemByCbid×2, CVOGReaction_RemoveObject×2.
//  - Strings: "Seek error, seeking %li bytes from current"; "!!!!!!!!!!!!!!!@@@@@@@@\nTotal:"; "(%d)%d "; "\nNumGfx:%d \n".
//  - Return sites: 6.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "
NumGfx:%d 
"
 * Domain alias of FUN_004deb20 (FUN_* retained)
 *
...
Gfx_NumGfxDebug(void *param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ *param_4)
...

{
  ...
  uint32_t /* width from decompiler */ local_e34;

  int local_e30;

  uint32_t /* width from decompiler */ local_e2c;
  ...
  uint32_t /* width from decompiler */ local_d74 [15];
  ...
  uint32_t /* width from decompiler */ uStack_d20;

  uint32_t /* width from decompiler */ uStack_d1c;

  uint32_t /* width from decompiler */ uStack_d18;

  uint32_t /* width from decompiler */ uStack_d14;
  ...
  if (*(int *)((int)param_1 + 0xe4f8) != 0) {
    ...
    *(uint8_t *)((int)param_1 + 0x40) = 0;

    FUN_004e2880(*(uint32_t /* width from decompiler */ *)(*(int *)((int)param_1 + 0x38) + 4));
    ...
    *(uint32_t /* width from decompiler */ *)((int)param_1 + 0x3c) = 0;

    *(uint32_t /* width from decompiler */ *)*(uint32_t /* width from decompiler */ *)((int)param_1 + 0x38) = *(uint32_t /* width from decompiler */ *)((int)param_1 + 0x38);
    ...
    *(int *)(*(int *)((int)param_1 + 0x38) + 8) = *(int *)((int)param_1 + 0x38);
    ...
    do {
      ...
      *(uint32_t /* width from decompiler */ *)((int)local_d74 + iVar12) = uVar4;
    ...
    *(uint8_t *)(*(int *)((int)param_1 + 0xe894) + 0x8b) = 1;

    QueryPerformanceFrequency(local_cd0);

    QueryPerformanceCounter(&local_d28);

    *(uint32_t /* width from decompiler */ **)((int)param_1 + 0xe504) = param_4;
    ...
    if (piVar5 != (int *)0x0) {
      ...
      *(DWORD *)((int)param_1 + 0xe6dc) = local_d34.s.LowPart + (0xfffffffe < local_d38);
      ...
      uVar17 = (uint8_t)((uint)unaff_ESI >> 0x18);
...
LAB_004def89:
                ...
                cVar3 = (**(code **)(*piVar6 + 0xa4))
                                  ...
                                  (piVar5,*(uint32_t /* width from decompiler */ *)((int)param_1 + 0x8c),auStack_e0c + 0x1b,0)
                ...
                if (cVar3 == '\0') {
                  ...
                  if ((int)local_e54 < (int)(uint)*(ushort *)((int)param_1 + 0x940)) {
                    ...
                    uStack_e38 = FUN_004e53a0(*(uint32_t /* width from decompiler */ *)

                                               ((int)param_1 + (local_e54 * 3 + 300) * 8));

                    if (uStack_e38 != 0) {

                      *(uint32_t /* width from decompiler */ *)((int)param_1 + 0xe6d8) =

                           *(uint32_t /* width from decompiler */ *)((int)param_1 + local_e54 * 0x18 + 0x958);

                      *(uint32_t /* width from decompiler */ *)((int)param_1 + 0xe6dc) =

                           *(uint32_t /* width from decompiler */ *)((int)param_1 + local_e54 * 0x18 + 0x95c);

                      FUN_004db820();

                      iVar12 = *(int *)(*(int *)(local_e3c + 4) + 4);

                      uStack_d20 = *(uint32_t /* width from decompiler */ *)(iVar12 + 0x84 + local_e3c);

                      uStack_d1c = *(uint32_t /* width from decompiler */ *)(iVar12 + 0x88 + local_e3c);

                      uStack_d18 = *(uint32_t /* width from decompiler */ *)(iVar12 + 0x8c + local_e3c);

                      uStack_d14 = *(uint32_t /* width from decompiler */ *)(iVar12 + 0x90 + local_e3c);
              ...
              if (param_4 == (uint32_t /* width from decompiler */ *)0x0) goto LAB_004def89;
              ...
              if (cVar3 == '\0') {
                ...
                (*(code *)((uint32_t /* width from decompiler */ *)*piVar6)[0x29])

                          (piVar5,*(uint32_t /* width from decompiler */ *)((int)param_1 + 0x8c),auStack_e0c + 0x1a,0);
...
LAB_004df147:
      ...
      *(uint32_t /* width from decompiler */ *)((int)param_1 + 0xe7fc) = 0;

      *(uint32_t /* width from decompiler */ *)((int)param_1 + 0xe800) = 0;

      *(uint32_t /* width from decompiler */ *)((int)param_1 + 0xe804) = 0;
              ...
              if (param_4 == (uint32_t /* width from decompiler */ *)0x0) {
                ...
                if ((iVar12 == 0) || (*(int *)(iVar12 + 0xc) == 0)) {
                  ...
                  cVar3 = (**(code **)(*piVar6 + 0xa4))
                                    ...
                                    (piVar5,*(uint32_t /* width from decompiler */ *)((int)param_1 + 0x8c),auStack_e0c + 0x1f,
...
LAB_004df695:
      ...
      *(uint32_t /* width from decompiler */ *)((int)param_1 + 0xe504) = 0;
      ...
      puVar14 = (uint32_t /* width from decompiler */ *)(auStack_abd + 1);

      for (iVar12 = 7; iVar12 != 0; iVar12 = iVar12 + -1) {

        *puVar14 = *(uint32_t /* width from decompiler */ *)pcVar9;
      ...
      *(uint16_t *)puVar14 = *(uint16_t *)pcVar9;
      ...
      *(char *)((int)puVar14 + 2) = pcVar9[2];
      ...
      puVar14 = (uint32_t /* width from decompiler */ *)auStack_abd;

      do {

        puVar16 = puVar14;

        puVar14 = (uint32_t /* width from decompiler */ *)((int)puVar16 + 1);

      } while (*(char *)((int)puVar16 + 1) != '\0');

      *(uint32_t /* width from decompiler */ *)((int)puVar16 + 1) = DAT_009cca30;

      *(uint16_t *)((int)puVar16 + 5) = DAT_009cca34;
      ...
      *(uint32_t /* width from decompiler */ *)((int)puVar16 + 1) = DAT_009cca28;

      *(uint16_t *)((int)puVar16 + 5) = DAT_009cca2c;
