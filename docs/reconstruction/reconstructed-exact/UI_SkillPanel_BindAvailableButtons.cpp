// =============================================================================
// UI_SkillPanel_BindAvailableButtons
// -----------------------------------------------------------------------------
// Purpose:  Binds skill-panel widgets from i_d_s_2d_btn_skill_available/btn.xml templates.
//
// Address:  0x00824140  (autoassault.exe, image base 0x400000)
// Stable:   aa_00824140
// System:   skills-abilities
//
// String evidence: "i_d_s_2d_btn_skill_available.xml" / "i_d_s_2d_btn_skill_btn.xml"
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_00824140.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_00824140 using string evidence: "i_d_s_2d_btn_skill_available.xml" / "i_d_s_2d_btn_skill_btn.xml"
