...
//  - Notable callees: FUN_00462340, FUN_00462570, FUN_00462770, FUN_00743c50, FUN_0076cec0, FUN_00985800, vog_LogMessage.
//  - Strings: "IBFactory Shutdown - Slice still allocated! (%d Indices)".
//  - Return sites: 4.

// =============================================================================
// Named_gfxIndexBufferFactory_00985800
// -----------------------------------------------------------------------------
// Stable ID: aa_00985800
// Address:   0x00985800  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void Named_gfxIndexBufferFactory_00985800(int param_1)
...

{
  ...
  do {
    ...
    if (puVar13 == puVar2) {
      ...
      FUN_00462770(*(uint32_t /* width from decompiler */ *)(*(int *)(iVar14 + 0x14) + 4));
      ...
      do {
        ...
        *puVar15 = 0;
        ...
        if (*(char *)((int)pvVar7 + 0x11) == '\0') {
          ...
          FUN_00462570(*(uint32_t /* width from decompiler */ *)((int)pvVar7 + 8));
