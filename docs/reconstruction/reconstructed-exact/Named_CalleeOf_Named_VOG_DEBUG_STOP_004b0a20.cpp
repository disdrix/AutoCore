// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_004b0a20
// -----------------------------------------------------------------------------
...
void Named_CalleeOf_Named_VOG_DEBUG_STOP_004b0a20(int param_1,int param_2,int param_3,uint32_t /* width from decompiler */ param_4)
...
LAB_004b0ab7:
    ...
    if ((int)(local_8 - param_1 & 0xfffffff8U) < (int)(param_2 - local_4 & 0xfffffff8U)) {
      ...
      Named_CalleeOf_Named_VOG_DEBUG_STOP_004b0a20(param_1,local_8,param_3,param_4);
      ...
      Named_CalleeOf_Named_VOG_DEBUG_STOP_004b0a20(local_4,param_2,param_3,param_4);
