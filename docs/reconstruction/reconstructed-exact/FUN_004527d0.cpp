...
// PURPOSE (auto): Scaffold unit for FUN_004527d0 @ 0x004527d0
// Stable ID: aa_004527d0
...
uint32_t /* width from decompiler */ * __thiscall FUN_004527d0(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3)
