...
// =============================================================================
// Skill_DbLoadSkillsCharacters
// -----------------------------------------------------------------------------
// Purpose:  ADO/DB bulk-load of character skill definitions from the `//vSkillsCharacters/row` result set into in-memory skill trees. Reads IDSkill, target/affected CO types, status effect, and IDSkillPrerequisite1..3 (and related class/race columns), then allocates skill element child rows via Skill_DbLoadSkillElements.
//
...
//   - "//vSkillsCharacters/row"
//   - "IDSkill"
//   - "IDSkillPrerequisite1"
//   - "IDSkillPrerequisite2"
//   - "IDSkillPrerequisite3"
//   - "intTargetType"
//   - "intStatusEffect"
//   - "IDClass"
//   - "IDRace"
//
// Notable callees:
//   - FUN_007d9440 (Skill_DbLoadSkillElements)
//   - FUN_0041a810 / FUN_004231d0 (ADO field helpers)
//   - SysAllocString
//   - operator_new__
//   - FUN_007a4480 (log)
//
// Notes:    Large COM/ADO reader (~40KB). Treat as skill definition manager ingest path. param_1 is connection/query context (char*).
//
...
uint32_t /* width from decompiler */ __fastcall Skill_DbLoadSkillsCharacters(char *param_1)
