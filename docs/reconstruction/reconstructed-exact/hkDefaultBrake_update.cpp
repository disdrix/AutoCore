// =============================================================================
// hkDefaultBrake_update
// -----------------------------------------------------------------------------
// Stable ID: aa_0064e6f0
// Address:   0x0064e6f0  (autoassault.exe, image base 0x400000)
// System:    unknown
...

{
    ...
    if (bVar6) {
      ...
      do {
        if (*(float *)(*(int *)(param_1 + 0x34) + iVar7 * 4) <= fVar2) {
          *(uint8_t *)(iVar7 + *(int *)(param_1 + 0x1c)) = 1;
        }
        iVar7 = iVar7 + 1;
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x50) = *(uint32_t /* width from decompiler */ *)(param_1 + 0x4c);
  return;
}
