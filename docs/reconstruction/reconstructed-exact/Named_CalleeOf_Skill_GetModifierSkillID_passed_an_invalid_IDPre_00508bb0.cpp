// =============================================================================
// Named_CalleeOf_Skill_GetModifierSkillID_passed_an_invalid_IDPre_00508bb0
// -----------------------------------------------------------------------------
// Stable ID: aa_00508bb0
// Callee of Skill_GetModifierSkillID_passed_an_invalid_IDPrefix_i
// Address:   0x00508bb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
int __thiscall Named_CalleeOf_Skill_GetModifierSkillID_passed_an_invalid_IDPre_00508bb0(int param_1,int param_2)
