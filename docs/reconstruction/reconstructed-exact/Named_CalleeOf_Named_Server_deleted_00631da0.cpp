// =============================================================================
// Named_CalleeOf_Named_Server_deleted_00631da0
// -----------------------------------------------------------------------------
// Stable ID: aa_00631da0
// Callee of Named_Server_deleted (+4 other named callers)
// Address:   0x00631da0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
int __fastcall Named_CalleeOf_Named_Server_deleted_00631da0(int param_1)
