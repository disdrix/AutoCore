...
//  - Notable callees: FUN_0056eef0, FUN_007a4480, _CxxThrowException, malloc.
//  - Strings: "VOG_DEBUG_STOP".
//  - Return sites: 2.

// =============================================================================
// Named_VOG_DEBUG_STOP_0056eef0
// -----------------------------------------------------------------------------
// Stable ID: aa_0056eef0
// Address:   0x0056eef0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_VOG_DEBUG_STOP_0056eef0(int param_1)
