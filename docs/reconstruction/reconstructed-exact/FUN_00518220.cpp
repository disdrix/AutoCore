...
// FUN_00518220
// -----------------------------------------------------------------------------
// Stable ID: aa_00518220
// Address:   0x00518220  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00518220 @ 0x00518220
// Stable ID: aa_00518220
...
void __thiscall FUN_00518220(uint32_t /* width from decompiler */ *param_1,int param_2,uint32_t /* width from decompiler */ *param_3)
...
LAB_00518296:
      ...
      if (((int)puVar6[1] < (int)puVar5[5]) ||
         ...
         (((int)puVar6[1] <= (int)puVar5[5] && (*puVar6 < (uint)puVar5[4])))) goto LAB_00518296;
