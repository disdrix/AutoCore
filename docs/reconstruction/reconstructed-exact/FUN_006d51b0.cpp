...
// FUN_006d51b0
// -----------------------------------------------------------------------------
// Stable ID: aa_006d51b0
// Address:   0x006d51b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006d51b0 @ 0x006d51b0
// Stable ID: aa_006d51b0
...
//  - Notable callees: FUN_006f63e0×2, FUN_006d51b0.
//  - Return sites: 2.
...
void FUN_006d51b0(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ *param_3,uint32_t /* width from decompiler */ param_4,
...

{
  ...
  if (param_5 != 0) {
    ...
    FUN_006f63e0(param_2,param_1,&local_a0,&local_70,&local_40);

    return;

  }

  FUN_006f63e0(param_2,param_1,&local_a0,&local_70,0);
