// =============================================================================
// Named_CalleeOf_CVOGReaction_RelockContinentObject_004d1d00
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from CVOGReaction_RelockContinentObject: event/reaction helper. Evidence string: "allocatenewobjectfromcbid failed %d Get a programmer". Supports parent flow (not a free-standing entry point). CVOGReaction_RelockContinentObject (+1 other named callers).
...
void __fastcall Named_CalleeOf_CVOGReaction_RelockContinentObject_004d1d00(int param_1)
