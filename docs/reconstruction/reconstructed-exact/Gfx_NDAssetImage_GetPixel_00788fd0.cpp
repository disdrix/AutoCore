// =============================================================================
// Gfx_NDAssetImage_GetPixel_00788fd0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Gfx_NDAssetImage_GetPixel_00788fd0 @ 0x00788fd0
// Stable ID: aa_00788fd0
...
//  - Notable callees: FUN_004336c0, Gfx_NDAssetImage_GetPixel_00788fd0, FUN_007a4480, NDAssetImage::GetPixel.
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "NDAssetImage::GetPixel() - request of pixel [%d,%d] is outside image[%dx%d] or not locked."
 * Domain alias of FUN_00788fd0 (FUN_* retained)
 *
...
uint __thiscall Gfx_NDAssetImage_GetPixel_00788fd0(int param_1,uint param_2,uint param_3)
