...
//  - Control keywords: if×14, return×2, for×1, goto×1.
//  - Notable callees: FUN_007a4480×3, FUN_00415720, FUN_00415ac0, FUN_00416ff0, FUN_00429310, FUN_00823790, FUN_00824410, FUN_0083b830.
//  - Strings: "VOG_DEBUG_STOP"; "Duplicate hash insert %u, failing out".
//  - Return sites: 2.

// =============================================================================
// Named_VOG_DEBUG_STOP_0083cdb0
// -----------------------------------------------------------------------------
// Stable ID: aa_0083cdb0
// Address:   0x0083cdb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void Named_VOG_DEBUG_STOP_0083cdb0(int *param_1,uint param_2)
...
LAB_0083cfe4:
      ...
      puVar7 = (uint32_t /* width from decompiler */ *)FUN_00416ff0();
      ...
      *puVar7 = &PTR_LAB_00a6d5fc;
      ...
      puVar7[3] = *(uint32_t /* width from decompiler */ *)(iVar6 + 4);
      ...
      *(uint32_t /* width from decompiler */ **)(iVar6 + 4) = puVar7;
      ...
      if (*(int *)(iVar4 + 0x18) == 0) {
        ...
        *(uint32_t /* width from decompiler */ **)(*(int *)(iVar4 + 0x18) + 0x14) = puVar7;

        puVar7[5] = 0;

        puVar7[6] = *(uint32_t /* width from decompiler */ *)(iVar4 + 0x18);
