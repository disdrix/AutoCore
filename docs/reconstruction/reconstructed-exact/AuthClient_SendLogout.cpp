...
//  - Notable callees: FUN_0067b110×2, FUN_0043fe60, FUN_0046e280, FUN_006759b0, FUN_0067ba30, FUN_00718c10, FUN_00727c00, FUN_00728ae0.
//  - Strings: "Logout"; "AuthServer".
//  - Return sites: 1.

// =============================================================================
// AuthClient_SendLogout
// -----------------------------------------------------------------------------
// Purpose:  Outbound AuthServer Logout - client logout request.
//
// Address:  0x00728ae0  (autoassault.exe, image base 0x400000)
// Stable:   aa_00728ae0
// System:   auth
//
// String evidence: FUN_00727b70("Logout","AuthServer")
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_00728ae0.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_00728ae0 using string evidence: FUN_00727b70("Logout","AuthServer")
