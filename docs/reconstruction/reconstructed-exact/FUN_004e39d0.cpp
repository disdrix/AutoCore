...
// PURPOSE (auto): Scaffold unit for FUN_004e39d0 @ 0x004e39d0
// Stable ID: aa_004e39d0
...
void __thiscall FUN_004e39d0(int param_1,void *param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
