...
// Address:   0x007b1ec0  (autoassault.exe, image base 0x400000)
// System:    unknown
...

{
  ...
  if (param_4 == 0) {
    ...
    *(uint8_t *)((int)param_1 + 0xd6) = 0;
    ...
    param_1[0x6c] = 0;
    param_1[0x6d] = 0;
    *(uint8_t *)((int)param_1 + 0x1c9) = 0;
    *(uint8_t *)((int)param_1 + 0x1ca) = 0;
                ...
                if (iVar8 == 0) {
                  ...
                  if (iVar8 == 0) {
                    ...
                    if (iVar3 == 0) {
                      FUN_0040d230();
                      (**(code **)(*(int *)bstrString + 0x68))(bstrString,&ppOStack_174);
                      puVar4 = (uint32_t /* width from decompiler */ *)FUN_00402d50(ppOVar10);
                      uStack_28 = 1;
                                                ...
                                                if (iVar8 == 0) {
                                                  ...
                                                  if (iVar8 == 0) {
                                                    ...
                                                    if (pOStack_170 == (BSTR)0x0) {
                                                      ...
                                                      *(uint8_t *)((int)param_1 + 0xd6) = 1;
                                                      *(uint8_t *)((int)param_1 + 0x1c9) = 0;
                                                      *(uint8_t *)((int)param_1 + 0x1ca) = 0;
                                                    }
                                                    else if (pOStack_170 == (BSTR)0x2) {
                                                      *(uint8_t *)((int)param_1 + 0xd6) = 0;
                                                      *(uint8_t *)((int)param_1 + 0x1c9) = 1;
                                                      *(uint8_t *)((int)param_1 + 0x1ca) = 0;
                                                    }
                                                    else if (pOStack_170 == (BSTR)0x3) {
                                                      *(uint8_t *)((int)param_1 + 0xd6) = 0;
                                                      *(uint8_t *)((int)param_1 + 0x1c9) = 1;
                                                      *(uint8_t *)((int)param_1 + 0x1ca) = 1;
                                                    }
                                                  }
                                                  else {
