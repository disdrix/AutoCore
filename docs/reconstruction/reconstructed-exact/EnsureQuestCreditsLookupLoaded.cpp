...
// -----------------------------------------------------------------------------
// Purpose:  Ensure-load wrapper for tQuestCreditsLookup (client table used by
//           Mission_ComputeObjectiveCredits). Always invokes the WAD/DB load
//           path; does not early-out on the ready flag (caller-gated).
//
// Address:  0x00512830  (autoassault.exe, image base 0x400000)
// Body:     0x00512830 – 0x0051286d (62 bytes)
// Stable:   aa_00512830
...
//   status = LoadQuestCreditsLookupFromWad(ECX, &g_pQuestCreditsLookupMap_Inferred)
//           // stack imm 0x00b04258; callee 0x007cc470
//   ECX = *g_pDbReaderCtx_Inferred
...
// Sibling: EnsureQuestBaseCreditsLoaded (0x00512870) — same shape, map 0x00b04264.
//
...
// aa_007cc470 — ECX = DB ctx; stack = address of map root block at 0x00b04258
int  __fastcall LoadQuestCreditsLookupFromWad(void* pDbCtx, void* pMapRoot);
...
// 0x00b04258 — map root; +4 end sentinel; +8 loaded flag (flag not written here)
...
void EnsureQuestCreditsLookupLoaded(void)
{
    ...
    pCtx = g_pDbReaderCtx_Inferred;
    nLoadResult = LoadQuestCreditsLookupFromWad(pCtx, &g_pQuestCreditsLookupMap_Inferred);
