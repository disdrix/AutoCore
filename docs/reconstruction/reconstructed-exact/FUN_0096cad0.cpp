...
// PURPOSE (auto): Scaffold unit for FUN_0096cad0 @ 0x0096cad0
// Stable ID: aa_0096cad0
...
FUN_0096cad0(uint param_1,int param_2,uint param_3,uint param_4,uint32_t /* width from decompiler */ param_5,
