// =============================================================================
// CVOGGraphicsBase_LoadNextChildAsset
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for CVOGGraphicsBase_LoadNextChildAsset @ 0x00583fa0
// Stable ID: aa_00583fa0
...
//  - Notable callees: FUN_0075d610×3, FUN_007a4480×2, FUN_007a6880×2, FUN_007a69d0×2, CVOGGraphicsBase::LoadNextChildAsset, FUN_004eb1c0, FUN_00581e20, CVOGGraphicsBase_LoadNextChildAsset.
//  - Strings: "ForceLoaded child <%s>"; ".dds".
//  - Return sites: 3.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "CVOGGraphicsBase::LoadNextChildAsset() - loading asset <%s> resulted in error code(%d)"
 * Domain alias of FUN_00583fa0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __fastcall CVOGGraphicsBase_LoadNextChildAsset(int param_1)
