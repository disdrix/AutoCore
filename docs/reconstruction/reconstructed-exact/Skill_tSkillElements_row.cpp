...
// =============================================================================
// Skill_tSkillElements_row
// -----------------------------------------------------------------------------
// Purpose:  String-driven human alias for decompiled bulk unit.
//           Primary evidence: "//tSkillElements/row"
//           Named entry point for reconstruction indexing / coverage ledger.
//           Behavior preserved from FUN_007d9440 clean capture (not modernized).
//
...
//           docs/reconstruction/raw/aa_007d9440_*.md
//           Original Ghidra symbol: FUN_007d9440
//
// Exactness: Body mirrors reconstructed-exact/FUN_007d9440*.cpp when present.
...
/*
 * Behavioral notes:
 * String-driven human alias evidence: "//tSkillElements/row"
 *
...
uint32_t /* width from decompiler */ __thiscall Skill_tSkillElements_row(char *param_1,char param_2)
