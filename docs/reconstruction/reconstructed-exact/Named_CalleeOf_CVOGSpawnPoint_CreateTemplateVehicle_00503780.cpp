// =============================================================================
// Named_CalleeOf_CVOGSpawnPoint_CreateTemplateVehicle_00503780
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from CVOGSpawnPoint_CreateTemplateVehicle: spawn/transfer helper. Evidence string: "Found invalid template: %d". Supports parent flow (not a free-standing entry point).
// Embedded strings (evidence):
//   - "Found invalid template: %d"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~256 non-empty decompiler lines.
//  - Control keywords: if×33, goto×8, return×4, do×1, while×1.
//  - Notable callees: FUN_0040dab0×4, FUN_004f79d0×4, FUN_00512160×4, Vehicle_AttachWeapon×3, FUN_0056e730×2, FUN_00402d50, FUN_0040b330, FUN_004c3700.
//  - Strings: "Found invalid template: %d".
//  - Return sites: 4.
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_CVOGSpawnPoint_CreateTemplateVehicle_00503780(void *param_1,float param_2,int param_3,int param_4)
