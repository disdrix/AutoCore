// =============================================================================
// Named_CalleeOf_CVOGHBAIBase_GetTargetFromAggro_0051cb40
// -----------------------------------------------------------------------------
// Stable ID: aa_0051cb40
// Callee of CVOGHBAIBase_GetTargetFromAggro
// Address:   0x0051cb40  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from CVOGHBAIBase_GetTargetFromAggro: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~150 non-empty decompiler lines.
//  - Control keywords: if×22, return×2, do×1, goto×1, while×1.
//  - Notable callees: block×11, FUN_004192a0×3, FUN_004192f0×3, FUN_00421b50, FUN_004cb270, FUN_0051b5d0, FUN_0051cb40, _CxxThrowException.
...
void __thiscall Named_CalleeOf_CVOGHBAIBase_GetTargetFromAggro_0051cb40(int param_1,uint32_t /* width from decompiler */ param_2,int *param_3)
