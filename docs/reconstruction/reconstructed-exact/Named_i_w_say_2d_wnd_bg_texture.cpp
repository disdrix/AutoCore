// =============================================================================
// Named_i_w_say_2d_wnd_bg_texture
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_i_w_say_2d_wnd_bg_texture @ 0x00866900
// Stable ID: aa_00866900
...
//  - Notable callees: FUN_0079c860×3, FUN_00795f20×2, FUN_00792600, FUN_007b5dd0, Named_i_w_say_2d_wnd_bg_texture.
//  - Strings: "i_w_say_2d_wnd_bg_texture.xml"; "i_w_say_2d_edt_recipient.xml"; "i_w_say_2d_edt_msg.xml"; "i_w_say_2d_btn_ok.xml".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "i_w_say_2d_wnd_bg_texture.xml"
 * Domain alias of FUN_00866900 (FUN_* retained)
 *
...
void __fastcall Named_i_w_say_2d_wnd_bg_texture(int *param_1)
