// =============================================================================
// CloneBase_LoadWadFile
// -----------------------------------------------------------------------------
// Stable ID: aa_00541410
// Address:   0x00541410  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ CloneBase_LoadWadFile(void)

{
  ...
  uint32_t /* width from decompiler */ auStack_314 [12];
  ...
  int local_198;
  void *local_194;
  uint32_t /* width from decompiler */ auStack_190 [95];
  void *local_14;
  uint8_t *puStack_10;
  ...
  if (DAT_00b04694 != '\0') {
    ...
    if (0 < local_19c) {
      do {
        ...
        *(uint32_t /* width from decompiler */ *)((int)pvVar2 + 0x930) = 0;
        local_194 = pvVar2;
