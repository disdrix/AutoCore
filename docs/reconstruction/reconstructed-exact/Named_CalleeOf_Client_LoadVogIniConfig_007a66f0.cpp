// =============================================================================
// Named_CalleeOf_Client_LoadVogIniConfig_007a66f0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Client_LoadVogIniConfig: config/load helper. Evidence string: ");

      iVar1 = *(int *)(unaff_ESI + 0x2c);

      if (iVar1 == 1) {

        sprintf(lo". Supports parent flow (not a free-standing entry point). Client_LoadVogIniConfig (+1 other named callers).
...
void Named_CalleeOf_Client_LoadVogIniConfig_007a66f0(void)
