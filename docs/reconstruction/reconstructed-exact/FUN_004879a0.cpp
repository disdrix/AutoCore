...
// PURPOSE (auto): Scaffold unit for FUN_004879a0 @ 0x004879a0
// Stable ID: aa_004879a0
...
void __fastcall FUN_004879a0(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,int param_3)
