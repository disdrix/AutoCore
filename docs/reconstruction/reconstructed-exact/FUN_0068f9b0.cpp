...
// PURPOSE (auto): Scaffold unit for FUN_0068f9b0 @ 0x0068f9b0
// Stable ID: aa_0068f9b0
...
void __thiscall FUN_0068f9b0(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,int param_4)
