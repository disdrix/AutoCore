// =============================================================================
// Named_CalleeOf_Drive_Player_Vehicle_Sound_Volume_008209c0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Drive_Player_Vehicle_Sound_Volume: drive/input helper. Evidence string: "Sound Priority Highest". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: Client_GetMissionCompleteAudioTable, FUN_004073a0, FUN_00818fe0, FUN_008209c0, __RTDynamicCast.
...
void Named_CalleeOf_Drive_Player_Vehicle_Sound_Volume_008209c0(int param_1)
