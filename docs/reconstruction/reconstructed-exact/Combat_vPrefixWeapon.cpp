...
// PURPOSE (auto): Scaffold unit for Combat_vPrefixWeapon @ 0x007d30c0
// Stable ID: aa_007d30c0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//vPrefixWeapon/row"
 * Domain alias of FUN_007d30c0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Combat_vPrefixWeapon(char *param_1,int *param_2,int *param_3)
