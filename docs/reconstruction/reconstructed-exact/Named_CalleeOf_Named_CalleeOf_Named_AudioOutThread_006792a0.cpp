// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_AudioOutThread_006792a0
// -----------------------------------------------------------------------------
// Stable ID: aa_006792a0
// Callee of Named_CalleeOf_Named_AudioOutThread
// Address:   0x006792a0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00679120, FUN_006792a0, thunk_FUN_0076c4d0.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Named_CalleeOf_Named_AudioOutThread_006792a0(int param_1)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x7c) = 8;

  *(uint8_t *)(param_1 + 0x78) = 1;
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x84) = 0xffffffff;
  ...
  if (*(uint *)(param_1 + 0x18) < *(uint *)(*(int *)(param_1 + 4) + 8) / 3) {
    ...
    do {
      ...
      FUN_00679120(*(uint32_t /* width from decompiler */ *)(param_1 + 0x18));
