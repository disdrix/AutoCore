// =============================================================================
// Named_CalleeOf_Client_RecvInventoryUsePaint_004fab40
// -----------------------------------------------------------------------------
...
//  - Notable callees: FUN_004fab40, FUN_00519a30.
//  - Return sites: 2.
...
void __thiscall Named_CalleeOf_Client_RecvInventoryUsePaint_004fab40(int param_1,uint32_t /* width from decompiler */ param_2)
