...
// Address:   0x006fa7d0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006fa7d0 @ 0x006fa7d0
// Stable ID: aa_006fa7d0
...
//  - Notable callees: ABS×11, FUN_006fa6f0×4, CONCAT22×3, FUN_006f80d0×2, FUN_006f7d90, FUN_006f8d00, FUN_006f8e00, FUN_006fa7d0.
//  - Return sites: 2.
...
void __thiscall FUN_006fa7d0(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,uint16_t param_4)
...

{
  ...
  if (0 < *(int *)(param_2 + 0x54)) {
    ...
    if ((_DAT_00a0ef10 <= local_20[uVar15]) && (_DAT_00a0ef10 <= local_30[local_6c])) {
      ...
      uVar13 = FUN_006f80d0(*(uint32_t /* width from decompiler */ *)(param_1 + 0xb0 + uVar15 * 4));

      uVar19 = 0x6f;

      uVar14 = FUN_006f80d0(*(uint32_t /* width from decompiler */ *)(param_1 + 0xc0 + local_6c * 4));

      param_3 = CONCAT22(uVar13,(uint16_t)local_68);
      ...
      if (DAT_00d09690 != '\0') {
        ...
        uVar9 = *(uint32_t /* width from decompiler */ *)(&DAT_00a0ef24 + local_6c * 2);

        local_50 = -local_50;

        uVar10 = *(uint32_t /* width from decompiler */ *)(&DAT_00a0ef24 + local_68 * 2);

        uVar11 = *(uint32_t /* width from decompiler */ *)(&UNK_00a0ef28 + local_68 * 4);

        local_4c = -local_4c;

        uVar12 = *(uint32_t /* width from decompiler */ *)(&UNK_00a0ef28 + local_6c * 4);
