...
void Named_VOG_DEBUG_STOP_007fde80(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,int param_3,int param_4,int param_5)
