...
// PURPOSE (auto): Scaffold unit for GameUtils_createRagDoll @ 0x005f44c0
// Stable ID: aa_005f44c0
...
uint32_t /* width from decompiler */ GameUtils_createRagDoll(int param_1,int param_2,int param_3)
