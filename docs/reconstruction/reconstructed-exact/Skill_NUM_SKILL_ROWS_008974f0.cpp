...
/*
 * Behavioral notes:
 * String-driven rename evidence: "NUM_SKILL_ROWS"
 *
...
void __thiscall Skill_NUM_SKILL_ROWS_008974f0(int param_1,int *param_2,int param_3)
