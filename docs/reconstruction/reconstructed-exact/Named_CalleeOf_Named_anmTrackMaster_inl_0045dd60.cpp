// =============================================================================
// Named_CalleeOf_Named_anmTrackMaster_inl_0045dd60
// -----------------------------------------------------------------------------
// Stable ID: aa_0045dd60
// Callee of Named_anmTrackMaster_inl
// Address:   0x0045dd60  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00769e40×2, FUN_0045dd60, stoChunkReader_EnterChunkScope, stoChunkReader_readF32Array.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_anmTrackMaster_inl_0045dd60(void)
