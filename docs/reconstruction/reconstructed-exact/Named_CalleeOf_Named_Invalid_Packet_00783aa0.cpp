// =============================================================================
// Named_CalleeOf_Named_Invalid_Packet_00783aa0
// -----------------------------------------------------------------------------
// Stable ID: aa_00783aa0
// Callee of Named_Invalid_Packet (+13 other named callers)
...
// PURPOSE (auto): Called from Named_Invalid_Packet: packet/network helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_Invalid_Packet (+13 other named callers).
...
void Named_CalleeOf_Named_Invalid_Packet_00783aa0(char *param_1)
