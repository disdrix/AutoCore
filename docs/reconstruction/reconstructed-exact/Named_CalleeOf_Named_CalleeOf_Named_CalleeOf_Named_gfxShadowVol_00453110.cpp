// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVol_00453110
// -----------------------------------------------------------------------------
// Stable ID: aa_00453110
// Callee of Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVolume
// Address:   0x00453110  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00455b80×2, FUN_004560f0×2, FUN_00537860×2, FUN_00453110, FUN_004540b0, FUN_00455ba0, FUN_00455e10, FUN_00480c80.
//  - Return sites: 4.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVol_00453110(int param_1,int param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
...

{
  ...
  if (param_3 != 0) {
    ...
    if ((uint)((iVar3 - param_2) / 0xc) < param_3) {
      ...
      FUN_00455b80(param_2,iVar3,param_3 * 0xc + param_2);
      ...
      *(int *)(param_1 + 8) = *(int *)(param_1 + 8) + param_3 * 0xc;
    ...
    uVar5 = FUN_00455b80(iVar2,iVar3,iVar3);

    *(uint32_t /* width from decompiler */ *)(param_1 + 8) = uVar5;

    FUN_00455ba0(param_2,iVar2,iVar3);
