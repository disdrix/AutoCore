// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGCharacter_ApplyCreateFromPack_005c9c50
// -----------------------------------------------------------------------------
// Stable ID: aa_005c9c50
// Callee of Named_CalleeOf_CVOGCharacter_ApplyCreateFromPacket
// Address:   0x005c9c50  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Named_CalleeOf_CVOGCharacter_ApplyCreateFromPack_005c9c50(int param_1)
...

{
  ...
  if (*(int *)(param_1 + 0xd4) == 0) {
    ...
    *(void **)(param_1 + 0xd4) = pvVar1;

  }

  ExceptionList = local_c;

  return *(uint32_t /* width from decompiler */ *)(param_1 + 0xd4);
