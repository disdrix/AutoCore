// =============================================================================
// Inv_invmis_item_icon_bg
// -----------------------------------------------------------------------------
// Stable ID: aa_008be1b0
// Address:   0x008be1b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for Inv_invmis_item_icon_bg @ 0x008be1b0
// Stable ID: aa_008be1b0
// Embedded strings (evidence for future rename):
//   - "i_d_invmis_2d_wnd_title.xml"
//   - "i_d_invmis_2d_wnd_icon.xml"
//   - "i_d_invmis_2d_wnd_title_cover.xml"
//   - "i_d_invmis_2d_sb_inv.xml"
//   - "i_d_invmis_2d_wnd_item_name.xml"
//   - "i_d_invmis_2d_wnd_item_icon_bg.xml"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~323 non-empty decompiler lines.
//  - Control keywords: if×15, do×1, while×1, return×1.
//  - Notable callees: FUN_007b5dd0×10, FUN_00410420, FUN_0078f890, FUN_00792600, FUN_008bdb10, Inv_invmis_item_icon_bg.
//  - Strings: "i_d_invmis_2d_wnd_title.xml"; "i_d_invmis_2d_wnd_icon.xml"; "i_d_invmis_2d_wnd_title_cover.xml"; "i_d_invmis_2d_sb_inv.xml".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "i_d_invmis_2d_wnd_item_icon_bg.xml"
 * Domain alias of FUN_008be1b0 (FUN_* retained)
 *
...
void __fastcall Inv_invmis_item_icon_bg(int *param_1)
...

{
  ...
  uint32_t /* width from decompiler */ *puStack_1ac;
  ...
  uint32_t /* width from decompiler */ *puStack_180;
  ...
  do {
    ...
    *piVar3 = iVar4;
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)*piVar3 + 0x120))();
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)piVar3[8] + 0x120))(&stack0xfffffea4,1);
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)piVar3[0xc] + 0x120))(&pcStack_158,1,0);

    uStack_1a4 = *puVar5;

    puStack_1a0 = (uint8_t *)(iVar4 + iVar2);
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)piVar3[0x10] + 0x120))(&stack0xfffffeac,1,0);

    uStack_1b0 = *puVar5;

    puStack_1ac = (uint32_t /* width from decompiler */ *)(iVar4 + iVar2);
