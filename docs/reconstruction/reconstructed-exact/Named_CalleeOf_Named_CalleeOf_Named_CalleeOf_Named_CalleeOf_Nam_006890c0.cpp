// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_006890c0
// -----------------------------------------------------------------------------
// Stable ID: aa_006890c0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam
// Address:   0x006890c0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004e2e80×2, FUN_005739b0×2, FUN_00689090×2, memmove×2, CONCAT44, FUN_00686070, FUN_006890c0, FUN_00697510.
//  - Return sites: 4.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_006890c0(int param_1,void *param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
...

{
  ...
  if (param_3 != 0) {
    ...
    if (uVar2 < iVar1 + param_3) {
      ...
      pvVar3 = (void *)FUN_00689090((void *)((int)pvVar3 + _Size),param_3,&param_4);

      memmove(pvVar3,param_2,(*(int *)(param_1 + 8) - (int)param_2 >> 2) << 2);
    ...
    if ((uint)(iVar1 - (int)param_2 >> 2) < param_3) {
      ...
      FUN_00689090(*(int *)(param_1 + 8),param_3 - (*(int *)(param_1 + 8) - (int)param_2 >> 2),

                   &param_4);

      iVar5 = *(int *)(param_1 + 8) + iVar5;

      *(int *)(param_1 + 8) = iVar5;

      FUN_005739b0(param_2,iVar5 + param_3 * -4,&param_4);
    ...
    *(uint32_t /* width from decompiler */ *)(param_1 + 8) = uVar4;
    ...
    FUN_00697510(param_2,iVar6,iVar1);
