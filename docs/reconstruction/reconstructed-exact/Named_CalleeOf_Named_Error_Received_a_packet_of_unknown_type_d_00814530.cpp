// =============================================================================
// Named_CalleeOf_Named_Error_Received_a_packet_of_unknown_type_d_00814530
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_Error_Received_a_packet_of_unknown_type_d: packet/network helper. Evidence string: "Got a local obj ghost and no obj? coid:%I64d cbid:%d". Supports parent flow (not a free-standing entry point).
...
int * Named_CalleeOf_Named_Error_Received_a_packet_of_unknown_type_d_00814530(uint32_t /* width from decompiler */ param_1,int *param_2)
