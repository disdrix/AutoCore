// =============================================================================
// Named_START_X_007a9cc0
// -----------------------------------------------------------------------------
// Stable ID: aa_007a9cc0
// Address:   0x007a9cc0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for Named_START_X_007a9cc0 @ 0x007a9cc0
// Stable ID: aa_007a9cc0
...
//  - Control keywords: if×21, return×2, goto×2, do×1, while×1.
//  - Notable callees: wcscmp×10, swscanf×8, SysFreeString×7, FUN_0040d230×5, FUN_007a9cc0.
//  - Strings: "%d;%d"; "WIDTH"; "HEIGHT"; "LEFT".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * String-driven rename evidence: "START_X"
 *
...
void Named_START_X_007a9cc0(uint32_t /* width from decompiler */ param_1,int *param_2)
