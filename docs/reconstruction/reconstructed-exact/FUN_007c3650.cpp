...
// PURPOSE (auto): Scaffold unit for FUN_007c3650 @ 0x007c3650
// Stable ID: aa_007c3650
...
uint32_t /* width from decompiler */ __thiscall FUN_007c3650(char *param_1,uint32_t /* width from decompiler */ param_2,char param_3,int *param_4)
