...
// =============================================================================
// Named_Received_a_packet_out_of_sequence_lu_expected_lu_0067e3a0
// -----------------------------------------------------------------------------
...
/*
 * Behavioral notes:
 * String-driven rename evidence: "Received a packet out of sequence (%lu, expected %lu) - packet lost!"
 *
...
char __thiscall Named_Received_a_packet_out_of_sequence_lu_expected_lu_0067e3a0(int param_1,uint *param_2,uint32_t /* width from decompiler */ param_3,int param_4)
