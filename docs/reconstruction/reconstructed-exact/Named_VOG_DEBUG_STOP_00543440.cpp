...
//  - Notable callees: FUN_00543440, FUN_007a4480, _CxxThrowException, malloc.
//  - Strings: "VOG_DEBUG_STOP".
//  - Return sites: 2.

// =============================================================================
// Named_VOG_DEBUG_STOP_00543440
// -----------------------------------------------------------------------------
// Stable ID: aa_00543440
// Address:   0x00543440  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_VOG_DEBUG_STOP_00543440(int param_1)
