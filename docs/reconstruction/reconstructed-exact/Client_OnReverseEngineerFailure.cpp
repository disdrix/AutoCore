...
// =============================================================================
// Client_OnReverseEngineerFailure
// -----------------------------------------------------------------------------
// Purpose:  Reverse Engineer result messages: skill, inventory room, craft mats, generic fail.
//
// Address:  0x0080df40  (autoassault.exe, image base 0x400000)
// Stable:   aa_0080df40
// System:   inventory-transfer
//
// String evidence: "You do not have enough room in your inventory." / Reverse Engineer
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_0080df40.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_0080df40 using string evidence: "You do not have enough room in your inventory." / Reverse Engineer
