// =============================================================================
// Net_GhostObject_getUpdatePriority
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Net_GhostObject_getUpdatePriority @ 0x005b10a0
// Stable ID: aa_005b10a0
...
//  - Notable callees: FUN_0076cef0×2, FUN_0040aff0, Net_GhostObject_getUpdatePriority, FUN_0076cf00, SQRT, TFID_EqualsObjectId.
//  - Strings: "GhostObject::getUpdatePriority".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "GhostObject::getUpdatePriority"
 * Domain alias of FUN_005b10a0 (FUN_* retained)
 *
...
Net_GhostObject_getUpdatePriority(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4,int param_5)
