// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_effVertexDecl_004458b0
// -----------------------------------------------------------------------------
// Stable ID: aa_004458b0
// Callee of Named_CalleeOf_Named_effVertexDecl
// Address:   0x004458b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004458b0, FUN_00445fa0.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_CalleeOf_Named_effVertexDecl_004458b0(int param_1,uint32_t /* width from decompiler */ param_2)
