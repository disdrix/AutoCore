...
// Address:   0x00440c90  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void Named_CalleeOf_Named_gfxUIWindow_00440c90(void *param_1)
...

{
  ...
  if (*(char *)((int)param_1 + 0x1d) == '\0') {
    ...
    Named_CalleeOf_Named_gfxUIWindow_00440c90(*(uint32_t /* width from decompiler */ *)((int)param_1 + 8));
