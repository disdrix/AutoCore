...
// PURPOSE (auto): Scaffold unit for FUN_004524a0 @ 0x004524a0
// Stable ID: aa_004524a0
...
uint32_t /* width from decompiler */ * __thiscall FUN_004524a0(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3)
