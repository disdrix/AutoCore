...
// PURPOSE (auto): Scaffold unit for FUN_00414ae0 @ 0x00414ae0
// Stable ID: aa_00414ae0
...
uint32_t /* width from decompiler */ __thiscall FUN_00414ae0(int param_1,int param_2,int param_3,uint32_t /* width from decompiler */ param_4)
