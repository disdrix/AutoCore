...
// FUN_0045ab40
// -----------------------------------------------------------------------------
// Stable ID: aa_0045ab40
// Address:   0x0045ab40  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0045ab40 @ 0x0045ab40
// Stable ID: aa_0045ab40
...
uint32_t /* width from decompiler */ __thiscall FUN_0045ab40(int *param_1,int param_2)
...

{
  ...
  if ((local_4c == 0x5042414d) || (local_4c == 0x5452414b)) {
    ...
    if ((0 < param_2) && (iVar1 = FUN_0045e4c0(), iVar1 == 0)) {
