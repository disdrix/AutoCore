...
// PURPOSE (auto): Scaffold unit for FUN_004a34f0 @ 0x004a34f0
// Stable ID: aa_004a34f0
...
uint32_t /* width from decompiler */ FUN_004a34f0(int *param_1,uint32_t /* width from decompiler */ param_2,int *param_3)
