...
//  - Notable callees: FUN_007a4480×3, FUN_004e23d0×2, FUN_004e2360, FUN_004e7e60, FUN_00589890.
//  - Strings: "HashError:insert, already locked for traversal"; "VOG_DEBUG_STOP"; "Duplicate hash insert %u, failing out".
//  - Return sites: 5.

// =============================================================================
// Named_VOG_DEBUG_STOP_004e7e60
// -----------------------------------------------------------------------------
...
Named_VOG_DEBUG_STOP_004e7e60(int param_1,uint param_2,uint32_t /* width from decompiler */ param_3,int param_4,char param_5)
