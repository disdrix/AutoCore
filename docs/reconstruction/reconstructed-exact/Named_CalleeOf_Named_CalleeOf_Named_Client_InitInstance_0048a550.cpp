// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance_0048a550
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_Client_InitInstance: callee helper. Evidence string: "EffectProc - ENTER\n". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance_0048a550(void)
