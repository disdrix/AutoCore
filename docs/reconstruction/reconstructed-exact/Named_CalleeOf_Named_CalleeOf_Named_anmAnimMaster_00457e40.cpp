// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_anmAnimMaster_00457e40
// -----------------------------------------------------------------------------
// Stable ID: aa_00457e40
// Callee of Named_CalleeOf_Named_anmAnimMaster
// Address:   0x00457e40  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00457e40, FUN_004582e0.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ * __fastcall Named_CalleeOf_Named_CalleeOf_Named_anmAnimMaster_00457e40(int param_1)
...

{
  ...
  if ((puVar4 != *(uint32_t /* width from decompiler */ **)(param_1 + 4)) && ((uint)puVar4[3] <= *in_EAX)) {
