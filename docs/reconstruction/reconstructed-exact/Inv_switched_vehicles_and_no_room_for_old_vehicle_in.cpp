...
// =============================================================================
// Inv_switched_vehicles_and_no_room_for_old_vehicle_in
// -----------------------------------------------------------------------------
...
Inv_switched_vehicles_and_no_room_for_old_vehicle_in(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3,uint param_4,uint param_5)
