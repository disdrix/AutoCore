...
// PURPOSE (auto): Scaffold unit for FUN_0047a620 @ 0x0047a620
// Stable ID: aa_0047a620
...
FUN_0047a620(int param_1,uint32_t /* width from decompiler */ *param_2,int param_3,uint8_t *param_4,uint *param_5)
