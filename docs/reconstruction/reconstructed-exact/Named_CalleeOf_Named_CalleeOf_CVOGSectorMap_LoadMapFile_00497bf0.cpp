// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGSectorMap_LoadMapFile_00497bf0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_CVOGSectorMap_LoadMapFile: config/load helper. Evidence string: "CVOGFlairObject". Supports parent flow (not a free-standing entry point).
...
void __fastcall Named_CalleeOf_Named_CalleeOf_CVOGSectorMap_LoadMapFile_00497bf0(int param_1)
