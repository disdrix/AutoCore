...
// PURPOSE (auto): Scaffold unit for FUN_007c29f0 @ 0x007c29f0
// Stable ID: aa_007c29f0
...
uint32_t /* width from decompiler */ __thiscall FUN_007c29f0(char *param_1,uint32_t /* width from decompiler */ *param_2,int param_3)
