// =============================================================================
// Named_CalleeOf_Drive_Loading_Vehicles_00833680
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Drive_Loading_Vehicles: drive/input helper. Evidence string: "allocatenewobjectfromcbid failed %d Get a programmer". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Drive_Loading_Vehicles_00833680(void)
