// =============================================================================
// UI_DirectInput_NotInitializedOnAcquire_00796240
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for UI_DirectInput_NotInitializedOnAcquire_00796240 @ 0x00796240
// Stable ID: aa_00796240
...
//  - Notable callees: Poll×6, sprintf×6, OutputDebugStringA×4, UI_DirectInput_NotInitializedOnAcquire_00796240.
//  - Strings: "DIERR_NOTACQUIRED on m_parrDIDevicesImmediate[%i]->Poll()\n"; "DIERR_INPUTLOST on m_parrDIDevicesImmediate[%i]->Poll()\n"; "DIERR_INVALIDPARAM on m_parrDIDevicesImmediate[%i]->Poll()\n".
//  - Return sites: 6.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "DIERR_NOTINITIALIZED on m_parrDIDevicesImmediate[%i]->Poll()
"
 * Domain alias of FUN_00796240 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ UI_DirectInput_NotInitializedOnAcquire_00796240(uint32_t /* width from decompiler */ param_1)
