// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00675860
// -----------------------------------------------------------------------------
// Stable ID: aa_00675860
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_AudioOutThre
// Address:   0x00675860  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00675860, FUN_00680fd0.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00675860(uint32_t /* width from decompiler */ *param_1,int param_2,uint param_3,int param_4,uint param_5,
...

{
  ...
  while ((param_2 != param_4 || (param_3 != param_5))) {
    ...
    FUN_00680fd0(*(uint32_t /* width from decompiler */ *)(*(int *)(param_4 + 4) + uVar1 * 4));
