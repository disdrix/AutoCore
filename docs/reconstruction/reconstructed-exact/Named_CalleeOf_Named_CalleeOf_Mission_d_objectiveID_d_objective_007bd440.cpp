// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Mission_d_objectiveID_d_objective_007bd440
// -----------------------------------------------------------------------------
// Stable ID: aa_007bd440
// Callee of Named_CalleeOf_Mission_d_objectiveID_d_objectiveName_s_don_t_ev
...
// PURPOSE (auto): Called from Named_CalleeOf_Mission_d_objectiveID_d_objectiveName_s_don_t_ev: mission/objective helper. Evidence string: "DBReader: %u against %s". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Named_CalleeOf_Mission_d_objectiveID_d_objective_007bd440(char *param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ *param_3)
