// =============================================================================
// Named_CalleeOf_Named_Could_not_get_Palantir_desktop_window_00583170
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_Could_not_get_Palantir_desktop_window: callee helper. Evidence string: "veh_paint_pallet.dds". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Named_Could_not_get_Palantir_desktop_window_00583170(void)
