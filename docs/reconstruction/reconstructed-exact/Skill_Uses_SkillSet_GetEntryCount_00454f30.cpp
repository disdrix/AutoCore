...
//  - Notable callees: FUN_00456310×4, FUN_00456030×2, FUN_00409ed0, FUN_004426e0, FUN_004540b0, FUN_00454f30, SkillSet_GetEntryCount.
//  - Return sites: 3.

// =============================================================================
// Skill_Uses_SkillSet_GetEntryCount_00454f30
// -----------------------------------------------------------------------------
...
//           Behavior preserved from FUN_00454f30 clean capture (not modernized).
//
// Address:  0x00454f30  (autoassault.exe, image base 0x400000)
// Stable:   aa_00454f30
// Stable ID: aa_00454f30
// System:   skills-abilities
//
// Naming:   From informative string/keyword evidence in
//           docs/reconstruction/raw/aa_00454f30_*.md
//           Original Ghidra symbol: FUN_00454f30
//
// Exactness: Body mirrors reconstructed-exact/FUN_00454f30*.cpp when present.
...
void __fastcall Skill_Uses_SkillSet_GetEntryCount_00454f30(uint param_1,void *param_2,int param_3)
...

{
  ...
  if (param_1 != 0) {
    ...
    if (uVar5 < iVar1 + param_1) {
      ...
      FUN_00456310(*(uint32_t /* width from decompiler */ *)((int)param_2 + 8),param_3);
