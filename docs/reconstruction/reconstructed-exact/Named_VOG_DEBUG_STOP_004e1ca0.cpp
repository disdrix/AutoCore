...
//  - Notable callees: FUN_004e1ca0, FUN_007a4480, _CxxThrowException, malloc.
//  - Strings: "VOG_DEBUG_STOP".
//  - Return sites: 2.

// =============================================================================
// Named_VOG_DEBUG_STOP_004e1ca0
// -----------------------------------------------------------------------------
// Stable ID: aa_004e1ca0
// Address:   0x004e1ca0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_VOG_DEBUG_STOP_004e1ca0(int param_1)
