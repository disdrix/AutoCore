...
// =============================================================================
// Skill_FormatCooldownDurationRangeLines
// -----------------------------------------------------------------------------
// Purpose:  Format compact skill combat lines: Cooldown, Duration, Power-every, Range (single or min-max meters), Maintain Limit, Splash, Chance percent, with stealthed gate prefix.
//
...
//   - sprintf
//
// Notes:    UI/format companion to Skill_FormatTimingAttributeLines.
//
...
char __thiscall Skill_FormatCooldownDurationRangeLines(int param_1,int param_2)
