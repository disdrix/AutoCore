// =============================================================================
// Named_CalleeOf_CVOGTacArc_InitializeMesh_00970140
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_CVOGTacArc_InitializeMesh_00970140(int *param_1,int param_2,uint32_t /* width from decompiler */ param_3)
