// =============================================================================
// Named_RESIST_ICONS_00839df0
// -----------------------------------------------------------------------------
// Stable ID: aa_00839df0
// Address:   0x00839df0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for Named_RESIST_ICONS_00839df0 @ 0x00839df0
// Stable ID: aa_00839df0
...
//  - Notable callees: SysFreeString×3, _wcsicmp×3, FUN_007a8b00×2, FUN_007933a0, FUN_00839df0.
//  - Strings: "RESIST_ICONS"; "START"; "TEX_SIZE".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * String-driven rename evidence: "RESIST_ICONS"
 *
...
void __thiscall Named_RESIST_ICONS_00839df0(int param_1,int *param_2,int param_3)
        ...
        if (0 < (int)unaff_EDI) {
          ...
          do {
            ...
            if (iVar3 == 0) {
              ...
              piVar1 = (int *)(param_1 + 0x508);

              FUN_007a8b00(unaff_EDI,piVar1,param_1 + 0x50c,0);

              fVar4 = (float)*(int *)(param_1 + 0x50c) * (float)DAT_00d1e81c * DAT_00aaa678;

              *piVar1 = (int)((float)*piVar1 * (float)DAT_00d1e818 * DAT_00aaa67c);

              *(int *)(param_1 + 0x50c) = (int)fVar4;
              ...
              if (iVar3 == 0) {
                ...
                FUN_007a8b00(unaff_EDI,param_1 + 0x510,param_1 + 0x514,0);
