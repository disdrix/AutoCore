// =============================================================================
// Snd_Soundqueue_wiping_all_soundreqs
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Snd_Soundqueue_wiping_all_soundreqs @ 0x00723dc0
// Stable ID: aa_00723dc0
...
//  - Notable callees: FUN_0071f810, Snd_Soundqueue_wiping_all_soundreqs, FUN_007a4480.
//  - Strings: "Soundqueue wiping all %d soundreqs".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Soundqueue wiping all %d soundreqs"
 * Domain alias of FUN_00723dc0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ Snd_Soundqueue_wiping_all_soundreqs(int param_1)
