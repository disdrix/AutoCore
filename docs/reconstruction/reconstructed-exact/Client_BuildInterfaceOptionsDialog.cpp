...
// =============================================================================
// Client_BuildInterfaceOptionsDialog
// -----------------------------------------------------------------------------
// Purpose:  Builds interface options UI (quickbar drag-shift, auto-set new mission active, etc.).
//
// Address:  0x0081c4d0  (autoassault.exe, image base 0x400000)
// Stable:   aa_0081c4d0
// System:   skills-abilities
//
// String evidence: "Quickbar Drag Requires Shift" / "Auto-set New Mission Active" / widget xml
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_0081c4d0.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_0081c4d0 using string evidence: "Quickbar Drag Requires Shift" / "Auto-set New Mission Active" / widget xml
