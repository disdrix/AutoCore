// =============================================================================
// Gfx_SurfaceFormat_AssertUnknownFormat
// -----------------------------------------------------------------------------
// Purpose:  Assert/report unknown texture surface format (effSurfaceFormat.h).
//
// Address:  0x0044b1f0  (autoassault.exe, image base 0x400000)
// Stable:   aa_0044b1f0
// System:   graphics
//
// String evidence: "..\\palantir/graphics/Effects/effSurfaceFormat.h"
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_0044b1f0.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_0044b1f0 using string evidence: "..\\palantir/graphics/Effects/effSurfaceFormat.h"
