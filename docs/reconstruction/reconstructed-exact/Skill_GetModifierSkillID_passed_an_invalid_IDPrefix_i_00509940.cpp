// =============================================================================
// Skill_GetModifierSkillID_passed_an_invalid_IDPrefix_i_00509940
// -----------------------------------------------------------------------------
// Stable ID: aa_00509940
// Alias of:  GetModifierSkillID  (product string seal, W23-P 2026-07-29)
// Address:   0x00509940  (autoassault.exe, image base 0x400000)
// Prefer:    reconstructed-exact/GetModifierSkillID.cpp
// Body:      identical CF to FUN_00509940 / GetModifierSkillID
// =============================================================================
...
int32_t __thiscall Skill_GetModifierSkillID_passed_an_invalid_IDPrefix_i_00509940(
    void* registry,
    int32_t idPrefix)
{
  uint8_t local_it[4];
