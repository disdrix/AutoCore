...
// =============================================================================
// Named_for_the_new_client_connection_as_it_is_not_in_th_00640f00
// -----------------------------------------------------------------------------
...
/*
 * Behavioral notes:
 * String-driven rename evidence: "] for the new client connection as it is not in the viewer list"
 *
...
uint32_t /* width from decompiler */ __thiscall Named_for_the_new_client_connection_as_it_is_not_in_th_00640f00(int *param_1,uint32_t /* width from decompiler */ param_2)
