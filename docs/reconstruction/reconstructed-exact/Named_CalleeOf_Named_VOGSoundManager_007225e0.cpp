// =============================================================================
// Named_CalleeOf_Named_VOGSoundManager_007225e0
// -----------------------------------------------------------------------------
// Stable ID: aa_007225e0
// Callee of Named_VOGSoundManager
...
// PURPOSE (auto): Called from Named_VOGSoundManager: presentation/world helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
int Named_CalleeOf_Named_VOGSoundManager_007225e0(int *param_1)
