...
// Address:   0x005cb2d0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_005cb2d0 @ 0x005cb2d0
// Stable ID: aa_005cb2d0
...
//  - Notable callees: FUN_005c9be0×4, FUN_004ce940, FUN_005097b0, FUN_005cb2d0.
//  - Return sites: 1.
...

{
  ...
  iVar3 = (**(code **)(*(int *)(*(int *)(*(int *)(param_1 + -0x10c) + 4) + -0x10c + param_1) + 0x60)
