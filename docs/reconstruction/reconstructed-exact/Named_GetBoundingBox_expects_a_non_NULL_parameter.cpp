...
// =============================================================================
// Named_GetBoundingBox_expects_a_non_NULL_parameter
// -----------------------------------------------------------------------------
...
void __thiscall Named_GetBoundingBox_expects_a_non_NULL_parameter(int param_1,uint32_t /* width from decompiler */ *param_2)
