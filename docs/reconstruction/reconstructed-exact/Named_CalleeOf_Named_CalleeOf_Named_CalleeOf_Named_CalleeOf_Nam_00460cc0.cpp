// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00460cc0
// -----------------------------------------------------------------------------
// Stable ID: aa_00460cc0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxVertexBuf
// Address:   0x00460cc0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00460300, FUN_00460380, FUN_00460cc0.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ * __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00460cc0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ *param_3)
