...
// Address:   0x008eec60  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for Named_sec_unknown @ 0x008eec60
// Stable ID: aa_008eec60
// Embedded strings (evidence for future rename):
//   - "You must first visit this map before INC can take you here!"
//   - "Click to have INC take you here for:"
//   - "To have INC take you here costs:"
//   - "Click this button to have INC take you to a local repair station:"
//   - "sec_unknown.dds"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~168 non-empty decompiler lines.
//  - Control keywords: if×16, return×2, goto×2, while×2, for×1.
//  - Notable callees: FUN_0040e490×4, FUN_0040ccb0×3, CNDHash_LookupByKey×2, CONCAT44×2, FUN_0040e230×2, InitializeCriticalSection×2, block×2, FUN_00403450.
//  - Strings: "You must first visit this map before INC can take you here!"; "Click to have INC take you here for:"; "To have INC take you here costs:"; "sec_unknown.dds".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "sec_unknown.dds"
 * Domain alias of FUN_008eec60 (FUN_* retained)
 *
...
void __thiscall Named_sec_unknown(int param_1,uint param_2)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x50c) = 1;
...
LAB_008eeeca:
  ...
  if (*(int **)(param_1 + 0x574) != (int *)0x0) {
    ...
    *(uint8_t *)(*(int *)(param_1 + 0x574) + 0xd7) = 0;
  ...
  if (*(int *)(param_1 + 0x67c) != 0) {
    ...
    *(bool *)(*(int *)(param_1 + 0x67c) + 0x4fc) = bVar6;
    ...
    if (*(int *)(param_1 + 0x680) == 0) {
      ...
      (**(code **)(**(int **)(param_1 + 0x67c) + 0x54))(*(uint32_t /* width from decompiler */ *)(param_1 + 0x680),1,0,0);
