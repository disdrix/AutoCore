...
// PURPOSE (auto): Scaffold unit for FUN_00447660 @ 0x00447660
// Stable ID: aa_00447660
...
uint32_t /* width from decompiler */ * FUN_00447660(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
