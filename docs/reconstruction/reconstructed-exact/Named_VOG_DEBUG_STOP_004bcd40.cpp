...
//  - Notable callees: FUN_007a4480×2, FUN_004bc840, FUN_004bcca0, FUN_004bcd40.
//  - Strings: "HashError:Recreate, already locked for traversal"; "VOG_DEBUG_STOP".
//  - Return sites: 1.

// =============================================================================
// Named_VOG_DEBUG_STOP_004bcd40
// -----------------------------------------------------------------------------
// Stable ID: aa_004bcd40
// Address:   0x004bcd40  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_VOG_DEBUG_STOP_004bcd40(int param_1,byte param_2)
