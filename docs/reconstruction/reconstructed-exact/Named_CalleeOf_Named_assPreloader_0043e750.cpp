// =============================================================================
// Named_CalleeOf_Named_assPreloader_0043e750
// -----------------------------------------------------------------------------
// Stable ID: aa_0043e750
// Callee of Named_assPreloader
// Address:   0x0043e750  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: LeaveCriticalSection×2, EnterCriticalSection, FUN_0043e750.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_assPreloader_0043e750(void)
