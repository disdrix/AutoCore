// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxBody_0043a7e0
// -----------------------------------------------------------------------------
// Stable ID: aa_0043a7e0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_gfxBody
// Address:   0x0043a7e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
int __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxBody_0043a7e0(int param_1,int param_2)
