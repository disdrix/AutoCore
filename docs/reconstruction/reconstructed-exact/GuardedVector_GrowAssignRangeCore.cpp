// =============================================================================
// GuardedVector_GrowAssignRangeCore
// -----------------------------------------------------------------------------
// Stable ID: aa_0043cf40
// Address:   0x0043cf40–0x0043d2f6  (autoassault.exe, image base 0x400000)
// System:    STL / guarded ring-deque (family GuardedVector_*)
// Generated: dual A/B seal 2026-07-29 (W28-B); Ghidra FUN_0043cf40
...
/*
 * Behavioral notes:
 * - Core worker for GuardedVector_GrowAssignRange (FUN_0043cec0 trampoline).
 * - stdcall 8 args (RET 0x20); sole caller repeats dest as 8th.
 * - Shorter-side prefix/suffix policy; excess via push_front (0043ce10) /
 *   push_back (0043c830); range move via FUN_0043d300 / FUN_0043d390.
 * - Nested move free packing residual in unowned callees → accept-with-gaps.
 */
...
// Retail: stdcall 8 stack args; RET 0x20.
void GuardedVector_GrowAssignRangeCore(int param_1, uint32_t param_2, uint param_3, int param_4,
                                       ...
                                       uint32_t /*param_8*/)
{
  ...
  iVar3 = param_4;
  // prefix = param_3 - dest.begin; suffix = dest.size - prefix; src_len = param_7 - param_5
