// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_SkillTrainUiRequest_INFERR_005533f0
// -----------------------------------------------------------------------------
// Stable ID: aa_005533f0
// Callee of Named_CalleeOf_Client_SkillTrainUiRequest_INFERRED (+1 other named callers)
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_SkillTrainUiRequest_INFERRED: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_CalleeOf_Client_SkillTrainUiRequest_INFERRED (+1 other named callers).
...
uint __thiscall Named_CalleeOf_Named_CalleeOf_Client_SkillTrainUiRequest_INFERR_005533f0(int param_1,int param_2)
