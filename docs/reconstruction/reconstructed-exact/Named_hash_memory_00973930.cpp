...
/*
 * Behavioral notes:
 * String-driven rename evidence: "hash_memory"
 *
...
int Named_hash_memory_00973930(int param_1,uint32_t /* width from decompiler */ param_2,int param_3,uint *param_4)
