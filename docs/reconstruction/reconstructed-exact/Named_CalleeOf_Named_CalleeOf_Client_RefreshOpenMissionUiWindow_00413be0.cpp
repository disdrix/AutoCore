// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_RefreshOpenMissionUiWindow_00413be0
// -----------------------------------------------------------------------------
...
uint __thiscall Named_CalleeOf_Named_CalleeOf_Client_RefreshOpenMissionUiWindow_00413be0(int param_1,int *param_2,uint32_t /* width from decompiler */ *param_3)
