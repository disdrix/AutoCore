// =============================================================================
// Named_CollectAllGraphicsPreloads
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_CollectAllGraphicsPreloads @ 0x004f1ff0
// Stable ID: aa_004f1ff0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "CollectAllGraphicsPreloads"
 * Domain alias of FUN_004f1ff0 (FUN_* retained)
 *
...
void __thiscall Named_CollectAllGraphicsPreloads(int param_1,uint32_t /* width from decompiler */ param_2)
