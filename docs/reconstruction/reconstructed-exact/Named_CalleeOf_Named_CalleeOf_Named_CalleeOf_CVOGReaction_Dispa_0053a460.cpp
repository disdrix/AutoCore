// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGReaction_Dispa_0053a460
// -----------------------------------------------------------------------------
// Stable ID: aa_0053a460
// Callee of Named_CalleeOf_Named_CalleeOf_CVOGReaction_Dispatch
// Address:   0x0053a460  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00539620×2, FUN_0053a460, FUN_005a2850.
//  - Return sites: 3.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGReaction_Dispa_0053a460(int param_1,uint32_t /* width from decompiler */ *param_2,uint *param_3)
...

{
  ...
  if (bVar5) {
    ...
    if (puVar4 == (uint32_t /* width from decompiler */ *)**(int **)(param_1 + 4)) {
      ...
      puVar4 = (uint32_t /* width from decompiler */ *)FUN_00539620(&param_3,1,puVar4,puVar2);
  ...
  if (param_3[3] < *puVar2) {
    ...
    puVar4 = (uint32_t /* width from decompiler */ *)FUN_00539620(&param_3,bVar5,puVar4,puVar2);
