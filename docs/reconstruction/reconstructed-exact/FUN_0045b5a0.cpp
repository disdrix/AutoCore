...
// FUN_0045b5a0
// -----------------------------------------------------------------------------
// Stable ID: aa_0045b5a0
// Address:   0x0045b5a0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0045b5a0 @ 0x0045b5a0
// Stable ID: aa_0045b5a0
...
//  - Notable callees: FUN_0046d130×5, FUN_00439810×3, FUN_00436f80×2, FUN_00767160×2, FUN_0044c9e0, FUN_0045b5a0, FUN_0045e990, FUN_00734640.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ __thiscall FUN_0045b5a0(int param_1,uint32_t /* width from decompiler */ *param_2)
...

{
  ...
  if ((*(int *)(param_1 + 0x20) != 0) &&
     ...
     (*(int *)(param_1 + 0x24) - *(int *)(param_1 + 0x20) >> 3 != 0)) {
  ...
  if (*(int *)(param_1 + 0x20) != 0) {
    ...
    iVar9 = *(int *)(param_1 + 0x24) - *(int *)(param_1 + 0x20) >> 3;
  ...
  if (iVar9 != 0) {
    ...
    FUN_0045e990(*(uint32_t /* width from decompiler */ *)(param_1 + 0x20),iVar9);
