// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli_004973f0
// -----------------------------------------------------------------------------
// Stable ID: aa_004973f0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_PacketDispa
// Address:   0x004973f0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004973f0, _CxxThrowException, exception::exception.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli_004973f0(int param_1,uint param_2)
...

{
  ...
  puStack_8 = &LAB_009a0da2;

  local_c = ExceptionList;

  if (0xfffffffU - *(int *)(param_1 + 8) < param_2) {
