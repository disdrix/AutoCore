// =============================================================================
// Named_You_are_already_arena_match
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_You_are_already_arena_match @ 0x0080c5e0
// Stable ID: aa_0080c5e0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "You are already in an arena match"
 * Domain alias of FUN_0080c5e0 (FUN_* retained)
 *
...
void Named_You_are_already_arena_match(int param_1)
