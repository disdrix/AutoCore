// =============================================================================
// Named_CalleeOf_Client_GetMissionCompleteAudioTable_00723510
// -----------------------------------------------------------------------------
// Stable ID: aa_00723510
// Callee of Client_GetMissionCompleteAudioTable
...
// PURPOSE (auto): Called from Client_GetMissionCompleteAudioTable: mission/objective helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Client_GetMissionCompleteAudioTable_00723510(uint32_t /* width from decompiler */ *param_1)
