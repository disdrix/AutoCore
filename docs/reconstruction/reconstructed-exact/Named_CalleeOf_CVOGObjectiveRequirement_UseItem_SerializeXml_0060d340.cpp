// =============================================================================
// Named_CalleeOf_CVOGObjectiveRequirement_UseItem_SerializeXml_0060d340
// -----------------------------------------------------------------------------
// Stable ID: aa_0060d340
// Callee of CVOGObjectiveRequirement_UseItem_SerializeXml
// Address:   0x0060d340  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_CalleeOf_CVOGObjectiveRequirement_UseItem_SerializeXml_0060d340(int param_1,char *param_2)
...

{
  ...
  *(char **)(param_1 + 0x38) = pcVar4;
  ...
  pcVar3[*(int *)(param_1 + 0x38) - (int)pcVar1] = '\0';
