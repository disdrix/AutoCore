// =============================================================================
// Named_CalleeOf_Named_gfxDeviceVB_009728e0
// -----------------------------------------------------------------------------
// Stable ID: aa_009728e0
// Callee of Named_gfxDeviceVB (+1 other named callers)
// Address:   0x009728e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0076f240, FUN_009728e0.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_gfxDeviceVB_009728e0(uint32_t /* width from decompiler */ *param_1)
