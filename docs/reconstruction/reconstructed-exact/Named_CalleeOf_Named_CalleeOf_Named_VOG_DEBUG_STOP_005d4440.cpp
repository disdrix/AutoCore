// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_005d4440
// -----------------------------------------------------------------------------
// Stable ID: aa_005d4440
// Callee of Named_CalleeOf_Named_VOG_DEBUG_STOP (+2 other named callers)
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_VOG_DEBUG_STOP: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_CalleeOf_Named_VOG_DEBUG_STOP (+2 other named callers).
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_005d4440(int param_1,int param_2)
