...
// =============================================================================
// Inv_Client_ReverseEngineerItem
// -----------------------------------------------------------------------------
// Purpose:  Client reverse-engineer UI/action gate. State machine on client+0x30c0: validates item is in cargo (not broken/crafting-mat/stacked), has a recipe, confirms unequip/unusable warning dialog, and requires both items in locker and/or cargo for related combine paths.
//
...
//   - "You can not Reverse Engineer an item in a stack..."
//   - "This item has no associated recipe."
//   - "Are you sure you wish to reverse engineer this object? (This will make it unequippable/unusable)."
//   - "Both items must be in your locker and/or cargo!"
//
// Notable callees:
//   - FUN_00571010 (cargo membership)
//   - FUN_007a6de0 / FUN_007fdfb0
//   - FUN_00522950 / FUN_00513e70 / FUN_00599dd0
//   - CVOGReaction_ResolveObjectTarget
//   - __RTDynamicCast
//   - FUN_0085f660 / FUN_0085fa20
//
// Notes:    param_1 is selected object/view; unaff_ESI is client shell.
//
...
void Inv_Client_ReverseEngineerItem(int *param_1)
