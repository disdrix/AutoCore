// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGCharacter_SetAreaExploredBit_007dd5e0
// -----------------------------------------------------------------------------
// Stable ID: aa_007dd5e0
// Callee of Named_CalleeOf_CVOGCharacter_SetAreaExploredBit
...
// PURPOSE (auto): Called from Named_CalleeOf_CVOGCharacter_SetAreaExploredBit: character create/apply helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Named_CalleeOf_CVOGCharacter_SetAreaExploredBit_007dd5e0(char *param_1)
