...
// Address:   0x00685a50  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00685a50 @ 0x00685a50
// Stable ID: aa_00685a50
...
void __fastcall FUN_00685a50(uint8_t *param_1)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 4) = 0xbf800000;

  *(uint32_t /* width from decompiler */ *)(param_1 + 8) = 0xffffffff;

  *(uint16_t *)(param_1 + 0xc) = 0;
