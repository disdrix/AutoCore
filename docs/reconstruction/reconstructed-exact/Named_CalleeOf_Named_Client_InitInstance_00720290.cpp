// =============================================================================
// Named_CalleeOf_Named_Client_InitInstance_00720290
// -----------------------------------------------------------------------------
// Stable ID: aa_00720290
// Callee of Named_Client_InitInstance (+1 other named callers)
// Address:   0x00720290  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0071f810×2, EnterCriticalSection, FUN_00720290, LeaveCriticalSection.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Named_Client_InitInstance_00720290(int param_1,int param_2,char param_3)
  ...
  if (*(char *)(param_1 + 0x10) != '\0') {
    ...
    if (param_2 == -1) {
      ...
      if (iVar3 != 0) {
        ...
        *(uint32_t /* width from decompiler */ *)(*(int *)(param_1 + 0x88 + param_2 * 4) + 0x1b0) = 0;
