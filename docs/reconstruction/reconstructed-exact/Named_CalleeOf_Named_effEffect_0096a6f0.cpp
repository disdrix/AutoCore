// =============================================================================
// Named_CalleeOf_Named_effEffect_0096a6f0
// -----------------------------------------------------------------------------
// Stable ID: aa_0096a6f0
// Callee of Named_effEffect (+1 other named callers)
...
// PURPOSE (auto): Called from Named_effEffect: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_effEffect (+1 other named callers).
...
int __thiscall Named_CalleeOf_Named_effEffect_0096a6f0(int *param_1,uint32_t /* width from decompiler */ *param_2,char param_3)
...

{
  ...
  if ((DAT_00d1a560 == (code *)0x0) || (param_3 == '\0')) {
    ...
    if (-1 < iVar1) {
      ...
      iVar1 = Named_CalleeOf_Named_effEffect_0096a6f0(param_2,0);
