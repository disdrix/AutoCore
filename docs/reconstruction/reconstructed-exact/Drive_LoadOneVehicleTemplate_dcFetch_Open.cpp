...
// =============================================================================
// Drive_LoadOneVehicleTemplate_dcFetch_Open
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __thiscall Drive_LoadOneVehicleTemplate_dcFetch_Open(char *param_1,uint32_t /* width from decompiler */ param_2,int param_3)
