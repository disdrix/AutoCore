...
// PURPOSE (auto): Scaffold unit for Drive_vPrefixPowerPlant @ 0x007d51b0
// Stable ID: aa_007d51b0
// Embedded strings (evidence for future rename):
//   - "//vPrefixPowerPlant/row"
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//vPrefixPowerPlant/row"
 * Domain alias of FUN_007d51b0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Drive_vPrefixPowerPlant(char *param_1,int *param_2,int *param_3)
