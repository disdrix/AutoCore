// =============================================================================
// Named_CalleeOf_Named_assPreloader_00971b80
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_assPreloader: callee helper. Evidence string: "filename=\"". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Named_assPreloader_00971b80(uint32_t /* width from decompiler */ param_1,int *param_2,int param_3,uint32_t /* width from decompiler */ *param_4)
