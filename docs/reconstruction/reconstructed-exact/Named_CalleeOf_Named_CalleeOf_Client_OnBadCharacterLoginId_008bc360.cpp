// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_OnBadCharacterLoginId_008bc360
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_OnBadCharacterLoginId: auth/session helper. Evidence string: "i_d_ls.xml". Supports parent flow (not a free-standing entry point).
...
int * Named_CalleeOf_Named_CalleeOf_Client_OnBadCharacterLoginId_008bc360(int *param_1)
