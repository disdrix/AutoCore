// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00441480
// -----------------------------------------------------------------------------
// Stable ID: aa_00441480
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST
// Address:   0x00441480  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00441e40×2, FUN_00441ed0×2, FUN_00401a40, FUN_00441480, FUN_00441f60, _CxxThrowException.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00441480(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ param_4)
...

{
  ...
  piVar3 = (int *)FUN_00441f60(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4),param_1,*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  do {
    ...
    if (cVar1 != '\0') {
      ...
      *(uint8_t *)(*(int *)(*(int *)(unaff_EDI + 4) + 4) + 0x3c) = 1;
...
LAB_0044155a:
        ...
        *(uint8_t *)(*piVar4 + 0x3c) = 1;

        *(uint8_t *)(piVar5 + 0xf) = 1;

        *(uint8_t *)(*(int *)(*piVar4 + 4) + 0x3c) = 0;
        ...
        *(uint8_t *)(piVar6[1] + 0x3c) = 1;

        *(uint8_t *)(*(int *)(piVar6[1] + 4) + 0x3c) = 0;
