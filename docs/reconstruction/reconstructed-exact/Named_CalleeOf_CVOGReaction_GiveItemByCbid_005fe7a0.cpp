// =============================================================================
// Named_CalleeOf_CVOGReaction_GiveItemByCbid_005fe7a0
// -----------------------------------------------------------------------------
// Stable ID: aa_005fe7a0
// Callee of CVOGReaction_GiveItemByCbid
// Address:   0x005fe7a0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00518940, FUN_005c7f30, FUN_005fe7a0.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ * __thiscall Named_CalleeOf_CVOGReaction_GiveItemByCbid_005fe7a0(uint32_t /* width from decompiler */ *param_1,int param_2)
