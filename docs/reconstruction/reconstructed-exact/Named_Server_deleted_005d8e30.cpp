...
/*
 * Behavioral notes:
 * String-driven rename evidence: "Server deleted"
 *
...
void __fastcall Named_Server_deleted_005d8e30(uint32_t /* width from decompiler */ *param_1)
