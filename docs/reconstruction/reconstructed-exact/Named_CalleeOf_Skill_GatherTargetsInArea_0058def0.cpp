// =============================================================================
// Named_CalleeOf_Skill_GatherTargetsInArea_0058def0
// -----------------------------------------------------------------------------
...
void __thiscall Named_CalleeOf_Skill_GatherTargetsInArea_0058def0(int param_1,uint32_t /* width from decompiler */ *param_2,float *param_3)
