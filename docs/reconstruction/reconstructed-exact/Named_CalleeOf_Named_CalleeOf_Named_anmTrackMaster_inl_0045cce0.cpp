// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_anmTrackMaster_inl_0045cce0
// -----------------------------------------------------------------------------
// Stable ID: aa_0045cce0
// Callee of Named_CalleeOf_Named_anmTrackMaster_inl
// Address:   0x0045cce0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Named_CalleeOf_Named_anmTrackMaster_inl_0045cce0(int param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ *param_3,uint32_t /* width from decompiler */ *param_4)
