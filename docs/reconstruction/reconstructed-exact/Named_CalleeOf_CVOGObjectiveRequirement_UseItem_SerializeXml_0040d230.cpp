// =============================================================================
// Named_CalleeOf_CVOGObjectiveRequirement_UseItem_SerializeXml_0040d230
// -----------------------------------------------------------------------------
// Stable ID: aa_0040d230
// Callee of CVOGObjectiveRequirement_UseItem_SerializeXml
// Address:   0x0040d230  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0040d230, SysFreeString.
//  - Return sites: 1.
...
void __fastcall Named_CalleeOf_CVOGObjectiveRequirement_UseItem_SerializeXml_0040d230(uint32_t /* width from decompiler */ *param_1)
