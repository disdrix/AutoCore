...
//  - Notable callees: FUN_007a4480×3, FUN_004e23d0×2, FUN_004e2360, FUN_004e7d30, FUN_00589890.
//  - Strings: "HashError:insert, already locked for traversal"; "VOG_DEBUG_STOP"; "Duplicate hash insert %u, failing out".
//  - Return sites: 5.

// =============================================================================
// Named_VOG_DEBUG_STOP_004e7d30
// -----------------------------------------------------------------------------
// Stable ID: aa_004e7d30
// Address:   0x004e7d30  (autoassault.exe, image base 0x400000)
// System:    unknown
...
Named_VOG_DEBUG_STOP_004e7d30(int param_1,uint param_2,uint32_t /* width from decompiler */ param_3,int param_4,char param_5)
