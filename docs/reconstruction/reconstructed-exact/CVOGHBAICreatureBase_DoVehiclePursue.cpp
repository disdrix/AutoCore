...
//  - Control keywords: if×18, for×2, return×1.
//  - Notable callees: FUN_00404c90×10, SQRT×6, ABS, CVOGHBAICreatureBase_DoVehiclePursue, FUN_004e8a40, FUN_0053e510, FUN_00567ce0, FUN_005cc460.
//  - Strings: "CVOGHBAICreatureBase::DoVehiclePursue".
//  - Return sites: 1.

// =============================================================================
// CVOGHBAICreatureBase_DoVehiclePursue
// -----------------------------------------------------------------------------
// Purpose:  Steer the owned vehicle toward the active attack/pursue target: compute
//           aim point, clamp direction, apply velocity / destination via vtbl.
//
// Address:  0x005cfb60  (autoassault.exe, image base 0x400000)
// Stable:   aa_005cfb60
// System:   npc-ai / HBAI
//
// Control flow (high level):
//   1) Vehicle = owner+0x250; target at this+0x6+0xa0
//   2) Alive check vtbl+0x198; target pos vtbl+0x1c8
//   3) Offset by vehicle type (+0x84 ground / +0xb0 air)
//   4) Destination vtbl+0x4c; pursuit dir normalize + clamp DAT_009da864
//   5) Speed-threshold branch: FUN_005cc460 heading + FUN_00567ce0 rot matrix
//      else direct vector; apply vtbl+0x4c
// Caller: Driver_DoLogic combat state; idle may call when no map path.
//
