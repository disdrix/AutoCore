...
// PURPOSE (auto): Scaffold unit for Gfx_PalVisibleBoundingShape @ 0x0099e0a0
// Stable ID: aa_0099e0a0
 ...
 * Domain alias of FUN_0099e0a0 (FUN_* retained)
 *
...
uint __fastcall Gfx_PalVisibleBoundingShape(int param_1)
