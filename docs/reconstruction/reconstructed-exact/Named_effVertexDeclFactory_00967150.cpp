...
// =============================================================================
// Named_effVertexDeclFactory_00967150
// -----------------------------------------------------------------------------
...
void __thiscall Named_effVertexDeclFactory_00967150(int param_1,int param_2)
...
LAB_00967205:
        ...
        if (*(int *)(iVar4 + 0x10) == 0) {
          ...
          Named_effVertexDeclFactory_00967150(iVar4);
