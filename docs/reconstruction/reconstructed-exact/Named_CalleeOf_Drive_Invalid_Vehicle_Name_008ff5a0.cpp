// =============================================================================
// Named_CalleeOf_Drive_Invalid_Vehicle_Name_008ff5a0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Drive_Invalid_Vehicle_Name: drive/input helper. Evidence string: "i_d_body_2d_cb_paint_primary_btn_element.xml". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Drive_Invalid_Vehicle_Name_008ff5a0(void)
