// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00569320
// -----------------------------------------------------------------------------
...
//  - Notable callees: FUN_005690a0×2, FUN_00537770, FUN_00569320.
//  - Return sites: 3.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00569320(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3)
...

{
  ...
  if (bVar2) {
    ...
    if (puVar5 == (uint32_t /* width from decompiler */ *)**(int **)(param_1 + 4)) {
      ...
      puVar5 = (uint32_t /* width from decompiler */ *)FUN_005690a0(&param_3,1,puVar5,piVar3);
  ...
  if (param_3[3] < *piVar3) {
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)FUN_005690a0(&param_3,bVar2,puVar5,piVar3);
