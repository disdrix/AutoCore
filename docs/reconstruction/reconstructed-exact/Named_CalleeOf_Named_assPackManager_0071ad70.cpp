// =============================================================================
// Named_CalleeOf_Named_assPackManager_0071ad70
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_assPackManager: callee helper. Evidence string: "Bzip output full.\n". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: printf×3, FUN_0047f730, FUN_004832d0, FUN_0071ad70.
...
Named_CalleeOf_Named_assPackManager_0071ad70(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ param_3,uint *param_4)
