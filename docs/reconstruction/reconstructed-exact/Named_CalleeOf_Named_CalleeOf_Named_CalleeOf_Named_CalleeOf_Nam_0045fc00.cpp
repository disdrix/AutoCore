// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_0045fc00
// -----------------------------------------------------------------------------
// Stable ID: aa_0045fc00
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxVertexBuf
// Address:   0x0045fc00  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0045fd80×2, FUN_0045fc00, FUN_004608a0.
//  - Return sites: 3.
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_0045fc00(uint32_t /* width from decompiler */ *param_1)
...

{
  ...
  if (bVar3) {
    ...
    if (param_1 == (uint32_t /* width from decompiler */ *)**(int **)(in_EAX + 4)) {
      ...
      puVar2 = (uint32_t /* width from decompiler */ *)FUN_0045fd80(&param_1,1,unaff_EBX);
  ...
  if ((uint)param_1[3] < *unaff_EBX) {
    ...
    puVar2 = (uint32_t /* width from decompiler */ *)FUN_0045fd80(&param_1,bVar3,unaff_EBX);
