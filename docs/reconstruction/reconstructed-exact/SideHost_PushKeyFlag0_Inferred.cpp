// =============================================================================
// SideHost_PushKeyFlag0_Inferred
// -----------------------------------------------------------------------------
// Stable ID: aa_00970b20
// Address:   0x00970b20–0x00970b55  (autoassault.exe, image base 0x400000)
// Ghidra:    FUN_00970b20
...
// Builds PodU32U8{key=*ecx, flag=0} then locked push to host+0xAC.
// Bit-twin of SideHost_PushKeyFlag1_Inferred (00970b60) with imm flag 0.
// =============================================================================
...
extern "C" void SideHost_PushKeyFlag0_Inferred(
    void* keyHolder /*ECX*/,
    void* host /*stack*/)
{
  PodU32U8 pod;
