// =============================================================================
// Named_AllocateNewObjectFromCbidFailed_004fedc0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_AllocateNewObjectFromCbidFailed_004fedc0 @ 0x004fedc0
// Stable ID: aa_004fedc0
...
//  - Control keywords: if×29, goto×4, do×2, while×2, return×1.
//  - Notable callees: __RTDynamicCast×3, CVOGReaction_GiveItemByCbid×2, FUN_0053d970×2, FUN_0056be70×2, FUN_007a4480×2, Object_ResolveFromTFID×2, CONCAT31, CVOGHBBase_Start.
 ...
 * Domain alias of FUN_004fedc0 (FUN_* retained)
 *
...
Named_AllocateNewObjectFromCbidFailed_004fedc0(int param_1,int *param_2,int param_3,uint32_t /* width from decompiler */ param_4,uint32_t /* width from decompiler */ param_5,int *param_6
