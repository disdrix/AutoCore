// =============================================================================
// Named_CalleeOf_CVOGMapPath_AdvanceAndSteer_00788400
// -----------------------------------------------------------------------------
// Stable ID: aa_00788400
// Callee of CVOGMapPath_AdvanceAndSteer
...
// PURPOSE (auto): Called from CVOGMapPath_AdvanceAndSteer: drive/input helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
float10 Named_CalleeOf_CVOGMapPath_AdvanceAndSteer_00788400(float *param_1,float *param_2,float *param_3)
