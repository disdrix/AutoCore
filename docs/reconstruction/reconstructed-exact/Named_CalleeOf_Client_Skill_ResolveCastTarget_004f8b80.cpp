// =============================================================================
// Named_CalleeOf_Client_Skill_ResolveCastTarget_004f8b80
// -----------------------------------------------------------------------------
// Stable ID: aa_004f8b80
// Callee of Client_Skill_ResolveCastTarget
...
// PURPOSE (auto): Called from Client_Skill_ResolveCastTarget: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
uint32_t /* width from decompiler */ * __fastcall Named_CalleeOf_Client_Skill_ResolveCastTarget_004f8b80(int param_1)
