// =============================================================================
// Named_CalleeOf_Skill_Uses_SkillSet_GetEntryCount_00422070
// -----------------------------------------------------------------------------
// Stable ID: aa_00422070
// Callee of Skill_Uses_SkillSet_GetEntryCount
// Address:   0x00422070  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void Named_CalleeOf_Skill_Uses_SkillSet_GetEntryCount_00422070(uint32_t /* width from decompiler */ *param_1,int param_2,uint32_t /* width from decompiler */ *param_3)
