// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs_00894190
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Mission_createNDUIDialogs: mission/objective helper. Evidence string: "i_d_speed.xml". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_0087b890, FUN_008935c0, FUN_00894190, FUN_0097c720, NDUIWindow_ReloadInterface.
...
int * Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs_00894190(int *param_1,uint32_t /* width from decompiler */ param_2)
