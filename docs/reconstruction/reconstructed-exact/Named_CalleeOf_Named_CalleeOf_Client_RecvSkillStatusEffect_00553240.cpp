// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_RecvSkillStatusEffect_00553240
// -----------------------------------------------------------------------------
...
Named_CalleeOf_Named_CalleeOf_Client_RecvSkillStatusEffect_00553240(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,ushort param_4,uint8_t *param_5)
