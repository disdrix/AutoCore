// =============================================================================
// Client_InitInstance  (was FUN_0094a6a0 / Named_Client_InitInstance_0094a6a0)
// -----------------------------------------------------------------------------
// Stable ID: aa_0094a6a0
// Address:   0x0094a6a0–0x0094b324  (autoassault.exe, image base 0x400000)
...
// Dual: reviews/A|B_aa_0094a6a0_Client_InitInstance.md
// =============================================================================
//
// PURPOSE:
//   Client application InitInstance orchestration. Brings up crypto, COM, render
//   engine, sector map, asset catalog, clonebase lists, optional data tables,
//   physics, generators, sound, and UI. Sole caller FUN_0094ba40 passes
//   &DAT_00d1a840. Success returns 1; graphics failure _exit(1).
//
// ABI:
//   __stdcall — client object on stack; RET 4; return uint32_t in EAX.
//
// Gate:
//   *(char*)(app+0x31f5)==0 enables heavy table ensures + map generators +
//   one asset post-init path. Nonzero skips those (light/alternate boot).
// =============================================================================
...
uint32_t /* width from decompiler */ Client_InitInstance(int param_1)
