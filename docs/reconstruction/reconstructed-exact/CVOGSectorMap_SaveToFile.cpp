// =============================================================================
// CVOGSectorMap_SaveToFile
// -----------------------------------------------------------------------------
// Stable ID: aa_004dcb80
// Address:   0x004dcb80  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Domain alias CVOGSectorMap_SaveToFile for FUN_004dcb80 @ 0x004dcb80
// Stable ID: aa_004dcb80
// Embedded strings (evidence for future rename):
//   - "CVOGSectorMap::SaveToFile"
//   - "garbagefile"
...
//  - Control keywords: if×28, while×18, do×16, for×3, return×3.
//  - Notable callees: fwrite×41, ftell×8, CONCAT13×6, FUN_00512350×5, FUN_00403430×4, FUN_0040fb90×4, CONCAT31×3, FUN_005d6870×3.
//  - Strings: "CVOGSectorMap::SaveToFile"; "garbagefile".
//  - Return sites: 3.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "CVOGSectorMap::SaveToFile"
 * Domain alias of FUN_004dcb80 (FUN_* retained)
 *
...
uint __thiscall CVOGSectorMap_SaveToFile(int param_1,char *param_2,uint32_t /* width from decompiler */ param_3,char param_4)
...

{
  ...
  uint32_t /* width from decompiler */ uStack_b58;
  ...
  uint32_t /* width from decompiler */ local_b48;

  uint8_t uStack_b41;

  uint32_t /* width from decompiler */ local_b40;
  ...
  uint32_t /* width from decompiler */ local_b20;
  ...
  uint32_t /* width from decompiler */ local_b10;
  ...
  uint32_t /* width from decompiler */ local_b00;

  uint8_t local_afc [4];

  int *local_af8;

  uint32_t /* width from decompiler */ local_af4;

  int local_af0;

  uint32_t /* width from decompiler */ local_aec;

  uint32_t /* width from decompiler */ local_ae8;

  uint32_t /* width from decompiler */ local_ae4;

  uint8_t local_adc [4];

  uint32_t /* width from decompiler */ local_ad8;

  uint32_t /* width from decompiler */ local_ad4;

  uint8_t local_ad0;

  uint32_t /* width from decompiler */ uStack_9d1;

  uint8_t auStack_9cc [780];
  ...
  if (*(int *)(param_1 + 0xe4f8) != 0) {
    ...
    if (pcVar3 == (char *)0x0) {
      ...
      for (uVar5 = (uint)((int)pcVar3 - (int)param_2) >> 2; uVar5 != 0; uVar5 = uVar5 - 1) {
        ...
        *(uint32_t /* width from decompiler */ *)pcVar6 = *(uint32_t /* width from decompiler */ *)pcVar12;
    ...
    local_aec = *(uint32_t /* width from decompiler */ *)(DAT_00d1f050 + 100);

    pcVar3 = strrchr((char *)&local_ad8,0x2e);

    if (pcVar3 == (char *)0x0) {

      puVar2 = (uint32_t /* width from decompiler */ *)(local_adc + 3);
      ...
      *(uint32_t /* width from decompiler */ *)((int)puVar13 + 1) = DAT_00a285c4;

      *(uint8_t *)((int)puVar13 + 5) = DAT_00a285c8;
    ...
    *(uint32_t /* width from decompiler */ *)((int)puVar13 + 1) = DAT_009cc944;

    *(uint8_t *)((int)puVar13 + 5) = DAT_009cc948;
      ...
      if (local_b50 != local_b24) {
        ...
        do {
          ...
          if (piVar11[0x2a] == 0) {
            ...
            local_b40 = *(uint32_t /* width from decompiler */ *)(piVar11[0x2a] + 0x34);
