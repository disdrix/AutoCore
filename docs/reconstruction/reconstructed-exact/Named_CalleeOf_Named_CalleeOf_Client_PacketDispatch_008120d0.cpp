...
// PURPOSE (auto): Called from Named_CalleeOf_Client_PacketDispatch: packet/network helper. Evidence string: "allocatenewobjectfromcbid failed %d Get a programmer". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: CONCAT31×2, block×2, CVOGReaction_GiveItemByCbid, FUN_007a4480, FUN_007fb2b0, FUN_008024d0, FUN_008120d0, FUN_009972a0.
...
int * Named_CalleeOf_Named_CalleeOf_Client_PacketDispatch_008120d0(int param_1,int param_2)
