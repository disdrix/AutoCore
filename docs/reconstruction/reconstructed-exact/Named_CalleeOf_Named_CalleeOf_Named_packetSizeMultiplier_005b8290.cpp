// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_packetSizeMultiplier_005b8290
// -----------------------------------------------------------------------------
// Stable ID: aa_005b8290
// Callee of Named_CalleeOf_Named_packetSizeMultiplier
// Address:   0x005b8290  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_packetSizeMultiplier_005b8290(uint32_t /* width from decompiler */ *param_1)
...

{
  ...
  *param_1 = &PTR_LAB_009d9b54;
  ...
  if ((uint32_t /* width from decompiler */ *)param_1[10] != (uint32_t /* width from decompiler */ *)0x0) {
    ...
    *(uint32_t /* width from decompiler */ *)param_1[10] = 0;
