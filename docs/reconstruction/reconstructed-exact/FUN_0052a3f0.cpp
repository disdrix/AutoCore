...
// PURPOSE (auto): Scaffold unit for FUN_0052a3f0 @ 0x0052a3f0
// Stable ID: aa_0052a3f0
...
uint32_t /* width from decompiler */ __thiscall FUN_0052a3f0(int param_1,int param_2,int param_3,int param_4)
