// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_PacketDispatch_0052cec0
// -----------------------------------------------------------------------------
// Stable ID: aa_0052cec0
// Callee of Named_CalleeOf_Client_PacketDispatch
// Address:   0x0052cec0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Control keywords: if×8, return×4, do×1, while×1, goto×1.
//  - Notable callees: FUN_0052ada0, FUN_0052cec0, _CIpow, _stricmp.
//  - Return sites: 4.
...
float10 __thiscall Named_CalleeOf_Named_CalleeOf_Client_PacketDispatch_0052cec0(int param_1,int *param_2)
...

{
  ...
  iVar4 = FUN_0052ada0(*(uint32_t /* width from decompiler */ *)(iVar3 + 0x4ac));
