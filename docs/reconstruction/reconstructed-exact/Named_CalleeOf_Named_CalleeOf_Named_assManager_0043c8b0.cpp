// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_assManager_0043c8b0
// -----------------------------------------------------------------------------
// Stable ID: aa_0043c8b0
// Callee of Named_CalleeOf_Named_assManager (+1 other named callers)
// Address:   0x0043c8b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_assManager_0043c8b0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2)
