// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_SkyBoxParticles_005064e0
// -----------------------------------------------------------------------------
// Stable ID: aa_005064e0
// Callee of Named_CalleeOf_Named_SkyBoxParticles
// Address:   0x005064e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004e2e80×2, FUN_004e2f70×2, FUN_005739b0×2, memmove×2, CONCAT44, FUN_004e24d0, FUN_00506320, FUN_005064e0.
//  - Return sites: 4.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_SkyBoxParticles_005064e0(int param_1,void *param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
