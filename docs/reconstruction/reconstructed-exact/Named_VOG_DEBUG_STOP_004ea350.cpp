...
//  - Control keywords: if×23, return×4, do×3, goto×3, while×3.
//  - Notable callees: CONCAT31×6, FUN_0040afb0×3, FUN_004cba00×3, FUN_004cbaa0×3, FUN_004cc400×3, FUN_004eae00×3, FUN_0058d9c0×3, FUN_004ead30×2.
//  - Strings: "CVOGPhysicsUtils::GetObjectsInArea::aabb"; "VOG_DEBUG_STOP".
//  - Return sites: 4.

// =============================================================================
// Named_VOG_DEBUG_STOP_004ea350
// -----------------------------------------------------------------------------
...
Named_VOG_DEBUG_STOP_004ea350(int param_1,float *param_2,float param_3,uint32_t /* width from decompiler */ param_4,int param_5,
