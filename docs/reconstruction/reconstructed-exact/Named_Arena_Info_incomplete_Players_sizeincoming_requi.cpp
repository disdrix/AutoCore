// =============================================================================
// Named_Arena_Info_incomplete_Players_sizeincoming_requi
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_Arena_Info_incomplete_Players_sizeincoming_requi @ 0x004cd240
// Stable ID: aa_004cd240
...
//  - Notable callees: Named_Arena_Info_incomplete_Players_sizeincoming_requi, FUN_007a4480.
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Arena Info incomplete! Players:%d sizeincoming:%d required:%d... Reseting players"
 * Domain alias of FUN_004cd240 (FUN_* retained)
 *
...
int Named_Arena_Info_incomplete_Players_sizeincoming_requi(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,int param_3)
