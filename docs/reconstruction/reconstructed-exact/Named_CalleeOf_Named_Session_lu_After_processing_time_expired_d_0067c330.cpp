// =============================================================================
// Named_CalleeOf_Named_Session_lu_After_processing_time_expired_d_0067c330
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_Session_lu_After_processing_time_expired_d: auth/session helper. Evidence string: "Remote\'s newest-received timestamp (%hu) is more recent than current timestamp (%hu)". Supports parent flow (not a free-standing entry point).
...
void __thiscall Named_CalleeOf_Named_Session_lu_After_processing_time_expired_d_0067c330(int param_1,uint32_t /* width from decompiler */ param_2,ushort param_3)
