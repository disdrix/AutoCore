...
// PURPOSE (auto): Scaffold unit for FUN_0041fae0 @ 0x0041fae0
// Stable ID: aa_0041fae0
...
FUN_0041fae0(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ *param_2,int param_3,int param_4,uint param_5)
