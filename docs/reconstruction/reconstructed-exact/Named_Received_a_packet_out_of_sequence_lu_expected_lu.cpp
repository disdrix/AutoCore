...
// =============================================================================
// Named_Received_a_packet_out_of_sequence_lu_expected_lu
// -----------------------------------------------------------------------------
...
char __thiscall Named_Received_a_packet_out_of_sequence_lu_expected_lu(int param_1,uint *param_2,uint32_t /* width from decompiler */ param_3,int param_4)
