...
uint32_t /* width from decompiler */ __thiscall Named_VOG_DEBUG_STOP_004e3170(int param_1,uint param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ *param_4)
