// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO_00420670
// -----------------------------------------------------------------------------
// Stable ID: aa_00420670
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGReaction_GiveI
// Address:   0x00420670  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00401a40, FUN_00420670, _CxxThrowException.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO_00420670(uint param_1,int param_2)
...

{
  ...
  if ((uint)((int)&DAT_00aaaaaa - *(int *)(param_2 + 8)) < param_1) {
