...
//  - Notable callees: FUN_004bc840, FUN_007a4480, _CxxThrowException, malloc.
//  - Strings: "VOG_DEBUG_STOP".
//  - Return sites: 2.

// =============================================================================
// Named_VOG_DEBUG_STOP_004bc840
// -----------------------------------------------------------------------------
// Stable ID: aa_004bc840
// Address:   0x004bc840  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_VOG_DEBUG_STOP_004bc840(int param_1)
