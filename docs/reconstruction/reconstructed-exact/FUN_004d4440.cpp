...
// PURPOSE (auto): Scaffold unit for FUN_004d4440 @ 0x004d4440
// Stable ID: aa_004d4440
...
FUN_004d4440(int param_1,int param_2,int param_3,uint32_t /* width from decompiler */ param_4,uint32_t /* width from decompiler */ param_5,char param_6,
