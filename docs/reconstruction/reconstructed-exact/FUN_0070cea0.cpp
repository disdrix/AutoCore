...
// Address:   0x0070cea0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0070cea0 @ 0x0070cea0
// Stable ID: aa_0070cea0
...
//  - Control keywords: if×29, do×16, while×16, return×1.
//  - Notable callees: FUN_0070c8a0×2, FUN_0070cea0, FUN_0070e910.
//  - Return sites: 1.
...
FUN_0070cea0(int *param_1,int param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4,uint32_t /* width from decompiler */ param_5,

            int param_6,int param_7,uint32_t /* width from decompiler */ param_8,int param_9,int param_10,int param_11,
...

{
  ...
  do {
    ...
    if (3 < in_EAX) {
      ...
      puVar7 = (uint32_t /* width from decompiler */ *)(local_6c[(int)local_88 + 4] + 8);

      local_78 = (float *)((local_6c[3] + 2) - param_7);

      local_8c = (uint32_t /* width from decompiler */ *)(param_10 + (int)local_78 * 4);

      puVar8 = (uint32_t /* width from decompiler */ *)(param_10 + (local_6c[3] + 2) * 4);
    ...
    if (iVar20 < in_EAX) {
      ...
      local_8c = (uint32_t /* width from decompiler */ *)(iVar20 - iVar12);

      puVar8 = (uint32_t /* width from decompiler */ *)(local_6c[(int)local_88 + 4] + iVar20 * 4);

      local_78 = (float *)((int)local_8c - param_7);

      puVar7 = (uint32_t /* width from decompiler */ *)(param_10 + (int)local_8c * 4);

      puVar14 = (uint32_t /* width from decompiler */ *)(param_10 + (int)local_78 * 4);
      ...
      do {
        ...
        local_8c = (uint32_t /* width from decompiler */ *)((int)local_8c + 1);
    ...
    if (local_88 == 2.8026e-45) {
      ...
      if (3 < iVar12) {
        ...
        puVar8 = (uint32_t /* width from decompiler */ *)(iVar13 + 4);

        puVar7 = (uint32_t /* width from decompiler */ *)(iVar19 + 0xc);
        ...
        do {
          ...
          *(uint32_t /* width from decompiler */ *)((iVar19 - iVar13) + (int)puVar8) = puVar8[-1];
      ...
      if (iVar20 < iVar12) {
        ...
        puVar7 = (uint32_t /* width from decompiler */ *)(local_6c[(int)local_88 + 1] + iVar20 * 4);
      ...
      puVar8 = (uint32_t /* width from decompiler */ *)local_6c[(int)local_88];

      *puVar8 = 0;

      local_8c = (uint32_t /* width from decompiler */ *)0x0;
      ...
      if (3 < in_EAX) {
        ...
        local_8c = (uint32_t /* width from decompiler */ *)(iVar12 * 4);
  ...
  do {
    ...
    local_8c = (uint32_t /* width from decompiler */ *)((int)local_8c + 4);
