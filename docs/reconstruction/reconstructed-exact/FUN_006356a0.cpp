...
// PURPOSE (auto): Scaffold unit for FUN_006356a0 @ 0x006356a0
// Stable ID: aa_006356a0
...
uint32_t /* width from decompiler */ * __thiscall FUN_006356a0(uint32_t /* width from decompiler */ *param_1,int param_2)
