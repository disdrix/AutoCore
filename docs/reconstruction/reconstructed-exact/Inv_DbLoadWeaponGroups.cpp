...
// =============================================================================
// Inv_DbLoadWeaponGroups
// -----------------------------------------------------------------------------
// Purpose:  ADO/DB load of weapon group tables (`//tWeaponGroup/row` and `//tWeaponGroup_x/row`) mapping IDWeaponGroup / CBIDWeapon / strName into inventory equip-group lookup structures.
//
...
//
// Notable callees:
//   - FUN_00439770 / FUN_004933f0
//   - FUN_0041a810 / FUN_004231d0
//   - operator_new / operator_new__
//   - SysAllocString
//   - FUN_007a4480
//
// Notes:    Inventory equip-group manager ingest path.
//
...
uint32_t /* width from decompiler */ __fastcall Inv_DbLoadWeaponGroups(char *param_1)
