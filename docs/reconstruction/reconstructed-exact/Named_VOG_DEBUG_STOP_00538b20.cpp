...
uint32_t /* width from decompiler */ __thiscall Named_VOG_DEBUG_STOP_00538b20(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ *param_3)
