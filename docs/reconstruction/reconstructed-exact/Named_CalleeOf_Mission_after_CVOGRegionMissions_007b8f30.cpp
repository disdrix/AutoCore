// =============================================================================
// Named_CalleeOf_Mission_after_CVOGRegionMissions_007b8f30
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Mission_after_CVOGRegionMissions: mission/objective helper. Evidence string: "IDCloneBaseOld". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Mission_after_CVOGRegionMissions_007b8f30(char *param_1)
