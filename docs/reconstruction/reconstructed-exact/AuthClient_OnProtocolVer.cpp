...
// =============================================================================
// AuthClient_OnProtocolVer
// -----------------------------------------------------------------------------
// Purpose:  Inbound AuthServer ProtocolVer handler - protocol version negotiation.
//
// Address:  0x00728590  (autoassault.exe, image base 0x400000)
// Stable:   aa_00728590
// System:   auth
//
// String evidence: FUN_00727b70("ProtocolVer","AuthServer")
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_00728590.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_00728590 using string evidence: FUN_00727b70("ProtocolVer","AuthServer")
