// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVolume_00452330
// -----------------------------------------------------------------------------
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVolume_00452330(int param_1,int *param_2,int param_3,uint32_t /* width from decompiler */ param_4)
