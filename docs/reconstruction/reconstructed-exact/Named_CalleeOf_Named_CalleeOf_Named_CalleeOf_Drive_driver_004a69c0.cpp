// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Drive_driver_004a69c0
// -----------------------------------------------------------------------------
// Stable ID: aa_004a69c0
// Callee of Named_CalleeOf_Named_CalleeOf_Drive_driver (+1 other named callers)
// Address:   0x004a69c0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Drive_driver_004a69c0(int param_1,int param_2,uint32_t /* width from decompiler */ *param_3)
...

{
  ...
  for (; param_1 != param_2; param_2 = param_2 + -4) {
    ...
    *param_3 = *(uint32_t /* width from decompiler */ *)(param_2 + -4);
