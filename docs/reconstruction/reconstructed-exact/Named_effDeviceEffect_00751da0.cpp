...
// =============================================================================
// Named_effDeviceEffect_00751da0
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __thiscall Named_effDeviceEffect_00751da0(int param_1,int param_2,undefined **param_3,int *param_4)
