...
// Address:   0x0055ecb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0055ecb0 @ 0x0055ecb0
// Stable ID: aa_0055ecb0
...
//  - Notable callees: FUN_0055eb10, FUN_0055ecb0.
//  - Return sites: 1.
...

{
  ...
  if (0 < *(int *)(param_1 + 0x10c)) {
    ...
    do {
      ...
      puVar2 = *(uint32_t /* width from decompiler */ **)(*(int *)(param_1 + 0x108) + iVar3 * 4);
