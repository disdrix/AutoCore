...
// Address:   0x005ac320  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_005ac320 @ 0x005ac320
// Stable ID: aa_005ac320
...
//  - Notable callees: FUN_005ac120×2, FUN_0055b580, FUN_005ac220, FUN_005ac320, _CxxThrowException, exception::exception.
...
FUN_005ac320(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ *param_4,uint32_t /* width from decompiler */ param_5)
...

{
  ...
  piVar4 = (int *)FUN_005ac220(*(uint32_t /* width from decompiler */ *)(param_1 + 4),param_4,*(uint32_t /* width from decompiler */ *)(param_1 + 4),
...
LAB_005ac426:
      ...
      if ((char)piVar6[0xb] == '\0') goto LAB_005ac426;
