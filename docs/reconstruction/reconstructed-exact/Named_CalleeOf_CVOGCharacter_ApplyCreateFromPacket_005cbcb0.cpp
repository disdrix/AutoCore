// =============================================================================
// Named_CalleeOf_CVOGCharacter_ApplyCreateFromPacket_005cbcb0
// -----------------------------------------------------------------------------
// Stable ID: aa_005cbcb0
// Callee of CVOGCharacter_ApplyCreateFromPacket
// Address:   0x005cbcb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: CONCAT12×2, CONCAT31, FUN_00512160, FUN_00512670, FUN_00513de0, FUN_00513e30, FUN_005c96c0, FUN_005c9be0.
//  - Return sites: 1.
...
void __thiscall Named_CalleeOf_CVOGCharacter_ApplyCreateFromPacket_005cbcb0(int param_1,int *param_2,uint8_t *param_3)
...

{
...

  {
    ...
    *(uint8_t *)(param_1 + -0x1f) = *(uint8_t *)((int)piVar3 + 0x89);
    ...
    *(uint8_t *)(param_1 + -0x1e) = *(uint8_t *)((int)piVar3 + 0xa3);

    *(char *)(param_1 + -0x1d) = (char)piVar3[0x29];

    *(uint8_t *)(param_1 + -0x1c) = *(uint8_t *)((int)piVar3 + 0xa5);
    ...
    *(uint16_t *)(param_1 + -0x38) = *(uint16_t *)((int)piVar3 + 0xc2);
