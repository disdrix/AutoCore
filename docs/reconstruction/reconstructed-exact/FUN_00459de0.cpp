...
// FUN_00459de0
// -----------------------------------------------------------------------------
// Stable ID: aa_00459de0
// Address:   0x00459de0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00459de0 @ 0x00459de0
// Stable ID: aa_00459de0
...
uint32_t /* width from decompiler */ __thiscall FUN_00459de0(int *param_1,int param_2)
...

{
  ...
  if ((local_4c == 0x5042414d) || (local_4c == 0x5452414b)) {
    ...
    if ((0 < param_2) && (iVar1 = FUN_0045e050(), iVar1 == 0)) {
