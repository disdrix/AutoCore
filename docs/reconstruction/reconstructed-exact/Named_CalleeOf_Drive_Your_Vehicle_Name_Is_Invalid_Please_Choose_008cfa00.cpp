// =============================================================================
// Named_CalleeOf_Drive_Your_Vehicle_Name_Is_Invalid_Please_Choose_008cfa00
// -----------------------------------------------------------------------------
// Stable ID: aa_008cfa00
// Callee of Drive_Your_Vehicle_Name_Is_Invalid_Please_Choose_Anoth
// Address:   0x008cfa00  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Drive_Your_Vehicle_Name_Is_Invalid_Please_Choose: drive/input helper. Evidence string: "Body Type". Supports parent flow (not a free-standing entry point).
...
//  - Control keywords: if×74, do×34, while×34, for×20, goto×11, return×5.
//  - Notable callees: FUN_007a6de0×14, sprintf×10, FUN_004fcb50, FUN_007a69d0, FUN_008cfa00.
//  - Strings: "Body Type"; " %d"; "No Helmet"; "Helmet".
//  - Return sites: 5.
...
void Named_CalleeOf_Drive_Your_Vehicle_Name_Is_Invalid_Please_Choose_008cfa00(int *param_1)
