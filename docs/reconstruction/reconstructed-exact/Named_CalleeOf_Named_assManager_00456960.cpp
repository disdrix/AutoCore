// =============================================================================
// Named_CalleeOf_Named_assManager_00456960
// -----------------------------------------------------------------------------
// Stable ID: aa_00456960
// Callee of Named_assManager (+7 other named callers)
...
// PURPOSE (auto): Called from Named_assManager: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_assManager (+7 other named callers).
...
void __fastcall Named_CalleeOf_Named_assManager_00456960(uint param_1,int param_2,uint32_t /* width from decompiler */ *param_3)
