...
//  - Notable callees: FUN_0076cec0, FUN_009863c0, vog_LogMessage.
//  - Strings: "VBFactory Shutdown - Slice still allocated! (%d Vertices)".
//  - Return sites: 1.

// =============================================================================
// Named_gfxVertexBufferFactory_009863c0
// -----------------------------------------------------------------------------
// Stable ID: aa_009863c0
// Address:   0x009863c0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void Named_gfxVertexBufferFactory_009863c0(void)
