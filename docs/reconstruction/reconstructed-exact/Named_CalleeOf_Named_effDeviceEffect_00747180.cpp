// =============================================================================
// Named_CalleeOf_Named_effDeviceEffect_00747180
// -----------------------------------------------------------------------------
// Stable ID: aa_00747180
// Callee of Named_effDeviceEffect (+1 other named callers)
// Address:   0x00747180  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004454f0, FUN_00747180.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_effDeviceEffect_00747180(void)
