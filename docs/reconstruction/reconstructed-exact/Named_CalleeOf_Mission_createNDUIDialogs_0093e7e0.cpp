...
// PURPOSE (auto): Called from Mission_createNDUIDialogs: mission/objective helper. Evidence string: "i_g_2d_btn_death_respawn.xml". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Mission_createNDUIDialogs_0093e7e0(int param_1)
