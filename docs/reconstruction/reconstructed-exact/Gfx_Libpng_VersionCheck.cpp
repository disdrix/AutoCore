...
// PURPOSE (auto): Domain alias Gfx_Libpng_VersionCheck for FUN_00475070 @ 0x00475070
// Stable ID: aa_00475070
...
//  - Notable callees: FUN_00476cc0×4, FUN_00476d60×4, setjmp3×2, sprintf×2, Gfx_Libpng_VersionCheck, FUN_00477690, FUN_004776d0, FUN_00478d60.
//  - Strings: "1.2.8"; "Application was compiled with png.h from libpng-%.20s"; "Application  is  running with png.c from libpng-%.20s".
//  - Return sites: 8.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Application was compiled with png.h from libpng-%.20s"
 * Domain alias of FUN_00475070 (FUN_* retained)
 *
...
Gfx_Libpng_VersionCheck(char *param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4,
