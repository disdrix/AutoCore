// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_004a7a20
// -----------------------------------------------------------------------------
// Stable ID: aa_004a7a20
// Callee of Named_VOG_DEBUG_STOP (+1 other named callers)
// Address:   0x004a7a20  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004a6f70, FUN_004a7a20.
//  - Return sites: 2.
...
void __thiscall Named_CalleeOf_Named_VOG_DEBUG_STOP_004a7a20(int param_1,uint32_t /* width from decompiler */ *param_2)
...

{
  ...
  FUN_004a6f70(*(uint32_t /* width from decompiler */ *)(param_1 + 8),1,param_2);
