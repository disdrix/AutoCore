// =============================================================================
// LoadQuestBaseCreditsFromWad
// -----------------------------------------------------------------------------
// Stable ID: aa_007cc810
// Address:   0x007cc810  (autoassault.exe, image base 0x400000)
...
uint32_t /* width from decompiler */ __fastcall LoadQuestBaseCreditsFromWad(int param_1)
