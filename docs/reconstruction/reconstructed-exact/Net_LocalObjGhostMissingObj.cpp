...
// PURPOSE (auto): Scaffold unit for Net_LocalObjGhostMissingObj @ 0x00814530
// Stable ID: aa_00814530
...
//  - Notable callees: FUN_004c0140, FUN_004e23d0, FUN_007971b0, FUN_007a4480, FUN_00812360, Net_LocalObjGhostMissingObj.
//  - Strings: "Got a local obj ghost and no obj? coid:%I64d cbid:%d".
//  - Return sites: 4.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Got a local obj ghost and no obj? coid:%I64d cbid:%d"
 * Domain alias of FUN_00814530 (FUN_* retained)
 *
...
int * Net_LocalObjGhostMissingObj(uint32_t /* width from decompiler */ param_1,int *param_2)
