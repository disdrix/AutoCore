// =============================================================================
// Net_Assigned_pending_ghost_I64d
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Net_Assigned_pending_ghost_I64d @ 0x00807550
// Stable ID: aa_00807550
...
//  - Notable callees: FUN_00409220, FUN_004cba00, FUN_007a4480, Net_Assigned_pending_ghost_I64d.
//  - Strings: "Assigned a pending ghost to %I64d".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Assigned a pending ghost to %I64d"
 * Domain alias of FUN_00807550 (FUN_* retained)
 *
...
void Net_Assigned_pending_ghost_I64d(int *param_1)
