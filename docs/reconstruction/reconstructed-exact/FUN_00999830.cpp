...
// PURPOSE (auto): Scaffold unit for FUN_00999830 @ 0x00999830
// Stable ID: aa_00999830
...
uint32_t /* width from decompiler */ __thiscall FUN_00999830(int param_1,int param_2,uint32_t /* width from decompiler */ *param_3)
