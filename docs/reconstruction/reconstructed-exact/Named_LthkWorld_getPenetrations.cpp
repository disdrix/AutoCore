// =============================================================================
// Named_LthkWorld_getPenetrations
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_LthkWorld_getPenetrations @ 0x00560c90
// Stable ID: aa_00560c90
...
//  - Notable callees: rdtsc×3, Named_LthkWorld_getPenetrations.
//  - Strings: "LthkWorld::getPenetrations"; "Stnarrowphase".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "LthkWorld::getPenetrations"
 * Domain alias of FUN_00560c90 (FUN_* retained)
 *
...
void __thiscall Named_LthkWorld_getPenetrations(int param_1,int *param_2,uint32_t /* width from decompiler */ param_3,int *param_4)
