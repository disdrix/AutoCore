// =============================================================================
// Named_CalleeOf_CVOGReaction_Dispatch_0053b040
// -----------------------------------------------------------------------------
// Stable ID: aa_0053b040
// Callee of CVOGReaction_Dispatch
// Address:   0x0053b040  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0053abc0, FUN_0053b040.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ * __thiscall Named_CalleeOf_CVOGReaction_Dispatch_0053b040(int param_1,uint *param_2)
...

{
  ...
  if ((puVar4 != *(uint32_t /* width from decompiler */ **)(param_1 + 4)) && ((uint)puVar4[3] <= *param_2)) {
