// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Skill_Skill_d_applied_to_incorrec_00627930
// -----------------------------------------------------------------------------
// Stable ID: aa_00627930
// Callee of Named_CalleeOf_Skill_Skill_d_applied_to_incorrect_target_d
// Address:   0x00627930  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Named_CalleeOf_Skill_Skill_d_applied_to_incorrect_target_d: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~120 non-empty decompiler lines.
//  - Control keywords: if×14, return×2, do×1, goto×1, while×1.
//  - Notable callees: FUN_006753b0×2, FUN_004e22d0, FUN_006173a0, FUN_00627930, _CxxThrowException, exception::exception.
...
Named_CalleeOf_Named_CalleeOf_Skill_Skill_d_applied_to_incorrec_00627930(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ *param_4,uint32_t /* width from decompiler */ param_5)
...

{
  ...
  piVar4 = (int *)FUN_006173a0(*(uint32_t /* width from decompiler */ *)(param_1 + 4),param_4,*(uint32_t /* width from decompiler */ *)(param_1 + 4),
...
LAB_00627a36:
      ...
      if ((char)piVar6[5] == '\0') goto LAB_00627a36;
