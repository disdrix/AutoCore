// =============================================================================
// LoadQuestCreditsLookupFromWad
// -----------------------------------------------------------------------------
// Stable ID: aa_007cc470
// Address:   0x007cc470  (autoassault.exe, image base 0x400000)
...
uint32_t /* width from decompiler */ __fastcall LoadQuestCreditsLookupFromWad(int param_1)
