// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGSectorMap_LoadMapFile_0079cd10
// -----------------------------------------------------------------------------
// Stable ID: aa_0079cd10
// Callee of Named_CalleeOf_CVOGSectorMap_LoadMapFile (+1 other named callers)
// Address:   0x0079cd10  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Named_CalleeOf_CVOGSectorMap_LoadMapFile_0079cd10(int *param_1)
