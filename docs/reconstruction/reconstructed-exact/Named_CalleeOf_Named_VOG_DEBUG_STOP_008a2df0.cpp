// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_008a2df0
// -----------------------------------------------------------------------------
// Stable ID: aa_008a2df0
// Callee of Named_VOG_DEBUG_STOP
// Address:   0x008a2df0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Control keywords: if×24, while×4, goto×4, return×4, for×3, do×2.
//  - Notable callees: FUN_00419880×3, CONCAT31, FUN_00411180, FUN_0059db80, FUN_00829fa0, FUN_008a20b0, FUN_008a2410, FUN_008a2670.
//  - Return sites: 4.
...
void __fastcall Named_CalleeOf_Named_VOG_DEBUG_STOP_008a2df0(int *param_1)
...

{
  ...
  uint32_t /* width from decompiler */ auStack_58 [2];
  ...
  if (((param_1[0x156] != 0) &&
...

    {
      ...
      puVar5 = (uint32_t /* width from decompiler */ *)(iVar11 + uVar8 * 4);
...
LAB_008a329d:
          ...
          puVar5 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)param_1[0x156] + 0x120))(auStack_4c,1,0);
