...
// =============================================================================
// Client_UpdateObjectiveDisplayHud
// -----------------------------------------------------------------------------
// Purpose:  Refreshes objective HUD strings (level/money/objective display labels).
//
// Address:  0x008066f0  (autoassault.exe, image base 0x400000)
// Stable:   aa_008066f0
// System:   missions-progression
//
// String evidence: "Objective Display"
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_008066f0.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_008066f0 using string evidence: "Objective Display"
