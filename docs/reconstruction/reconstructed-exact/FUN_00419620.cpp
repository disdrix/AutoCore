...
// PURPOSE (auto): Scaffold unit for FUN_00419620 @ 0x00419620
// Stable ID: aa_00419620
...
uint32_t /* width from decompiler */ FUN_00419620(int param_1,uint param_2,uint32_t /* width from decompiler */ param_3,int param_4,char param_5)
