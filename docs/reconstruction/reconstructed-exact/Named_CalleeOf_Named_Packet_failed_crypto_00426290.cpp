// =============================================================================
// Named_CalleeOf_Named_Packet_failed_crypto_00426290
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_Packet_failed_crypto: packet/network helper. Evidence string: "LogConnectionProtocol". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Named_Packet_failed_crypto_00426290(void)
