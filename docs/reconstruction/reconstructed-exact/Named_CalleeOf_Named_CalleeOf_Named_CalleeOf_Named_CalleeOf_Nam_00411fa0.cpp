// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00411fa0
// -----------------------------------------------------------------------------
// Stable ID: aa_00411fa0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_Client_InitI
// Address:   0x00411fa0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00412330×2, FUN_00411fa0, FUN_004129f0.
//  - Return sites: 3.
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00411fa0(uint32_t /* width from decompiler */ *param_1)
...

{
  ...
  if (bVar3) {
    ...
    if (param_1 == (uint32_t /* width from decompiler */ *)**(int **)(in_EAX + 4)) {
      ...
      puVar2 = (uint32_t /* width from decompiler */ *)FUN_00412330(&param_1,1,unaff_EBX);
  ...
  if ((uint)param_1[3] < *unaff_EBX) {
    ...
    puVar2 = (uint32_t /* width from decompiler */ *)FUN_00412330(&param_1,bVar3,unaff_EBX);
