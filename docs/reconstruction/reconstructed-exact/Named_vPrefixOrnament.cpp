...
// PURPOSE (auto): Scaffold unit for Named_vPrefixOrnament @ 0x007d0250
// Stable ID: aa_007d0250
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//vPrefixOrnament/row"
 * Domain alias of FUN_007d0250 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Named_vPrefixOrnament(char *param_1,int *param_2,int *param_3)
