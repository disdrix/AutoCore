// =============================================================================
// Named_CalleeOf_Named_ChatClientImpl_0067bdf0
// -----------------------------------------------------------------------------
// Stable ID: aa_0067bdf0
// Callee of Named_ChatClientImpl
// Address:   0x0067bdf0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0067bdf0, setsockopt.
//  - Return sites: 1.
...
int __thiscall Named_CalleeOf_Named_ChatClientImpl_0067bdf0(SOCKET *param_1,int param_2,int param_3,uint32_t /* width from decompiler */ param_4)
