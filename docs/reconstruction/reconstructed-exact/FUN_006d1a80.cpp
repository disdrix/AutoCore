...
// Address:   0x006d1a80  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006d1a80 @ 0x006d1a80
// Stable ID: aa_006d1a80
...
//  - Notable callees: FUN_006cec70, FUN_006d1a80.
//  - Return sites: 1.
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_2 + 0x20) = *(uint32_t /* width from decompiler */ *)(param_1 + 0x20);
