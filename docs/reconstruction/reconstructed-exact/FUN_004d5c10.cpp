// =============================================================================
// FUN_004d5c10 / Mission_ProcessInteractOfferStaging
// -----------------------------------------------------------------------------
...
// PURPOSE:
// Mission interact offer / turn-in staging processor.
// Resolve TFID block + character, clear staging (FUN_0052d8b0 0,-1), then:
//   - if interact target def type +0xa8→+0x38 == 0x3a: stage active turn-ins,
//     collect offerable missions from target vectors/region table, fill rolled
//     rewards via FUN_004d08c0(def, char, param_3);
//   - else: hash char[0x152] type-0 path via FUN_004cf100.
// Sole call site: 0x009245e6 (push param_3, &out, tfidBlock).

// ABI (image-sealed): free function, ret 0xC, three stack formals + SEH.
// Dual: reviews/A|B_aa_004d5c10_Mission_ProcessInteractOfferStaging.md

// READABILITY:
//  - Body size: ~344 non-empty decompiler lines.
//  - Control keywords: if×34, while×9, goto×7, return×6, do×3, for×1.
//  - Notable callees: CNDHash_LookupByKey, FUN_0053fff0, FUN_00411900, FUN_004e54a0,
//    CheckMissionRequirements, HasCompletedMission, FUN_004d08c0, FUN_004cf100,
//    FUN_0052d8b0, FUN_0052c700, FUN_0052dac0, FUN_0052b420, ResolveObjectTarget.

/*
 * Behavioral notes:
 * - Derived from Ghidra decompile + read_memory; dual A/B sealed 2026-07-29.
 * - unaff_EDI into CheckMissionRequirements is a decompiler residual.
 * - operator_delete "noreturn" warnings are SEH/cleanup shapes — not product exits.
...
void FUN_004d5c10(TFID_16 *param_1,int *param_2,uint32_t /* width from decompiler */ param_3)
