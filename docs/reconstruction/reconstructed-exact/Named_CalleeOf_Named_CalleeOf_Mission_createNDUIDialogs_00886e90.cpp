// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs_00886e90
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Mission_createNDUIDialogs: mission/objective helper. Evidence string: "i_d_timer.xml". Supports parent flow (not a free-standing entry point).
...
int * Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs_00886e90(int *param_1,uint32_t /* width from decompiler */ param_2)
