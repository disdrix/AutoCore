...
// Address:   0x0047ccf0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0047ccf0 @ 0x0047ccf0
// Stable ID: aa_0047ccf0
...
//  - Control keywords: if×22, for×5, return×5, do×3, while×3.
//  - Notable callees: FUN_0047ccf0.
//  - Return sites: 5.
...

{
  ...
  if (param_2 == 0xff) {
    ...
    for (uVar4 = uVar3 >> 2; uVar4 != 0; uVar4 = uVar4 - 1) {
      ...
      *(uint32_t /* width from decompiler */ *)param_1 = *(uint32_t /* width from decompiler */ *)pbVar5;
      ...
      do {
        ...
        if (((byte)param_2 & bVar2) != 0) {
          ...
          for (uVar4 = (uint)(bVar1 >> 5); uVar4 != 0; uVar4 = uVar4 - 1) {
            ...
            *(uint32_t /* width from decompiler */ *)pbVar10 = *(uint32_t /* width from decompiler */ *)pbVar9;
