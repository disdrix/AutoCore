...
// Address:   0x008e1ff0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for UI_discipline_title @ 0x008e1ff0
// Stable ID: aa_008e1ff0
// Embedded strings (evidence for future rename):
//   - "i_d_d_2d_wnd_title.xml"
//   - "i_d_d_2d_wnd_discipline_title.xml"
//   - " ID:%i"
//   - "%S:%i"
//   - " %S:%i"
//   - "i_d_d_2d_wnd_discipline_bar.xml"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~598 non-empty decompiler lines.
//  - Control keywords: if×27, while×23, for×22, do×20, return×7.
//  - Notable callees: FUN_0052b040×6, _snprintf×5, sprintf×5, FUN_007b5dd0×4, FUN_0040fa00×2, FUN_0052ad60×2, FUN_00403450, FUN_0040f5b0.
//  - Strings: "i_d_d_2d_wnd_title.xml"; "i_d_d_2d_wnd_discipline_title.xml"; " ID:%i"; "%S:%i".
//  - Return sites: 7.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "i_d_d_2d_wnd_discipline_title.xml"
 * Domain alias of FUN_008e1ff0 (FUN_* retained)
 *
...
void __fastcall UI_discipline_title(int *param_1)
...

{
  ...
  uint8_t auStack_ba8 [4];

  char *local_ba4;

  char *pcStack_ba0;

  uint32_t /* width from decompiler */ uStack_b9c;

  char acStack_b90 [12];

  uint8_t auStack_b84 [36];

  uint16_t uStack_b60;

  uint32_t /* width from decompiler */ auStack_b5e [3];
  ...
  uint32_t /* width from decompiler */ auStack_b1e [60];
  ...
  uint8_t auStack_890 [15];

  char acStack_881 [11];

  char acStack_876 [2];

  uint32_t /* width from decompiler */ auStack_874 [9];

  uint16_t uStack_850;

  uint32_t /* width from decompiler */ auStack_84e [249];
  ...
  uint32_t /* width from decompiler */ auStack_44e [237];
  ...
  while( true ) {
    ...
    uVar9 = *(uint32_t /* width from decompiler */ *)(uStack_bf0 + *(int *)(iVar5 + 4));
    ...
    if ((pvStack_bec != (void *)0x0) && (uStack_bf0 < 0x140)) {
      ...
      *(uint16_t *)puVar15 = 0;
      ...
      do {
        ...
        puVar15 = (uint32_t /* width from decompiler */ *)pcVar10;
      ...
      *(uint32_t /* width from decompiler */ *)((int)puVar15 + 1) = DAT_00a3bedc;

      *(uint16_t *)((int)puVar15 + 5) = DAT_00a3bee0;
      ...
      for (uVar13 = uVar6 >> 2; uVar13 != 0; uVar13 = uVar13 - 1) {
        ...
        *(uint32_t /* width from decompiler */ *)pcVar10 = *(uint32_t /* width from decompiler */ *)pcVar16;
      ...
      if (0 < sVar2) {
        ...
        *(uint32_t /* width from decompiler */ *)(pcVar10 + 1) = DAT_00a3beb8;

        *(uint32_t /* width from decompiler */ *)(pcVar10 + 5) = DAT_00a3bebc;

        *(uint16_t *)(pcVar10 + 9) = DAT_00a3bec0;
  ...
  while( true ) {
    ...
    *(uint32_t /* width from decompiler */ *)((int)pvVar7 + 8) = 0;

    *(uint32_t /* width from decompiler */ *)((int)pvVar7 + 0xc) = 0;

    *(uint32_t /* width from decompiler */ *)((int)pvVar7 + 0x10) = 0;
