// =============================================================================
// Named_CalleeOf_Client_SendInventoryUnequip_005714e0
// -----------------------------------------------------------------------------
// Stable ID: aa_005714e0
// Callee of Client_SendInventoryUnequip (+3 other named callers)
...
// PURPOSE (auto): Called from Client_SendInventoryUnequip: inventory/item helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Client_SendInventoryUnequip (+3 other named callers).
...
Named_CalleeOf_Client_SendInventoryUnequip_005714e0(int *param_1,uint8_t *param_2,uint8_t *param_3,char param_4,uint32_t /* width from decompiler */ param_5)
