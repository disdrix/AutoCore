// =============================================================================
// FUN_0094a6a0  — alias plate for Client_InitInstance
// -----------------------------------------------------------------------------
...
// See:       reconstructed-exact/Client_InitInstance.cpp
// Dual:      reviews/A|B_aa_0094a6a0_Client_InitInstance.md
// Full CF:   identical to Client_InitInstance (this file is the Ghidra-named alias).
// =============================================================================
...
uint32_t FUN_0094a6a0(int param_1)
