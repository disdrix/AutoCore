...
// =============================================================================
// Drive_LoadOneVehicleTemplate_dcFetch_Open_007d8fe0
// -----------------------------------------------------------------------------
...
/*
 * Behavioral notes:
 * String-driven rename evidence: "LoadOneVehicleTemplate::dcFetch::Open"
 *
...
uint32_t /* width from decompiler */ __thiscall Drive_LoadOneVehicleTemplate_dcFetch_Open_007d8fe0(char *param_1,uint32_t /* width from decompiler */ param_2,int param_3)
