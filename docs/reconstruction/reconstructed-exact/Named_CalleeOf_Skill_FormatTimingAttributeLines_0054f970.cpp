// =============================================================================
// Named_CalleeOf_Skill_FormatTimingAttributeLines_0054f970
// -----------------------------------------------------------------------------
// Stable ID: aa_0054f970
// Callee of Skill_FormatTimingAttributeLines
// Address:   0x0054f970  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Skill_FormatTimingAttributeLines: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~68 non-empty decompiler lines.
//  - Control keywords: do×6, while×6, for×4, if×1, return×1.
//  - Notable callees: FUN_0054f970.
//  - Return sites: 1.
...
void Named_CalleeOf_Skill_FormatTimingAttributeLines_0054f970(int param_1,char *param_2,char *param_3,char param_4)
