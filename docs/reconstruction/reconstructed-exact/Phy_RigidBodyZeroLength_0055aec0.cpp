// =============================================================================
// Phy_RigidBodyZeroLength_0055aec0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Phy_RigidBodyZeroLength_0055aec0 @ 0x0055aec0
// Stable ID: aa_0055aec0
...
//  - Notable callees: FUN_005f3160×2, FUN_004367f0, Phy_RigidBodyZeroLength_0055aec0, FUN_0055c7a0, FUN_005f3120, FUN_005f3740, FUN_007a4480, FUN_007b6a20.
//  - Strings: "Rigid body of object \'%s\' is zero length".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Rigid body of object '%s' is zero length"
 * Domain alias of FUN_0055aec0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ Phy_RigidBodyZeroLength_0055aec0(char *param_1,int param_2,int param_3)
