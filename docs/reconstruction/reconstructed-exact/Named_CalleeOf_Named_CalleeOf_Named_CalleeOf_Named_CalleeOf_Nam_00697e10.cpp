// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00697e10
// -----------------------------------------------------------------------------
// Stable ID: aa_00697e10
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam
// Address:   0x00697e10  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004e2e80×2, FUN_00506430, FUN_00697700, FUN_00697e10, memmove.
//  - Return sites: 9.
...
int __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00697e10(int param_1,int param_2)
...

{
  ...
  if (_Src != (void *)0x0) {
    ...
    uVar4 = *(int *)(param_2 + 8) - (int)_Src >> 2;
    ...
    if (uVar4 != 0) {
      ...
      if (_Dst == (void *)0x0) {
        ...
        uVar5 = *(int *)(param_1 + 8) - (int)_Dst >> 2;

      }

      if (uVar4 <= uVar5) {

        memmove(_Dst,_Src,(*(int *)(param_2 + 8) - (int)_Src >> 2) << 2);
      ...
      if (_Dst == (void *)0x0) {
        ...
        uVar5 = *(int *)(param_1 + 0xc) - (int)_Dst >> 2;
