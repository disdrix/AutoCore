// =============================================================================
// Named_CalleeOf_Mission_i_d_npc_xml_008ab0a0
// -----------------------------------------------------------------------------
// Stable ID: aa_008ab0a0
// Callee of Mission_i_d_npc_xml
...
// PURPOSE (auto): Called from Mission_i_d_npc_xml: mission/objective helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __fastcall Named_CalleeOf_Mission_i_d_npc_xml_008ab0a0(int param_1)
