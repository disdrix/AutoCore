// =============================================================================
// Named_CalleeOf_CVOGCreature_FindTerrainHeight_00580ed0
// -----------------------------------------------------------------------------
// Stable ID: aa_00580ed0
// Callee of CVOGCreature_FindTerrainHeight
...
// PURPOSE (auto): Called from CVOGCreature_FindTerrainHeight: creature/setup helper. Evidence string: "TtPhantom::castRay". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: rdtsc×2, FUN_00580ed0, FUN_005d6ae0.
...
void __thiscall Named_CalleeOf_CVOGCreature_FindTerrainHeight_00580ed0(int param_1,float *param_2,int param_3)
