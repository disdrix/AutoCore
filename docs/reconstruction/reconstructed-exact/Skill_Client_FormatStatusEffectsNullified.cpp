...
// =============================================================================
// Skill_Client_FormatStatusEffectsNullified
// -----------------------------------------------------------------------------
// Purpose:  Client combat log/tooltip formatter for skills that nullify status effects. Builds '\nStatus Effects Nullified: %s\n' using skill rank reevaluation and target-filter format helpers.
//
...
//
// Notable callees:
//   - FUN_005506a0 (Skill_FormatTargetFilterTooltip)
//   - Skill_SetRankAndReevaluate
//   - FUN_0083f510 / FUN_007fcb80 / FUN_0088a910
//   - sprintf / strstr / strrchr
//   - FUN_007a4480
//
// Notes:    in_EAX skill/context pointer.
//
...
void Skill_Client_FormatStatusEffectsNullified(void)
