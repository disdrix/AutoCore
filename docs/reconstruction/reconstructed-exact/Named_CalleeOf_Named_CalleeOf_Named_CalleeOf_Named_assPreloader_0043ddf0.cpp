// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_assPreloader_0043ddf0
// -----------------------------------------------------------------------------
// Stable ID: aa_0043ddf0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_assPreloader
// Address:   0x0043ddf0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0040b910×2, FUN_00446b10×2, FUN_00401a40, FUN_0043ddf0, FUN_0043e380, _CxxThrowException.
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_assPreloader_0043ddf0(uint32_t /* width from decompiler */ *param_1,char param_2,uint32_t /* width from decompiler */ *param_3)
...

{
  ...
  piVar3 = (int *)FUN_0043e380(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4),param_3,*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  if (param_3 == *(uint32_t /* width from decompiler */ **)(unaff_EDI + 4)) {
    ...
    **(uint32_t /* width from decompiler */ **)(unaff_EDI + 4) = piVar3;
    ...
    if (param_3 != *(uint32_t /* width from decompiler */ **)(iVar4 + 8)) goto LAB_0043dea2;
