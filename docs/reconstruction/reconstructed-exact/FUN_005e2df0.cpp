...
// Address:   0x005e2df0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_005e2df0 @ 0x005e2df0
// Stable ID: aa_005e2df0
// No high-value strings recovered; name via xrefs/callers in follow-up.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~999 non-empty decompiler lines.
//  - Control keywords: if×40, do×11, while×11, return×9, for×4, goto×2.
//  - Notable callees: FUN_0096efd0×8, CONCAT31×7, FUN_0076f5f0×5, FUN_00788280×4, FUN_00970140×4, FUN_0076e240×3, FUN_00989e00×3, D3DXVec2CatmullRom×2.
//  - Strings: "goo".
//  - Return sites: 9.
...

{
  ...
  uint8_t auStack_598 [8];

  uint32_t /* width from decompiler */ uStack_590;
  ...
  uint32_t /* width from decompiler */ uStack_4ac;

  uint32_t /* width from decompiler */ uStack_4a8;
  ...
  uint32_t /* width from decompiler */ *puStack_414;
  ...
  uint32_t /* width from decompiler */ uStack_219;

  uint8_t auStack_214 [255];

  uint32_t /* width from decompiler */ uStack_115;

  uint8_t auStack_110 [260];
  ...
  *local_430 = fStack_4ec + fStack_54c;
  ...
  puStack_540 = (uint8_t *)(0.0 - fStack_54c);
  ...
  puStack_4e0 = (uint8_t *)fStack_54c;
  ...
  *pfVar13 = fStack_4ec + fStack_54c;
  ...
  if (1 < (int)fStack_524) {
    ...
    do {
      ...
      puStack_540 = (uint8_t *)fStack_518;

      fStack_53c = fStack_510;

      if (cVar2 != '\0') {

        puStack_540 = (uint8_t *)(fStack_52c - fStack_4fc);
  ...
  puStack_4e0 = (uint8_t *)((int)fStack_524 / 3);
  ...
  if (0 < (int)fVar16) {
    ...
    puStack_540 = (uint8_t *)(iStack_520 * 0x168);
  ...
  if (3 < (int)fStack_524) {
    ...
    do {
      ...
      *pfVar5 = *pfVar5 - param_6;
      ...
      puStack_540 = (uint8_t *)(pfVar5[0x1c] - param_4);
  ...
  if (iVar3 < (int)fStack_524) {
    ...
    do {
      ...
      puStack_540 = (uint8_t *)(*pfVar5 - param_4);
  ...
  *param_3 = iVar3;
  ...
  do {
    ...
    puVar7 = (uint32_t /* width from decompiler */ *)((int)puVar14 + 1);
  ...
  *(uint32_t /* width from decompiler */ *)((int)puVar14 + 1) = DAT_009d4800;

  *(uint16_t *)((int)puVar14 + 5) = DAT_009d4804;
  ...
  *(uint8_t *)((int)puVar14 + 5) = DAT_00a2c540;
  ...
  puStack_8 = (uint8_t *)CONCAT31(puStack_8._1_3_,10);
  ...
  if (iVar3 < 0) {
    ...
    if ((uint32_t /* width from decompiler */ *)*param_2 != (uint32_t /* width from decompiler */ *)0x0) {
      ...
      (*(code *)**(uint32_t /* width from decompiler */ **)*param_2)();
    ...
    *param_2 = 0.0;
    ...
    if (*(int *)(piVar4[5] + 0x10) != 0) {
      ...
      puVar7 = (uint32_t /* width from decompiler */ *)FUN_00746520();
      ...
      if (puVar7 != (uint32_t /* width from decompiler */ *)0x0) {
        ...
        for (iVar3 = 0; iVar3 != 0; iVar3 = iVar3 + -1) {
          ...
          *(uint8_t *)puVar7 = *(uint8_t *)puStack_414;

          puStack_414 = (uint32_t /* width from decompiler */ *)((int)puStack_414 + 1);
        ...
        if ((uint32_t /* width from decompiler */ *)*piStack_c != (uint32_t /* width from decompiler */ *)0x0) {

          pfStack_574 = (float *)0x1;

          pfStack_578 = (float *)0x5e4b60;

          (*(code *)**(uint32_t /* width from decompiler */ **)*piStack_c)();
