// =============================================================================
// WorldObj_SnapshotHostRefsAndUnbind_Inferred
// -----------------------------------------------------------------------------
// Stable ID: aa_005617c0
// Address:   0x005617c0–0x005618a0 (224 B / 0xE0); ret 8
// Module:    autoassault.exe (image base 0x400000)
// Ghidra:    FUN_005617c0
// System:    world-object / mode-7 leave snapshot + unbind
// Dual:      2026-07-29 W29-T OWN-ONLY
// =============================================================================
//
// ABI: __thiscall  ECX = Manager*; stack1 = WorldObj*; stack2 = snapshot desc*;
//      void; ret 8
//
// CF:
//   host = *(manager+0x2c)
//   snapshot.count = 0
//   for each entry in host list +0x58/+0x5c:
//     if entry+0xc==obj OR entry+0x10==obj:
//       grow snapshot; push entry
//       entry->vtbl+0x28(local16)
//       host->vtbl+0xc(entry, &managerLocal)
//       compact-remove; i--
//   FUN_005614f0(manager, &objSlot, obj)  // defer if +0x12c else unbind
//
// Sole caller: FUN_005d4440 when old HBAI mode == 7.
// Consumer: WorldObj_RehomeLinksFromSnapshot_Inferred (00560f70).
