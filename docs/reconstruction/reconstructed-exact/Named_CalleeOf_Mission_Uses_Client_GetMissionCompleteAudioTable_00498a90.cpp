// =============================================================================
// Named_CalleeOf_Mission_Uses_Client_GetMissionCompleteAudioTable_00498a90
// -----------------------------------------------------------------------------
// Stable ID: aa_00498a90
// Callee of Mission_Uses_Client_GetMissionCompleteAudioTable
// Address:   0x00498a90  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Mission_Uses_Client_GetMissionCompleteAudioTable_00498a90(int param_1)
