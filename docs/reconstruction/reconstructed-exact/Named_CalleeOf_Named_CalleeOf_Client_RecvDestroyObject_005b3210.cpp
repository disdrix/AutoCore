// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_RecvDestroyObject_005b3210
// -----------------------------------------------------------------------------
...
//  - Notable callees: CVOGHBBase_AttachOwnerObject×2, CVOGHBBase_SetPeriodAndCounter, CVOGHBBase_ctor, FUN_005b3210.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ * __thiscall Named_CalleeOf_Named_CalleeOf_Client_RecvDestroyObject_005b3210(uint32_t /* width from decompiler */ *param_1,int param_2,uint32_t /* width from decompiler */ param_3)
