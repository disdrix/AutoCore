// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_PacketDispatch_00870680
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_PacketDispatch: packet/network helper. Evidence string: "Please wait for next match". Supports parent flow (not a free-standing entry point). Named_CalleeOf_Client_PacketDispatch (+1 other named callers).
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Client_PacketDispatch_00870680(int *param_1,int param_2)
