// =============================================================================
// Named_CalleeOf_Named_Starting_ShutDown_on_Client_0048a410
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_Starting_ShutDown_on_Client: callee helper. Evidence string: "SetLEDSettings() - Enter". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_Starting_ShutDown_on_Client_0048a410(int param_1,int param_2,uint32_t /* width from decompiler */ param_3)
