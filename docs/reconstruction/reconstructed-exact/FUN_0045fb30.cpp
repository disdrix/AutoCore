...
// PURPOSE (auto): Scaffold unit for FUN_0045fb30 @ 0x0045fb30
// Stable ID: aa_0045fb30
...
uint32_t /* width from decompiler */ * FUN_0045fb30(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
