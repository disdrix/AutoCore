// =============================================================================
// Named_CalleeOf_Auth_AuthServer_0046e2a0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Auth_AuthServer: auth/session helper. Evidence string: "c:\\vog\\1_code\\palantir\\platform\\library\\include\\nazgul\\net\\../../../src/nazgul/ne". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_0046e2a0, FUN_0067bac0, WSAGetLastError, connect, vog_LogMessage.
//  - Strings: "
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Auth_AuthServer_0046e2a0(SOCKET *param_1,sockaddr *param_2,uint32_t /* width from decompiler */ *param_3)
