...
// PURPOSE (auto): Scaffold unit for Named_GameUtils_createRagDoll @ 0x005f44c0
// Stable ID: aa_005f44c0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "**GameUtils::createRagDoll() error. %d bones not found in model <%s>."
 * Domain alias of FUN_005f44c0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ Named_GameUtils_createRagDoll(int param_1,int param_2,int param_3)
