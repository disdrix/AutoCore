// =============================================================================
// Named_CalleeOf_Mission_VOGRegionMissions_0053b0b0
// -----------------------------------------------------------------------------
// Stable ID: aa_0053b0b0
// Callee of Mission_VOGRegionMissions
// Address:   0x0053b0b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_005378d0, FUN_0053b0b0.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ * __thiscall Named_CalleeOf_Mission_VOGRegionMissions_0053b0b0(uint32_t /* width from decompiler */ *param_1,byte param_2)
