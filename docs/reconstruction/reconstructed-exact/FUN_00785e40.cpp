...
// PURPOSE (auto): Scaffold unit for FUN_00785e40 @ 0x00785e40
// Stable ID: aa_00785e40
...
//  - Notable callees: FUN_00785e40×2, s, sprintf.
    ...
    *param_2 = *param_2 + 1;
    ...
    if (((param_3[4] != 0) && (iVar8 = (int)(param_3[5] - param_3[4]) >> 2, 0 < iVar8)) &&
      ...
      do {
        ...
        FUN_00785e40(param_1,param_2,*(uint32_t /* width from decompiler */ *)(param_3[4] + iVar6 * 4));
