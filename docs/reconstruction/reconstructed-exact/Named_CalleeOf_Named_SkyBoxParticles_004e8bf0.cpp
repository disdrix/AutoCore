// =============================================================================
// Named_CalleeOf_Named_SkyBoxParticles_004e8bf0
// -----------------------------------------------------------------------------
// Stable ID: aa_004e8bf0
// Callee of Named_SkyBoxParticles (+5 other named callers)
...
// PURPOSE (auto): Called from Named_SkyBoxParticles: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_SkyBoxParticles (+5 other named callers).
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~36 non-empty decompiler lines.
//  - Control keywords: return×1.
//  - Notable callees: FUN_004e8bf0.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_SkyBoxParticles_004e8bf0(float *param_1,float *param_2,float *param_3,float *param_4)
