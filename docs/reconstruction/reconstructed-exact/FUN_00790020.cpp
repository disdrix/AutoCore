...
// PURPOSE (auto): Scaffold unit for FUN_00790020 @ 0x00790020
// Stable ID: aa_00790020
...
uint32_t /* width from decompiler */ __thiscall FUN_00790020(int *param_1,int param_2,uint32_t /* width from decompiler */ param_3)
