// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST_004bf740
// -----------------------------------------------------------------------------
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST_004bf740(int param_1)
...

{
  ...
  while (iVar1 != 0) {
    ...
    if (puVar2 != (uint32_t /* width from decompiler */ *)0x0) {
      ...
      *(uint32_t /* width from decompiler */ *)(param_1 + 4) = puVar2[1];
