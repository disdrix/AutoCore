...
// FUN_006760b0
// -----------------------------------------------------------------------------
// Stable ID: aa_006760b0
// Address:   0x006760b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006760b0 @ 0x006760b0
// Stable ID: aa_006760b0
...
//  - Notable callees: FUN_00675450×2, FUN_006756b0, FUN_006759e0, FUN_006760b0, _CxxThrowException, exception::exception.
...
FUN_006760b0(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ *param_4,uint32_t /* width from decompiler */ param_5)
...

{
  ...
  piVar4 = (int *)FUN_006759e0(*(uint32_t /* width from decompiler */ *)(param_1 + 4),param_4,*(uint32_t /* width from decompiler */ *)(param_1 + 4),
  ...
  *(int *)(param_1 + 8) = *(int *)(param_1 + 8) + 1;
  ...
  do {
    ...
    if (cVar1 != '\0') {
      ...
      *(uint8_t *)(*(int *)(*(int *)(param_1 + 4) + 4) + 0x24) = 1;
...
LAB_006761b6:
        ...
        *(uint8_t *)(*(int *)(piVar7[1] + 4) + 0x24) = 0;
        ...
        FUN_00675450(*(uint32_t /* width from decompiler */ *)(piVar7[1] + 4));
      ...
      if ((char)piVar6[9] == '\0') goto LAB_006761b6;
