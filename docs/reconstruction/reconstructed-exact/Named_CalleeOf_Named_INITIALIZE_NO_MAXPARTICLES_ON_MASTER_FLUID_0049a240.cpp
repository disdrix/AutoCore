// =============================================================================
// Named_CalleeOf_Named_INITIALIZE_NO_MAXPARTICLES_ON_MASTER_FLUID_0049a240
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_INITIALIZE_NO_MAXPARTICLES_ON_MASTER_FLUID: callee helper. Evidence string: "NDFluidMesh.fx". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Named_INITIALIZE_NO_MAXPARTICLES_ON_MASTER_FLUID_0049a240(int param_1)
