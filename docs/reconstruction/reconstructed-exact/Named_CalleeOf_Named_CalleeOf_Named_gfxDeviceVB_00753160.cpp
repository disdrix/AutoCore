// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_gfxDeviceVB_00753160
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_gfxDeviceVB: callee helper. Evidence string: "Diffuse". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_CalleeOf_Named_gfxDeviceVB_00753160(int param_1,float param_2,float param_3,float param_4,float param_5)
