// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Packet_failed_crypto_00425890
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_Packet_failed_crypto: packet/network helper. Evidence string: "LogConnectionProtocol". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Named_CalleeOf_Named_Packet_failed_crypto_00425890(uint param_1,uint32_t /* width from decompiler */ *param_2)
