// =============================================================================
// Mission_tExperienceLevel
// -----------------------------------------------------------------------------
// Stable ID: aa_007cbbb0
// Address:   0x007cbbb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for Mission_tExperienceLevel @ 0x007cbbb0
// Stable ID: aa_007cbbb0
// Embedded strings (evidence for future rename):
//   - "//tExperienceLevel/row"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~155 non-empty decompiler lines.
//  - Control keywords: if×10, while×2, return×2, do×1.
//  - Notable callees: block×17, FUN_004231d0×5, _com_issue_error×3, CONCAT22×2, CONCAT31×2, FUN_0041a3e0×2, FUN_0041c000×2, FUN_00423170×2.
//  - Strings: "//tExperienceLevel/row".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tExperienceLevel/row"
 * Domain alias of FUN_007cbbb0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __fastcall Mission_tExperienceLevel(int param_1)
  ...
  if (DAT_00d1793c == '\0') {
    ...
    if ((((iVar2 < 0) || (iVar2 = FUN_004231d0(), iVar2 < 0)) || (iVar2 = FUN_004231d0(), iVar2 < 0)
      ...
      while (iVar2 == 0) {
        ...
        local_50 = CONCAT22((uint16_t)local_6c,(short)local_7c[3]);

        uVar1 = (uint)local_4c >> 0x10;

        local_4c = CONCAT22((short)uVar1,(uint16_t)local_68);
