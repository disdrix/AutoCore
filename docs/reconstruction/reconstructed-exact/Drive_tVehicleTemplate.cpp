...
// PURPOSE (auto): Scaffold unit for Drive_tVehicleTemplate @ 0x007c6110
// Stable ID: aa_007c6110
// Embedded strings (evidence for future rename):
//   - "//tVehicleTemplate/row"
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tVehicleTemplate/row"
 * Domain alias of FUN_007c6110 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Drive_tVehicleTemplate(char *param_1,uint32_t /* width from decompiler */ *param_2,int param_3)
