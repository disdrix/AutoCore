...
/*
 * Behavioral notes:
 * String-driven rename evidence: "anmTrack_inl"
 *
...
void __thiscall Named_anmTrack_inl_0045e100(int param_1,float param_2,uint32_t /* width from decompiler */ *param_3)
