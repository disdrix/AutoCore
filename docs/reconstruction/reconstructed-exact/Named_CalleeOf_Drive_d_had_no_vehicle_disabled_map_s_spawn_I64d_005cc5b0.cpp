// =============================================================================
// Named_CalleeOf_Drive_d_had_no_vehicle_disabled_map_s_spawn_I64d_005cc5b0
// -----------------------------------------------------------------------------
// Stable ID: aa_005cc5b0
// Callee of Drive_d_had_no_vehicle_disabled_map_s_spawn_I64d
...
// PURPOSE (auto): Called from Drive_d_had_no_vehicle_disabled_map_s_spawn_I64d: drive/input helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __fastcall Named_CalleeOf_Drive_d_had_no_vehicle_disabled_map_s_spawn_I64d_005cc5b0(int param_1)
