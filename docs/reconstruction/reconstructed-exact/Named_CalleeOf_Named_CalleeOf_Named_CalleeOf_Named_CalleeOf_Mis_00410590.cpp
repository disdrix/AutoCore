// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mis_00410590
// -----------------------------------------------------------------------------
// Stable ID: aa_00410590
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_createNDUI
// Address:   0x00410590  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00410660×2, FUN_00410590, FUN_004645c0.
//  - Return sites: 3.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mis_00410590(uint param_1,int param_2)
...

{
  ...
  if (uVar2 < param_1) {
    ...
    if (iVar1 == 0) {
      ...
      FUN_00410660(*(uint32_t /* width from decompiler */ *)(param_2 + 8),&stack0x00000004);
