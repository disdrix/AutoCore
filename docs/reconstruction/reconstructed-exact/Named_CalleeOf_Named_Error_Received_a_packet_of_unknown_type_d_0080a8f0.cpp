// =============================================================================
// Named_CalleeOf_Named_Error_Received_a_packet_of_unknown_type_d_0080a8f0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_Error_Received_a_packet_of_unknown_type_d: packet/network helper. Evidence string: "Do you accept". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Named_Error_Received_a_packet_of_unknown_type_d_0080a8f0(uint32_t /* width from decompiler */ param_1)
