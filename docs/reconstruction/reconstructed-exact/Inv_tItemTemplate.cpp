...
// PURPOSE (auto): Scaffold unit for Inv_tItemTemplate @ 0x007c4920
// Stable ID: aa_007c4920
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tItemTemplate/row"
 * Domain alias of FUN_007c4920 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __fastcall Inv_tItemTemplate(char *param_1)
