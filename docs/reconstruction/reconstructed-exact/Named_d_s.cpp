...
// PURPOSE (auto): Scaffold unit for Named_d_s @ 0x00870680
// Stable ID: aa_00870680
...
//  - Notable callees: FUN_00870290×3, FUN_007a6de0×2, FUN_007a69d0, Named_d_s, GetTickCount, sprintf.
//  - Strings: "Please wait for next match"; "Finished round"; "%s %d / %d. %s.".
//  - Return sites: 4.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "%s %d / %d. %s."
 * Domain alias of FUN_00870680 (FUN_* retained)
 *
...
void __thiscall Named_d_s(int *param_1,int param_2)
