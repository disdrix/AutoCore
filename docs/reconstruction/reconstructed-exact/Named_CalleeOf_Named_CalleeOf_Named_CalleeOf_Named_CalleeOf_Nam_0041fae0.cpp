// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_0041fae0
// -----------------------------------------------------------------------------
// Stable ID: aa_0041fae0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST
// Address:   0x0041fae0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00422770×4, FUN_0041afc0, FUN_0041cb10, FUN_0041fae0, FUN_00421fa0, FUN_004220f0, FUN_004222f0, FUN_004540b0.
//  - Return sites: 3.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_0041fae0(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ *param_2,int param_3,int param_4,uint param_5)
...

{
  ...
  uint32_t /* width from decompiler */ local_3ec [245];
