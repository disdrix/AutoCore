...
// FUN_004ce640
// -----------------------------------------------------------------------------
// Stable ID: aa_004ce640
// Address:   0x004ce640  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_004ce640 @ 0x004ce640
// Stable ID: aa_004ce640
...
//  - Notable callees: FUN_004ce640, sprintf, strncat.
//  - Strings: "_0%i"; "_%i".
//  - Return sites: 1.
...
void __thiscall FUN_004ce640(int param_1,char *param_2)
...

{
  ...
  if (param_2 != (char *)0x0) {
    ...
    *(uint32_t /* width from decompiler */ *)(pcVar7 + 1) = DAT_009cc32c;

    *(uint16_t *)(pcVar7 + 5) = DAT_009cc330;
