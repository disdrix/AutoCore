...
// PURPOSE (auto): Scaffold unit for FUN_004c50c0 @ 0x004c50c0
// Stable ID: aa_004c50c0
...
void __thiscall FUN_004c50c0(int *param_1,int *param_2,int param_3,uint32_t /* width from decompiler */ param_4)
