...
// PURPOSE (auto): Scaffold unit for FUN_00481690 @ 0x00481690
// Stable ID: aa_00481690
...
uint32_t /* width from decompiler */ * FUN_00481690(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
