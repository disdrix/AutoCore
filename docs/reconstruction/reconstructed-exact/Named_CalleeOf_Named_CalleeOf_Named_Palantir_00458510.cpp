// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Palantir_00458510
// -----------------------------------------------------------------------------
...
//  - Notable callees: FUN_00438140×2, FUN_004129f0, FUN_00458510.
//  - Return sites: 3.
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Named_CalleeOf_Named_Palantir_00458510(uint32_t /* width from decompiler */ *param_1)
...

{
  ...
  if (bVar4) {
    ...
    if (puVar3 == (uint32_t /* width from decompiler */ *)**(int **)(in_EAX + 4)) {
      ...
      puVar3 = (uint32_t /* width from decompiler */ *)FUN_00438140(&param_1,1,puVar3,unaff_EBX);
  ...
  if ((uint)param_1[3] < *unaff_EBX) {
    ...
    puVar3 = (uint32_t /* width from decompiler */ *)FUN_00438140(&param_1,bVar4,puVar3,unaff_EBX);
