...
// PURPOSE (auto): Scaffold unit for FUN_007772e0 @ 0x007772e0
// Stable ID: aa_007772e0
...
int FUN_007772e0(uint32_t /* width from decompiler */ param_1,int param_2,int *param_3,uint32_t /* width from decompiler */ param_4)
