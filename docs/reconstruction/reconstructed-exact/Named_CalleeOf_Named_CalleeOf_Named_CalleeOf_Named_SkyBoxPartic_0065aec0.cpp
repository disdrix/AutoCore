// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_SkyBoxPartic_0065aec0
// -----------------------------------------------------------------------------
// Stable ID: aa_0065aec0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_SkyBoxParticles
// Address:   0x0065aec0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_006380d0, FUN_0065aec0.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ * __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_SkyBoxPartic_0065aec0(uint32_t /* width from decompiler */ *param_1)
