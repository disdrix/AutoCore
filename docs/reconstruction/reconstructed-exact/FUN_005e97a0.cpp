...
// FUN_005e97a0
// -----------------------------------------------------------------------------
// Stable ID: aa_005e97a0
// Address:   0x005e97a0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_005e97a0 @ 0x005e97a0
// Stable ID: aa_005e97a0
...
//  - Notable callees: FUN_005e97a0, _CxxThrowException, exception::exception.
...
void __thiscall FUN_005e97a0(int param_1,uint param_2)
...

{
  ...
  puStack_8 = &LAB_009a76b2;

  local_c = ExceptionList;

  if (0x15555555U - *(int *)(param_1 + 8) < param_2) {
