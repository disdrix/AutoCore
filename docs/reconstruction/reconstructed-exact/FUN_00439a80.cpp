// =============================================================================
// FUN_00439a80  (scaffold alias → Client_ApplyPairRelativeTransform)
// -----------------------------------------------------------------------------
...
// =============================================================================
// Authoritative named clean: Client_ApplyPairRelativeTransform.cpp
// Parent-seed alias: Named_CalleeOf_Named_ClientSpecialEvent_TeleportIn_00439a80
//   (incomplete sole-role claim — multi-caller unit)
...
void FUN_00439a80(void)
{
  ...
  FUN_0040cf90((void *)(unsigned int)uVar4);
  uVar4 = 3;
  (**(void (**)(int, void *))(*(int *)unaff_EDI[2] + 0x10))(3, auStack_6c);
  FUN_0040d1a0((void *)(unsigned int)uVar4);
  (**(void (**)(void))(*(int *)unaff_EDI[2] + 0x34))();
  return;
}
