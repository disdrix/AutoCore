// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_stoPackOSFil_00481750
// -----------------------------------------------------------------------------
// Stable ID: aa_00481750
// Callee of Named_CalleeOf_Named_CalleeOf_Named_stoPackOSFile
// Address:   0x00481750  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00481bf0×2, FUN_00481c40×2, FUN_00401a40, FUN_00481750, FUN_00481c90, _CxxThrowException.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_stoPackOSFil_00481750(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,char param_3)
...

{
  ...
  piVar3 = (int *)FUN_00481c90(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4),param_1,*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  if (param_1 == *(uint32_t /* width from decompiler */ **)(unaff_EDI + 4)) {
    ...
    **(uint32_t /* width from decompiler */ **)(unaff_EDI + 4) = piVar3;
    ...
    if (param_1 != *(uint32_t /* width from decompiler */ **)(iVar4 + 8)) goto LAB_004817fe;
