// =============================================================================
// Named_CalleeOf_Client_RecvCompleteDynamicObjective_008a0370
// -----------------------------------------------------------------------------
// Stable ID: aa_008a0370
// Callee of Client_RecvCompleteDynamicObjective
...
// PURPOSE (auto): Called from Client_RecvCompleteDynamicObjective: mission/objective helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void Named_CalleeOf_Client_RecvCompleteDynamicObjective_008a0370(void)
