// =============================================================================
// Named_CalleeOf_Skill_ResolveTargetList_0058c0a0
// -----------------------------------------------------------------------------
...
float10 Named_CalleeOf_Skill_ResolveTargetList_0058c0a0(int *param_1,int *param_2,float param_3,float param_4,uint32_t /* width from decompiler */ param_5,
