// =============================================================================
// Named_CalleeOf_Named_gfxDevice_00968680
// -----------------------------------------------------------------------------
...
void Named_CalleeOf_Named_gfxDevice_00968680(void)
...

{
  ...
  for (puVar1 = (uint32_t /* width from decompiler */ *)*DAT_00d1ee30; puVar1 != puVar2; puVar1 = (uint32_t /* width from decompiler */ *)*puVar1) {

    if (puVar1[2] != 0) {

      *(uint32_t /* width from decompiler */ *)(puVar1[2] + 0x184) = 0;
