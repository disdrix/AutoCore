...
uint32_t /* width from decompiler */ * Skill_i_w_skill_xml_008422f0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ param_2)
