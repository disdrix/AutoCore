...
// PURPOSE (auto): Scaffold unit for Named_Outpost @ 0x006081b0
// Stable ID: aa_006081b0
...
//  - Notable callees: sprintf×2, FUN_0040c5c0, FUN_006065a0, Named_Outpost.
//  - Strings: "Outpost %s has fallen to a rogue faction!"; "%s has captured outpost %s for ".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Outpost %s has fallen to a rogue faction!"
 * Domain alias of FUN_006081b0 (FUN_* retained)
 *
...
void __thiscall Named_Outpost(int param_1,int param_2)
