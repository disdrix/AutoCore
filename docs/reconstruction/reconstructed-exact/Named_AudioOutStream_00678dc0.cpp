...
Named_AudioOutStream_00678dc0(uint32_t /* width from decompiler */ *param_1,int param_2,uint32_t /* width from decompiler */ param_3,int param_4,int param_5)
