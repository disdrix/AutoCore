// =============================================================================
// Named_CalleeOf_CVOGSectorMap_LoadMapFile_004ce020
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from CVOGSectorMap_LoadMapFile: config/load helper. Evidence string: ".fam". Supports parent flow (not a free-standing entry point).
...
void __thiscall Named_CalleeOf_CVOGSectorMap_LoadMapFile_004ce020(int param_1,char *param_2)
