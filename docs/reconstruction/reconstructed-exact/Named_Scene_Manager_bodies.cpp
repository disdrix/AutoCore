...
// PURPOSE (auto): Scaffold unit for Named_Scene_Manager_bodies @ 0x009387e0
// Stable ID: aa_009387e0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "  Scene Manager: %.5f, %.1f%%;  (%d bodies) (x%d,mx%d,z%d,mz%d) (g:%d/%d, ng:%d/%d)"
 * Domain alias of FUN_009387e0 (FUN_* retained)
 *
...
int Named_Scene_Manager_bodies(int param_1)
