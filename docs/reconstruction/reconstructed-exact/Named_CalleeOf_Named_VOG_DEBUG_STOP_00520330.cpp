// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_00520330
// -----------------------------------------------------------------------------
// Stable ID: aa_00520330
// Callee of Named_VOG_DEBUG_STOP (+1 other named callers)
// Address:   0x00520330  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_CalleeOf_Named_VOG_DEBUG_STOP_00520330(int param_1,uint32_t /* width from decompiler */ param_2)



{

  *(uint32_t /* width from decompiler */ *)(param_1 + 0xcb0) = param_2;
