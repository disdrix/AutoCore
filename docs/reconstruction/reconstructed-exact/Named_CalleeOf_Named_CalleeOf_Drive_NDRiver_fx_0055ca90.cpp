...
// PURPOSE (auto): Called from Named_CalleeOf_Drive_NDRiver_fx: drive/input helper. Evidence string: "Particle_Distort.dds". Supports parent flow (not a free-standing entry point).
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Drive_NDRiver_fx_0055ca90(int param_1)
