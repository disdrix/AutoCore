// =============================================================================
// FUN_00560f70 / WorldObj_RehomeLinksFromSnapshot_Inferred
// -----------------------------------------------------------------------------
// Stable ID: aa_00560f70
// Address:   0x00560f70  (autoassault.exe, image base 0x400000)
// Body:      0x00560f70–0x00561312 (930 B / 0x3A2); epilogue ret 8
...
// Residual:  unaff_EBX on second virtual after child vtbl+0x28 (decompiler)
// =============================================================================

// PURPOSE: Manager thiscall — guarded reattach (same as 00560f30), then re-home
// snapshot children onto host (obj+0x44), push body pairs from link array
// (obj+0x88), re-home actions (obj+0x94) via HostActionList push + reverse
// remove, and collect neighbor body pairs. Used by SwitchHBAI when leaving
// mode code 7 with snapshot from FUN_005617c0.

// void __thiscall WorldObj_RehomeLinksFromSnapshot_Inferred(
//     Manager *m, WorldObj *obj, int *snapshot /* {ptr*, count} */)
// RET 8
...
void __thiscall FUN_00560f70(int param_1, int param_2, int *param_3)
{
  ...
  int *piVar7;
  int *piVar8;
  int *unaff_EBX; /* decompiler residual — not a formal */
  int iVar9;
  int iVar10;
  int local_2c;
  int iStack_28;
  ...
  *(uint8_t *)(param_1 + 300) = uVar1;
  ...
  if (0 < param_3[1]) {
    do {
      iVar5 = *param_3;
      iVar9 = local_2c * 4;
      if (*(uint32_t *)(iVar2 + 0x5c) == (*(uint32_t *)(iVar2 + 0x60) & 0x7fffffff)) {
        FUN_005b3370((int *)(iVar2 + 0x58), 4);
      }
      *(uint32_t *)(*(int *)(iVar2 + 0x58) + *(int *)(iVar2 + 0x5c) * 4) =
           *(uint32_t *)(iVar5 + iVar9);
      *(int *)(iVar2 + 0x5c) = *(int *)(iVar2 + 0x5c) + 1;
      (**(code **)(**(int **)(iVar9 + *param_3) + 0x28))(local_24);
      (**(code **)(*unaff_EBX + 8))(*(uint32_t *)(iVar9 + *param_3), &iStack_28);
    ...
    do {
      ...
      if (iVar5 != 0xb) {
        ...
        if ((iVar9 == iVar4) && (iVar5 = *(int *)(iVar5 + 0x10), *(char *)(iVar5 + 0x40) == '\0')) {
          ...
          uVar6 = *(uint32_t *)(param_1 + 0x28) & 0x7fffffff;
          if ((int)uVar6 < iVar9) {
            iVar10 = uVar6 * 2;
            if (iVar10 <= iVar9) {
              iVar10 = iVar9;
    ...
    do {
      ...
      if (0 < iVar9) {
        ...
        do {
          if (iVar3 == *piVar8) {
            FUN_006292a0(iVar3);
            FUN_00628f10(*(uint32_t *)(*piVar7 + iVar10 * 4));
