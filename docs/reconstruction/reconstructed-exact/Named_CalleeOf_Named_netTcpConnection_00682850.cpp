// =============================================================================
// Named_CalleeOf_Named_netTcpConnection_00682850
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_netTcpConnection: callee helper. Evidence string: "Error getting generator from key exchanger - prime and generator were likely not set.". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_0076cec0×3, vog_LogMessage×2, FUN_00682070, FUN_00682850.
//  - Strings: "
...
uint8_t __fastcall Named_CalleeOf_Named_netTcpConnection_00682850(int param_1)
