// =============================================================================
// GhostCreature_UnpackUpdate
// -----------------------------------------------------------------------------
// Stable ID: aa_005d2e40
// Address:   0x005d2e40  (autoassault.exe, image base 0x400000)
// System:    unknown
...

{
  ...
  if (DAT_00bc5590 != '\0') {
    ...
    FUN_007a4480(0xffffffff,"unpacking update from net %I64d for ghost %d, %d, %I64d",
                 *(uint32_t /* width from decompiler */ *)(param_2 + 0x238),*(uint32_t /* width from decompiler */ *)(param_2 + 0x23c),uVar4,uVar8,uVar9
                );
  }
...
LAB_005d2f0a:
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0xd8) = 0xffffffff;
  }
  else {
    ...
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0xd8) = uVar4;
  }
  uVar8 = *(uint *)(param_3 + 0x18);
  if (*(uint *)(param_3 + 0x2c) < uVar8) {
    *(uint8_t *)(param_3 + 0x1c) = 1;
LAB_005d2f24:
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0x128) = 0xffffffff;
  }
  else {
    bVar2 = *(byte *)((uVar8 >> 3) + *(int *)(param_3 + 0xc));
    *(int *)(param_3 + 0x18) = *(int *)(param_3 + 0x18) + 1;
    ...
    uVar4 = BitStream_readInt();
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0x128) = uVar4;
  }
  uVar8 = *(uint *)(param_3 + 0x18);
  if (*(uint *)(param_3 + 0x2c) < uVar8) {
    *(uint8_t *)(param_3 + 0x1c) = 1;
LAB_005d2f3e:
    *(uint32_t /* width from decompiler */ *)(iVar5 + 300) = 0xffffffff;
  }
  else {
    bVar2 = *(byte *)((uVar8 >> 3) + *(int *)(param_3 + 0xc));
    *(int *)(param_3 + 0x18) = *(int *)(param_3 + 0x18) + 1;
    ...
    uVar4 = BitStream_readInt();
    *(uint32_t /* width from decompiler */ *)(iVar5 + 300) = uVar4;
  }
  uVar8 = *(uint *)(param_3 + 0x18);
  if (*(uint *)(param_3 + 0x2c) < uVar8) {
    *(uint8_t *)(param_3 + 0x1c) = 1;
LAB_005d2f58:
    ...
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0xe4) = DAT_009da9e4;
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0xe8) = DAT_009da9e8;
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0xec) = DAT_009da9ec;
  }
  else {
    bVar2 = *(byte *)((uVar8 >> 3) + *(int *)(param_3 + 0xc));
    *(int *)(param_3 + 0x18) = *(int *)(param_3 + 0x18) + 1;
    ...
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0xe0) = local_f0;
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0xe4) = local_ec;
    BitStream_readFlag();
  }
  uVar8 = *(uint *)(param_3 + 0x18);
  if (*(uint *)(param_3 + 0x2c) < uVar8) {
    *(uint8_t *)(param_3 + 0x1c) = 1;
LAB_005d2f8f:
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0x108) = 0xffffffff;
  }
  else {
    bVar2 = *(byte *)((uVar8 >> 3) + *(int *)(param_3 + 0xc));
    *(int *)(param_3 + 0x18) = *(int *)(param_3 + 0x18) + 1;
    ...
    BitStream_readBits(0x40,&local_f0);
    *(uint32_t /* width from decompiler */ *)(iVar5 + 0x108) = local_f0;
  }
  uVar8 = *(uint *)(param_3 + 0x18);
  if (*(uint *)(param_3 + 0x2c) < uVar8) {
    *(uint8_t *)(param_3 + 0x1c) = 1;
...
LAB_005d316e:
  ...
  if (*(uint *)(param_3 + 0x2c) < uVar8) {
    ...
    *(uint *)(param_3 + 0x18) = uVar8 + 1;
    ...
    if ((bVar2 & (byte)(1 << ((byte)uVar8 & 7))) != 0) {
      ...
      if (DAT_00d1798c != 0) {
        iVar5 = local_f4[0x17];
        *(uint32_t /* width from decompiler */ *)(iVar5 + 0x130) = uStack_d8;
        *(uint32_t /* width from decompiler */ *)(iVar5 + 0x134) = uStack_d4;
      }
    }
  }
  uVar8 = *(uint *)(param_3 + 0x18);
  if (*(uint *)(param_3 + 0x2c) < uVar8) {
    ...
    *(uint *)(param_3 + 0x18) = uVar8 + 1;
    if ((bVar2 & (byte)(1 << ((byte)uVar8 & 7))) != 0) {
      ...
      if (DAT_00d1798c != 0) {
        *(uint32_t /* width from decompiler */ *)(local_f4[0x17] + 0x10) = uStack_dc;
  ...
  if (*(uint *)(param_3 + 0x2c) < uVar8) {
    ...
    *(int *)(param_3 + 0x18) = *(int *)(param_3 + 0x18) + 1;
    if ((bVar2 & (byte)(1 << ((byte)uVar8 & 7))) != 0) {
      ...
      if (DAT_00d1798c != 0) {
        *(uint8_t *)(local_f4[0x17] + 0x127) = uStack_10a;
      }
    }
  }
  uVar8 = *(uint *)(param_3 + 0x18);
  ...
  if ((piVar6 != (int *)0x0) &&
    ...
    if (local_fd != '\0') {
      *(uint8_t *)(piVar6 + 0x9b) = uStack_10a;
    }
    if (local_10b == 0) {
      if (local_109 != '\0') {
      ...
      if (local_109 == '\0') {
        ...
        if (iVar5 == 0) {
          ...
          uStack_2c = *(uint32_t /* width from decompiler */ *)(iVar5 + 0x164);
          uStack_28 = *(uint32_t /* width from decompiler */ *)(iVar5 + 0x168);
          uStack_24 = *(uint32_t /* width from decompiler */ *)(iVar5 + 0x16c);
        }
      }
      else {
