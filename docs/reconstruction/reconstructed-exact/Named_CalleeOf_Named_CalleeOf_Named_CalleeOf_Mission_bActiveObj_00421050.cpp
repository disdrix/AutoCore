// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_bActiveObj_00421050
// -----------------------------------------------------------------------------
// Stable ID: aa_00421050
// Callee of Named_CalleeOf_Named_CalleeOf_Mission_bActiveObjectiveOverride
// Address:   0x00421050  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00438140×2, FUN_004129f0, FUN_00421050.
//  - Return sites: 3.
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_bActiveObj_00421050(uint32_t /* width from decompiler */ *param_1)
...

{
  ...
  if (bVar1) {
    ...
    if (puVar4 == (uint32_t /* width from decompiler */ *)**(int **)(in_EAX + 4)) {
      ...
      puVar4 = (uint32_t /* width from decompiler */ *)FUN_00438140(&param_1,1,puVar4,unaff_EBX);
  ...
  if ((int)param_1[3] < *unaff_EBX) {
    ...
    puVar4 = (uint32_t /* width from decompiler */ *)FUN_00438140(&param_1,bVar1,puVar4,unaff_EBX);
