// =============================================================================
// Named_CalleeOf_Inv_Currently_Equipped_0084b770
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Inv_Currently_Equipped: callee helper. Evidence string: "(No Value)". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Inv_Currently_Equipped_0084b770(int *param_1,char param_2)
