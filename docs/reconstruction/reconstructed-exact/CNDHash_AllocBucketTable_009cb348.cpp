// =============================================================================
// CNDHash_AllocBucketTable_009cb348
// -----------------------------------------------------------------------------
// Stable ID: aa_004bc7a0
// Address:   0x004bc7a0–0x004bc830  (autoassault.exe @ 0x400000)
// System:    container / CNDHash (COList tableC family; sentinel stamp 0x009cb348)
...
//
// Callers
//   CNDHash_Ctor_009cb450 (FUN_004bce90) @ 0x004bceea
//   Recreate              (FUN_004bcce0) @ 0x004bcd2c
//
// Twin
//   CNDHash_AllocBucketTable_009cb350 @ 0x004bc840 (stamp 009cb350)
...
//
// Rejected alias
//   Named_VOG_DEBUG_STOP_004bc7a0 as product identity
// =============================================================================
...
extern void *PTR_LAB_009cb348; // sentinel vtbl @ 0x009cb348
extern void *DAT_00acc430;     // ThrowInfo

// void __thiscall — bare ret (or noreturn throw)
void __thiscall CNDHash_AllocBucketTable_009cb348(int thisHash)
{
