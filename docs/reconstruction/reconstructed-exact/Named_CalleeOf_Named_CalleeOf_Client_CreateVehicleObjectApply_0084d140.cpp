// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_CreateVehicleObjectApply_0084d140
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_CreateVehicleObjectApply: vehicle helper. Evidence string: "i_d_item.xml". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Named_CalleeOf_Client_CreateVehicleObjectApply_0084d140(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ param_2)
