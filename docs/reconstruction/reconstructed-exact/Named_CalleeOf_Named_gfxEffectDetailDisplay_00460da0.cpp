// =============================================================================
// Named_CalleeOf_Named_gfxEffectDetailDisplay_00460da0
// -----------------------------------------------------------------------------
// Stable ID: aa_00460da0
// Callee of Named_gfxEffectDetailDisplay
...
// PURPOSE (auto): Called from Named_gfxEffectDetailDisplay: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __thiscall Named_CalleeOf_Named_gfxEffectDetailDisplay_00460da0(int param_1,uint param_2)
