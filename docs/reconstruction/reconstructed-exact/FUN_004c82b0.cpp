...
// PURPOSE (auto): Scaffold unit for FUN_004c82b0 @ 0x004c82b0
// Stable ID: aa_004c82b0
...
FUN_004c82b0(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,int param_4,uint32_t /* width from decompiler */ param_5,
