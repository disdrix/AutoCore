// =============================================================================
// Named_CalleeOf_Drive_NDRiver_fx_00576860
// -----------------------------------------------------------------------------
// Stable ID: aa_00576860
// Callee of Drive_NDRiver_fx
// Address:   0x00576860  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00576860, FUN_00576c40, FUN_00746400.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ Named_CalleeOf_Drive_NDRiver_fx_00576860(void)
