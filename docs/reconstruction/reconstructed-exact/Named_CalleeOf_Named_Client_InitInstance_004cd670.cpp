// =============================================================================
// Named_CalleeOf_Named_Client_InitInstance_004cd670
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_Client_InitInstance: callee helper. Evidence string: "@@CVOGSectorMap::InitGenerators CVOGCreatureGenerator". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Named_Client_InitInstance_004cd670(void)
