...
// FUN_0059f580
// -----------------------------------------------------------------------------
// Stable ID: aa_0059f580
// Address:   0x0059f580  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0059f580 @ 0x0059f580
// Stable ID: aa_0059f580
...
//  - Notable callees: CONCAT31, FUN_00424dc0, FUN_0042b270, FUN_0059f580, FUN_00780820, free.
//  - Return sites: 1.
...
FUN_0059f580(uint32_t /* width from decompiler */ param_1,int param_2,uint16_t param_3,uint16_t param_4,uint16_t param_5
...

{
  ...
  if (piVar3 == (int *)0x0) {
    ...
    *piVar3 = (int)&PTR_LAB_009d7d1c;

    piVar3[6] = (int)&PTR_FUN_009d7c0c;

    piVar3[7] = (int)&LAB_005a20c0;
