// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Ski_00421980
// -----------------------------------------------------------------------------
// Stable ID: aa_00421980
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Skill_DbLoadSkills
// Address:   0x00421980  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Ski_00421980(int param_1)



{

  operator_new(param_1 * 0x934);
