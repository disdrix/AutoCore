// =============================================================================
// Named_CalleeOf_Client_NpcDialog_PrepareResponseOpcode_0092d580
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Client_NpcDialog_PrepareResponseOpcode: UI/dialog helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __fastcall Named_CalleeOf_Client_NpcDialog_PrepareResponseOpcode_0092d580(int param_1,uint param_2)
