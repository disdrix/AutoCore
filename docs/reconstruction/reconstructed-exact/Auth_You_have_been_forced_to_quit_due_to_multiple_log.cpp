...
// =============================================================================
// Auth_You_have_been_forced_to_quit_due_to_multiple_log
// -----------------------------------------------------------------------------
...
void __fastcall Auth_You_have_been_forced_to_quit_due_to_multiple_log(int param_1,char param_2,int param_3)
