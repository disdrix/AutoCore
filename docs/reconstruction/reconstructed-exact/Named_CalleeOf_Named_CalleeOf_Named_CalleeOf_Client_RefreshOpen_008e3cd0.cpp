// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_RefreshOpen_008e3cd0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Client_RefreshOpenMissionUiWindow: mission/objective helper. Evidence string: "i_d_qb_2d_btn_slot_off.dds". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_005711c0×2, FUN_0040ed60, FUN_008e3bd0, FUN_008e3cd0, Map_LowerBoundFindByIntKey.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_RefreshOpen_008e3cd0(int param_1,uint32_t /* width from decompiler */ *param_2)
