...
uint32_t /* width from decompiler */ * __thiscall Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs_004063a0(byte param_1,uint32_t /* width from decompiler */ *param_2)
