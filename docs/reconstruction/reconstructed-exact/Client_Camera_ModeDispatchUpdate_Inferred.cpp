// =============================================================================
// Client_Camera_ModeDispatchUpdate_Inferred  (named alias of FUN_0091ce80)
// -----------------------------------------------------------------------------
...
// Authoritative clean twin: FUN_0091ce80.cpp
//
...
void Client_Camera_ModeDispatchUpdate_Inferred(float param_1)
{
  int iVar1;
  char cVar2;
  int *in_EAX; // cam*
