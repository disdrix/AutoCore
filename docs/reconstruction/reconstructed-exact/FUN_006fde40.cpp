...
// Address:   0x006fde40  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006fde40 @ 0x006fde40
// Stable ID: aa_006fde40
// No high-value strings recovered; name via xrefs/callers in follow-up.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~680 non-empty decompiler lines.
//  - Control keywords: if×55, goto×38, while×5, do×4, switch×1, return×1.
//  - Notable callees: case×11, ABS×9, FUN_006fb890×2, FUN_006fbc20×2, FUN_006f6ef0, FUN_006fc000, FUN_006fc8d0, FUN_006fde40.
//  - Return sites: 1.
...

{
  ...
  uint32_t /* width from decompiler */ uVar29;
  ...
  *local_e8 = (int)*(char *)(param_5 + 9);
  ...
  if (3 < (int)uVar19) {
    ...
    puStack_f4 = (uint32_t /* width from decompiler */ *)(uVar19 >> 2);
    ...
    do {
      ...
      *pfVar21 = fVar3 * param_4[6] + fVar4 * param_4[10] + fVar2 * param_4[2] + param_4[0xe];
      ...
      puStack_f4 = (uint32_t /* width from decompiler */ *)((int)puStack_f4 - 1);

      pfVar17 = pfVar18;

      pfVar21 = pfVar21 + 0x10;

    } while (puStack_f4 != (uint32_t /* width from decompiler */ *)0x0);
...
LAB_006ff195:
    ...
    *(char *)(param_5 + 9) = (char)*unaff_EDI;
    ...
    puVar20 = (uint16_t *)(param_5 + iVar24 * 2);
