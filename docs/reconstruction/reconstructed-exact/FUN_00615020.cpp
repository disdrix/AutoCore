// W18-S 2026-07-29: dual sealed — prefer Skill_HB_SpawnEntities_Execute_Inferred.cpp stage plate + reviews A/B; this file keeps expanded decompiler body.
// =============================================================================
// FUN_00615020
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for FUN_00615020 @ 0x00615020
// Stable ID: aa_00615020
...
int FUN_00615020(int *param_1,int param_2,int param_3,uint32_t /* width from decompiler */ param_4,uint32_t /* width from decompiler */ param_5,
