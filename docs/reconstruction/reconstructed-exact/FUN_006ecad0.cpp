...
// FUN_006ecad0
// -----------------------------------------------------------------------------
// Stable ID: aa_006ecad0
// Address:   0x006ecad0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006ecad0 @ 0x006ecad0
// Stable ID: aa_006ecad0
...
//  - Notable callees: FUN_005ffdb0, FUN_00668190, FUN_006c7fa0, FUN_006e8880, FUN_006ecad0.
//  - Return sites: 1.
...
void FUN_006ecad0(int *param_1,uint32_t /* width from decompiler */ *param_2,int *param_3,uint32_t /* width from decompiler */ param_4,
...

{
  ...
  if (0 < *(int *)(iVar4 + 0xc)) {
    ...
    do {
      ...
      (**(code **)(*param_3 + 0x318c + (iVar4 * 0x20 + iStack_94) * 4))

                (&pppuStack_90,param_2,param_3,param_4,param_5);
