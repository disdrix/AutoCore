...
// PURPOSE (auto): Scaffold unit for FUN_0085bd40 @ 0x0085bd40
// Stable ID: aa_0085bd40
...
void FUN_0085bd40(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,int param_4,int param_5)
