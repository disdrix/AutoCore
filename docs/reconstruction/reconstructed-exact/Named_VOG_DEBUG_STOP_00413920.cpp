...
uint32_t /* width from decompiler */ Named_VOG_DEBUG_STOP_00413920(int param_1,uint param_2,uint32_t /* width from decompiler */ param_3,int param_4,char param_5)
