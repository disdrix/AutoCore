...
//  - Notable callees: FUN_007a4480×2, FUN_004bc7a0, FUN_004bcc60, FUN_004bcce0.
//  - Strings: "HashError:Recreate, already locked for traversal"; "VOG_DEBUG_STOP".
//  - Return sites: 1.

// =============================================================================
// Named_VOG_DEBUG_STOP_004bcce0
// -----------------------------------------------------------------------------
...
void __thiscall Named_VOG_DEBUG_STOP_004bcce0(int param_1,byte param_2)
