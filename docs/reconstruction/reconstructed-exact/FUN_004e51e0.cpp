...
// PURPOSE (auto): Scaffold unit for FUN_004e51e0 @ 0x004e51e0
// Stable ID: aa_004e51e0
...
void __thiscall FUN_004e51e0(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3,int *param_4)
