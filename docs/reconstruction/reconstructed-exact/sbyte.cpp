...

{
  ...
  if (iVar2 != 0) {
    ...
    uStack_28 = *(uint32_t /* width from decompiler */ *)(iVar2 + 0x164);
    uStack_24 = *(uint32_t /* width from decompiler */ *)(iVar2 + 0x168);
    uStack_20 = *(uint32_t /* width from decompiler */ *)(iVar2 + 0x16c);
    uStack_1c = *(uint32_t /* width from decompiler */ *)(iVar2 + 0x170);
    uStack_18 = *(uint32_t /* width from decompiler */ *)(unaff_ESI + 4);
    uStack_8 = 3;
    uStack_10 = 0;
