...
// PURPOSE (auto): Scaffold unit for FUN_00677110 @ 0x00677110
// Stable ID: aa_00677110
...
uint32_t /* width from decompiler */ * __thiscall FUN_00677110(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3,byte *param_4)
