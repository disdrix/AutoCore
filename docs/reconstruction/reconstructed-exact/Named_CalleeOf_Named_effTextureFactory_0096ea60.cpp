// =============================================================================
// Named_CalleeOf_Named_effTextureFactory_0096ea60
// -----------------------------------------------------------------------------
// Stable ID: aa_0096ea60
// Callee of Named_effTextureFactory
...
// PURPOSE (auto): Called from Named_effTextureFactory: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
int Named_CalleeOf_Named_effTextureFactory_0096ea60(int *param_1,uint *param_2,uint32_t /* width from decompiler */ param_3)
