// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_Cre_005de1b0
// -----------------------------------------------------------------------------
// Stable ID: aa_005de1b0
// Callee of Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_CreateCreature
// Address:   0x005de1b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0043fb00, FUN_004cbfc0, FUN_005de1b0.
//  - Return sites: 2.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_Cre_005de1b0(int param_1,uint param_2)
...

{
  ...
  if (uVar3 < param_2) {
    ...
    FUN_004cbfc0(*(uint32_t /* width from decompiler */ *)(param_1 + 8),param_2 - iVar4,&stack0x00000008);
