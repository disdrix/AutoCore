// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_bActiveObj_00438140
// -----------------------------------------------------------------------------
...
//  - Notable callees: FUN_004219b0×2, FUN_0046f030×2, FUN_00401a40, FUN_00438140, FUN_00439110, _CxxThrowException.
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_bActiveObj_00438140(uint32_t /* width from decompiler */ *param_1,char param_2,uint32_t /* width from decompiler */ *param_3)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  if (param_3 == *(uint32_t /* width from decompiler */ **)(unaff_EDI + 4)) {
    ...
    **(uint32_t /* width from decompiler */ **)(unaff_EDI + 4) = piVar3;
    ...
    if (param_3 != *(uint32_t /* width from decompiler */ **)(iVar4 + 8)) goto LAB_004381f2;
