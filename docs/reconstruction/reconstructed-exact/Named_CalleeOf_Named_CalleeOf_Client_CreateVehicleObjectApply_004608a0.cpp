// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_CreateVehicleObjectApply_004608a0
// -----------------------------------------------------------------------------
// Stable ID: aa_004608a0
// Callee of Named_CalleeOf_Client_CreateVehicleObjectApply
// Address:   0x004608a0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Client_CreateVehicleObjectApply_004608a0(uint32_t /* width from decompiler */ param_1,int *param_2)
