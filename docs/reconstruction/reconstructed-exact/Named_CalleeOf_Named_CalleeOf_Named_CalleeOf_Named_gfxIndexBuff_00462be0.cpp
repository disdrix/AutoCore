// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxIndexBuff_00462be0
// -----------------------------------------------------------------------------
// Stable ID: aa_00462be0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_gfxIndexBufferImpl
// Address:   0x00462be0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004540b0, FUN_00462be0, FUN_00463710.
//  - Return sites: 1.
...
int __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxIndexBuff_00462be0(int param_1,int param_2)
  ...
  *(uint32_t /* width from decompiler */ *)(param_2 + 0xc) = 0;
  ...
  if (uVar1 != 0) {
    ...
    *(void **)(param_2 + 0xc) = (void *)(uVar1 * 0x20 + (int)pvVar2);
    ...
    uVar3 = FUN_00463710(*(uint32_t /* width from decompiler */ *)(param_1 + 4),*(uint32_t /* width from decompiler */ *)(param_1 + 8),pvVar2,param_2);
