// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_004a7580
// -----------------------------------------------------------------------------
...
//  - Notable callees: FUN_004a6d80×2, FUN_004a7580, FUN_005a2850.
//  - Return sites: 3.
...
void __thiscall Named_CalleeOf_Named_VOG_DEBUG_STOP_004a7580(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3)
...

{
  ...
  if (bVar2) {
    ...
    if (puVar5 == (uint32_t /* width from decompiler */ *)**(int **)(param_1 + 4)) {
      ...
      puVar5 = (uint32_t /* width from decompiler */ *)FUN_004a6d80(&param_3,1,puVar5,piVar3);
  ...
  if (param_3[3] < *piVar3) {
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)FUN_004a6d80(&param_3,bVar2,puVar5,piVar3);
