...
// PURPOSE (auto): Scaffold unit for Named_tConfigCosts @ 0x007d81a0
// Stable ID: aa_007d81a0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tConfigCosts/row[1]"
 * Domain alias of FUN_007d81a0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Named_tConfigCosts(char *param_1,uint32_t /* width from decompiler */ *param_2)
