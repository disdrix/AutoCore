// =============================================================================
// Snd_replaceSoundInChannel_found_dead_sound_reserves_
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Snd_replaceSoundInChannel_found_dead_sound_reserves_ @ 0x00723ea0
// Stable ID: aa_00723ea0
...
//  - Notable callees: FUN_0071f810, FUN_00723ab0, Snd_replaceSoundInChannel_found_dead_sound_reserves_, FUN_007a4480, reserves.
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "replaceSoundInChannel found a dead sound in reserves(0x%X), removing it
"
 * Domain alias of FUN_00723ea0 (FUN_* retained)
 *
...
void Snd_replaceSoundInChannel_found_dead_sound_reserves_(int param_1)
