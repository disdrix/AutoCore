...
// PURPOSE (auto): Scaffold unit for Inv_tLootConfig @ 0x007cd9a0
// Stable ID: aa_007cd9a0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tLootConfig/row"
 * Domain alias of FUN_007cd9a0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Inv_tLootConfig(char *param_1,uint32_t /* width from decompiler */ *param_2)
