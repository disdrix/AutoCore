// =============================================================================
// FUN_00629d90  (twin of PhysSim_LtBroadPhase_Inferred)
// -----------------------------------------------------------------------------
// Stable ID: aa_00629d90
// Address:   0x00629d90
// Prefer named clean: PhysSim_LtBroadPhase_Inferred.cpp
// W28-S dual seal 2026-07-29
// =============================================================================

#include <cstdint>

void __thiscall FUN_00629d90(uint32_t param_1, int *param_2)
{
  float fVar1;
  int iVar2;
  uint64_t uVar3;
  ...
  local_34 = param_1;
  FUN_0062d960(*(uint32_t *)(*(int *)(param_1 + 0x20) + 0x238));
  FUN_0062d960(*(uint32_t *)(*(int *)(param_1 + 0x20) + 0x238));
  ...
  puVar12 = local_14;
  (**(code **)(*param_2 + 0x14))(piStack_44, local_40, *(uint32_t *)(param_1 + 0x40), &local_28);
  fVar4 = fStack_38;
  if (DAT_00bc5644 < DAT_00bc5648) {
