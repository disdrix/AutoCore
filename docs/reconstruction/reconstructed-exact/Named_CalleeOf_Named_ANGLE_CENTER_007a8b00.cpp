// =============================================================================
// Named_CalleeOf_Named_ANGLE_CENTER_007a8b00
// -----------------------------------------------------------------------------
// Stable ID: aa_007a8b00
// Callee of Named_ANGLE_CENTER (+18 other named callers)
...
// PURPOSE (auto): Called from Named_ANGLE_CENTER: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_ANGLE_CENTER (+18 other named callers).
...
void Named_CalleeOf_Named_ANGLE_CENTER_007a8b00(int *param_1)
