// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_assPackManag_00477790
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Named_assPackManager: callee helper. Evidence string: "insufficient memory". Supports parent flow (not a free-standing entry point).
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_assPackManag_00477790(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7)
