// =============================================================================
// Named_CalleeOf_Named_i_d_fec_2d_wnd_tooltip_attrib_combat_xml_008d44a0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_i_d_fec_2d_wnd_tooltip_attrib_combat_xml: combat/reward helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void Named_CalleeOf_Named_i_d_fec_2d_wnd_tooltip_attrib_combat_xml_008d44a0(void)
