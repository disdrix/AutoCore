// =============================================================================
// Named_CalleeOf_Mission_Mission_lacking_child_nodes_s_00545ff0
// -----------------------------------------------------------------------------
// Stable ID: aa_00545ff0
// Callee of Mission_Mission_lacking_child_nodes_s
// Address:   0x00545ff0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_CalleeOf_Mission_Mission_lacking_child_nodes_s_00545ff0(int param_1,char *param_2)
...

{
  ...
  *(char **)(param_1 + 0x150) = pcVar4;
  ...
  pcVar3[*(int *)(param_1 + 0x150) - (int)pcVar1] = '\0';
