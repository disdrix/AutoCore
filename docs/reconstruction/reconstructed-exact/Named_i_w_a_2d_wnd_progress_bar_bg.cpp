// =============================================================================
// Named_i_w_a_2d_wnd_progress_bar_bg
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_i_w_a_2d_wnd_progress_bar_bg @ 0x0084f2a0
// Stable ID: aa_0084f2a0
...
//  - Notable callees: FUN_00792600, Named_i_w_a_2d_wnd_progress_bar_bg, FUN_0097ffa0.
//  - Strings: "i_w_a_2d_wnd_frame.xml"; "i_w_a_2d_wnd_name.xml"; "i_w_a_2d_wnd_description.xml"; "i_w_a_2d_wnd_stats_full.xml".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "i_w_a_2d_wnd_progress_bar_bg.xml"
 * Domain alias of FUN_0084f2a0 (FUN_* retained)
 *
...
void __fastcall Named_i_w_a_2d_wnd_progress_bar_bg(int *param_1)
