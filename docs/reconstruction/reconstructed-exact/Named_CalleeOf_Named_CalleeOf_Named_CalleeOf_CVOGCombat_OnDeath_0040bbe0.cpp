// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGCombat_OnDeath_0040bbe0
// -----------------------------------------------------------------------------
// Stable ID: aa_0040bbe0
// Callee of Named_CalleeOf_Named_CalleeOf_CVOGCombat_OnDeathAwardKillXp
// Address:   0x0040bbe0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ * __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGCombat_OnDeath_0040bbe0(int param_1,int *param_2)
