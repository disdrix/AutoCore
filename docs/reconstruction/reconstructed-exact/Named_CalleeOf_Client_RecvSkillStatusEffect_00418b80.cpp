// =============================================================================
// Named_CalleeOf_Client_RecvSkillStatusEffect_00418b80
// -----------------------------------------------------------------------------
// Stable ID: aa_00418b80
// Callee of Client_RecvSkillStatusEffect (+1 other named callers)
// Address:   0x00418b80  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_CalleeOf_Client_RecvSkillStatusEffect_00418b80(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3)
