...
//   → docs/reconstruction/reconstructed-exact/MissionHost_CollectMediaPreloads_Inferred.cpp
// Wave:      W32-H dual 2026-07-29 (accept-with-gaps)
// Body:      0x004b88e0–0x004b8db1 exclusive (1233 B); RET 0x10
// Exactness: Behavior-preserving rewrite of decompiler control flow. Not modernization.
// Bit-for-bit vs retail EXE: DEFERRED (loaded image may differ slightly).
// =============================================================================

// PURPOSE: Mission host flag-gated media/audio preload path collect + enqueue.
// Prefer named clean over this FUN_* twin for port work.
...
void __thiscall FUN_004b88e0(int param_1,uint32_t /* width from decompiler */ param_2,char param_3,char param_4,char param_5)
