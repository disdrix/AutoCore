...
// PURPOSE (auto): Scaffold unit for Named_tRegionMaps @ 0x007db190
// Stable ID: aa_007db190
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tRegionMaps/row[@IDRegion='"
 * Domain alias of FUN_007db190 (FUN_* retained)
 *
...
void Named_tRegionMaps(char *param_1,int param_2)
