...
// =============================================================================
// Mission_Uses_Client_GetMissionCompleteAudioTable_004bb5b0
// -----------------------------------------------------------------------------
...
//           Behavior preserved from FUN_004bb5b0 clean capture (not modernized).
//
...
//           docs/reconstruction/raw/aa_004bb5b0_*.md
//           Original Ghidra symbol: FUN_004bb5b0
//
// Exactness: Body mirrors reconstructed-exact/FUN_004bb5b0*.cpp when present.
...
void Mission_Uses_Client_GetMissionCompleteAudioTable_004bb5b0(int param_1,float param_2,float *param_3,float *param_4,int *param_5)
