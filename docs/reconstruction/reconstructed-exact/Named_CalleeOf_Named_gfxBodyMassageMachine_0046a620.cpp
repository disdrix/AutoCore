// =============================================================================
// Named_CalleeOf_Named_gfxBodyMassageMachine_0046a620
// -----------------------------------------------------------------------------
// Stable ID: aa_0046a620
// Callee of Named_gfxBodyMassageMachine
// Address:   0x0046a620  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ * __fastcall Named_CalleeOf_Named_gfxBodyMassageMachine_0046a620(uint32_t /* width from decompiler */ param_1,int param_2)
...

{
  ...
  puVar1 = *(uint32_t /* width from decompiler */ **)(*in_EAX + 0xc);
