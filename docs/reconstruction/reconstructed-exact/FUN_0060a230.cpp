...
// PURPOSE (auto): Scaffold unit for FUN_0060a230 @ 0x0060a230
// Stable ID: aa_0060a230
...
FUN_0060a230(int param_1,uint32_t /* width from decompiler */ param_2,uint param_3,uint param_4,uint32_t /* width from decompiler */ param_5)
