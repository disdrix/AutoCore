...
// PURPOSE (auto): Scaffold unit for Named_tCloneBase @ 0x007e07b0
// Stable ID: aa_007e07b0
// Embedded strings (evidence for future rename):
//   - "//tCloneBase/row[@IDCloneBase=\'"
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tCloneBase/row[@IDCloneBase='"
 * Domain alias of FUN_007e07b0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Named_tCloneBase(int *param_1,char *param_2)
