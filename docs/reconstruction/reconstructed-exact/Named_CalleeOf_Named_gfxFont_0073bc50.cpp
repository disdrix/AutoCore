// =============================================================================
// Named_CalleeOf_Named_gfxFont_0073bc50
// -----------------------------------------------------------------------------
// Stable ID: aa_0073bc50
// Callee of Named_gfxFont
...
// PURPOSE (auto): Called from Named_gfxFont: callee helper. Evidence string: "Arial". Supports parent flow (not a free-standing entry point).
...
int * __thiscall Named_CalleeOf_Named_gfxFont_0073bc50(uint32_t /* width from decompiler */ param_1,int param_2,char *param_3,uint32_t /* width from decompiler */ param_4)
