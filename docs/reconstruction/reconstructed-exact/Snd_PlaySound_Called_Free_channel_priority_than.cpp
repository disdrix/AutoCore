// =============================================================================
// Snd_PlaySound_Called_Free_channel_priority_than
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Snd_PlaySound_Called_Free_channel_priority_than @ 0x00723f70
// Stable ID: aa_00723f70
...
//  - Notable callees: FUN_007a4480×3, FUN_00723ea0, Snd_PlaySound_Called_Free_channel_priority_than, SQRT.
//  - Strings: "Sound file had invalid group : %d".
//  - Return sites: 4.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "PlaySound Called: No Free channel of <= priority than %d found"
 * Domain alias of FUN_00723f70 (FUN_* retained)
 *
...
int Snd_PlaySound_Called_Free_channel_priority_than(float *param_1,int param_2)
