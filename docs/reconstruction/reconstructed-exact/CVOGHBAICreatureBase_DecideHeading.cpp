...
//  - Control keywords: if×15, for×2, return×1.
//  - Notable callees: ABS×11, FUN_004c56a0×3, _CIacos×2, CVOGHBAICreatureBase_DecideHeading, FUN_0040d040, FUN_004e8a40, FUN_004e8ad0, FUN_005070b0.
//  - Strings: "CVOGHBAICreatureBase::DecideHeading".
//  - Return sites: 1.

// =============================================================================
// CVOGHBAICreatureBase_DecideHeading
// -----------------------------------------------------------------------------
// Purpose:  Turn / aim the creature (or its vehicle) toward a desired heading derived
//           from target or path. Shared helper for pursue and patrol.
//
// Address:  0x005d0840  (autoassault.exe, image base 0x400000)
// Stable:   aa_005d0840
// System:   npc-ai / HBAI
//
// Convention: thiscall/fastcall on HBAI. Uses owner transform + heading
// helpers; CF preserved from raw (FPU-heavy). Called from combat/engage paths.
//
