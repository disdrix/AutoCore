// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_SetAnnouncementLabelTextur_0090b6a0
// -----------------------------------------------------------------------------
// Stable ID: aa_0090b6a0
// Callee of Named_CalleeOf_Client_SetAnnouncementLabelTextures
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_SetAnnouncementLabelTextures: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void Named_CalleeOf_Named_CalleeOf_Client_SetAnnouncementLabelTextur_0090b6a0(int param_1,int param_2,int param_3,int param_4)
