// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_005eddd0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_VOG_DEBUG_STOP: callee helper. Evidence string: "Dividing Actor, please wait.". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ * __thiscall Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_005eddd0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ param_3)
