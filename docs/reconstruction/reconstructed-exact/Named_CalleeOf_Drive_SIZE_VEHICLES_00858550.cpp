// =============================================================================
// Named_CalleeOf_Drive_SIZE_VEHICLES_00858550
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Drive_SIZE_VEHICLES: drive/input helper. Evidence string: "i_d_map_2d_icon_circle.dds". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Drive_SIZE_VEHICLES_00858550(uint32_t /* width from decompiler */ param_1)
