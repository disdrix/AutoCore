...
// PURPOSE (auto): Scaffold unit for FUN_007cd9a0 @ 0x007cd9a0
// Stable ID: aa_007cd9a0
...
uint32_t /* width from decompiler */ __thiscall FUN_007cd9a0(char *param_1,uint32_t /* width from decompiler */ *param_2)
