...
// =============================================================================
// Mission_Attempting_to_open_null_dialog_i_007fef20
// -----------------------------------------------------------------------------
...
/*
 * Behavioral notes:
 * String-driven rename evidence: "Attempting to open null dialog %i."
 *
...
void __thiscall Mission_Attempting_to_open_null_dialog_i_007fef20(int param_1,int param_2,char param_3,char param_4)
...

{
  ...
  if ((((*(int *)(param_1 + 0x1084) != 0) &&
    ...
    Mission_Attempting_to_open_null_dialog_i_007fef20(0x1d,1,0);
