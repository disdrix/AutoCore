...
//  - Notable callees: FUN_0067b110×2, FUN_0043fe60, FUN_0046e280, FUN_006759b0, FUN_0067ba30, FUN_00718c10, FUN_00727c00, FUN_00728840.
//  - Strings: "ServerListEx"; "AuthServer".
//  - Return sites: 1.

// =============================================================================
// AuthClient_SendServerListEx
// -----------------------------------------------------------------------------
// Purpose:  Outbound AuthServer ServerListEx request - ask for extended server list.
//
// Address:  0x00728840  (autoassault.exe, image base 0x400000)
// Stable:   aa_00728840
// System:   auth
//
...
// Source:    Prefer over FUN_00728840.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_00728840 using string evidence: FUN_00727b70("ServerListEx","AuthServer")
