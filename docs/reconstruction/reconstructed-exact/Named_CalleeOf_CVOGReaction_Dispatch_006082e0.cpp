// =============================================================================
// Named_CalleeOf_CVOGReaction_Dispatch_006082e0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from CVOGReaction_Dispatch: packet/network helper. Evidence string: "Invalid faction in CaptureOutpost = %d". Supports parent flow (not a free-standing entry point).
...
void __thiscall Named_CalleeOf_CVOGReaction_Dispatch_006082e0(int param_1,int *param_2)
