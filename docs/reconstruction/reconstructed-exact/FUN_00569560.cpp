// =============================================================================
// FUN_00569560  (scaffold alias — prefer StdMap_InsertWithHint_IntKey_Inferred)
// -----------------------------------------------------------------------------
...
// Canonical clean: StdMap_InsertWithHint_IntKey_Inferred.cpp
// =============================================================================
...
uint32_t *__thiscall FUN_00569560(int param_1, uint32_t *param_2, int *param_3, int *param_4)
{
    int *piVar1;
    int iVar2;
    int iVar3;
