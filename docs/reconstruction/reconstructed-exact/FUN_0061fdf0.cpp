...
// PURPOSE (auto): Scaffold unit for FUN_0061fdf0 @ 0x0061fdf0
// Stable ID: aa_0061fdf0
...
//  - Control keywords: if×12, return×2, goto×1, do×1, while×1.
//  - Notable callees: TFID_NotEquals×3, CVOGReaction_RandomUnitScalar×2, __RTDynamicCast×2, CVOGHBBase_Start, CVOGHBList_Enqueue, FUN_00404c90, FUN_0051b720, FUN_00578270.
//  - Return sites: 2.
...

{
  ...
  uint32_t /* width from decompiler */ uStack_cc0;

  uint32_t /* width from decompiler */ uStack_cbc;

  uint32_t /* width from decompiler */ uStack_cb8;

  uint32_t /* width from decompiler */ uStack_cb4;

  uint32_t /* width from decompiler */ local_cac;
    ...
    if ((*(char *)(param_1[0x1a2] + 0x7e) != '\0') && (param_1[4] != 0)) {
      ...
      *(int *)(iVar4 + 0xc) = *(int *)(iVar4 + 0xc) + 1;
      ...
      if (0x19 < (uint)uVar1 % 100) {
        ...
        aTStack_ca0[0].bGlobal = (uint8_t)DAT_009e2df8;
        ...
        aTStack_ca0[0].bPad3 = (uint8_t)DAT_009e2dfc;
