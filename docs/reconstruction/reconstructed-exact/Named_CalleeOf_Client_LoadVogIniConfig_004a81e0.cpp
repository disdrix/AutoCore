// =============================================================================
// Named_CalleeOf_Client_LoadVogIniConfig_004a81e0
// -----------------------------------------------------------------------------
// Stable ID: aa_004a81e0
// Callee of Client_LoadVogIniConfig (+1 other named callers)
// Address:   0x004a81e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004a81e0, strncpy.
//  - Return sites: 1.
...
void __thiscall Named_CalleeOf_Client_LoadVogIniConfig_004a81e0(int param_1,char *param_2)
