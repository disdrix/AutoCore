...
// PURPOSE (auto): Scaffold unit for Named_Cable_20k @ 0x0081e650
// Stable ID: aa_0081e650
...
//  - Notable callees: Cable, FUN_00794090, Named_Cable_20k, FUN_0092dcc0, ISDN.
//  - Strings: "DSL/Cable (20k+)"; "ISDN (10k)"; "56k (5k)".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "DSL/Cable (20k+)"
 * Domain alias of FUN_0081e650 (FUN_* retained)
 *
...
void Named_Cable_20k(int param_1)
