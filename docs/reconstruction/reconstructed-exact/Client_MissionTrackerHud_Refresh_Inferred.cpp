// =============================================================================
// Client_MissionTrackerHud_Refresh_Inferred
// -----------------------------------------------------------------------------
// Stable ID: aa_008a8770
// Address:   0x008a8770-0x008a9618  (autoassault.exe, image base 0x400000)
...
//
// PURPOSE:
//   Refresh mission-tracker HUD chrome (title, instruction, icon materials,
//   optional range/minimap captions). Host in ECX. No sector packet builders.
//
// NAMING:
//   Role-High promote: Client_MissionTrackerHud_Refresh_Inferred
//   Reject sole product name from one string: "Look in your Mission Inventory"
//   is an instruction-text branch only (not the whole function).
//
// ABI: void __thiscall (void *host); ECX=host; ret 0
// Host widgets: [0x1a2]=+0x688 title; [0x1a5]=+0x694 instruction; [0x1a4]=+0x690 icon
// Tracker: DAT_00d1ad10; character: DAT_00d1b6d8
//
// READABILITY (CF summary):
//  - Gates: client, busy+0x4f1, three widgets
//  - Title arm (tracker+9==0): mission hash lookup / No Objective / objective types 3+6 / contact
//  - Else title "Next mission"
//  - Instruction arm if FUN_0092c810()<1: mission inventory / journal / Go to
//  - Range arm if FUN_0092c810()>=1: waypoint TFID, distance metric/imperial, materials
// =============================================================================

void __fastcall Client_MissionTrackerHud_Refresh_Inferred(int *param_1)
