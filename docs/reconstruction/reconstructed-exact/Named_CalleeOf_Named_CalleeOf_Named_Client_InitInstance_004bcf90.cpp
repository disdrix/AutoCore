// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance_004bcf90
// -----------------------------------------------------------------------------
// Stable ID: aa_004bcf90
// Callee of Named_CalleeOf_Named_Client_InitInstance
// Address:   0x004bcf90  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004bc840, FUN_004bcf90.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ * __thiscall Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance_004bcf90(uint32_t /* width from decompiler */ *param_1,byte param_2)
