// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_PacketDispatch_00558eb0
// -----------------------------------------------------------------------------
// Stable ID: aa_00558eb0
// Callee of Named_CalleeOf_Client_PacketDispatch
// Address:   0x00558eb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Client_PacketDispatch_00558eb0(int param_1,uint32_t /* width from decompiler */ *param_2,byte *param_3)
