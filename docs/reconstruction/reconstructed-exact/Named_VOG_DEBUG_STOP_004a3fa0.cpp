...
uint8_t * Named_VOG_DEBUG_STOP_004a3fa0(int *param_1)
                          ...
                          if ((iVar14 == 0) && ((puVar9[0x90c] & 2) == 0)) {
                            ...
                            if ((iVar14 == 0) && ((puVar9[0x90c] & 2) == 0)) {
                              ...
                              if (((cVar5 != '\0') && (DAT_00af06e9 != '\0')) &&
                                 ...
                                 (piStack_2e8 = (int *)Named_VOG_DEBUG_STOP_004a3fa0(local_2f8,unaff_retaddr,param_1)
