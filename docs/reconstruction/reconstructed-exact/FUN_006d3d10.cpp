...
// FUN_006d3d10
// -----------------------------------------------------------------------------
// Stable ID: aa_006d3d10
// Address:   0x006d3d10  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006d3d10 @ 0x006d3d10
// Stable ID: aa_006d3d10
...
//  - Notable callees: FUN_006eb700×2, FUN_006d3d10.
//  - Return sites: 2.
...
void FUN_006d3d10(int *param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ *param_3,uint32_t /* width from decompiler */ param_4,int param_5
...

{
  ...
  if (param_5 != 0) {
    ...
    local_b0 = *(uint32_t /* width from decompiler */ *)(*param_1 + 0xc);

    local_ac = param_1[1];

    FUN_006eb700(param_2,&local_b0,&local_a0,&local_70,&local_40);
  ...
  FUN_006eb700(param_2,&local_b0,&local_a0,&local_70,0);
