...
// PURPOSE (auto): Scaffold unit for FUN_007e7fd0 @ 0x007e7fd0
// Stable ID: aa_007e7fd0
...
FUN_007e7fd0(char *param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,uint16_t *param_4,
