...
// PURPOSE (auto): Scaffold unit for FUN_0075e8e0 @ 0x0075e8e0
// Stable ID: aa_0075e8e0
...
uint32_t /* width from decompiler */ __thiscall FUN_0075e8e0(uint32_t /* width from decompiler */ *param_1,int param_2,int param_3,int param_4)
