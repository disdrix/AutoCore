// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs_008e1860
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Mission_createNDUIDialogs: mission/objective helper. Evidence string: "i_d_dt.xml". Supports parent flow (not a free-standing entry point).
...
int * Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs_008e1860(int *param_1)
