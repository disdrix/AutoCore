// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST_00539400
// -----------------------------------------------------------------------------
// Stable ID: aa_00539400
// Callee of Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP
// Address:   0x00539400  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_005376f0×2, FUN_00537e00, FUN_00538640, FUN_00539400, _CxxThrowException, exception::exception.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST_00539400(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ *param_4,uint32_t /* width from decompiler */ param_5)
...

{
  ...
  piVar4 = (int *)FUN_00538640(*(uint32_t /* width from decompiler */ *)(param_1 + 4),param_4,*(uint32_t /* width from decompiler */ *)(param_1 + 4),
  ...
  *(int *)(param_1 + 8) = *(int *)(param_1 + 8) + 1;
  ...
  do {
    ...
    if (cVar1 != '\0') {
      ...
      *(uint8_t *)(*(int *)(*(int *)(param_1 + 4) + 4) + 0x20c) = 1;
...
LAB_0053950c:
        ...
        *(uint8_t *)(piVar7[1] + 0x20c) = 1;

        *(uint8_t *)(*(int *)(piVar7[1] + 4) + 0x20c) = 0;

        FUN_005376f0(*(uint32_t /* width from decompiler */ *)(piVar7[1] + 4));
      ...
      if ((char)piVar6[0x83] == '\0') goto LAB_0053950c;
