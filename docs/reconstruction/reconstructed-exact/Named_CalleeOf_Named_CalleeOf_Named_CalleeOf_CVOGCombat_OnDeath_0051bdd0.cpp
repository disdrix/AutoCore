// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGCombat_OnDeath_0051bdd0
// -----------------------------------------------------------------------------
// Stable ID: aa_0051bdd0
// Callee of Named_CalleeOf_Named_CalleeOf_CVOGCombat_OnDeathAwardKillXp
// Address:   0x0051bdd0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0051bdd0, memmove.
//  - Return sites: 1.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGCombat_OnDeath_0051bdd0(int param_1,uint32_t /* width from decompiler */ *param_2,void *param_3)
