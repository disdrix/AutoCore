...
// PURPOSE (auto): Scaffold unit for FUN_005bf270 @ 0x005bf270
// Stable ID: aa_005bf270
...
uint32_t /* width from decompiler */ __thiscall FUN_005bf270(int param_1,int *param_2,int param_3,int param_4)
