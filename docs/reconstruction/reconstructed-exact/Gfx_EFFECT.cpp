...
// PURPOSE (auto): Scaffold unit for Gfx_EFFECT @ 0x007a9af0
// Stable ID: aa_007a9af0
...
//  - Notable callees: SysFreeString×5, swscanf×2, wcscmp×2, Gfx_EFFECT.
//  - Strings: "EFFECT"; "%d;%d"; "SPEED"; "%f;%f".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "EFFECT"
 * Domain alias of FUN_007a9af0 (FUN_* retained)
 *
...
void Gfx_EFFECT(uint32_t /* width from decompiler */ param_1,int *param_2)
