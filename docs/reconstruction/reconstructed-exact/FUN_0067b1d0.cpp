...
// PURPOSE (auto): Scaffold unit for FUN_0067b1d0 @ 0x0067b1d0
// Stable ID: aa_0067b1d0
...
uint32_t /* width from decompiler */ __thiscall FUN_0067b1d0(uint32_t /* width from decompiler */ *param_1,int param_2,u_short param_3,char param_4)
