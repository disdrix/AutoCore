...
// PURPOSE (auto): Scaffold unit for Named_UpdateContinentObject @ 0x007bd440
// Stable ID: aa_007bd440
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "UpdateContinentObject"
 * Domain alias of FUN_007bd440 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __fastcall Named_UpdateContinentObject(char *param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ *param_3)
