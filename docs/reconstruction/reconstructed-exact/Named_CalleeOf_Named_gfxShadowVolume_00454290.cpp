// =============================================================================
// Named_CalleeOf_Named_gfxShadowVolume_00454290
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Named_gfxShadowVolume_00454290(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
