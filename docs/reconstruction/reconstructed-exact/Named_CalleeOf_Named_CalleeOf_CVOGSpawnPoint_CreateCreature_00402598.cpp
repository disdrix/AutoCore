// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_CreateCreature_00402598
// -----------------------------------------------------------------------------
// Stable ID: aa_00402598
// Callee of Named_CalleeOf_CVOGSpawnPoint_CreateCreature
// Address:   0x00402598  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: LeaveCriticalSection×2, FUN_00402598, InterlockedIncrement.
//  - Return sites: 1.
...
uint8_t Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_CreateCreature_00402598(void)
