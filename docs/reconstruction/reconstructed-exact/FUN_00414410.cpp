...
// FUN_00414410
// -----------------------------------------------------------------------------
// Stable ID: aa_00414410
// Address:   0x00414410  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00414410 @ 0x00414410
// Stable ID: aa_00414410
...
//  - Notable callees: EnterCriticalSection×2, FUN_0040e490×2, LeaveCriticalSection×2, FUN_0040e380, FUN_0040fb90, FUN_004141c0, FUN_00414410.
//  - Return sites: 3.
...
void __thiscall FUN_00414410(int *param_1,float *param_2)
...

{
  ...
  lpCriticalSection = (LPCRITICAL_SECTION)(param_1 + 0x19e);
  ...
  if (param_1[0x195] == 0) {
    ...
    local_98 = *(int *)(param_1[0x195] + 4);

  }

  LeaveCriticalSection(lpCriticalSection);

  piVar3 = (int *)FUN_0040e490(param_1 + 0x194);
...
LAB_00414570:
        ...
        *local_a4 = local_a4;
        ...
        if (puVar9 == local_a4) goto LAB_00414570;
      ...
      pfVar4 = (float *)FUN_004141c0(local_30);
    ...
    FUN_0040e380(param_1 + 0x194,piVar3);
