...
// Address:   0x007b0ef0  (autoassault.exe, image base 0x400000)
// System:    unknown
...

{
  ...
  uint8_t local_20c [4];
  char local_208 [2];
  uint32_t /* width from decompiler */ auStack_206 [64];
  char cStack_105;
  char local_104 [260];
  ...
  if (param_2 == (char *)0x0) {
    ...
    if (*(int *)(iVar7 + 0x2c) == 0) {
      ...
      for (uVar8 = uVar4 >> 2; uVar8 != 0; uVar8 = uVar8 - 1) {
        *(uint32_t /* width from decompiler */ *)pcVar3 = *(uint32_t /* width from decompiler */ *)param_2;
        param_2 = param_2 + 4;
        pcVar3 = pcVar3 + 4;
      }
      ...
      if (iVar7 == 1) {
        puVar11 = (uint32_t /* width from decompiler */ *)(local_20c + 3);
        do {
      ...
      if ((*(byte *)(iVar7 + 4) & 1) != 0) {
        ...
        do {
          ...
          auVar6 = local_20c;
          for (uVar8 = uVar4 >> 2; uVar8 != 0; uVar8 = uVar8 - 1) {
            *(uint32_t /* width from decompiler */ *)pcVar9 = *(uint32_t /* width from decompiler */ *)auVar6;
            auVar6 = (uint8_t  [4])((int)auVar6 + 4);
            pcVar9 = pcVar9 + 4;
          }
          for (uVar4 = uVar4 & 3; uVar4 != 0; uVar4 = uVar4 - 1) {
            *pcVar9 = *(char *)auVar6;
