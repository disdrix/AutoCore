// =============================================================================
// Named_CalleeOf_Mission_bActiveObjectiveOverride_0041b440
// -----------------------------------------------------------------------------
// Stable ID: aa_0041b440
// Callee of Mission_bActiveObjectiveOverride (+2 other named callers)
// Address:   0x0041b440  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0041b440, FUN_0041d680.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ * __fastcall Named_CalleeOf_Mission_bActiveObjectiveOverride_0041b440(int param_1)
