// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGReaction_Dispatch_00566490
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_CVOGReaction_Dispatch: packet/network helper. Evidence string: "Invalid AI %d in spawn %I64d, on map %s". Supports parent flow (not a free-standing entry point).
...
void __thiscall Named_CalleeOf_Named_CalleeOf_CVOGReaction_Dispatch_00566490(int *param_1,char param_2,uint32_t /* width from decompiler */ param_3,uint param_4)
