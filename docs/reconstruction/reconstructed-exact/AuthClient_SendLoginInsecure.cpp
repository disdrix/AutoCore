...
// =============================================================================
// AuthClient_SendLoginInsecure
// -----------------------------------------------------------------------------
// Purpose:  Outbound AuthServer LoginInsecure - username/password login; path cites AuthClientImpl.cpp.
//
// Address:  0x00728c20  (autoassault.exe, image base 0x400000)
// Stable:   aa_00728c20
// System:   auth
//
// String evidence: LoginInsecure / AuthClientImpl.cpp / "username string too long"
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_00728c20.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_00728c20 using string evidence: LoginInsecure / AuthClientImpl.cpp / "username string too long"
