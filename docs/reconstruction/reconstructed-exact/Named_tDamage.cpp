...
// PURPOSE (auto): Scaffold unit for Named_tDamage @ 0x007e0230
// Stable ID: aa_007e0230
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tDamage/row[@IDDamage='"
 * Domain alias of FUN_007e0230 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Named_tDamage(char *param_1,int param_2,uint32_t /* width from decompiler */ *param_3)
