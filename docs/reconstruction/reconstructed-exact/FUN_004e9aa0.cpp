...
// PURPOSE (auto): Scaffold unit for FUN_004e9aa0 @ 0x004e9aa0
// Stable ID: aa_004e9aa0
...
float10 FUN_004e9aa0(uint32_t /* width from decompiler */ *param_1,float param_2,float param_3,int param_4,float *param_5,
