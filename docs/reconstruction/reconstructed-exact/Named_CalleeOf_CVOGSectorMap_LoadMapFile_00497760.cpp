// =============================================================================
// Named_CalleeOf_CVOGSectorMap_LoadMapFile_00497760
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from CVOGSectorMap_LoadMapFile: config/load helper. Evidence string: "../maps/". Supports parent flow (not a free-standing entry point).
...
uint __thiscall Named_CalleeOf_CVOGSectorMap_LoadMapFile_00497760(char *param_1,uint32_t /* width from decompiler */ param_2)
