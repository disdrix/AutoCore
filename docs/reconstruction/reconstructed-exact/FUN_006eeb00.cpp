...
// FUN_006eeb00
// -----------------------------------------------------------------------------
// Stable ID: aa_006eeb00
// Address:   0x006eeb00  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006eeb00 @ 0x006eeb00
// Stable ID: aa_006eeb00
...
//  - Notable callees: FUN_006ee740×2, FUN_006eeb00.
//  - Return sites: 2.
...
void FUN_006eeb00(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ *param_3,uint32_t /* width from decompiler */ param_4,
...

{
  ...
  if (param_5 != 0) {
    ...
    FUN_006ee740(param_2,param_1,&local_a0,&local_70,&local_40);

    return;

  }

  FUN_006ee740(param_2,param_1,&local_a0,&local_70,0);
