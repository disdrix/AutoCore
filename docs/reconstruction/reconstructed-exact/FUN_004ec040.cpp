...
// PURPOSE (auto): Scaffold unit for FUN_004ec040 @ 0x004ec040
// Stable ID: aa_004ec040
...
int * __thiscall FUN_004ec040(int param_1,uint32_t /* width from decompiler */ param_2,float *param_3,float *param_4)
