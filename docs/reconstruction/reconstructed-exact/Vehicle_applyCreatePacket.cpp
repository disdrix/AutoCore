...
// Address:   0x00505270  (autoassault.exe, image base 0x400000)
// System:    unknown
...
Vehicle_applyCreatePacket
          ...
          (int param_1,int *param_2,uint32_t /* or float bits */ param_3,uint32_t /* or float bits */ param_4,uint32_t /* or float bits */ param_5,

          uint32_t /* or float bits */ param_6,uint32_t /* or float bits */ param_7,uint32_t /* or float bits */ param_8)
...

{
  ...
  uint32_t /* or float bits */ uVar5;

  int iVar6;

  int iVar7;

  uint32_t /* or float bits */ uVar8;

  TypeDescriptor *pTVar9;

  TypeDescriptor *pTVar10;

  uint32_t /* or float bits */ uVar11;
  ...
  uint32_t /* or float bits */ uStack_4;
  ...
  if (param_2 != (int *)0x0) {
    ...
    *(uint8_t *)(param_1 + -0x3c4) = *(uint8_t *)((int)param_2 + 0x151);

    *(uint8_t *)(param_1 + -0x55c) = *(uint8_t *)((int)param_2 + 0x152);
    ...
    *(uint32_t /* or float bits */ *)(iVar6 + param_1 + -0x5ac) =

         *(uint32_t /* or float bits */ *)(*(int *)(*(int *)(iVar6 + -0x5c4 + param_1) + 0x3c) + 0x3e4);
    ...
    if (*(int *)(param_1 + -0x524) != -1) {
      ...
      if (*piVar4 == *(int *)(param_1 + -0x524)) {
        ...
        *(uint32_t /* or float bits */ *)(param_1 + -0x524) = 0xffffffff;
    ...
    if (iVar6 != -1) {
      ...
      *(int *)(param_1 + -0x3f0) = iVar6;
      ...
      if (iVar6 == 0) {
        ...
        *(uint32_t /* or float bits */ *)(param_1 + -0x3f0) = uVar5;
    ...
    if (iVar6 != 0) {
      ...
      if (piVar4 != (int *)0x0) {
        ...
        if ((((iVar6 != 0) &&
          ...
          *(uint32_t /* or float bits */ *)(*(int *)(param_1 + -0x3ec) + 0x5c) = DAT_00a0f704;
