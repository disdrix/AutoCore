// =============================================================================
// Named_CalleeOf_Named_Received_a_packet_out_of_sequence_lu_expec_0067bfa0
// -----------------------------------------------------------------------------
// Stable ID: aa_0067bfa0
// Callee of Named_Received_a_packet_out_of_sequence_lu_expected_lu
// Address:   0x0067bfa0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
Named_CalleeOf_Named_Received_a_packet_out_of_sequence_lu_expec_0067bfa0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ *param_3,uint param_4)
  ...
  if (param_4 != 0) {
    ...
    *param_1 = puVar1;
    ...
    for (param_4 = param_4 & 3; param_4 != 0; param_4 = param_4 - 1) {
      ...
      *(uint8_t *)puVar1 = *(uint8_t *)param_3;
