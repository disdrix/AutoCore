// =============================================================================
// Named_CalleeOf_Named_Sending_Challenge_Response_8x_00784d20
// -----------------------------------------------------------------------------
// Stable ID: aa_00784d20
// Callee of Named_Sending_Challenge_Response_8x (+4 other named callers)
...
// PURPOSE (auto): Called from Named_Sending_Challenge_Response_8x: callee helper. Evidence string: "Socket::sendto". Supports parent flow (not a free-standing entry point). Named_Sending_Challenge_Response_8x (+4 other named callers).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_Sending_Challenge_Response_8x_00784d20(SOCKET *param_1,char *param_2,int param_3)
