// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_missileExplosion_005be600
// -----------------------------------------------------------------------------
// Stable ID: aa_005be600
// Callee of Named_CalleeOf_Named_missileExplosion
// Address:   0x005be600  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004073a0, FUN_005be600, _aligned_malloc.
//  - Return sites: 1.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_missileExplosion_005be600(int *param_1)
...

{
  ...
  if (((int *)*param_1 == (int *)0x0) || (*(int *)*param_1 == 0)) {
    ...
    piVar2 = _aligned_malloc(0x3f930,0x10);
