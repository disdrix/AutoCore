// =============================================================================
// Named_CalleeOf_Auth_i_d_fesh_2d_wnd_frame_btn_login_xml_007fbe50
// -----------------------------------------------------------------------------
// Stable ID: aa_007fbe50
// Callee of Auth_i_d_fesh_2d_wnd_frame_btn_login_xml
...
// PURPOSE (auto): Called from Auth_i_d_fesh_2d_wnd_frame_btn_login_xml: auth/session helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void Named_CalleeOf_Auth_i_d_fesh_2d_wnd_frame_btn_login_xml_007fbe50(void)
