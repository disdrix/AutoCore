...
/*
 * Behavioral notes:
 * String-driven rename evidence: "stoPackOSFile"
 *
...
uint32_t /* width from decompiler */ Named_stoPackOSFile_007199e0(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,int param_3,int *param_4)
