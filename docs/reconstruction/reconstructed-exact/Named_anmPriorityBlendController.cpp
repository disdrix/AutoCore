...
// =============================================================================
// Named_anmPriorityBlendController
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __thiscall Named_anmPriorityBlendController(int *param_1,uint32_t /* width from decompiler */ param_2)
