...
// Address:   0x006ca1d0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006ca1d0 @ 0x006ca1d0
// Stable ID: aa_006ca1d0
...
//  - Notable callees: SQRT×6, FUN_005ee650, FUN_006c7fa0, FUN_006c7fc0, FUN_006c9c50, FUN_006c9e90, FUN_006ca1d0.
//  - Return sites: 3.
...
uint8_t * __thiscall FUN_006ca1d0(int param_1,uint8_t *param_2,float *param_3,float *param_4)
    ...
    if (local_8c <= *(float *)(param_1 + 0xc) * *(float *)(param_1 + 0xc)) {
      ...
      if (local_88 <= g_flOne) {
        ...
        if ((SQRT((*param_3 - local_60) * (*param_3 - local_60) +
          ...
          FUN_006c7fa0(*(uint32_t /* width from decompiler */ *)(param_1 + 0xc));
