// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_RecvCreateCharacter_004cd310
// -----------------------------------------------------------------------------
// Stable ID: aa_004cd310
// Callee of Named_CalleeOf_Client_RecvCreateCharacter (+1 other named callers)
// Address:   0x004cd310  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Client_RecvCreateCharacter_004cd310(int param_1,uint32_t /* width from decompiler */ param_2)



{

  *(uint32_t /* width from decompiler */ *)(param_1 + 0xe8a0) = param_2;
