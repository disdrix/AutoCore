// =============================================================================
// Snd_UpdateForegroundMusic_PlayMusic
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Snd_UpdateForegroundMusic_PlayMusic @ 0x00721f30
// Stable ID: aa_00721f30
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "UpdateForegroundMusic::PlayMusic FAILED: %s
"
 * Domain alias of FUN_00721f30 (FUN_* retained)
 *
...
int Snd_UpdateForegroundMusic_PlayMusic(int param_1,uint32_t /* width from decompiler */ param_2)
