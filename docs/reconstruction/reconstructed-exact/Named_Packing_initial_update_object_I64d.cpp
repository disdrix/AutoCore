// =============================================================================
// Named_Packing_initial_update_object_I64d
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_Packing_initial_update_object_I64d @ 0x005b1fd0
// Stable ID: aa_005b1fd0
...
//  - Notable callees: BitStream_writeBits×14, BitStream_writeFlag×8, CONCAT31×4, BitStream_writeInt×3, FUN_007a4480×3, FUN_0042be20, Named_Packing_initial_update_object_I64d, SUB43.
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Packing initial update for object %I64d"
 * Domain alias of FUN_005b1fd0 (FUN_* retained)
 *
...
uint64_t __thiscall Named_Packing_initial_update_object_I64d(int param_1,uint32_t /* width from decompiler */ param_2,uint param_3)
