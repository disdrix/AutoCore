// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Drive_driver_004a76e0
// -----------------------------------------------------------------------------
// Stable ID: aa_004a76e0
// Callee of Named_CalleeOf_Drive_driver
// Address:   0x004a76e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Named_CalleeOf_Drive_driver: drive/input helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~109 non-empty decompiler lines.
//  - Control keywords: if×13, return×4.
//  - Notable callees: FUN_004935b0×4, FUN_005739b0×2, CONCAT44, FUN_004a6820, FUN_004a69c0, FUN_004a7640, FUN_004a76e0, FUN_005c96c0.
//  - Return sites: 4.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Drive_driver_004a76e0(int param_1,int param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
