// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_007ed3b0
// -----------------------------------------------------------------------------
// Stable ID: aa_007ed3b0
// Callee of Named_CalleeOf_Named_VOG_DEBUG_STOP
// Address:   0x007ed3b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: block×25, FUN_004231d0×11, FUN_00423170×3, _com_issue_error×3, CONCAT31×2, FUN_0041a3e0×2, FUN_0041a990×2, FUN_007a4480×2.
//  - Return sites: 5.
...
int __thiscall Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_007ed3b0(char *param_1,int *param_2,uint32_t /* width from decompiler */ param_3,uint16_t *param_4)
  ...
  if (-1 < iVar1) {
    ...
    if (DAT_00d1793c == '\0') {
      ...
      if (((((iVar1 < 0) || (iVar1 = FUN_004231d0(), iVar1 < 0)) ||
        ...
        *(uint8_t *)(param_4 + 7) = uStack_189;

        *(uint8_t *)(param_4 + 6) = uStack_18b;

        *(uint8_t *)((int)param_4 + 0xd) = uStack_18a;
