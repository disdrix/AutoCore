// =============================================================================
// Inv_ConvoyLootMode_KillerTakes
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Inv_ConvoyLootMode_KillerTakes @ 0x0080fe10
// Stable ID: aa_0080fe10
...
//  - Notable callees: FUN_00574dd0, FUN_007a69d0, FUN_007a6de0, Inv_ConvoyLootMode_KillerTakes, FUN_008f8200, __RTDynamicCast.
//  - Strings: "Convoy Loot Mode switched to \'Killer Takes Loot\'."; "Convoy Loot Mode switched to \'Even Distribution\'.".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Convoy Loot Mode switched to 'Killer Takes Loot'."
 * Domain alias of FUN_0080fe10 (FUN_* retained)
 *
...
void Inv_ConvoyLootMode_KillerTakes(void)
