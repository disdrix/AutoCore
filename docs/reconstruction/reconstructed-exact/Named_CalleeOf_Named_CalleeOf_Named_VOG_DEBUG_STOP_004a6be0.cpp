// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_004a6be0
// -----------------------------------------------------------------------------
// Stable ID: aa_004a6be0
// Callee of Named_CalleeOf_Named_VOG_DEBUG_STOP
// Address:   0x004a6be0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004a6be0, _CxxThrowException, exception::exception.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_004a6be0(int param_1,uint param_2)
