// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_CreateCreature_00568670
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_CVOGSpawnPoint_CreateCreature: spawn/transfer helper. Evidence string: "ILLEGAL ENHANCEMENT: %i, CBID %i". Supports parent flow (not a free-standing entry point).
...
int Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_CreateCreature_00568670(uint32_t /* width from decompiler */ param_1,int param_2)
