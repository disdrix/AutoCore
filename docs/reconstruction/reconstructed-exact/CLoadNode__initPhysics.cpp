...
// PURPOSE (auto): Scaffold unit for CLoadNode__initPhysics @ 0x005c76f0
// Stable ID: aa_005c76f0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "CLoadNode::_initPhysics"
 * Domain alias of FUN_005c76f0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall CLoadNode__initPhysics(int param_1,int param_2,char param_3)
