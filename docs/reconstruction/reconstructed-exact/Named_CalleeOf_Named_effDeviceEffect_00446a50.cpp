// =============================================================================
// Named_CalleeOf_Named_effDeviceEffect_00446a50
// -----------------------------------------------------------------------------
// Stable ID: aa_00446a50
// Callee of Named_effDeviceEffect
// Address:   0x00446a50  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00446a50, FUN_00447350, FUN_00447760.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Named_effDeviceEffect_00446a50(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
