...
// =============================================================================
// Auth_Login_failure_Remove_this_message_when_login_fin_0080c3c0
// -----------------------------------------------------------------------------
...
/*
 * Behavioral notes:
 * String-driven rename evidence: "Login failure. Remove this message when login finalized."
 *
...
void Auth_Login_failure_Remove_this_message_when_login_fin_0080c3c0(int param_1)
