// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli_004e54f0
// -----------------------------------------------------------------------------
// Stable ID: aa_004e54f0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_RecvCreateC
// Address:   0x004e54f0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli_004e54f0(int param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ *param_3,uint32_t /* width from decompiler */ *param_4)
