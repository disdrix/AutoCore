// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_004eb560
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_VOG_DEBUG_STOP: callee helper. Evidence string: "Rigid body of PhysX object \'%s\' is zero length". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_007a4480×3, FUN_00766e50×2, sscanf×2, FUN_00404d80, FUN_004b4bf0, FUN_004b52e0, FUN_004b55e0, FUN_004eb560.
...
void Named_CalleeOf_Named_VOG_DEBUG_STOP_004eb560(int *param_1,char *param_2,float param_3,float param_4,int *param_5,char param_6,
