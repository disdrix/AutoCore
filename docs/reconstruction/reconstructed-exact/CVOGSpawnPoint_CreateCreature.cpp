...
//  - Control keywords: if×17, return×5, for×2, goto×2.
//  - Notable callees: FUN_007a4480×4, FUN_00567020×3, CONCAT31, CVOGSpawnPoint_CreateCreature, FUN_004024d0, FUN_00404d70, FUN_004bc180, FUN_004c9aa0.
//  - Strings: "Error: Unable to generate creature, cbid:%d leveloffset:%d"; "generic_elite".
//  - Return sites: 5.

// =============================================================================
// CVOGSpawnPoint_CreateCreature
// -----------------------------------------------------------------------------
// Purpose:  Spawn a creature from a map spawn point: instantiate, place (terrain ray +
//           flying/foot offsets when Speed/flag/IsNPC), bind AI/waypoints.
//
// Address:  0x00564f60  (autoassault.exe, image base 0x400000)
// Stable:   aa_00564f60
// System:   npc-ai / spawn
//
// AutoCore: SpawnPoint.ApplyStaticNpcSpawnHeight; docs NPC_SPAWN_HEIGHT.md.
// When Speed>0 OR spawn flag OR IsNPC==1: terrain ray Y+3, then
//   Y += rlFlyingHeight (flag bit4 clear) + creature[+0x120] foot offset.
// Also initializes waypoint / path hooks for HBAI.
//
...
int __thiscall
CVOGSpawnPoint_CreateCreature(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,char param_4)
{
  ...
  if (*(int *)(iVar4 + 0x38) != 0x12) {
    ...
    FUN_007a4480(1,"!!Old vehicle spawn: %d, not a template for spawn %I64d Map %d",param_2,
                 *(uint32_t /* width from decompiler */ *)(param_1 + 0x164 + iVar4),*(uint32_t /* width from decompiler */ *)(param_1 + iVar4 + 0x168),
                 *(uint32_t /* width from decompiler */ *)(*(int *)(param_1 + 0xa8 + iVar4) + 0xfc));
    ExceptionList = pvStack_20;
    return 0;
  }
  if (*(char *)(param_1 + 0xa8) == '\0') {
    ...
    (**(code **)(*(int *)(*(int *)(piVar5[1] + 4) + 4 + (int)piVar5) + 8))
              (param_2,*(uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_1 + 4) + 4) + 0xa8 + param_1),1);
    goto LAB_005650e0;
  }
...
LAB_005650e0:
  ...
  *(uint *)(iVar4 + 0xe6dc) = iVar6 + (uint)(0xfffffffe < uVar9);
  ...
  CVOGWaypoint_InitFromSpawn
             ...
             *(uint32_t /* width from decompiler */ *)(param_1 + 0x7c),CONCAT31((int3)(uVar9 >> 8),uVar9 == 0xffffffff),0);
  iVar4 = *(int *)(*(int *)(param_1 + 4) + 4);
  uStack_84 = *(uint32_t /* width from decompiler */ *)(param_1 + 0x84 + iVar4);
  fStack_80 = *(float *)(param_1 + 0x88 + iVar4);
  pvStack_7c = *(void **)(param_1 + 0x8c + iVar4);
  uStack_78 = *(uint32_t /* width from decompiler */ *)(param_1 + 0x90 + iVar4);
  ...
  if (((*(int *)(iVar4 + 0x4e0) != 1) && (*(char *)(param_1 + 0x1a9) != '\0')) &&
    ...
    cVar3 = FUN_004e9720(*(uint32_t /* width from decompiler */ *)(param_1 + 0xa8 + *(int *)(*(int *)(param_1 + 4) + 4)),
                         &uStack_84,*(uint32_t /* width from decompiler */ *)(param_1 + 0x9c),
    ...
    if (cVar3 == '\0') {
      ...
      (*(code *)**(uint32_t /* width from decompiler */ **)(*(int *)(piVar5[1] + 4) + 4 + (int)piVar5))();
      ExceptionList = pvStack_20;
      return 0;
    }
    uStack_84 = uStack_74;
  ...
  *(uint32_t /* width from decompiler */ *)(iVar4 + 0x84 + (int)piVar5) = uStack_84;
  *(float *)(iVar4 + 0x88 + (int)piVar5) = fStack_80;
  *(void **)(iVar4 + 0x8c + (int)piVar5) = pvStack_7c;
  *(uint32_t /* width from decompiler */ *)((int)piVar5 + iVar4 + 0x90) = uStack_78;
  iVar6 = *(int *)(*(int *)(param_1 + 4) + 4);
  puVar1 = (uint32_t /* width from decompiler */ *)(*(int *)(piVar5[1] + 4) + 0x94 + (int)piVar5);
  iVar4 = iVar6 + 0x94 + param_1;
  *puVar1 = *(uint32_t /* width from decompiler */ *)(iVar6 + 0x94 + param_1);
  puVar1[1] = *(uint32_t /* width from decompiler */ *)(iVar4 + 4);
  puVar1[2] = *(uint32_t /* width from decompiler */ *)(iVar4 + 8);
  puVar1[3] = *(uint32_t /* width from decompiler */ *)(iVar4 + 0xc);
  ...
  if (param_4 != '\0') {
    ...
    (**(code **)*piVar5)(*(uint32_t /* width from decompiler */ *)(param_1 + 0xa8),&stack0xffffff74,param_1 + 0x94,0);
