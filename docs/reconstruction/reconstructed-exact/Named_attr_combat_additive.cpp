...
uint32_t /* width from decompiler */ Named_attr_combat_additive(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3)
