// =============================================================================
// Named_CalleeOf_CVOGReaction_Dispatch_004058f0
// -----------------------------------------------------------------------------
// Stable ID: aa_004058f0
// Callee of CVOGReaction_Dispatch
// Address:   0x004058f0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004058f0, FUN_00406750.
//  - Return sites: 1.
...
void __fastcall Named_CalleeOf_CVOGReaction_Dispatch_004058f0(int param_1)



{

  FUN_00406750(*(uint32_t /* width from decompiler */ *)(*(int *)(param_1 + 4) + 4));
