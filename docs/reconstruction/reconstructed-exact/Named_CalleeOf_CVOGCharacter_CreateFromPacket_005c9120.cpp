// =============================================================================
// Named_CalleeOf_CVOGCharacter_CreateFromPacket_005c9120
// -----------------------------------------------------------------------------
// Stable ID: aa_005c9120
// Callee of CVOGCharacter_CreateFromPacket
// Address:   0x005c9120  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004bc180, FUN_004c0140, FUN_005c9120, FUN_00797170.
//  - Return sites: 2.
...
Named_CalleeOf_CVOGCharacter_CreateFromPacket_005c9120(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,int param_4,uint32_t /* width from decompiler */ param_5,
...

{
  ...
  if (param_4 != 0) {
    ...
    puVar7 = (uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_1 + -0x10c) + 4) + -0x8c + param_1);
    ...
    *(uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_1 + -0x10c) + 4) + -0xfc + param_1) =
