...
// PURPOSE (auto): Scaffold unit for FUN_007ee340 @ 0x007ee340
// Stable ID: aa_007ee340
...
int __thiscall FUN_007ee340(char *param_1,int *param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ *param_4)
