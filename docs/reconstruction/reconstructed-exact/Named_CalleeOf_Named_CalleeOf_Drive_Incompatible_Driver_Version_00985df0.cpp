// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Drive_Incompatible_Driver_Version_00985df0
// -----------------------------------------------------------------------------
// Stable ID: aa_00985df0
// Callee of Named_CalleeOf_Drive_Incompatible_Driver_Version_Detected_Drive
// Address:   0x00985df0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00462f80, FUN_005ae270, FUN_00985df0.
//  - Return sites: 1.
...
int Named_CalleeOf_Named_CalleeOf_Drive_Incompatible_Driver_Version_00985df0(int param_1)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x1c) = 0x1000;
