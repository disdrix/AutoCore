// =============================================================================
// CreateSimpleObject_Serialize
// -----------------------------------------------------------------------------
// Stable ID: aa_005c9f20
// Address:   0x005c9f20  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ __thiscall CreateSimpleObject_Serialize(int param_1,uint *param_2)

{
  ...
  *param_2 = 0x2012;
  ...
  param_2[0x24] = *(uint32_t /* width from decompiler */ *)(iVar5 + 0xa4 + param_1);
  param_2[0x25] = *(uint32_t /* width from decompiler */ *)(iVar5 + 0xa8 + param_1);
  *(uint8_t *)(param_2 + 0x26) =
       *(uint8_t *)(*(int *)(*(int *)(param_1 + -0xbc) + 4) + 0xac + param_1);
  param_2[4] = *(uint32_t /* width from decompiler */ *)(param_1 + -0x34);
  param_2[5] = *(uint32_t /* width from decompiler */ *)(param_1 + -0x30);
  param_2[0x21] = *(uint32_t /* width from decompiler */ *)(param_1 + -0x2c);
  *(uint8_t *)(param_2 + 0x22) = *(uint8_t *)(param_1 + -0x24);
  *(uint8_t *)((int)param_2 + 0x89) = *(uint8_t *)(param_1 + -0x23);
  param_2[6] = *(uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_1 + -0xbc) + 4) + 8 + param_1);
  param_2[7] = *(uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_1 + -0xbc) + 4) + -0xac + param_1);
  param_2[8] = *(uint32_t /* width from decompiler */ *)(param_1 + -0x38);
  param_2[2] = 0xffffffff;
  param_2[3] = 0xffffffff;
  *(byte *)((int)param_2 + 0x8a) =
       (byte)((uint)*(uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_1 + -0xbc) + 4) + 0xc0 + param_1) >> 8)
       & 1;
  *(uint8_t *)((int)param_2 + 0xa3) = *(uint8_t *)(param_1 + -0x22);
  *(uint8_t *)(param_2 + 0x29) = *(uint8_t *)(param_1 + -0x21);
  *(uint8_t *)((int)param_2 + 0xa5) = *(uint8_t *)(param_1 + -0x20);
  ...
  *(uint16_t *)(param_2 + 0x2b) =
       *(uint16_t *)(*(int *)(*(int *)(param_1 + -0xbc) + 4) + 0xc4 + param_1);
  ...
  *(uint8_t *)(param_2 + 0x30) = 0;
  param_2[9] = *(uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_1 + -0xbc) + 4) + 0xc + param_1);
  ...
  *(uint16_t *)((int)puVar3 + 0xc2) = *(uint16_t *)(param_1 + -0x3c);
  puVar3[0x34] = *(uint32_t /* width from decompiler */ *)(param_1 + -0x28);
  param_2 = puVar3 + 0xf;
  *param_2 = 0xffffffff;
...
LAB_005ca45f:
  ...
  *(uint16_t *)(puVar3 + 0x32) =
       *(uint16_t *)(*(int *)(*(int *)(param_1 + -0xbc) + 4) + 0x32 + param_1);
  *(uint16_t *)((int)puVar3 + 0xca) =
       *(uint16_t *)(*(int *)(*(int *)(param_1 + -0xbc) + 4) + 0x34 + param_1);
  *(uint16_t *)(puVar3 + 0x33) =
       *(uint16_t *)(*(int *)(*(int *)(param_1 + -0xbc) + 4) + 0x36 + param_1);
  ...
  puVar3[0x19] = *(uint32_t /* width from decompiler */ *)(iVar6 + -0x3c + param_1);
