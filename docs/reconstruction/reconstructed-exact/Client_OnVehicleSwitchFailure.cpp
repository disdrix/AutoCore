...
// =============================================================================
// Client_OnVehicleSwitchFailure
// -----------------------------------------------------------------------------
// Purpose:  Vehicle chassis switch failures (inventory fit / vehicle not found).
//
// Address:  0x00810360  (autoassault.exe, image base 0x400000)
// Stable:   aa_00810360
// System:   inventory-transfer
//
// String evidence: "vehicle not found in inventory" / chassis inventory fit
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_00810360.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_00810360 using string evidence: "vehicle not found in inventory" / chassis inventory fit
