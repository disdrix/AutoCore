...
// PURPOSE (auto): Scaffold unit for FUN_0066eec0 @ 0x0066eec0
// Stable ID: aa_0066eec0
// Embedded strings (evidence for future rename):
//   - "local Post Stop recording command"
...
uint32_t /* width from decompiler */ __fastcall FUN_0066eec0(int param_1)
