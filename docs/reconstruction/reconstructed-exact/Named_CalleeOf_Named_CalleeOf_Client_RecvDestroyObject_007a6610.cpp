// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_RecvDestroyObject_007a6610
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_RecvDestroyObject: packet/network helper. Evidence string: "[$/gender]". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Named_CalleeOf_Client_RecvDestroyObject_007a6610(void)
