// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGMap_CastTerrainHeight_005a5810
// -----------------------------------------------------------------------------
// Stable ID: aa_005a5810
// Callee of Named_CalleeOf_CVOGMap_CastTerrainHeight
...
// PURPOSE (auto): Called from Named_CalleeOf_CVOGMap_CastTerrainHeight: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
float10 __thiscall Named_CalleeOf_Named_CalleeOf_CVOGMap_CastTerrainHeight_005a5810(int *param_1,int param_2,int param_3)
