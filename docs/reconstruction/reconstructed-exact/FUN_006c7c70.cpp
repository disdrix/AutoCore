...
// Address:   0x006c7c70  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006c7c70 @ 0x006c7c70
// Stable ID: aa_006c7c70
...
void __thiscall FUN_006c7c70(int *param_1,uint32_t /* width from decompiler */ param_2,int param_3,uint32_t /* width from decompiler */ *param_4)
...

{
  ...
  if (*pcVar5 != '\0') {
    ...
    uStack_2c = *(uint32_t /* width from decompiler */ *)(param_3 + 4);
