// =============================================================================
// Named_CalleeOf_Client_DebugDumpEntityCombatStats_004e9aa0
// -----------------------------------------------------------------------------
// Stable ID: aa_004e9aa0
// Callee of Client_DebugDumpEntityCombatStats
// Address:   0x004e9aa0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Control keywords: if×16, return×3, do×1, while×1.
//  - Notable callees: FUN_005eb7d0×4, CONCAT31×3, FUN_0076cef0×3, ceil×3, FUN_004eacc0×2, FUN_004eae80×2, FUN_005eb790×2, FUN_005eb8d0×2.
//  - Return sites: 3.
...
float10 Named_CalleeOf_Client_DebugDumpEntityCombatStats_004e9aa0(uint32_t /* width from decompiler */ *param_1,float param_2,float param_3,int param_4,float *param_5,
...

{
  ...
  uint8_t auStack_4b4 [16];

  uint8_t auStack_4a4 [16];

  uint32_t /* width from decompiler */ *puStack_494;

  uint32_t /* width from decompiler */ uStack_484;
  ...
  uint32_t /* width from decompiler */ uStack_438;
  ...
  uint8_t auStack_2d8 [272];

  int *apiStack_1c8 [50];

  uint8_t auStack_100 [200];
  ...
  if ((param_4 != 0) && (*(int *)(param_4 + 8) != 0)) {
    ...
    *(uint16_t *)(iVar4 + 4) = 0xe0;

    local_1c._0_1_ = 2;

    DAT_00b03e60 = (uint32_t /* width from decompiler */ *)FUN_006c90d0(afStack_3b8 + 4,local_518,0x10,&local_508);
