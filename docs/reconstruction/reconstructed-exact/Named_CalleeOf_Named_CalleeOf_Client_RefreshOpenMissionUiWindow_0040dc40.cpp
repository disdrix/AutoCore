// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_RefreshOpenMissionUiWindow_0040dc40
// -----------------------------------------------------------------------------
// Stable ID: aa_0040dc40
// Callee of Named_CalleeOf_Client_RefreshOpenMissionUiWindows
// Address:   0x0040dc40  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: LeaveCriticalSection×2, EnterCriticalSection, FUN_0040dc40, _CxxThrowException.
//  - Return sites: 2.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Client_RefreshOpenMissionUiWindow_0040dc40(int param_1)
...

{
  ...
  while (puVar1 != (uint32_t /* width from decompiler */ *)0x0) {
    ...
    *(uint32_t /* width from decompiler */ *)(param_1 + 0x1c) = puVar1[4];
