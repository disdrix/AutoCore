...
uint32_t /* width from decompiler */ * Named_gfxLightImplDirectional(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ param_2)
