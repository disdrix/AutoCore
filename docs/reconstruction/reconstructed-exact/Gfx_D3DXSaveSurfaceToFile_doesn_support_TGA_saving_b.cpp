// =============================================================================
// Gfx_D3DXSaveSurfaceToFile_doesn_support_TGA_saving_b
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Gfx_D3DXSaveSurfaceToFile_doesn_support_TGA_saving_b @ 0x0079dbc0
// Stable ID: aa_0079dbc0
...
//  - Notable callees: _strnicmp×7, OutputDebugStringA×2, Gfx_D3DXSaveSurfaceToFile_doesn_support_TGA_saving_b, strrchr.
//  - Strings: "jpg"; "png"; "dib"; "hdr".
//  - Return sites: 8.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "D3DXSaveSurfaceToFile 9.0c doesn't support TGA -- saving as bitmap."
 * Domain alias of FUN_0079dbc0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ Gfx_D3DXSaveSurfaceToFile_doesn_support_TGA_saving_b(void)
