// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_0041ab70
// -----------------------------------------------------------------------------
// Stable ID: aa_0041ab70
// Callee of Named_CalleeOf_Named_VOG_DEBUG_STOP (+1 other named callers)
// Address:   0x0041ab70  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0041ab70, FUN_0041c5c0.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_0041ab70(void)
...

{
  ...
  uint32_t /* width from decompiler */ auStack_2bc [85];

  uint32_t /* width from decompiler */ local_15c [86];
