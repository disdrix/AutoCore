// =============================================================================
// Inv_Armor_modifier_does_not_exist_item
// -----------------------------------------------------------------------------
// Stable ID: aa_005fef10
// Address:   0x005fef10  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for Inv_Armor_modifier_does_not_exist_item @ 0x005fef10
// Stable ID: aa_005fef10
// Embedded strings (evidence for future rename):
//   - "Armor modifier %d does not exist for item %d %I64d"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~33 non-empty decompiler lines.
//  - Control keywords: if×2, do×1, for×1, while×1, return×1.
//  - Notable callees: FUN_004ce940, FUN_00508b10, Inv_Armor_modifier_does_not_exist_item, FUN_007a4480.
//  - Strings: "Armor modifier %d does not exist for item %d %I64d".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Armor modifier %d does not exist for item %d %I64d"
 * Domain alias of FUN_005fef10 (FUN_* retained)
 *
...
float10 __fastcall Inv_Armor_modifier_does_not_exist_item(int param_1)
