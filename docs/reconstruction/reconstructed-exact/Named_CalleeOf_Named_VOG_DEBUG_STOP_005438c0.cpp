// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_005438c0
// -----------------------------------------------------------------------------
// Stable ID: aa_005438c0
// Callee of Named_VOG_DEBUG_STOP (+1 other named callers)
// Address:   0x005438c0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004e2e80×2, FUN_004e2f70×2, FUN_005739b0×2, memmove×2, CONCAT44, FUN_004e24d0, FUN_00543060, FUN_005438c0.
//  - Return sites: 4.
...
void __thiscall Named_CalleeOf_Named_VOG_DEBUG_STOP_005438c0(int param_1,void *param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
