...
// PURPOSE (auto): Scaffold unit for Gfx_SwapEffect @ 0x0075e710
// Stable ID: aa_0075e710
...
//  - Notable callees: FUN_0076c130×10, Gfx_SwapEffect.
//  - Strings: "\t BackBuffer [%ux%u], format=0x%08X, #%u\n"; "\t MultiSampleType = %d, Quality = %u\n"; "FLIP"; "COPY".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "	 SwapEffect = %s
"
 * Domain alias of FUN_0075e710 (FUN_* retained)
 *
