// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_OnBadCharacterLoginId_00807710
// -----------------------------------------------------------------------------
// Stable ID: aa_00807710
// Callee of Named_CalleeOf_Client_OnBadCharacterLoginId (+1 other named callers)
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_OnBadCharacterLoginId: auth/session helper. Evidence string: "Retrying sector connection...". Supports parent flow (not a free-standing entry point). Named_CalleeOf_Client_OnBadCharacterLoginId (+1 other named callers).
...
//  - Notable callees: FUN_005a1f50, FUN_0079a470, FUN_007a4480, FUN_00807710, FUN_00812de0, GetTickCount, Sleep.
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_CalleeOf_Client_OnBadCharacterLoginId_00807710(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2)
