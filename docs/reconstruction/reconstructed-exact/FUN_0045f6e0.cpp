...
// PURPOSE (auto): Scaffold unit for FUN_0045f6e0 @ 0x0045f6e0
// Stable ID: aa_0045f6e0
...
uint32_t /* width from decompiler */ * __fastcall FUN_0045f6e0(uint32_t /* width from decompiler */ param_1,uint *param_2)
