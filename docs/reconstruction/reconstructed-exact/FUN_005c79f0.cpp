...
// PURPOSE (auto): Scaffold unit for FUN_005c79f0 @ 0x005c79f0
// Stable ID: aa_005c79f0
...
uint32_t /* width from decompiler */ __thiscall FUN_005c79f0(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3)
