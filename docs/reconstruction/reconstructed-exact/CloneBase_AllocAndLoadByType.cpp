// =============================================================================
// CloneBase_AllocAndLoadByType  (FUN_0059c000)
// -----------------------------------------------------------------------------
...
// =============================================================================
//
// PURPOSE: Allocate and DB-load a typed clonebase payload for a catalog record,
// keyed by record+0x38 type. Optional cache path when DAT_00b04694 is set.
// On success fills name fields and returns 0; unknown type → E_FAIL (0x80004005);
// loader failure → loader status.
//
// ABI: cdecl — stack arg = record*; bare ret (c3). Not thiscall.
// Parent-seed Named_CalleeOf_Named_VOG_DEBUG_STOP is misleading (failure log only).
//

#include <cstdint>
#include <cstring>

// External / CRT / Ghidra symbols retained where product names unknown.
...
extern void FUN_00403450(void* dstNameSlot, void* wideSrc /*, UINT codePage */);
...
// MSVC SEH frame symbols (decompiler surface).
...
int CloneBase_AllocAndLoadByType(int rec)
{
  ...
  if (DAT_00b04694 != '\0') {
    ExceptionList = &local_c;
    iVar2 = FUN_00540850(*(uint32_t*)(rec + 0x34));
    *(int*)(rec + 0x3c) = iVar2;
    if ((DAT_00b04694 != '\0') && (iVar2 != 0))
      goto LAB_0059c0aa;
  }

  switch (*(uint32_t*)(rec + 0x38)) {
  case 1:
  case 3:
  case 4:
  case 6:
  ...
  case 0x48:
    ...
    *(uint32_t**)(rec + 0x3c) = puVar3;
    puVar3[1] = *(uint32_t*)(rec + 0x34);
    iVar2 = FUN_007e59d0((void*)(*(int*)(rec + 0x3c) + 4),
                         (void*)(*(int*)(rec + 0x3c) + 0x3b8));
    break;

  default:
    ExceptionList = local_c;
    return (int)0x80004005; // E_FAIL; decompiler shows -0x7fffbffb
  ...
  case 8:
    ...
    *(int*)(rec + 0x3c) = iVar2;
    *(uint32_t*)(iVar2 + 4) = *(uint32_t*)(rec + 0x34);
    iVar2 = *(int*)(rec + 0x3c);
  ...
  case 10:
    ...
    *(uint32_t*)(iVar2 + 4) = *(uint32_t*)(rec + 0x34);
    iVar2 = DB_ReadPowerPlantSpecific(
        DAT_00b0469c, (char*)(*(int*)(rec + 0x3c) + 4),
        (void*)(*(int*)(rec + 0x3c) + 0x3b8));
    break;
...
LAB_0059c0aa:
  ...
  do {
    cVar1 = *pcVar5;
    pcVar5[(rec + 0x40) - (int)local_90] = cVar1;
    pcVar5 = pcVar5 + 1;
  } while (cVar1 != '\0');
  ...
  uVar4 = (uint32_t)PTR_FUN_00af8c9c();
  FUN_00403450((void*)(iVar2 + 0x10), (void*)uVar4);
  strncpy((char*)(rec + 0x188), acStack_110, 0x41);
  ExceptionList = local_c;
  return 0;
}
...
{
  return CloneBase_AllocAndLoadByType(param_1);
}
