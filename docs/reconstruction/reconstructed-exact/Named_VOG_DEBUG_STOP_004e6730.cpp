...
//  - Notable callees: FUN_007a4480×2, FUN_004e6730, FUN_004e67a0, FUN_0059c8a0.
//  - Strings: "HashError:Destructor, already locked for traversal"; "VOG_DEBUG_STOP".
//  - Return sites: 1.

// =============================================================================
// Named_VOG_DEBUG_STOP_004e6730
// -----------------------------------------------------------------------------
...
void __fastcall Named_VOG_DEBUG_STOP_004e6730(uint32_t /* width from decompiler */ *param_1)
