...
// =============================================================================
// Inv_Tried_to_equip_same_weapon_d
// -----------------------------------------------------------------------------
...
void __thiscall Inv_Tried_to_equip_same_weapon_d(int param_1,int param_2,int param_3,uint32_t /* width from decompiler */ *param_4)
