...
//  - Notable callees: _CxxThrowException×2, EnterCriticalSection, FUN_0041c7e0, FUN_007a4480, LeaveCriticalSection.
//  - Strings: "VOG_DEBUG_STOP".
//  - Return sites: 3.

// =============================================================================
// Named_VOG_DEBUG_STOP_0041c7e0
// -----------------------------------------------------------------------------
// Stable ID: aa_0041c7e0
// Address:   0x0041c7e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ Named_VOG_DEBUG_STOP_0041c7e0(int *param_1,uint32_t /* width from decompiler */ param_2)
