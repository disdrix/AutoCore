...
// PURPOSE (auto): Scaffold unit for FUN_00489310 @ 0x00489310
// Stable ID: aa_00489310
...
void __fastcall FUN_00489310(uint32_t /* width from decompiler */ param_1,int *param_2,int param_3,int param_4,int param_5)
