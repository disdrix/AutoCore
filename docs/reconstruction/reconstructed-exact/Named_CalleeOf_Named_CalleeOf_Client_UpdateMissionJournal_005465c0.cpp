...
// Callee of Named_CalleeOf_Client_UpdateMissionJournal (+1 other named callers)
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_UpdateMissionJournal: mission/objective helper. Evidence string: "[$name]". Supports parent flow (not a free-standing entry point). Named_CalleeOf_Client_UpdateMissionJournal (+1 other named callers).
...
//  - Notable callees: find×10, sprintf×2, FUN_00521800, FUN_00521900, FUN_005465c0.
...
void Named_CalleeOf_Named_CalleeOf_Client_UpdateMissionJournal_005465c0(int param_1,
