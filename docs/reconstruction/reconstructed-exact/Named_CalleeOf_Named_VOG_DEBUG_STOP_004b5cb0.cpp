// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_004b5cb0
// -----------------------------------------------------------------------------
// Stable ID: aa_004b5cb0
// Callee of Named_VOG_DEBUG_STOP
// Address:   0x004b5cb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Control keywords: if×14, for×2, return×1.
//  - Notable callees: FUN_005c64d0×4, FUN_005c6520×4, FUN_005c6610×2, FUN_005c6630×2, FUN_004b5cb0, FUN_005c65c0, FUN_005c65e0, NxCloseCooking.
//  - Return sites: 1.
...
char __thiscall Named_CalleeOf_Named_VOG_DEBUG_STOP_004b5cb0(int param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4)
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x54) = *(uint32_t /* width from decompiler */ *)(param_1 + 0x50);
  ...
  for (; iVar6 != 0; iVar6 = iVar6 + -1) {
    ...
    if (iVar8 == 5) {
      ...
      local_31 = NxScaleCookedConvexMesh(local_2c,param_4,local_1c);

      NxCloseCooking();

      if (local_31 != '\0') {

        FUN_005c6610(local_10);

        local_4._0_1_ = 2;

        uVar9 = (**(code **)(*(int *)*DAT_00b037f0 + 0x3c))(local_24);
