// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_RegisterDeb_00402f70
// -----------------------------------------------------------------------------
// Stable ID: aa_00402f70
// Callee of Named_CalleeOf_Named_CalleeOf_Client_RegisterDebugSlashCommands
// Address:   0x00402f70  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00403cb0×2, FUN_00403d00×2, FUN_00401a40, FUN_00402f70, FUN_00403db0, _CxxThrowException.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_RegisterDeb_00402f70(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ param_4)
...

{
  ...
  piVar3 = (int *)FUN_00403db0(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4),param_1,*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  do {
    ...
    if (cVar1 != '\0') {
      ...
      *(uint8_t *)(*(int *)(*(int *)(unaff_EDI + 4) + 4) + 0x130) = 1;
...
LAB_00403050:
        ...
        *(uint8_t *)(*piVar4 + 0x130) = 1;

        *(uint8_t *)(piVar5 + 0x4c) = 1;

        *(uint8_t *)(*(int *)(*piVar4 + 4) + 0x130) = 0;
        ...
        if (piVar6 == (int *)piVar2[2]) {
          ...
          FUN_00403cb0(unaff_EDI);

          piVar6 = piVar2;

        }

        *(uint8_t *)(piVar6[1] + 0x130) = 1;

        *(uint8_t *)(*(int *)(piVar6[1] + 4) + 0x130) = 0;

        FUN_00403d00(unaff_EDI);
      ...
      if ((char)piVar5[0x4c] == '\0') goto LAB_00403050;
