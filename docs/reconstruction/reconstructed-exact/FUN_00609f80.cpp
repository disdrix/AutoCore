...
// Address:   0x00609f80  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00609f80 @ 0x00609f80
// Stable ID: aa_00609f80
...

{
  ...
  **(uint32_t /* width from decompiler */ **)(param_1 + 0x5c) = 0x2015;
  ...
  *(uint32_t /* width from decompiler */ *)(iVar3 + 0xe0) = 0xffffffff;

  *(uint32_t /* width from decompiler */ *)(iVar3 + 0xe4) = 0xffffffff;
