// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00493a50
// -----------------------------------------------------------------------------
// Stable ID: aa_00493a50
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO
// Address:   0x00493a50  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00493640×2, FUN_00493380, FUN_00493a50.
//  - Return sites: 3.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00493a50(int param_1,uint32_t /* width from decompiler */ *param_2,
...

{
  ...
  if (bVar4 != false) {
    ...
    if (puVar2 == (uint32_t /* width from decompiler */ *)**(int **)(param_1 + 4)) {
      ...
      puVar6 = (uint32_t /* width from decompiler */ *)FUN_00493640(&param_3,1,puVar2,pbVar3);
  ...
  if (bVar5) {
    ...
    puVar6 = (uint32_t /* width from decompiler */ *)FUN_00493640(&param_3,bVar4,puVar2,pbVar3);
