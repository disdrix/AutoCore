...
// FUN_00458770
// -----------------------------------------------------------------------------
// Stable ID: aa_00458770
// Address:   0x00458770  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00458770 @ 0x00458770
// Stable ID: aa_00458770
...
//  - Notable callees: FUN_0046d130×5, FUN_00439810×3, FUN_00436f80×2, FUN_00767160×2, FUN_0044c9e0, FUN_00458770, FUN_0045d790, FUN_00734640.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ __thiscall FUN_00458770(int param_1,uint32_t /* width from decompiler */ *param_2)
...

{
  ...
  if ((*(int *)(param_1 + 0x20) != 0) &&
     ...
     ((*(int *)(param_1 + 0x24) - *(int *)(param_1 + 0x20)) / 0x2c != 0)) {
  ...
  if (*(int *)(param_1 + 0x20) != 0) {
    ...
    iVar9 = (*(int *)(param_1 + 0x24) - *(int *)(param_1 + 0x20)) / 0x2c;
  ...
  if (iVar9 != 0) {
    ...
    FUN_0045d790(*(uint32_t /* width from decompiler */ *)(param_1 + 0x20));
