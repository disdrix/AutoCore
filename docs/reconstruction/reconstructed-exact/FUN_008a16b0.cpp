// =============================================================================
// FUN_008a16b0  (scaffold alias — canonical: CDlgQuickBar_CreateChildWidgets_Inferred)
// -----------------------------------------------------------------------------
...
// PURPOSE: CDlgQuickBar CreateChildWidgets — build chrome, 2 page buttons, hazard
// skins, rebind page, restore selection. See named clean plate.
// Canonical: reconstructed-exact/CDlgQuickBar_CreateChildWidgets_Inferred.cpp
// Embedded strings:
