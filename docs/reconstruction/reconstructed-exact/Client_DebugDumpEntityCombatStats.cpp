...
// =============================================================================
// Client_DebugDumpEntityCombatStats
// -----------------------------------------------------------------------------
// Purpose:  DEBUG dump of entity AI/skill state, armor, resists, owner skills.
//
// Address:  0x00955eb0  (autoassault.exe, image base 0x400000)
// Stable:   aa_00955eb0
// System:   skills-abilities
//
// String evidence: "AI: State(%d) SkillsInState(%d)" / "Skill:(%d) Level(%d)"
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_00955eb0.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_00955eb0 using string evidence: "AI: State(%d) SkillsInState(%d)" / "Skill:(%d) Level(%d)"
