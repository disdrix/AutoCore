...
// Address:   0x0053ced0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0053ced0 @ 0x0053ced0
// Stable ID: aa_0053ced0
...
//  - Notable callees: FUN_0053ced0, FUN_005b2520.
//  - Return sites: 1.
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_1 + -0x4c) + 4) + -0x38 + param_1) = uVar3;
