// =============================================================================
// Named_CalleeOf_Named_gfxPhaseAlphaTest_0074f200
// -----------------------------------------------------------------------------
// Stable ID: aa_0074f200
// Callee of Named_gfxPhaseAlphaTest (+1 other named callers)
...
// PURPOSE (auto): Called from Named_gfxPhaseAlphaTest: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_gfxPhaseAlphaTest (+1 other named callers).
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Named_gfxPhaseAlphaTest_0074f200(int param_1,int param_2)
