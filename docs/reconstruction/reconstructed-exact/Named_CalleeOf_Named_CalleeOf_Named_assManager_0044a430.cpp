// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_assManager_0044a430
// -----------------------------------------------------------------------------
// Stable ID: aa_0044a430
// Callee of Named_CalleeOf_Named_assManager
// Address:   0x0044a430  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00401a40, FUN_0044a430, _CxxThrowException.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_assManager_0044a430(uint param_1,int param_2)
...

{
  ...
  if (0x15555555U - *(int *)(param_2 + 8) < param_1) {
