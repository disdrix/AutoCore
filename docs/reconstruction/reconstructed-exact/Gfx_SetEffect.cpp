...
// PURPOSE (auto): Domain alias Gfx_SetEffect for FUN_0048a780 @ 0x0048a780
// Stable ID: aa_0048a780
...
//  - Notable callees: FUN_0056f570×3, CloseHandle, CreateThread, Gfx_SetEffect, ResetEvent, SetEvent, WaitForSingleObject, stat.
//  - Strings: "SetEffect - ENTER\n"; "SetEffect - EXIT\n".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "SetEffect - g_effectSettings.szPath %s, g_effectSettings.capability %d
"
 * Domain alias of FUN_0048a780 (FUN_* retained)
 *
...
HANDLE Gfx_SetEffect(char *param_1,uint32_t /* width from decompiler */ param_2)
