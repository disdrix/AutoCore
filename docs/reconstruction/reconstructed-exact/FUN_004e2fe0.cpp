...
// Address:   0x004e2fe0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_004e2fe0 @ 0x004e2fe0
// Stable ID: aa_004e2fe0
...

{
  ...
  if ((puVar3 != *(uint32_t /* width from decompiler */ **)(param_1 + 4)) && (*(char *)(puVar3 + 3) <= *param_3)) {
