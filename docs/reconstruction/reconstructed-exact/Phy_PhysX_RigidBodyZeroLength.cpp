...
// PURPOSE (auto): Domain alias Phy_PhysX_RigidBodyZeroLength for FUN_004eb560 @ 0x004eb560
// Stable ID: aa_004eb560
// Embedded strings (evidence for future rename):
//   - "Rigid body of PhysX object \'%s\' is zero length"
//   - "No vertices for PhysX object \'%s\'"
//   - "%f %f %f"
//   - "Invalid vertex %ld for PhysX object \'%s\'"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~319 non-empty decompiler lines.
//  - Control keywords: if×19, do×6, while×6, for×5, return×2.
//  - Notable callees: FUN_007a4480×3, FUN_00766e50×2, sscanf×2, FUN_00404d80, FUN_004b4bf0, FUN_004b52e0, FUN_004b55e0, Phy_PhysX_RigidBodyZeroLength.
//  - Strings: "Rigid body of PhysX object \'%s\' is zero length"; "%ld"; "No vertices for PhysX object \'%s\'"; "%f %f %f".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Rigid body of PhysX object '%s' is zero length"
 * Domain alias of FUN_004eb560 (FUN_* retained)
 *
...
void Phy_PhysX_RigidBodyZeroLength(int *param_1,char *param_2,float param_3,float param_4,int *param_5,char param_6,
