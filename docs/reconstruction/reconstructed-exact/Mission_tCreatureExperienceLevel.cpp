// =============================================================================
// Mission_tCreatureExperienceLevel
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Mission_tCreatureExperienceLevel @ 0x007cd150
// Stable ID: aa_007cd150
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tCreatureExperienceLevel/row"
 * Domain alias of FUN_007cd150 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __fastcall Mission_tCreatureExperienceLevel(int param_1)
