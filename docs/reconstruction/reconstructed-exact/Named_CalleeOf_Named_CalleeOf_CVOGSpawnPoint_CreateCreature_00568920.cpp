// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_CreateCreature_00568920
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_CVOGSpawnPoint_CreateCreature: spawn/transfer helper. Evidence string: "GetCloneBaseFromID failed %d". Supports parent flow (not a free-standing entry point). Named_CalleeOf_CVOGSpawnPoint_CreateCreature (+1 other named callers).
...
int __thiscall Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_CreateCreature_00568920(int param_1,int param_2,uint32_t /* width from decompiler */ *param_3)
