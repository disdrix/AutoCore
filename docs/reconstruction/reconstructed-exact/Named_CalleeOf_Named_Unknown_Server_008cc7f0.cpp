// =============================================================================
// Named_CalleeOf_Named_Unknown_Server_008cc7f0
// -----------------------------------------------------------------------------
// Stable ID: aa_008cc7f0
// Callee of Named_Unknown_Server
...
// PURPOSE (auto): Called from Named_Unknown_Server: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __fastcall Named_CalleeOf_Named_Unknown_Server_008cc7f0(int param_1)
