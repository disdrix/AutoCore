...
// =============================================================================
// Named_SetWindStrength_expects_new_wind_strength_0_0
// -----------------------------------------------------------------------------
...
float10 __thiscall Named_SetWindStrength_expects_new_wind_strength_0_0(int param_1,float param_2,float param_3,float param_4)
