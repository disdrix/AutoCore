// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_assPackManager_0071a4a0
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Named_CalleeOf_Named_assPackManager_0071a4a0(int param_1,int *param_2,uint32_t /* width from decompiler */ param_3,int param_4)
