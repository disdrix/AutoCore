...
// PURPOSE (auto): Scaffold unit for UI_overlay_broken @ 0x0084b890
// Stable ID: aa_0084b890
// Embedded strings (evidence for future rename):
//   - "i_g_2d_overlay_broken.dds"
//   - "%.01f%% %s"
//   - "%s: %s"
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "i_g_2d_overlay_broken.dds"
 * Domain alias of FUN_0084b890 (FUN_* retained)
 *
...
void __fastcall UI_overlay_broken(float *param_1)
