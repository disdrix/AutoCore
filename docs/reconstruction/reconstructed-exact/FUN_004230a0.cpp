...
// PURPOSE (auto): Scaffold unit for FUN_004230a0 @ 0x004230a0
// Stable ID: aa_004230a0
...
void __fastcall FUN_004230a0(uint32_t /* width from decompiler */ param_1,int *param_2,uint32_t /* width from decompiler */ *param_3)
