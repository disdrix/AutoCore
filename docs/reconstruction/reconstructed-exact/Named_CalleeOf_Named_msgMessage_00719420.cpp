// =============================================================================
// Named_CalleeOf_Named_msgMessage_00719420
// -----------------------------------------------------------------------------
// Stable ID: aa_00719420
// Callee of Named_msgMessage
// Address:   0x00719420  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Named_msgMessage: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~99 non-empty decompiler lines.
//  - Control keywords: if×13, return×4.
//  - Notable callees: FUN_007191a0×2, FUN_00719200×2, FUN_00719230×2, memmove×2, CONCAT22, CONCAT44, FUN_00444220, FUN_00719120.
//  - Return sites: 4.
...
void __thiscall Named_CalleeOf_Named_msgMessage_00719420(int param_1,void *param_2,uint param_3,uint16_t *param_4)
