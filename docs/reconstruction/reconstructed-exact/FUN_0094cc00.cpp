...
// PURPOSE (auto): Scaffold unit for FUN_0094cc00 @ 0x0094cc00
// Stable ID: aa_0094cc00
// Embedded strings (evidence for future rename):
//   - "chance that dropped items will be enhanced"
//   - "and an additional"
//   - "XP Bonus"
//   - "When convoy members are in range, you can receive up to a"
//   - "Current Convoy Size"
//   - "%s: %d. %s %+d%% %s %s %+d%% %s."
