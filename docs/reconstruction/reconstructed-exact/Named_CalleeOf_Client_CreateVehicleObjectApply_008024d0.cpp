// =============================================================================
// Named_CalleeOf_Client_CreateVehicleObjectApply_008024d0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Client_CreateVehicleObjectApply: vehicle/entity helper. Evidence string: "Getting Data...". Supports parent flow (not a free-standing entry point).
...
Named_CalleeOf_Client_CreateVehicleObjectApply_008024d0(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,int param_4,uint32_t /* width from decompiler */ param_5,
