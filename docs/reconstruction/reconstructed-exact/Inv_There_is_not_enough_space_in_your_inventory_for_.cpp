...
// =============================================================================
// Inv_There_is_not_enough_space_in_your_inventory_for_
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ Inv_There_is_not_enough_space_in_your_inventory_for_(int *param_1,uint32_t /* width from decompiler */ param_2,char param_3)
