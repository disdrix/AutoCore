// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_effDeviceEffect_004607d0
// -----------------------------------------------------------------------------
// Stable ID: aa_004607d0
// Callee of Named_CalleeOf_Named_effDeviceEffect
// Address:   0x004607d0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_effDeviceEffect_004607d0(uint32_t /* width from decompiler */ param_1,int *param_2)
