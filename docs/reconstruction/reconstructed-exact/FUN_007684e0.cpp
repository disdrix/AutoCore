...
// Address:   0x007684e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_007684e0 @ 0x007684e0
// Stable ID: aa_007684e0
...
//  - Notable callees: vog_LogMessage×2, FUN_00435df0, FUN_00436250, FUN_00767600, FUN_007684e0, FUN_0076cec0, isspace.
//  - Strings: ");
    ...
    if (bVar3) {
      ...
      vog_LogMessage("; ",0x2a0,3,
                     ...
                     "; "Expected uint64 but got \"%s\" in chunk \"%s\""; "C:\\vog\\1_code\\palantir\\arda2\\storage\\stoChunk.cpp".
//  - Return sites: 2.
...
//   - ",0x2a0,3,
                     ...
                     "
//   - "Expected uint64 but got \"%s\" in chunk \"%s\""
...
uint32_t /* width from decompiler */ FUN_007684e0(uint32_t /* width from decompiler */ param_1)
