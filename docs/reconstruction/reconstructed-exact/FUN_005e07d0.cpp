...
// PURPOSE (auto): Scaffold unit for FUN_005e07d0 @ 0x005e07d0
// Stable ID: aa_005e07d0
...
FUN_005e07d0(int param_1,int param_2,void *param_3,int param_4,int param_5,uint32_t /* width from decompiler */ param_6,
