// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_ChatClientImpl_006808a0
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Named_CalleeOf_Named_ChatClientImpl_006808a0(int param_1,uint32_t /* width from decompiler */ *param_2)
