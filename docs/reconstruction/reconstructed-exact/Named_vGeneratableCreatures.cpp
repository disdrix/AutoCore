...
// PURPOSE (auto): Scaffold unit for Named_vGeneratableCreatures @ 0x007da1b0
// Stable ID: aa_007da1b0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//vGeneratableCreatures/row"
 * Domain alias of FUN_007da1b0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Named_vGeneratableCreatures(char *param_1,int *param_2)
