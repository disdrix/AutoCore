...
// =============================================================================
// Drive_CVOGVehicle_MoveToTarget3DPoint_004fc650
// -----------------------------------------------------------------------------
// Stable ID: aa_004fc650
// Address:   0x004fc650  (autoassault.exe, image base 0x400000)
// System:    input-drive-control (NPC/AI MoveToTarget axis writes)
// Generated: 2026-07-23 from raw capture
// Refined:   2026-07-23 human-refine — plate + densify; steer/thr gate notes
// Exactness: Behavior-preserving rewrite of decompiler control flow. Not modernization.
// Bit-for-bit vs retail EXE: DEFERRED (loaded image may differ slightly).
// Runtime / differential: OPEN.
//
// Purpose:  AI/path MoveToTarget3DPoint — compute heading error and write
//           entity thr/steer/HB (inline 0xC7-style gate on +0x618 OR SetSteerInput;
//           bulk thr at +0x614; PushDriveAxes). UF-007: sealed High 2026-07-29 —
//           three-load + bits ≡ SetSteerInput 0x004f5620 (see dual A/B + UNRESOLVED).
//
// Related:  VehicleEntity_SetSteerInput         0x004f5620
//           VehicleEntity_SetLongitudinalInput  0x004f5650
//           VehicleEntity_PushDriveAxesToController 0x004fbc10
//           systems/input-drive-control.md
//           physics/verified/fn_004fc650_driveController.md
// =============================================================================

/*
 * Behavioral notes:
 * String-driven rename evidence: "CVOGVehicle::MoveToTarget3DPoint"
 *
 * Axis write summary (from raw aa_004fc650_FUN_004fc650):
 * - Gate vehicle+0x101==0 and physics body present to enter drive path.
 * - Proportional path: inline wobj+0xb4 bits 0x01|0x02|0x04|0x40|0x80 allow
 *   store to entity+0x618; else hard spin via SetSteerInput(+/-1).
 * - Longitudinal: direct store entity+0x614 (not always via SetLongitudinal).
 * - Handbrake sharp when speed high and heading error large -> +0x61c.
 * - Ends with PushDriveAxesToController; arrival path thr->0 via SetLongitudinal.
 *
 * Readability pass:
 * - Densified whitespace; plate only (body CF from decompile, not modernized).
 * - FUN_* / DAT_* kept where unresolved.
 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint32_t /* width from decompiler */ __thiscall
Drive_CVOGVehicle_MoveToTarget3DPoint_004fc650(int param_1,float param_2,float param_3,uint32_t /* width from decompiler */ param_4,char param_5)
{
  float fVar1;
  float fVar2;
  float *pfVar3;
