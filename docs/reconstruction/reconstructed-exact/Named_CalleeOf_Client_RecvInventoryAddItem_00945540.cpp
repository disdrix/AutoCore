// =============================================================================
// Named_CalleeOf_Client_RecvInventoryAddItem_00945540
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Client_RecvInventoryAddItem: inventory/item helper. Evidence string: "lootpickup". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Client_RecvInventoryAddItem_00945540(int param_1)
