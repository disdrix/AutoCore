...
// PURPOSE (auto): Scaffold unit for FUN_004d2820 @ 0x004d2820
// Stable ID: aa_004d2820
...
void __thiscall FUN_004d2820(int param_1,int *param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4)
