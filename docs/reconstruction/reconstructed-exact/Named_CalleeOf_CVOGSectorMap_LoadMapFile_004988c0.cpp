// =============================================================================
// Named_CalleeOf_CVOGSectorMap_LoadMapFile_004988c0
// -----------------------------------------------------------------------------
// Stable ID: aa_004988c0
// Callee of CVOGSectorMap_LoadMapFile (+1 other named callers)
// Address:   0x004988c0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004988c0, FUN_00793710, FUN_00793830, FUN_0079cd10, FUN_0079cd30.
//  - Return sites: 5.
...
bool __thiscall Named_CalleeOf_CVOGSectorMap_LoadMapFile_004988c0(int *param_1,uint32_t /* width from decompiler */ param_2,uint8_t *param_3)
