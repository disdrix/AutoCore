...
//  - Notable callees: CVOGReaction_FailMissionNotify, FUN_00419bd0, _aligned_malloc.
//  - Return sites: 1.

// =============================================================================
// Mission_Uses_CVOGReaction_FailMissionNotify_00419bd0
// -----------------------------------------------------------------------------
...
//           Behavior preserved from FUN_00419bd0 clean capture (not modernized).
//
...
//           docs/reconstruction/raw/aa_00419bd0_*.md
//           Original Ghidra symbol: FUN_00419bd0
//
// Exactness: Body mirrors reconstructed-exact/FUN_00419bd0*.cpp when present.
...
void Mission_Uses_CVOGReaction_FailMissionNotify_00419bd0(void)
