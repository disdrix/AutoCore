// =============================================================================
// Named_CalleeOf_CVOGHBAIBase_FindTargetToAttack_00639710
// -----------------------------------------------------------------------------
// Stable ID: aa_00639710
// Callee of CVOGHBAIBase_FindTargetToAttack
// Address:   0x00639710  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004ba850, FUN_00639710, memmove.
//  - Return sites: 2.
...
void __thiscall Named_CalleeOf_CVOGHBAIBase_FindTargetToAttack_00639710(int param_1,uint param_2)
...

{
  ...
  if (uVar1 < param_2) {
    ...
    FUN_004ba850(*(uint32_t /* width from decompiler */ *)(param_1 + 8),param_2 - iVar2,&stack0x00000008);
