...
// PURPOSE (auto): Scaffold unit for FUN_0042b3a0 @ 0x0042b3a0
// Stable ID: aa_0042b3a0
...
void __thiscall FUN_0042b3a0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ param_2,int param_3)
