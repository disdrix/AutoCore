...
// PURPOSE (auto): Scaffold unit for Inv_tLootTable @ 0x007ca4e0
// Stable ID: aa_007ca4e0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tLootTable/row"
 * Domain alias of FUN_007ca4e0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __fastcall Inv_tLootTable(char *param_1)
