// =============================================================================
// Named_CalleeOf_Client_UI_InventoryItemClickDispatch_00795b10
// -----------------------------------------------------------------------------
// Stable ID: aa_00795b10
// Callee of Client_UI_InventoryItemClickDispatch
...
// PURPOSE (auto): Called from Client_UI_InventoryItemClickDispatch: inventory/item helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void Named_CalleeOf_Client_UI_InventoryItemClickDispatch_00795b10(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,int param_4,
