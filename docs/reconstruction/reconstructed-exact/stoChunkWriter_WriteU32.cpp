 ...
 * - Text: stoChunkWriter_WriteFormatted("%u", value) then textCol=0 then "\r\n".
 * - ABI: ESI = writer*, EAX = const uint32_t* (decompiler in_EAX / unaff_ESI).
 * - DAT_00a9d718 = "%u"; DAT_00a97b84 = "\r\n".
 * - Sibling 0x00439870 = WriteI32 with "%i" (dual-sealed W19-Q).
...
{
  uint32_t *in_EAX;      /* const uint32_t* value pointer on entry */
  uint32_t uVar1;
