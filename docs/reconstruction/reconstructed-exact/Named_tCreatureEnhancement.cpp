...
// PURPOSE (auto): Scaffold unit for Named_tCreatureEnhancement @ 0x007d65a0
// Stable ID: aa_007d65a0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tCreatureEnhancement/row"
 * Domain alias of FUN_007d65a0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Named_tCreatureEnhancement(char *param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ *param_3)
