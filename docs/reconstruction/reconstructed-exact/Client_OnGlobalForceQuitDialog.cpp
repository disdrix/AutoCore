...
// =============================================================================
// Client_OnGlobalForceQuitDialog
// -----------------------------------------------------------------------------
// Purpose:  Global disconnect / force-quit dialog: multiple logins, GM kick/ban; Accept → login screen.
//
// Address:  0x008096c0  (autoassault.exe, image base 0x400000)
// Stable:   aa_008096c0
// System:   auth
//
// String evidence: "You have been forced to quit due to multiple logins." / login screen
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_008096c0.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_008096c0 using string evidence: "You have been forced to quit due to multiple logins." / login screen
