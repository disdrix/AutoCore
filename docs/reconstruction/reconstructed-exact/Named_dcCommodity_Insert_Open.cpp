...
// PURPOSE (auto): Scaffold unit for Named_dcCommodity_Insert_Open @ 0x007e7df0
// Stable ID: aa_007e7df0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "dcCommodity_Insert::Open"
 * Domain alias of FUN_007e7df0 (FUN_* retained)
 *
...
Named_dcCommodity_Insert_Open(char *param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,int param_4,uint32_t /* width from decompiler */ *param_5)
