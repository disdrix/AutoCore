// READABILITY (auto CF):
//  - Body size: ~1675 non-empty decompiler lines.
//  - Control keywords: if×202, while×57, do×50, goto×33, return×4, for×3, switch×1.
//  - Notable callees: CVOGReaction_FireNestedReactions×44, CVOGMap_LookupVariable×19, FUN_004022a0×14, FUN_005172d0×12, CVOGReaction_ResolveObjectTarget×8, Client_SendLogicUiPacket×8, ROUND×8, FUN_0040c700×7.
//  - Strings: "Unknown or invalid reaction type. COID:%I64d Type:%d"; "C:\\vog\\1_code\\vog_14_117_branch\\libVOG\\VOGReaction.cpp"; "Invalid reaction skill cast for skill %d, map: %s"; "allocatenewobjectfromcbid failed %d".
//  - Return sites: 4.
...
// Address:   0x0057c500  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ __thiscall CVOGReaction_Dispatch(int *param_1,int *param_2)
...

{
  ...
  uint32_t /* width from decompiler */ uVar30;

  uint32_t /* width from decompiler */ uVar31;

  uint32_t /* width from decompiler */ uVar32;
  ...
  uint32_t /* width from decompiler */ *puStack_828;
  ...
  uint32_t /* width from decompiler */ uStack_7d4;
  ...
  uint32_t /* width from decompiler */ uStack_77c;
              ...
              if (pfVar19 != pfStack_7e8) {
                ...
                do {
                  ...
                  if ((char)iVar16 != '\0') {
                    ...
                    uVar20 = *(uint32_t /* width from decompiler */ *)((int)fVar23 + 0x168);
                    ...
                    uVar20 = *(uint32_t /* width from decompiler */ *)((int)fVar23 + 0x16c);
...
LAB_0057ca98:
          ...
          pTVar26->bGlobal = (uint8_t)DAT_009d4060;
          ...
          pTVar26->bPad3 = (uint8_t)DAT_009d4064;
            ...
            do {
              ...
              if (piVar8 == (int *)0x0) {
                ...
                *(int *)(iVar16 + 0xe6e0) = (int)fStack_7ec + 1;
                ...
                (**(code **)(*piVar8 + 0x2a4))(*(uint32_t /* width from decompiler */ *)(param_1[0x29] + 0xe4e8));
    ...
    if (iVar16 != 0) {
      ...
      if (pfStack_820 != local_818) {
        ...
        do {
          ...
          puStack_828 = (uint32_t /* width from decompiler */ *)(**(code **)(*piVar8 + 0x19c))();

          if (((puStack_828 != (void *)0x0) ||

              (puStack_828 = (uint32_t /* width from decompiler */ *)(**(code **)(*piVar8 + 0x1c8))(),
            ...
            if (0xfffff < *(int *)(iVar16 + 0xc)) {
              ...
              *(uint32_t /* width from decompiler */ *)(iVar16 + 0xc) = 0;
    ...
    if (param_1[0x99] == 0) {
      ...
      if (cVar7 != '\0') {
        ...
        if (param_1[0x97] + *piVar8 < 0) {
          ...
          puVar11 = (uint32_t /* width from decompiler */ *)FUN_0053b040(&local_810);
    ...
    if (param_1[0x97] == -1) {
      ...
      if (iVar16 != 0) {
        ...
        do {
          ...
          *(uint16_t *)(*(int *)(*(int *)(param_1[0x29] + 0xe75c) + uVar10 * 4) + 0x60c) = 0;
      ...
      if (param_1[0x97] != 0) {
        ...
        puStack_828 = (uint32_t /* width from decompiler */ *)0x0;
        ...
        if (iVar16 != 0) {
          ...
          do {
            ...
            puStack_828 = (uint32_t /* width from decompiler */ *)((int)puStack_828 + 1);
      ...
      if (*(char *)((int)param_1 + 0x205) == '\0') {
        ...
        *(uint8_t *)((int)param_1 + 0x205) = 1;
        ...
        if (iVar16 != 0) {
          ...
          *(uint8_t *)((int)param_1 + 0x205) = uVar6;
...
LAB_0057f3b3:
  ...
  case 0x51:
    ...
    if ((((param_2 != (int *)0x0) && (iVar16 = (**(code **)(*param_2 + 0x210))(0), iVar16 != 0)) &&
      ...
      uVar20 = *(uint32_t /* width from decompiler */ *)(iVar13 + 0xa8 + iVar16);
    ...
    if (local_824 != local_818) {
      ...
      do {
        ...
        if ((((pfVar19 != (float *)0x0) &&
           ...
           (puStack_828 = (uint32_t /* width from decompiler */ *)pfStack_820[0x56],

           puStack_828 != (uint32_t /* width from decompiler */ *)pfStack_820[0x57])) {
          ...
          do {
            ...
            if (iVar16 == 0xe) {
              ...
              uVar24 = FUN_0057fd00(*(uint32_t /* width from decompiler */ *)(iVar16 + 0x94));
              ...
              if ((local_810 != 0.0) && (*(char *)(iVar16 + 0xa9) != '\0')) {
                ...
                if (((fStack_7f0 - fStack_7e0) * (fStack_7f0 - fStack_7e0) +
                  ...
                  *(uint32_t /* width from decompiler */ *)(iVar16 + 0xa4) = *(uint32_t /* width from decompiler */ *)(iVar16 + 0xa0);

                  *(uint8_t *)(iVar16 + 0xa9) = 0;

                  *(uint32_t /* width from decompiler */ *)(iVar16 + 0x94) = 0xffffffff;
          ...
          } while (puStack_828 != (uint32_t /* width from decompiler */ *)pfStack_820[0x57]);
