// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli_0071f2e0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_PlayNamedIn: callee helper. Evidence string: "MakeVorbisInfo ov_open_callbacks reported OV_EVERSION:Vorbis version mismatch.\n". Supports parent flow (not a free-standing entry point).
...
//   - "MakeVorbisInfo ov_open_callbacks reported OV_EFAULT:Internal logic fault; indicates a bug "
...
uint __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli_0071f2e0(uint8_t *param_1,char param_2)
