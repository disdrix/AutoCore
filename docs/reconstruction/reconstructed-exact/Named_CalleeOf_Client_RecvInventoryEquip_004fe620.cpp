// =============================================================================
// Named_CalleeOf_Client_RecvInventoryEquip_004fe620
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Client_RecvInventoryEquip: inventory/item helper. Evidence string: "Set ornament of unhappy type: CBID:%d COID:%I64d". Supports parent flow (not a free-standing entry point). Client_RecvInventoryEquip (+1 other named callers).
...
//  - Notable callees: FUN_004fe380×2, FUN_004fbb50, FUN_004fdcb0, FUN_004fe620, FUN_00512670, FUN_007a4480, FUN_00989270.
...
void __thiscall Named_CalleeOf_Client_RecvInventoryEquip_004fe620(int param_1,int param_2,uint32_t /* width from decompiler */ *param_3,char param_4)
