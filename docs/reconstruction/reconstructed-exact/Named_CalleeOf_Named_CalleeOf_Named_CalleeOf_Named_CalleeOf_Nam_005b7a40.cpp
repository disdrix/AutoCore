// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_005b7a40
// -----------------------------------------------------------------------------
// Stable ID: aa_005b7a40
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO
// Address:   0x005b7a40  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_005b7860, FUN_005b7a40.
//  - Return sites: 2.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_005b7a40(int param_1,uint32_t /* width from decompiler */ *param_2)
...

{
  ...
  FUN_005b7860(*(uint32_t /* width from decompiler */ *)(param_1 + 8),1,param_2);
