...
// Address:   0x005a3b00  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_005a3b00 @ 0x005a3b00
// Stable ID: aa_005a3b00
...
//  - Notable callees: FUN_005a3310×2, FUN_004cb4f0, FUN_005a3b00.
//  - Return sites: 3.
...
void __thiscall FUN_005a3b00(int param_1,uint32_t /* width from decompiler */ *param_2,uint *param_3)
...

{
  ...
  if (bVar2) {
    ...
    if (puVar5 == (uint32_t /* width from decompiler */ *)**(int **)(param_1 + 4)) {
      ...
      puVar5 = (uint32_t /* width from decompiler */ *)FUN_005a3310(&param_3,1,puVar5,puVar3);
  ...
  if (((int)param_3[5] <= (int)puVar3[1]) &&
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)FUN_005a3310(&param_3,local_4,puVar5,puVar3);
