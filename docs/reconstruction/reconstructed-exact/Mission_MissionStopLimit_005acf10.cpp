...
//  - Control keywords: if×10, while×9, for×4, do×3, return×1.
//  - Notable callees: fprintf×13, FUN_005ae100×2, FUN_005aec50×2, FUN_005acf10, FUN_005ae180, FUN_005aed20.
//  - Strings: "\t\t<Requirement type=\"crazytaxi\" slot=\"%d\">\r\n"; "\t\t\t<ContinentCBID>%d</ContinentCBID>\r\n"; "\t\t\t<MissionStopLimit>%d</MissionStopLimit>\r\n"; "\t\t\t<MissionStopCount>%d</MissionStopCount>\r\n".
//  - Return sites: 1.

// =============================================================================
// Mission_MissionStopLimit_005acf10
// -----------------------------------------------------------------------------
// Stable ID: aa_005acf10
// Address:   0x005acf10  (autoassault.exe, image base 0x400000)
// System:    unknown
...
/*
 * Behavioral notes:
 * String-driven rename evidence: "MissionStopLimit>
...
void __thiscall Mission_MissionStopLimit_005acf10(int param_1,FILE *param_2)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)*(uint32_t /* width from decompiler */ *)(param_1 + 0x8c) = *(uint32_t /* width from decompiler */ *)(param_1 + 0x8c);
  ...
  *(uint32_t /* width from decompiler */ *)*(uint32_t /* width from decompiler */ *)(param_1 + 0x74) = *(uint32_t /* width from decompiler */ *)(param_1 + 0x74);
  ...
  *(uint32_t /* width from decompiler */ *)*(uint32_t /* width from decompiler */ *)(param_1 + 0x80) = *(uint32_t /* width from decompiler */ *)(param_1 + 0x80);
  ...
  *(int *)(*(int *)(param_1 + 0x80) + 8) = *(int *)(param_1 + 0x80);
  ...
  for (local_24 = 0;
    ...
    local_10 = *(uint32_t /* width from decompiler */ *)(*(int *)(param_1 + 0x14) + 8 + local_20);

    puVar4 = (uint32_t /* width from decompiler */ *)(*(int *)(param_1 + 0x14) + local_20);
  ...
  for (uVar6 = 0;
    ...
    local_14 = *(uint32_t /* width from decompiler */ *)(local_20 + *(int *)(param_1 + 0x24));

    iVar5 = local_20 + *(int *)(param_1 + 0x24);

    local_10 = *(uint32_t /* width from decompiler */ *)(iVar5 + 8);

    local_8 = *(uint32_t /* width from decompiler */ *)(iVar5 + 4);

    local_4 = *(uint32_t /* width from decompiler */ *)(iVar5 + 8);
  ...
  for (uVar6 = 0;
    ...
    local_14 = *(uint32_t /* width from decompiler */ *)(iVar5 + uVar6 * 8);

    local_c = *(uint32_t /* width from decompiler */ *)(iVar5 + uVar6 * 8 + 4);
  ...
  for (uVar6 = 0;
    ...
    fprintf(param_2,"\t\t\t<GenericTargetCOID>%i</GenericTargetCOID>\r\n",
            ...
            *(uint32_t /* width from decompiler */ *)(iVar5 + uVar6 * 8));
