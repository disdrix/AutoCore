...
// PURPOSE (auto): Domain alias Phy_RigidBodyTooManyVertices for FUN_004ec8b0 @ 0x004ec8b0
// Stable ID: aa_004ec8b0
// Embedded strings (evidence for future rename):
//   - "Rigid body of object \'%s\' is zero length"
//   - "$$$$$$New TK cache:%s [%d]\n"
//   - "Rigid body of object \'%s\' is empty or corrupt"
//   - "Rigid body of object \'%s\' had too many vertices - max is %d"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~163 non-empty decompiler lines.
//  - Control keywords: do×6, while×6, if×5, return×5, for×2.
//  - Notable callees: FUN_007a4480×4, FUN_004f34b0×2, CONCAT31, Phy_RigidBodyTooManyVertices, FUN_005f3120, FUN_005f3160, FUN_005f3740, FUN_006ba870.
//  - Strings: "Rigid body of object \'%s\' is zero length"; "$$$$$$New TK cache:%s [%d]\n"; "Rigid body of object \'%s\' is empty or corrupt"; "Rigid body of object \'%s\' had too many vertices - max is %d".
//  - Return sites: 5.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Rigid body of object '%s' had too many vertices - max is %d"
 * Domain alias of FUN_004ec8b0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ Phy_RigidBodyTooManyVertices(char *param_1)
