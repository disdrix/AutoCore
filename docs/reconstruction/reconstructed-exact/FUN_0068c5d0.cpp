...
// PURPOSE (auto): Scaffold unit for FUN_0068c5d0 @ 0x0068c5d0
// Stable ID: aa_0068c5d0
...
void __thiscall FUN_0068c5d0(int param_1,ushort param_2,uint32_t /* width from decompiler */ param_3,ushort param_4)
