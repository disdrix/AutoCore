// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Client_Constructor_00408e20
// -----------------------------------------------------------------------------
// Stable ID: aa_00408e20
// Callee of Named_CalleeOf_Named_Client_Constructor
// Address:   0x00408e20  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void Named_CalleeOf_Named_CalleeOf_Named_Client_Constructor_00408e20(void)
...

{
  ...
  *(uint8_t *)(puVar1 + 0x4c) = 1;

  *(uint8_t *)((int)puVar1 + 0x131) = 0;
