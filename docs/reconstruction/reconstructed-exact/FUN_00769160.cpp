...
// FUN_00769160
// -----------------------------------------------------------------------------
// Stable ID: aa_00769160
// Address:   0x00769160  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00769160 @ 0x00769160
// Stable ID: aa_00769160
...
//  - Notable callees: vog_LogMessage×2, FUN_00435df0, FUN_00436250, FUN_00767600, FUN_00769160, FUN_0076cec0, isspace.
//  - Strings: ");
    ...
    if (bVar3) {
      ...
      vog_LogMessage("; ",0x2a0,3,
                     ...
                     "; "Expected char but got \"%s\" in chunk \"%s\""; "C:\\vog\\1_code\\palantir\\arda2\\storage\\stoChunk.cpp".
//  - Return sites: 2.
...
//   - ",0x2a0,3,
                     ...
                     "
//   - "Expected char but got \"%s\" in chunk \"%s\""
...
uint32_t /* width from decompiler */ __thiscall FUN_00769160(int param_1,uint32_t /* width from decompiler */ param_2)
...
LAB_00769226:
  ...
  uVar5 = FUN_0076cec0(&param_2,"Expected char but got \"%s\" in chunk \"%s\"",local_40[0],iVar4);

  vog_LogMessage("C:\\vog\\1_code\\palantir\\arda2\\storage\\stoChunk.cpp",0x3f0,3,uVar5);
