...
// =============================================================================
// Drive_S_30s_enemies_d_creatures_d_vehicles_d_00958290
// -----------------------------------------------------------------------------
...
/*
 * Behavioral notes:
 * String-driven rename evidence: "%-30s enemies:%d creatures:%d vehicles: %d"
 *
...
uint32_t /* width from decompiler */ __thiscall Drive_S_30s_enemies_d_creatures_d_vehicles_d_00958290(int param_1,uint32_t /* width from decompiler */ param_2,char *param_3)
