// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_SkyBoxParticles_005d4370
// -----------------------------------------------------------------------------
// Stable ID: aa_005d4370
// Callee of Named_CalleeOf_Named_SkyBoxParticles (+1 other named callers)
// Address:   0x005d4370  (autoassault.exe, image base 0x400000)
// System:    unknown
...
int * __thiscall Named_CalleeOf_Named_CalleeOf_Named_SkyBoxParticles_005d4370(int *param_1,uint param_2)
