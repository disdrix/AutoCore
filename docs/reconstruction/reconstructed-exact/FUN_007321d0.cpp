...
// Address:   0x007321d0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_007321d0 @ 0x007321d0
// Stable ID: aa_007321d0
// Embedded strings (evidence for future rename):
//   - "C:\\vog\\1_code\\palantir\\palantir\\graphics\\gfxGeometryPieceInstancing.cpp"
//   - "Effect does not contain a HW instancing technique\n"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~148 non-empty decompiler lines.
//  - Control keywords: if×13, return×3, while×2, for×1, do×1.
//  - Notable callees: CONCAT13×3, FUN_0044bfb0×2, FUN_00746d00×2, CONCAT31, FUN_00416160, FUN_00447ea0, FUN_0044c3c0, FUN_007321d0.
//  - Strings: "
...
uint32_t /* width from decompiler */ * FUN_007321d0(uint32_t /* width from decompiler */ *param_1,int *param_2)
  ...
  do {
    ...
    while( true ) {
      ...
      if (iVar5 == *(int *)(iVar4 + 0x2c)) {
        ...
        puVar1 = (uint32_t /* width from decompiler */ *)param_1[0x72];
        ...
        *puVar1 = 1;
        ...
        param_1[0x7b] = *(uint32_t /* width from decompiler */ *)(iVar4 + 0x34);

        iVar5 = -1;

        param_1[0x7c] = *(uint32_t /* width from decompiler */ *)(iVar4 + 0x38);
