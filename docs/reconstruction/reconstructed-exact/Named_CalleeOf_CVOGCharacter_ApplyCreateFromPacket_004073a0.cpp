// =============================================================================
// Named_CalleeOf_CVOGCharacter_ApplyCreateFromPacket_004073a0
// -----------------------------------------------------------------------------
// Stable ID: aa_004073a0
// Callee of CVOGCharacter_ApplyCreateFromPacket (+1 other named callers)
...
// PURPOSE (auto): Called from CVOGCharacter_ApplyCreateFromPacket: packet/network helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. CVOGCharacter_ApplyCreateFromPacket (+1 other named callers).
...
void __thiscall Named_CalleeOf_CVOGCharacter_ApplyCreateFromPacket_004073a0(int param_1,int param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
