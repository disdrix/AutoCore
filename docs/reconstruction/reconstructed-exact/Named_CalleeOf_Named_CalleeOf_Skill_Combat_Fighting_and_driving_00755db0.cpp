// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Skill_Combat_Fighting_and_driving_00755db0
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Named_CalleeOf_Skill_Combat_Fighting_and_driving_00755db0(int param_1,int *param_2)
...

{
  ...
  if (0 < iVar2) {
    ...
    do {
      ...
      Named_CalleeOf_Named_CalleeOf_Skill_Combat_Fighting_and_driving_00755db0(*(uint32_t /* width from decompiler */ *)(*(int *)(param_2[0x1b] + iVar6 * 4) + 8));
