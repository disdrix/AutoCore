// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli_005d6410
// -----------------------------------------------------------------------------
// Stable ID: aa_005d6410
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_PacketDispa
// Address:   0x005d6410  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli_005d6410(int param_1,uint32_t /* width from decompiler */ *param_2)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x30) = param_2[7];

  *(uint32_t /* width from decompiler */ *)(param_1 + 0x34) = param_2[8];

  *(uint32_t /* width from decompiler */ *)(param_1 + 0x38) = param_2[9];
