// =============================================================================
// NestedHash_Ctor_Sentinel0x30_Inferred
// -----------------------------------------------------------------------------
...
// Generated: 2026-07-23 scaffold as FUN_00463bd0; dual A/B seal 2026-07-29 (W34-F)
...
//   allocates a circular sentinel node (0x30), installs a 9-bucket pointer table
...
//   Body 98 B; SEH LAB_009bd31b.
//
// CALLER:
//   FUN_0075f7f0 @ 0x0075fa63:
//     node = operator_new(0x28); NestedHash_Ctor_Sentinel0x30_Inferred(node);
//     host[0x1d6] = node; DAT_00d1f628 = node;
//
// FAMILY:
//   Twin of AssResolverA_NestedHash_Ctor_Inferred (0x00423cf0) / FUN_00469db0 —
//   same 98 B CF; sentinel factory is FUN_005b43b0 (node 0x30) instead of 0x28.
//   Sibling this dual: NestedHash_Ctor_Sentinel0xC_Inferred (0x0043fdf0).
//
...
extern "C" NestedHash_Sentinel0x30*
NestedHash_Ctor_Sentinel0x30_Inferred(NestedHash_Sentinel0x30* self /*stack*/)
{
  // SEH frame LAB_009bd31b
...
// Ghidra twin symbol
extern "C" NestedHash_Sentinel0x30* FUN_00463bd0(NestedHash_Sentinel0x30* self)
{
  return NestedHash_Ctor_Sentinel0x30_Inferred(self);
}
