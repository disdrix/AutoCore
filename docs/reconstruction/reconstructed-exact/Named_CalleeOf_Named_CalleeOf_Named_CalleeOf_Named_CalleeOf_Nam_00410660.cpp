// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00410660
// -----------------------------------------------------------------------------
// Stable ID: aa_00410660
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli
// Address:   0x00410660  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004108a0×2, FUN_004108c0×2, FUN_00410940×2, FUN_00410660, FUN_00418130, FUN_00447c60, FUN_00447d70.
//  - Return sites: 3.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00410660(uint param_1,int param_2,int param_3)
...

{
  ...
  if (param_1 != 0) {
    ...
    if (uVar2 < iVar6 + param_1) {
      ...
      uVar5 = FUN_004108a0(param_2,param_3);

      FUN_004108c0(uVar5,param_1,local_34);

      FUN_004108a0(param_2,*(uint32_t /* width from decompiler */ *)(param_2 + 8));
    ...
    if ((uint)(iVar3 - param_3 >> 3) < param_1) {
      ...
      FUN_00410940(param_3,param_1 * 8 + param_3,local_38);

      local_8 = 2;

      FUN_004108c0(*(int *)(param_2 + 8),param_1 - (*(int *)(param_2 + 8) - param_3 >> 3),local_48);
      ...
      *(int *)(param_2 + 8) = *(int *)(param_2 + 8) + param_1 * 8;
      ...
      uVar5 = FUN_00410940(iVar3 + param_1 * -8,iVar3,local_4c);
