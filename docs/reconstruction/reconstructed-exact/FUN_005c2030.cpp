...
// PURPOSE (auto): Scaffold unit for FUN_005c2030 @ 0x005c2030
// Stable ID: aa_005c2030
...
FUN_005c2030(int param_1,float *param_2,uint32_t /* width from decompiler */ *param_3,float *param_4,float *param_5,
