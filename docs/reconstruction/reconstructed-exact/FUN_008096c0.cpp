...
// PURPOSE (auto): Scaffold unit for FUN_008096c0 @ 0x008096c0
// Stable ID: aa_008096c0
// Embedded strings (evidence for future rename):
//   - "Got global connect succeed:%d reconnecting:%d coid:%I64d str:%s"
//   - "You have been forced to quit due to multiple logins.\n"
//   - "\nClick Accept to return to the login screen."
//   - "Connection to global terminated:\n"
//   - "You have been forced to quit due to GM action.\n"
//   - "You have been banned due to GM action.\n"
...
void __fastcall FUN_008096c0(int param_1,char param_2,int param_3)
