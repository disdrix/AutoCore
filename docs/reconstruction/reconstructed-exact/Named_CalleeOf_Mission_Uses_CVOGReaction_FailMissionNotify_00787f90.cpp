// =============================================================================
// Named_CalleeOf_Mission_Uses_CVOGReaction_FailMissionNotify_00787f90
// -----------------------------------------------------------------------------
// Stable ID: aa_00787f90
// Callee of Mission_Uses_CVOGReaction_FailMissionNotify
...
// PURPOSE (auto): Called from Mission_Uses_CVOGReaction_FailMissionNotify: mission/objective helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
uint Named_CalleeOf_Mission_Uses_CVOGReaction_FailMissionNotify_00787f90(float *param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ *param_3,uint32_t /* width from decompiler */ *param_4)
