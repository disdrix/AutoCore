...
// Address:   0x006ff2f0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006ff2f0 @ 0x006ff2f0
// Stable ID: aa_006ff2f0
...
//  - Control keywords: if×23, goto×20, return×9, while×1, switch×1.
//  - Notable callees: case×76, CONCAT11×12, CONCAT21×5, FUN_006ff2f0×3, CONCAT31×2, FUN_00631f10, FUN_00631f70.
//  - Return sites: 9.
...
LAB_007002db:
      ...
      uStack_220 = *(uint32_t /* width from decompiler */ *)(iVar14 + 0x34);
      ...
      pcVar13 = (char *)(**(code **)**(uint32_t /* width from decompiler */ **)(iStack_224 + 4))();
      ...
      uStack_234 = *(uint32_t /* width from decompiler */ *)(iStack_204 + 0x28);

      piStack_23c = *(int **)(*(int *)(iStack_204 + 0x2c) + 0x30);

      auStack_340[0x3f] = *(uint32_t /* width from decompiler */ *)(*(int *)(iStack_204 + 0x2c) + 0x34);

      uStack_238 = *(uint32_t /* width from decompiler */ *)(iStack_204 + 0x24);
      ...
      *(uint32_t /* width from decompiler */ *)(iStack_204 + 0x1c) = *(uint32_t /* width from decompiler */ *)(*(int *)(iStack_204 + 0x24) + 4);
      ...
      if ((fVar6 <= local_1ec) || (fVar7 <= local_1ec)) {
        ...
        if (fVar9 <= fVar8) {
          ...
          if (*(float *)(param_1 + 0x1c) < *(float *)(param_1 + 0x20)) {
            ...
            *(uint32_t /* width from decompiler */ *)(param_1 + 0x20) = *(uint32_t /* width from decompiler */ *)(param_1 + 0x1c);
