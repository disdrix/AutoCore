// =============================================================================
// VehicleNet_PackUpdate  (stem: FUN_005f5de0)
// -----------------------------------------------------------------------------
...
// Dual: reviews/A_aa_005f5de0_VehicleNet_PackUpdate.md + B_* (accept-with-gaps)
// =============================================================================

// PURPOSE: Client GhostVehicle packUpdate — mask-gated BitStream serialization
//   of initial create body, hardpoints, owner GM/AI, PositionMask pose +
//   quantized thr(+0x614)/steer(+0x618), and combat pools.
// Stable ID: aa_005f5de0
// Embedded strings:
//   - "Can't save ghost data for vehicle!"
//   - "Packing initial update for vehicle %I64"
// Sibling unpack: VehicleNet_UnpackGhostVehicle @ 0x005f7720
