// =============================================================================
// Named_CalleeOf_Named_assPackManager_0071abd0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_assPackManager: callee helper. Evidence string: "Error: uncompress buffer not large enough.\n". Supports parent flow (not a free-standing entry point).
...
Named_CalleeOf_Named_assPackManager_0071abd0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,uint *param_3,uint param_4)
