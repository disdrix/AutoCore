// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Invalid_Packet_0042bdd0
// -----------------------------------------------------------------------------
// Stable ID: aa_0042bdd0
// Callee of Named_CalleeOf_Named_Invalid_Packet
// Address:   0x0042bdd0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0042bdd0, FUN_00784d20.
//  - Return sites: 1.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_Invalid_Packet_0042bdd0(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2)
