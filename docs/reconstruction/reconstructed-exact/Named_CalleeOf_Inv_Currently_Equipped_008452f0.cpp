// =============================================================================
// Named_CalleeOf_Inv_Currently_Equipped_008452f0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Inv_Currently_Equipped: callee helper. Evidence string: "\nCOID: %I64i\n". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Inv_Currently_Equipped_008452f0(void)
