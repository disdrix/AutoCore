// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Skill_Skill_d_had_0054d4a0
// -----------------------------------------------------------------------------
// Stable ID: aa_0054d4a0
// Callee of Named_CalleeOf_Named_CalleeOf_Skill_Skill_d_had_no_skill_elemen
// Address:   0x0054d4a0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Skill_Skill_d_had_0054d4a0(int param_1,int *param_2)
