// =============================================================================
// Named_premature_end_file_reached_parsing_collision
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_premature_end_file_reached_parsing_collision @ 0x0068aee0
// Stable ID: aa_0068aee0
...
//  - Notable callees: FUN_00699ed0×9, FUN_006874b0×3, _CxxThrowException×3, FUN_00699ee0×2, FUN_0068ae50, Named_premature_end_file_reached_parsing_collision.
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "premature end of file reached parsing collision object info"
 * Domain alias of FUN_0068aee0 (FUN_* retained)
 *
...
void __thiscall Named_premature_end_file_reached_parsing_collision(int param_1,uint *param_2)
