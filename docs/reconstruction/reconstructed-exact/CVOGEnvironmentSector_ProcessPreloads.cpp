// =============================================================================
// CVOGEnvironmentSector_ProcessPreloads
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Domain alias CVOGEnvironmentSector_ProcessPreloads for FUN_00495600 @ 0x00495600
// Stable ID: aa_00495600
...
//  - Notable callees: FUN_0076cef0×3, FUN_0076cf00×2, CVOGEnvironmentSector_ProcessPreloads, FUN_004baf50, FUN_004c00f0.
//  - Strings: "CVOGEnvironmentSector::ProcessPreloads"; "ProcessPreloads".
//  - Return sites: 3.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "CVOGEnvironmentSector::ProcessPreloads"
 * Domain alias of FUN_00495600 (FUN_* retained)
 *
...
void __fastcall CVOGEnvironmentSector_ProcessPreloads(int param_1)
