// =============================================================================
// Named_CalleeOf_Client_Input_DriveControlTick_0075c340
// -----------------------------------------------------------------------------
...
// PURPOSE: Parent-seed alias only. Canonical 2026-07-29:
//   GfxView_UnprojectScreenToWorldRay_Inferred (aa_0075c340) — multi-caller gfxView ray unproject.
//   Not drive-axis helper; secondary camera/pick for DriveControlTick + InteractClickPick + others.
...
void __thiscall Named_CalleeOf_Client_Input_DriveControlTick_0075c340(int param_1,int *param_2,uint32_t /* width from decompiler */ *param_3,float *param_4)
