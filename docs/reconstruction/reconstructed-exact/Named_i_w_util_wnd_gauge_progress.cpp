// =============================================================================
// Named_i_w_util_wnd_gauge_progress
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_i_w_util_wnd_gauge_progress @ 0x00891480
// Stable ID: aa_00891480
...
//  - Notable callees: FUN_007b5dd0×6, sprintf×4, FUN_0079c860×2, FUN_007f9160, Named_i_w_util_wnd_gauge_progress, FUN_0097ffa0, GetTickCount.
//  - Strings: "i_w_util_wnd_title.xml"; "i_w_util_wnd_text.xml"; "i_w_util_wnd_timer.xml"; "i_w_util_btn_close.xml".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "i_w_util_wnd_gauge_progress.xml"
 * Domain alias of FUN_00891480 (FUN_* retained)
 *
...
void Named_i_w_util_wnd_gauge_progress(int *param_1)
