// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVolume_004554e0
// -----------------------------------------------------------------------------
// Stable ID: aa_004554e0
// Callee of Named_CalleeOf_Named_gfxShadowVolume
// Address:   0x004554e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVolume_004554e0(uint32_t /* width from decompiler */ param_1,int *param_2)
