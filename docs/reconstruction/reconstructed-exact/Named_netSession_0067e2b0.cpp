...
uint32_t /* width from decompiler */ __thiscall Named_netSession_0067e2b0(int param_1,uint *param_2,uint32_t /* width from decompiler */ param_3,int param_4)
