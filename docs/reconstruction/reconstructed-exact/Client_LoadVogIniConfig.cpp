...
// =============================================================================
// Client_LoadVogIniConfig
// -----------------------------------------------------------------------------
// Purpose:  Parses VOG.ini (USERNAME/PASSWORD/AUTHSERVERIP/AUTHSERVERID/display mode, etc.).
//
// Address:  0x009365e0  (autoassault.exe, image base 0x400000)
// Stable:   aa_009365e0
// System:   auth
//
// String evidence: fopen("VOG.ini") / AUTHSERVERIP / AUTHSERVERID
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_009365e0.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_009365e0 using string evidence: fopen("VOG.ini") / AUTHSERVERIP / AUTHSERVERID
