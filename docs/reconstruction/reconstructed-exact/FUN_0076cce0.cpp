...
// Address:   0x0076cce0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0076cce0 @ 0x0076cce0
// Stable ID: aa_0076cce0
...
//  - Notable callees: FUN_0076cce0×2.
//  - Return sites: 3.
...

{
  ...
  for (puVar2 = *(uint32_t /* width from decompiler */ **)(param_1 + 0x40); puVar2 != *(uint32_t /* width from decompiler */ **)(param_1 + 0x44);
