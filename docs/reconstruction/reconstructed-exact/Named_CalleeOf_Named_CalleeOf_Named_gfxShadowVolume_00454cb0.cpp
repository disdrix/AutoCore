// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVolume_00454cb0
// -----------------------------------------------------------------------------
// Stable ID: aa_00454cb0
// Callee of Named_CalleeOf_Named_gfxShadowVolume
// Address:   0x00454cb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00456280×4, CONCAT31×2, FUN_00455fa0×2, FUN_00426f20, FUN_004540b0, FUN_00454cb0, FUN_00455700, FUN_00455c10.
//  - Return sites: 3.
...
void Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVolume_00454cb0(int param_1,int param_2,uint param_3)
...

{
  ...
  if (param_3 != 0) {
    ...
    if (uVar2 < iVar6 + param_3) {
      ...
      iVar3 = FUN_00456280(param_2,pvVar4,param_1,param_2);

      FUN_00455fa0(iVar3,local_28,param_1,param_2);

      FUN_00456280(*(uint32_t /* width from decompiler */ *)(param_1 + 8),iVar3 + param_3 * 0x10,param_1,param_2);
      ...
      *(void **)(param_1 + 4) = pvVar4;
      ...
      if ((uint)((int)(local_18 - param_2) >> 4) < param_3) {
        ...
        FUN_00456280(uVar1,uVar2,param_1,param_2);

        local_8 = CONCAT31(local_8._1_3_,3);

        FUN_00455fa0(*(uint32_t /* width from decompiler */ *)(param_1 + 8),local_28,param_1,param_2);
        ...
        *(int *)(param_1 + 8) = *(int *)(param_1 + 8) + param_3 * 0x10;
        ...
        uVar5 = FUN_00456280(local_18,local_18,param_1,param_2);
