// =============================================================================
// Named_CalleeOf_Inv_Client_ValidateCraftAffordability_00522060
// -----------------------------------------------------------------------------
// Stable ID: aa_00522060
// Callee of Inv_Client_ValidateCraftAffordability (+1 other named callers)
...
// PURPOSE (auto): Called from Inv_Client_ValidateCraftAffordability: inventory/item helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Inv_Client_ValidateCraftAffordability (+1 other named callers).
...
bool __thiscall Named_CalleeOf_Inv_Client_ValidateCraftAffordability_00522060(int param_1,int param_2,int *param_3,char param_4,char param_5)
