...
// PURPOSE (auto): Scaffold unit for FUN_00420760 @ 0x00420760
// Stable ID: aa_00420760
...
FUN_00420760(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ *param_2,int param_3,int param_4,uint param_5)
