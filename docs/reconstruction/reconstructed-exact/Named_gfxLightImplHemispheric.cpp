...
uint32_t /* width from decompiler */ * Named_gfxLightImplHemispheric(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ param_2)
