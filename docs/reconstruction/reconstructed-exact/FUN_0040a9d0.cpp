...
// PURPOSE (auto): Scaffold unit for FUN_0040a9d0 @ 0x0040a9d0
// Stable ID: aa_0040a9d0
...
void FUN_0040a9d0(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4,uint32_t /* width from decompiler */ param_5,
