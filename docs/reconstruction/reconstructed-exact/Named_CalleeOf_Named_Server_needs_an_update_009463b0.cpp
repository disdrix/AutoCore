// =============================================================================
// Named_CalleeOf_Named_Server_needs_an_update_009463b0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_Server_needs_an_update: callee helper. Evidence string: "start reinitPhysics". Supports parent flow (not a free-standing entry point).
...
//   - "before setmapinfo"
//   - ".fam"
//   - " button, then click the patch button again.\nHigher level content may not be available for"
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_Server_needs_an_update_009463b0(int param_1)
