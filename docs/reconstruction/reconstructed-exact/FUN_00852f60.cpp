...
// FUN_00852f60
// -----------------------------------------------------------------------------
// Stable ID: aa_00852f60
// Address:   0x00852f60  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00852f60 @ 0x00852f60
// Stable ID: aa_00852f60
...
void __fastcall FUN_00852f60(int param_1)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x580) = 0xffffffff;

  *(uint32_t /* width from decompiler */ *)(param_1 + 0x584) = 0xffffffff;
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x588) = 0xffffffff;

  *(uint32_t /* width from decompiler */ *)(param_1 + 0x58c) = 0xffffffff;
