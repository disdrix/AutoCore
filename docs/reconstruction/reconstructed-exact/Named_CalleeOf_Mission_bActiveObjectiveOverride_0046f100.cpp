// =============================================================================
// Named_CalleeOf_Mission_bActiveObjectiveOverride_0046f100
// -----------------------------------------------------------------------------
// Stable ID: aa_0046f100
// Callee of Mission_bActiveObjectiveOverride (+1 other named callers)
// Address:   0x0046f100  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Mission_bActiveObjectiveOverride_0046f100(uint32_t /* width from decompiler */ param_1,int *param_2)
