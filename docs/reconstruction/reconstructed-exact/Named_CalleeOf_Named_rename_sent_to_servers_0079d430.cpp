// =============================================================================
// Named_CalleeOf_Named_rename_sent_to_servers_0079d430
// -----------------------------------------------------------------------------
// Stable ID: aa_0079d430
// Callee of Named_rename_sent_to_servers (+4 other named callers)
...
// PURPOSE (auto): Called from Named_rename_sent_to_servers: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_rename_sent_to_servers (+4 other named callers).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_rename_sent_to_servers_0079d430(int *param_1,int param_2)
