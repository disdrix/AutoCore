// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_0043ebb0
// -----------------------------------------------------------------------------
// Stable ID: aa_0043ebb0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST
// Address:   0x0043ebb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_0043ebb0(int *param_1,int param_2,uint param_3,int param_4,uint param_5,int param_6,
...

{
  ...
  while ((param_2 != param_4 || (param_3 != param_5))) {
    ...
    puVar1 = (uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_4 + 4) + uVar6 * 4) + (param_5 + iVar3) * 4);
