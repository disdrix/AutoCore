...
// PURPOSE (auto): Scaffold unit for UI_Palantir_SetClientSize @ 0x00754090
// Stable ID: aa_00754090
...
//  - Notable callees: UI_Palantir_SetClientSize, FUN_0076c130, Palantir::SetClientSize, from, to.
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Palantir::SetClientSize() - Client size changed from (%i,%i) to (%i,%i); reset required
"
 * Domain alias of FUN_00754090 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ UI_Palantir_SetClientSize(void)
