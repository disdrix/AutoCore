// =============================================================================
// Named_CalleeOf_Named_gfxSubPhaseMap_0043ffb0
// -----------------------------------------------------------------------------
// Stable ID: aa_0043ffb0
// Callee of Named_gfxSubPhaseMap (+1 other named callers)
// Address:   0x0043ffb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0043ffb0, FUN_0045f020, FUN_0046d5b0.
//  - Return sites: 2.
...
void __thiscall Named_CalleeOf_Named_gfxSubPhaseMap_0043ffb0(uint param_1,uint32_t /* width from decompiler */ param_2)
...

{
  ...
  if (uVar2 < param_1) {
    ...
    FUN_0046d5b0(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 8),&param_2);
