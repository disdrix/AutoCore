...
// PURPOSE (auto): Scaffold unit for Named_Initial_Count_Avg_Size @ 0x0042b190
// Stable ID: aa_0042b190
...
//  - Notable callees: FUN_00783aa0×3, s×2, Named_Initial_Count_Avg_Size.
//  - Strings: "%s (Initial) - Count: %d   Avg Size: %g"; "%s (Partial) - Count: %d   Avg Size: %g".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "%s (Initial) - Count: %d   Avg Size: %g"
 * Domain alias of FUN_0042b190 (FUN_* retained)
 *
...
void Named_Initial_Count_Avg_Size(void)
