...
// PURPOSE (auto): Scaffold unit for Named_tells_convoy @ 0x008f6030
// Stable ID: aa_008f6030
...
//  - Notable callees: Named_tells_convoy.
//  - Strings: "%s broadcasts: "; "%s tells you: "; "%s tells the convoy: "; "%s tells the clan: ".
//  - Return sites: 15.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "%s tells the convoy: "
 * Domain alias of FUN_008f6030 (FUN_* retained)
 *
