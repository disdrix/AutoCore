...
Named_gfxDevice_0075ebd0(uint32_t /* width from decompiler */ *param_1,byte param_2,uint32_t /* width from decompiler */ *param_3,uint32_t /* width from decompiler */ param_4,
