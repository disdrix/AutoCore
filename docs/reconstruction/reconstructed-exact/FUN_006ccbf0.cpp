...
// Address:   0x006ccbf0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006ccbf0 @ 0x006ccbf0
// Stable ID: aa_006ccbf0
// No high-value strings recovered; name via xrefs/callers in follow-up.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~602 non-empty decompiler lines.
//  - Control keywords: if×80, goto×19, return×18, do×3, while×3.
//  - Notable callees: ABS×7, SBORROW4×3, ROUND×2, SQRT×2, CONCAT13, FUN_005ef3a0, FUN_006ccbf0.
//  - Return sites: 18.
...
void __thiscall FUN_006ccbf0(int *param_1,float *param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ *param_4)
