// =============================================================================
// CVOGScreen_PreloadInterfaceGeos
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for CVOGScreen_PreloadInterfaceGeos @ 0x0090e960
// Stable ID: aa_0090e960
...
//  - Notable callees: FUN_00540350×24, FUN_007a4480×2, CVOGScreen_PreloadInterfaceGeos.
//  - Strings: "CVOGScreen::PreloadInterfaceGeos start\n"; "char_h_c_m_b_1"; "char_m_c_m_b_1"; "char_b_c_m_b_1".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "CVOGScreen::PreloadInterfaceGeos start
"
 * Domain alias of FUN_0090e960 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ CVOGScreen_PreloadInterfaceGeos(void)
