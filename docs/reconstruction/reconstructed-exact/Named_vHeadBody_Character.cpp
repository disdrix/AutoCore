...
// PURPOSE (auto): Scaffold unit for Named_vHeadBody_Character @ 0x007de350
// Stable ID: aa_007de350
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//vHeadBody_Character/row[@bitIsHead='Fa']"
 * Domain alias of FUN_007de350 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Named_vHeadBody_Character(_func_5023 *param_1,byte *param_2)
