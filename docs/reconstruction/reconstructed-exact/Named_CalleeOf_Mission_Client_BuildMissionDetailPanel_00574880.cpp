// =============================================================================
// Named_CalleeOf_Mission_Client_BuildMissionDetailPanel_00574880
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Mission_Client_BuildMissionDetailPanel_00574880(int param_1)
...

{
  ...
  return *(uint32_t /* width from decompiler */ *)((*(int *)(param_1 + 0x194) + 0x1a) * 0x10 + param_1);
