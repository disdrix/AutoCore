// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOGSpecGlowF_00469360
// -----------------------------------------------------------------------------
// Stable ID: aa_00469360
// Callee of Named_CalleeOf_Named_CalleeOf_Named_VOGSpecGlowFilter
// Address:   0x00469360  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00450d70, FUN_00469360.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOGSpecGlowF_00469360(uint32_t /* width from decompiler */ *param_1,int param_2,uint32_t /* width from decompiler */ param_3)
...

{
  ...
  for (param_2 = param_2 - (int)param_1; 1 < param_2 >> 2; param_2 = param_2 + -4) {
    ...
    *(uint32_t /* width from decompiler */ *)((int)param_1 + param_2 + -4) = *param_1;
    ...
    FUN_00450d70(param_1,param_2 + -4 >> 2,uVar1,param_3);
