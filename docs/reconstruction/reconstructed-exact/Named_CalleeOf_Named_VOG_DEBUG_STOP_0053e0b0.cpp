// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_0053e0b0
// -----------------------------------------------------------------------------
// Stable ID: aa_0053e0b0
// Callee of Named_VOG_DEBUG_STOP (+2 other named callers)
// Address:   0x0053e0b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0053e020, FUN_0053e0b0.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Named_VOG_DEBUG_STOP_0053e0b0(int param_1)
...

{
  ...
  if (*(int *)(param_1 + 0x28) == 0) {
    ...
    *(uint32_t /* width from decompiler */ *)(param_1 + 0x28) = uVar1;
