...
// PURPOSE: SUPERSEDED scaffold — dual-sealed 2026-07-29 as InventoryGrid_MergeStackQty.
// Prefer: reconstructed-exact/InventoryGrid_MergeStackQty.cpp
// Dual:   reviews/A_aa_00571830_InventoryGrid_MergeStackQty.md
//         reviews/B_aa_00571830_InventoryGrid_MergeStackQty.md
// Note: "VOG_DEBUG_STOP" is miss-path only (log enable=0, no-op).
...
uint32_t /* width from decompiler */ __thiscall FUN_00571830(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4)
