// =============================================================================
// Named_CalleeOf_Client_RecvInventoryGrabResponse_0093d6e0
// -----------------------------------------------------------------------------
// Stable ID: aa_0093d6e0
// Callee of Client_RecvInventoryGrabResponse (+1 other named callers)
...
// PURPOSE (auto): Called from Client_RecvInventoryGrabResponse: inventory/item helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Client_RecvInventoryGrabResponse (+1 other named callers).
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Client_RecvInventoryGrabResponse_0093d6e0(uint32_t /* width from decompiler */ param_1,char param_2,int param_3,uint32_t /* width from decompiler */ param_4)
