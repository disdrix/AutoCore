// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_0076d8b0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_VOG_DEBUG_STOP: callee helper. Evidence string: "<Unknown> \r\n". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_VOG_DEBUG_STOP_0076d8b0(int param_1,int param_2,int param_3,int param_4,int param_5)
