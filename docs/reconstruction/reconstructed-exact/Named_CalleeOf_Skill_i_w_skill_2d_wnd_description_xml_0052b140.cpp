// =============================================================================
// Named_CalleeOf_Skill_i_w_skill_2d_wnd_description_xml_0052b140
// -----------------------------------------------------------------------------
// Stable ID: aa_0052b140
// Callee of Skill_i_w_skill_2d_wnd_description_xml (+1 other named callers)
...
// PURPOSE (auto): Called from Skill_i_w_skill_2d_wnd_description_xml: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Skill_i_w_skill_2d_wnd_description_xml (+1 other named callers).
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Skill_i_w_skill_2d_wnd_description_xml_0052b140(int param_1,uint32_t /* width from decompiler */ param_2)
