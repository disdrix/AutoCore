// =============================================================================
// Named_BAD_SPAWN_POINT_ACTIVATION_RANGE
// -----------------------------------------------------------------------------
// Stable ID: aa_00565950
// Address:   0x00565950  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for Named_BAD_SPAWN_POINT_ACTIVATION_RANGE @ 0x00565950
// Stable ID: aa_00565950
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "******BAD SPAWN POINT ACTIVATION RANGE: %d %f"
 * Domain alias of FUN_00565950 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Named_BAD_SPAWN_POINT_ACTIVATION_RANGE(int param_1,int *param_2,uint8_t *param_3,float *param_4)
