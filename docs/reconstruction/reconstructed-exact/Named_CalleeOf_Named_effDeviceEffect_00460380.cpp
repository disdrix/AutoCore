// =============================================================================
// Named_CalleeOf_Named_effDeviceEffect_00460380
// -----------------------------------------------------------------------------
// Stable ID: aa_00460380
// Callee of Named_effDeviceEffect
// Address:   0x00460380  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00448e90, FUN_004540b0, FUN_00460380.
//  - Return sites: 1.
...
int __thiscall Named_CalleeOf_Named_effDeviceEffect_00460380(int param_1,int param_2)
  ...
  *(uint32_t /* width from decompiler */ *)(param_2 + 0xc) = 0;
  ...
  if (uVar1 != 0) {
    ...
    *(void **)(param_2 + 0xc) = (void *)(uVar1 * 8 + (int)pvVar2);
    ...
    uVar3 = FUN_00448e90(*(uint32_t /* width from decompiler */ *)(param_1 + 4),*(uint32_t /* width from decompiler */ *)(param_1 + 8),param_2);
