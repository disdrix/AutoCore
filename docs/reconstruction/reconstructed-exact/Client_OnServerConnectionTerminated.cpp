...
// =============================================================================
// Client_OnServerConnectionTerminated
// -----------------------------------------------------------------------------
// Purpose:  Server connection terminated / GM force-quit path; Accept returns to login screen.
//
// Address:  0x00812de0  (autoassault.exe, image base 0x400000)
// Stable:   aa_00812de0
// System:   auth
//
// String evidence: "Connection to server terminated" / "return to the login screen"
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_00812de0.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_00812de0 using string evidence: "Connection to server terminated" / "return to the login screen"
