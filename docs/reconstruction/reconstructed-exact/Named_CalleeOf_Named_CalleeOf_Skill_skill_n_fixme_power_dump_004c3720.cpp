// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Skill_skill_n_fixme_power_dump_004c3720
// -----------------------------------------------------------------------------
// Stable ID: aa_004c3720
// Callee of Named_CalleeOf_Skill_skill_n_fixme_power_dump
...
// PURPOSE (auto): Called from Named_CalleeOf_Skill_skill_n_fixme_power_dump: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Skill_skill_n_fixme_power_dump_004c3720(int param_1,uint param_2)
