...
//
// PURPOSE:
//   Linear lookup: scan registry->table_at_0x58[0 .. DAT_00d02984) for the
...
//   FUN_00508c00  +0x54 / DAT_00d02988   (HandlerTable54_FindById6c)
//   FUN_00508c50  +0x58 / DAT_00d02984   <-- this unit
//
// CALLERS (selected):
//   Vehicle_ApplyItemStatusHooksOnEquip (0x004fe380) — subtype 0xa handlers
...
struct HandlerTableRegistry {
  // ...
  // HandlerTableEntry **table58; // @ +0x58
};

// INFERRED name — product English unknown.
void *__thiscall HandlerTable58_FindById6c(HandlerTableRegistry *self, int32_t id)
{
  int32_t i;
  ...
  if ((id != -1) && (DAT_00d02984 > 0)) {
    table = *(HandlerTableEntry ***)((char *)self + 0x58);
    do {
