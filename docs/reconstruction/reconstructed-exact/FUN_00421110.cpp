...
// PURPOSE (auto): Scaffold unit for FUN_00421110 @ 0x00421110
// Stable ID: aa_00421110
...
uint32_t /* width from decompiler */ * FUN_00421110(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
