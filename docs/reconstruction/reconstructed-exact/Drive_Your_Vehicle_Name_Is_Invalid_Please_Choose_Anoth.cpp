...
// =============================================================================
// Drive_Your_Vehicle_Name_Is_Invalid_Please_Choose_Anoth
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __thiscall Drive_Your_Vehicle_Name_Is_Invalid_Please_Choose_Anoth(int *param_1,int param_2,int param_3)
