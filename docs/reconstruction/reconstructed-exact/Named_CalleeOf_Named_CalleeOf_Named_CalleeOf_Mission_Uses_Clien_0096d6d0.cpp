// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_Uses_Clien_0096d6d0
// -----------------------------------------------------------------------------
...
int __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_Uses_Clien_0096d6d0(int param_1)
...

{
  ...
  while ((piVar1 = *(int **)(param_1 + 0x6c), piVar1 != (int *)0x0 &&
    ...
    iVar3 = Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_Uses_Clien_0096d6d0();
