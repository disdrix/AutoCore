...
// PURPOSE (auto): Scaffold unit for FUN_005d55f0 @ 0x005d55f0
// Stable ID: aa_005d55f0
...
void __thiscall FUN_005d55f0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ param_2,uint8_t param_3)
