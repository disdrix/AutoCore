// =============================================================================
// CVOGObject_ComputeOutcomeRolls_Inferred
// -----------------------------------------------------------------------------
...
int __thiscall
CVOGObject_ComputeOutcomeRolls_Inferred(int *param_1,int *param_2,char param_3,char param_4,uint32_t param_5,int param_6,
            int param_7)
