// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVol_00453bb0
// -----------------------------------------------------------------------------
// Stable ID: aa_00453bb0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVolume
// Address:   0x00453bb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00452680×2, FUN_00452710×2, FUN_00401a40, FUN_00453bb0, FUN_004554a0, _CxxThrowException.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVol_00453bb0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ param_4)
...

{
  ...
  piVar3 = (int *)FUN_004554a0(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4),param_1,*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  do {
    ...
    if (cVar1 != '\0') {
      ...
      *(uint8_t *)(*(int *)(*(int *)(unaff_EDI + 4) + 4) + 0x38) = 1;
...
LAB_00453c8a:
        ...
        *(uint8_t *)(*(int *)(*piVar4 + 4) + 0x38) = 0;
        ...
        if (piVar6 == (int *)piVar2[2]) {
          ...
          FUN_00452680(unaff_EDI);

          piVar6 = piVar2;

        }

        *(uint8_t *)(piVar6[1] + 0x38) = 1;

        *(uint8_t *)(*(int *)(piVar6[1] + 4) + 0x38) = 0;

        FUN_00452710(unaff_EDI);
      ...
      if ((char)piVar5[0xe] == '\0') goto LAB_00453c8a;
