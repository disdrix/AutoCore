// =============================================================================
// Named_CalleeOf_CVOGSpawnPoint_CreateCreature_004cf2a0
// -----------------------------------------------------------------------------
// Stable ID: aa_004cf2a0
// Callee of CVOGSpawnPoint_CreateCreature
// Address:   0x004cf2a0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004cf2a0, FUN_00568670, FUN_00568920.
//  - Return sites: 1.
...
void Named_CalleeOf_CVOGSpawnPoint_CreateCreature_004cf2a0(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3)
