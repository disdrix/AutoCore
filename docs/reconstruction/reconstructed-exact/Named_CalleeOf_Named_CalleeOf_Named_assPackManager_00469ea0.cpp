// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_assPackManager_00469ea0
// -----------------------------------------------------------------------------
// Stable ID: aa_00469ea0
// Callee of Named_CalleeOf_Named_assPackManager
// Address:   0x00469ea0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00401a40, FUN_00469ea0, _CxxThrowException.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_assPackManager_00469ea0(uint param_1,int param_2)
...

{
  ...
  if (0x7ffffffU - *(int *)(param_2 + 8) < param_1) {
