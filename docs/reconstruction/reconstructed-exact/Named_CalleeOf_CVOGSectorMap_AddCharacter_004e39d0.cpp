// =============================================================================
// Named_CalleeOf_CVOGSectorMap_AddCharacter_004e39d0
// -----------------------------------------------------------------------------
// Stable ID: aa_004e39d0
// Callee of CVOGSectorMap_AddCharacter
// Address:   0x004e39d0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from CVOGSectorMap_AddCharacter: character create/apply helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~99 non-empty decompiler lines.
//  - Control keywords: if×13, return×4.
//  - Notable callees: FUN_004e2e80×2, FUN_004e2f70×2, FUN_005739b0×2, memmove×2, CONCAT44, FUN_004e1050, FUN_004e24d0, FUN_004e39d0.
//  - Return sites: 4.
...
void __thiscall Named_CalleeOf_CVOGSectorMap_AddCharacter_004e39d0(int param_1,void *param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
