...
// PURPOSE (auto): Scaffold unit for FUN_007ed3b0 @ 0x007ed3b0
// Stable ID: aa_007ed3b0
...
int __thiscall FUN_007ed3b0(char *param_1,int *param_2,uint32_t /* width from decompiler */ param_3,uint16_t *param_4)
