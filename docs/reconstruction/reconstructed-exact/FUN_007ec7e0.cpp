...
// PURPOSE (auto): Scaffold unit for FUN_007ec7e0 @ 0x007ec7e0
// Stable ID: aa_007ec7e0
...
int __thiscall FUN_007ec7e0(char *param_1,int *param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ *param_4)
