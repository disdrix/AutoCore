...
// Address:   0x006cfe60  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006cfe60 @ 0x006cfe60
// Stable ID: aa_006cfe60
// No high-value strings recovered; name via xrefs/callers in follow-up.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~584 non-empty decompiler lines.
//  - Control keywords: if×26, goto×20, return×11, while×1, switch×1.
//  - Notable callees: case×76, CONCAT11×12, CONCAT21×5, FUN_006cfe60×3, CONCAT31×2, FUN_00631f10, FUN_00631f70.
//  - Return sites: 11.
...
LAB_006d0c89:
      ...
      if (*(uint32_t /* width from decompiler */ **)(param_1 + 0x44) != (uint32_t /* width from decompiler */ *)0x0) {
        ...
        pcVar9 = (char *)(**(code **)**(uint32_t /* width from decompiler */ **)(param_1 + 0x44))();
      ...
      if (pfStack_1ec != (float *)0x0) {
        ...
        *(uint8_t *)((int)local_1c0 + 0x50) = 1;

        *(uint32_t /* width from decompiler */ *)((int)local_1c0 + 0x54) =

             *(uint32_t /* width from decompiler */ *)(*(int *)((int)local_1c0 + 0x58) + 0x14);
      ...
      *(uint32_t /* width from decompiler */ *)((int)local_1c0 + 0x54) = *(uint32_t /* width from decompiler */ *)(*(int *)((int)local_1c0 + 0x5c) + 4);
