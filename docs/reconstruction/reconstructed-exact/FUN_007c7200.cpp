...
// PURPOSE (auto): Scaffold unit for FUN_007c7200 @ 0x007c7200
// Stable ID: aa_007c7200
...
uint32_t /* width from decompiler */ __thiscall FUN_007c7200(char *param_1,short *param_2,int *param_3,int *param_4)
