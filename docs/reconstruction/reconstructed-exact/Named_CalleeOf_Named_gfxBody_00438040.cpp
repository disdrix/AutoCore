// =============================================================================
// Named_CalleeOf_Named_gfxBody_00438040
// -----------------------------------------------------------------------------
...
//  - Notable callees: FUN_00438040, FUN_00438d00, FUN_00438d80.
//  - Return sites: 1.
...
void __fastcall Named_CalleeOf_Named_gfxBody_00438040(uint param_1,int param_2,uint32_t /* width from decompiler */ param_3,int *param_4)
...

{
  ...
  if (uVar2 < param_1) {
    ...
    FUN_00438d80(param_2,*(uint32_t /* width from decompiler */ *)(param_2 + 8),param_1 - iVar3,&param_3);
