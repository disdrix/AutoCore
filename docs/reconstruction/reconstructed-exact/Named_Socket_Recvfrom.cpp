...
// PURPOSE (auto): Scaffold unit for Named_Socket_Recvfrom @ 0x00785070
// Stable ID: aa_00785070
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Socket::recvfrom"
 * Domain alias of FUN_00785070 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ Named_Socket_Recvfrom(SOCKET *param_1,uint16_t *param_2,char *param_3,int param_4,uint *param_5)
