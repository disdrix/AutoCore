// =============================================================================
// Named_CalleeOf_CVOGTerrain_LoadMapImage_004a8960
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from CVOGTerrain_LoadMapImage: config/load helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_CVOGTerrain_LoadMapImage_004a8960(int param_1,int param_2)
