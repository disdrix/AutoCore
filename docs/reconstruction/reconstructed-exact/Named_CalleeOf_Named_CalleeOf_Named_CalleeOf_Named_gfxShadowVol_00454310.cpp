// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVol_00454310
// -----------------------------------------------------------------------------
// Stable ID: aa_00454310
// Callee of Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVolume
// Address:   0x00454310  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004529c0×2, FUN_00452a50×2, FUN_00401a40, FUN_00454310, FUN_00455570, _CxxThrowException.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxShadowVol_00454310(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ param_4)
...

{
  ...
  piVar3 = (int *)FUN_00455570(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4),param_1,*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  do {
    ...
    if (cVar1 != '\0') {
      ...
      *(uint8_t *)(*(int *)(*(int *)(unaff_EDI + 4) + 4) + 0x80) = 1;
...
LAB_004543f0:
        ...
        *(uint8_t *)(*piVar4 + 0x80) = 1;

        *(uint8_t *)(piVar5 + 0x20) = 1;

        *(uint8_t *)(*(int *)(*piVar4 + 4) + 0x80) = 0;
        ...
        if (piVar6 == (int *)piVar2[2]) {
          ...
          FUN_004529c0(unaff_EDI);

          piVar6 = piVar2;

        }

        *(uint8_t *)(piVar6[1] + 0x80) = 1;

        *(uint8_t *)(*(int *)(piVar6[1] + 4) + 0x80) = 0;

        FUN_00452a50(unaff_EDI);
      ...
      if ((char)piVar5[0x20] == '\0') goto LAB_004543f0;
