...
// Address:   0x00620ff0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00620ff0 @ 0x00620ff0
// Stable ID: aa_00620ff0
...
//  - Control keywords: if×19, return×6, goto×6.
//  - Notable callees: strncmp×8, CONCAT22×4, FUN_004f1e20×2, FUN_00552950×2, CONCAT31, FUN_00404d70, FUN_004eb010, FUN_005781a0.
//  - Strings: "max_hp"; "ls1."; "ls2."; "ls3.".
//  - Return sites: 6.
...

{
  ...
  if ((((cVar1 != 'c') || (pcVar7[1] != 's')) && ((cVar1 != 'm' || (pcVar7[1] != 's')))) ||
     ...
     (iVar3 = FUN_00404d70(*(uint32_t /* width from decompiler */ *)(param_1 + 0x14c)), iVar3 == 0)) goto LAB_0062131e;
