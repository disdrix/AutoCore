// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_anmTrackMast_0044c560
// -----------------------------------------------------------------------------
// Stable ID: aa_0044c560
// Callee of Named_CalleeOf_Named_CalleeOf_Named_anmTrackMaster_inl
// Address:   0x0044c560  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004014f0×2, FUN_0040e880×2, FUN_00401a40, FUN_0044c560, FUN_0045d740, _CxxThrowException.
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_anmTrackMast_0044c560(uint32_t /* width from decompiler */ *param_1,char param_2,uint32_t /* width from decompiler */ *param_3)
...

{
  ...
  piVar3 = (int *)FUN_0045d740(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4),param_3,*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  if (param_3 == *(uint32_t /* width from decompiler */ **)(unaff_EDI + 4)) {
    ...
    **(uint32_t /* width from decompiler */ **)(unaff_EDI + 4) = piVar3;
    ...
    if (param_3 != *(uint32_t /* width from decompiler */ **)(iVar4 + 8)) goto LAB_0044c612;
...
LAB_0044c637:
      ...
      if ((char)piVar6[8] == '\0') goto LAB_0044c637;
