// =============================================================================
// Named_CalleeOf_Client_NotifyActiveMissionChanged_0040b020
// -----------------------------------------------------------------------------
...
//  - Notable callees: EnterCriticalSection×2, LeaveCriticalSection×2, FUN_0040b020, InterlockedDecrement.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Client_NotifyActiveMissionChanged_0040b020(int param_1)
