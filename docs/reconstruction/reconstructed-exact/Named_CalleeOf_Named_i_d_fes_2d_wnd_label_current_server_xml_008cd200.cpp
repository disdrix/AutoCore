// =============================================================================
// Named_CalleeOf_Named_i_d_fes_2d_wnd_label_current_server_xml_008cd200
// -----------------------------------------------------------------------------
// Stable ID: aa_008cd200
// Callee of Named_i_d_fes_2d_wnd_label_current_server_xml
...
// PURPOSE (auto): Called from Named_i_d_fes_2d_wnd_label_current_server_xml: UI/dialog helper. Evidence string: "i_d_fes_2d_btn_character.xml". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Named_i_d_fes_2d_wnd_label_current_server_xml_008cd200(int *param_1)
