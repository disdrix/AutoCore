...
// Address:   0x004e2ae0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_004e2ae0 @ 0x004e2ae0
// Stable ID: aa_004e2ae0
...
//  - Notable callees: FUN_004e2ae0, _CxxThrowException, exception::exception.
...

{
  ...
  if (0xaaaaaaaU - *(int *)(param_1 + 8) < param_2) {
