// =============================================================================
// Named_CalleeOf_Named_assManager_0043c4f0
// -----------------------------------------------------------------------------
// Stable ID: aa_0043c4f0
// Callee of Named_assManager
// Address:   0x0043c4f0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: EnterCriticalSection, FUN_0043c4f0, FUN_0043c830, LeaveCriticalSection.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_assManager_0043c4f0(uint32_t /* width from decompiler */ param_1)
