// =============================================================================
// Named_CalleeOf_Skill_QueueDeferredCastId_0051c3b0
// -----------------------------------------------------------------------------
// Stable ID: aa_0051c3b0
// Callee of Skill_QueueDeferredCastId
// Address:   0x0051c3b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Skill_QueueDeferredCastId: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~63 non-empty decompiler lines.
//  - Control keywords: if×7, for×2, return×2.
//  - Notable callees: memmove×4, FUN_0051b5f0, FUN_0051c3b0.
//  - Return sites: 2.
...
void __thiscall Named_CalleeOf_Skill_QueueDeferredCastId_0051c3b0(int param_1,uint param_2)
