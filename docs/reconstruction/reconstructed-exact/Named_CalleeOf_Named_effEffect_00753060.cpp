// =============================================================================
// Named_CalleeOf_Named_effEffect_00753060
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_effEffect: callee helper. Evidence string: "Diffuse". Supports parent flow (not a free-standing entry point). Named_effEffect (+1 other named callers).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_effEffect_00753060(int param_1)
