...
uint32_t /* width from decompiler */ __thiscall Named_netSession_0067cde0(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,int param_4)
