// =============================================================================
// Named_CalleeOf_Client_OnBadCharacterLoginId_00937560
// -----------------------------------------------------------------------------
// Stable ID: aa_00937560
// Callee of Client_OnBadCharacterLoginId (+5 other named callers)
...
// PURPOSE (auto): Called from Client_OnBadCharacterLoginId: auth/session helper. Evidence string: "Attempting screen transition to bad screen %i.". Supports parent flow (not a free-standing entry point). Client_OnBadCharacterLoginId (+5 other named callers).
...
void Named_CalleeOf_Client_OnBadCharacterLoginId_00937560(int param_1)
