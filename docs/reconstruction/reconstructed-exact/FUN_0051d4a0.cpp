...
// PURPOSE (auto): Scaffold unit for FUN_0051d4a0 @ 0x0051d4a0
// Stable ID: aa_0051d4a0
...
void __thiscall FUN_0051d4a0(int param_1,int param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
