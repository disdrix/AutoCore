...
// PURPOSE (auto): Scaffold unit for FUN_00752460 @ 0x00752460
// Stable ID: aa_00752460
...
FUN_00752460(uint32_t /* width from decompiler */ param_1,int param_2,int param_3,uint32_t /* width from decompiler */ *param_4,int param_5)
