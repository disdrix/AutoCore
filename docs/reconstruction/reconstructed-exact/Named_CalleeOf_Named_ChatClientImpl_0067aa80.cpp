// =============================================================================
// Named_CalleeOf_Named_ChatClientImpl_0067aa80
// -----------------------------------------------------------------------------
// Stable ID: aa_0067aa80
// Callee of Named_ChatClientImpl
// Address:   0x0067aa80  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00680c80×3, FUN_0067aa80.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_ChatClientImpl_0067aa80(int param_1,int param_2,int param_3,int param_4)
