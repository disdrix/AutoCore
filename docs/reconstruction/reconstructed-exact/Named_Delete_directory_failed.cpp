...
// PURPOSE (auto): Scaffold unit for Named_Delete_directory_failed @ 0x0076ba10
// Stable ID: aa_0076ba10
...
//  - Notable callees: FUN_00416490×2, Named_Delete_directory_failed×2, _errno×2, _rmdir×2, CONCAT31, FUN_00431ae0, FUN_0076adc0, FUN_0076b080.
//  - Strings: "Delete file failed for: %s %d\n"; "Delete directory failed for: %s %d\n".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Delete directory failed for: %s %d
"
 * Domain alias of FUN_0076ba10 (FUN_* retained)
 *
...
bool Named_Delete_directory_failed(char *param_1,uint32_t /* width from decompiler */ param_2)
  ...
  if (local_6c != local_68) {
    ...
    do {
      ...
      if (cVar1 == '\0') {
        ...
        cVar1 = Named_Delete_directory_failed(ppppiVar4,param_2);
