// =============================================================================
// Named_CalleeOf_CVOGCombat_OnDeathAwardKillXp_004d2750
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from CVOGCombat_OnDeathAwardKillXp: combat/reward helper. Evidence string: "allocatenewobjectfromcbid failed %d". Supports parent flow (not a free-standing entry point).
...
void __thiscall Named_CalleeOf_CVOGCombat_OnDeathAwardKillXp_004d2750(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,int param_4,int param_5)
