...
// FUN_0045d4d0
// -----------------------------------------------------------------------------
// Stable ID: aa_0045d4d0
// Address:   0x0045d4d0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0045d4d0 @ 0x0045d4d0
// Stable ID: aa_0045d4d0
...
//  - Notable callees: FUN_0045f470×4, FUN_0045f240×2, FUN_004540b0, FUN_0045d4d0, FUN_0045efc0, FUN_0045f000.
//  - Return sites: 3.
...
void __fastcall FUN_0045d4d0(uint param_1,int param_2,int param_3)
...

{
  ...
  if (param_1 != 0) {
    ...
    if ((uint)(*(int *)(param_2 + 8) - param_3 >> 5) < param_1) {
      ...
      *(int *)(param_2 + 8) = *(int *)(param_2 + 8) + param_1 * 0x20;

    }

    else {

      uVar5 = FUN_0045f470(param_3);
