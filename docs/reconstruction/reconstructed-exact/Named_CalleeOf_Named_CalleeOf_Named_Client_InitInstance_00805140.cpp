// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance_00805140
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_Client_InitInstance: callee helper. Evidence string: "WARNING: lgLcdInit failed\n". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_0048a083, FUN_007a4480, FUN_00805140, FUN_00805460, InterlockedDecrement, InterlockedIncrement.
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance_00805140(void)
