// =============================================================================
// Named_CalleeOf_Named_netSession_0067ffb0
// -----------------------------------------------------------------------------
// Stable ID: aa_0067ffb0
// Callee of Named_netSession (+1 other named callers)
// Address:   0x0067ffb0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0067f930, FUN_0067ffb0.
//  - Return sites: 2.
...
void __thiscall Named_CalleeOf_Named_netSession_0067ffb0(int param_1,uint32_t /* width from decompiler */ *param_2)
...

{
  ...
  FUN_0067f930(*(uint32_t /* width from decompiler */ *)(param_1 + 8),1,param_2);
