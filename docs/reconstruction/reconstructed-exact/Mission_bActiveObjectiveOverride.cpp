...
// =============================================================================
// Mission_bActiveObjectiveOverride
// -----------------------------------------------------------------------------
// Purpose:  String-driven human alias for decompiled bulk unit.
//           Primary evidence: "bActiveObjectiveOverride"
//           Named entry point for reconstruction indexing / coverage ledger.
//           Behavior preserved from FUN_007c0350 clean capture (not modernized).
//
...
//           docs/reconstruction/raw/aa_007c0350_*.md
//           Original Ghidra symbol: FUN_007c0350
//
// Exactness: Body mirrors reconstructed-exact/FUN_007c0350*.cpp when present.
...
/*
 * Behavioral notes:
 * String-driven human alias evidence: "bActiveObjectiveOverride"
 *
...
uint32_t /* width from decompiler */ __thiscall Mission_bActiveObjectiveOverride(char *param_1,int *param_2)
