...
// Address:   0x008fda30  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_008fda30 @ 0x008fda30
// Stable ID: aa_008fda30
...
//  - Notable callees: FUN_00834470, FUN_008fda30, __RTDynamicCast.
//  - Return sites: 2.
...
LAB_008fdadd:
  ...
  if (*(int *)(in_EAX + 0x730) != 0) {
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)(in_EAX + 0x530);
