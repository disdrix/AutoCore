// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Auth_Setup_of_CNDAuthClient_faile_00417340
// -----------------------------------------------------------------------------
// Stable ID: aa_00417340
// Callee of Named_CalleeOf_Auth_Setup_of_CNDAuthClient_failed
// Address:   0x00417340  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00417320×2, FUN_004175f0×2, FUN_004176b0×2, FUN_00417340, FUN_00418130, FUN_00443360, FUN_004433e0, FUN_0045c230.
//  - Return sites: 3.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Auth_Setup_of_CNDAuthClient_faile_00417340(int param_1,int param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
...

{
  ...
  if (param_3 != 0) {
    ...
    puVar2 = &stack0xffffffac;

    if (0xcccccccU - iVar3 < param_3) {
    ...
    if (uVar7 < iVar3 + uVar6) {
      ...
      local_20 = FUN_004175f0(*(uint32_t /* width from decompiler */ *)(param_1 + 4),param_2);

      local_20 = FUN_00417320(&local_48);
      ...
      *(void **)(param_1 + 8) = (void *)((int)local_1c + (param_3 + iVar4) * 0x14);
    ...
    if ((uint)((iVar4 - param_2) / 0x14) < uVar6) {

      local_18 = uVar6 * 0x14;

      FUN_004176b0(param_2,local_18 + param_2,param_1,local_2c);

      local_8 = 2;

      FUN_00417320(&local_48);
      ...
      *(int *)(param_1 + 8) = *(int *)(param_1 + 8) + local_18;
      ...
      local_28 = iVar4 + uVar6 * -0x14;

      uVar5 = FUN_004176b0(local_28,iVar4,param_1,local_30);
