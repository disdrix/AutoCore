...
// FUN_00458a30
// -----------------------------------------------------------------------------
// Stable ID: aa_00458a30
// Address:   0x00458a30  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00458a30 @ 0x00458a30
// Stable ID: aa_00458a30
...
uint32_t /* width from decompiler */ __thiscall FUN_00458a30(int *param_1,int param_2)
...

{
  ...
  if ((local_4c == 0x5042414d) || (local_4c == 0x5452414b)) {
    ...
    if ((0 < param_2) && (iVar1 = FUN_0045d810(), iVar1 == 0)) {
