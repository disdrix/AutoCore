...
// =============================================================================
// Client_ConfirmEquipOrCustomizeItem
// -----------------------------------------------------------------------------
// Purpose:  Equip/customize gate: inventory space, town-only, permanent-customize confirm dialog.
//
// Address:  0x00941b20  (autoassault.exe, image base 0x400000)
// Stable:   aa_00941b20
// System:   inventory-transfer
//
// String evidence: "There is not enough space in your inventory..." / permanent customize warn
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_00941b20.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_00941b20 using string evidence: "There is not enough space in your inventory..." / permanent customize warn
 * - Remaining FUN_* / DAT_* identifiers are unresolved pending type recovery.
 * - Runtime / differential verification: OPEN unless matrix says otherwise.
 */

uint32_t /* width from decompiler */ Client_ConfirmEquipOrCustomizeItem(int *param_1,uint32_t /* width from decompiler */ param_2,char param_3)
