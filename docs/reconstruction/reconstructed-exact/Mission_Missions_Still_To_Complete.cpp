...
// =============================================================================
// Mission_Missions_Still_To_Complete
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ Mission_Missions_Still_To_Complete(uint32_t /* width from decompiler */ param_1,char *param_2)
