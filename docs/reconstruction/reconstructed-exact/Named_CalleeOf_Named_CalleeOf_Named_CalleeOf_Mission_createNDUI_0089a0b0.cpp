// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_createNDUI_0089a0b0
// -----------------------------------------------------------------------------
// Stable ID: aa_0089a0b0
// Callee of Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs
// Address:   0x0089a0b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_createNDUI_0089a0b0(int param_1)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x5d0) = 0xffffffff;

  *(uint32_t /* width from decompiler */ *)(param_1 + 0x5d4) = 0xffffffff;

  *(uint32_t /* width from decompiler */ *)(param_1 + 0x5d8) = 0xffffffff;
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x5ec) = 0xffffffff;
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x52c) = 1;
