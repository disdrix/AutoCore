// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_gfxLightImplPoint_00465260
// -----------------------------------------------------------------------------
// Stable ID: aa_00465260
// Callee of Named_CalleeOf_Named_gfxLightImplPoint
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_gfxLightImplPoint: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_gfxLightImplPoint_00465260(uint32_t /* width from decompiler */ param_1,int param_2)
