// =============================================================================
// Named_CalleeOf_Named_SkyBoxParticles_0096ff50
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_SkyBoxParticles: callee helper. Evidence string: "Opaque". Supports parent flow (not a free-standing entry point).
...
int __thiscall Named_CalleeOf_Named_SkyBoxParticles_0096ff50(int *param_1,char *param_2)
