// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_004628e0
// -----------------------------------------------------------------------------
// Stable ID: aa_004628e0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxIndexBuff
// Address:   0x004628e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00462a60×2, FUN_004608a0, FUN_004628e0.
//  - Return sites: 3.
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_004628e0(uint32_t /* width from decompiler */ *param_1)
...

{
  ...
  if (bVar3) {
    ...
    if (param_1 == (uint32_t /* width from decompiler */ *)**(int **)(in_EAX + 4)) {
      ...
      puVar2 = (uint32_t /* width from decompiler */ *)FUN_00462a60(&param_1,1,unaff_EBX);
  ...
  if ((uint)param_1[3] < *unaff_EBX) {
    ...
    puVar2 = (uint32_t /* width from decompiler */ *)FUN_00462a60(&param_1,bVar3,unaff_EBX);
