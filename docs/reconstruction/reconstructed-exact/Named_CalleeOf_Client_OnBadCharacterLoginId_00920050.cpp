// =============================================================================
// Named_CalleeOf_Client_OnBadCharacterLoginId_00920050
// -----------------------------------------------------------------------------
// Stable ID: aa_00920050
// Callee of Client_OnBadCharacterLoginId (+3 other named callers)
...
// PURPOSE (auto): Called from Client_OnBadCharacterLoginId: auth/session helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Client_OnBadCharacterLoginId (+3 other named callers).
...
void Named_CalleeOf_Client_OnBadCharacterLoginId_00920050(void)
