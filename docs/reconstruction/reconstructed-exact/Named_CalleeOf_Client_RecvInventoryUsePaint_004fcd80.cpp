// =============================================================================
// Named_CalleeOf_Client_RecvInventoryUsePaint_004fcd80
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Client_RecvInventoryUsePaint: inventory/item helper. Evidence string: "black.dds". Supports parent flow (not a free-standing entry point).
...
void __fastcall Named_CalleeOf_Client_RecvInventoryUsePaint_004fcd80(int param_1)
