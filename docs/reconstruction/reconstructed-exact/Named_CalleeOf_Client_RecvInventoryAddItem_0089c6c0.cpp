// =============================================================================
// Named_CalleeOf_Client_RecvInventoryAddItem_0089c6c0
// -----------------------------------------------------------------------------
// Stable ID: aa_0089c6c0
// Callee of Client_RecvInventoryAddItem (+1 other named callers)
...
// PURPOSE (auto): Called from Client_RecvInventoryAddItem: inventory/item helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Client_RecvInventoryAddItem (+1 other named callers).
...
void Named_CalleeOf_Client_RecvInventoryAddItem_0089c6c0(char param_1)
