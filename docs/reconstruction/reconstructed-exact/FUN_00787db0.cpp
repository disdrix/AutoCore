...
// PURPOSE (auto): Scaffold unit for FUN_00787db0 @ 0x00787db0
// Stable ID: aa_00787db0
...
void __thiscall FUN_00787db0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,uint *param_3,char param_4)
