// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mis_008575e0
// -----------------------------------------------------------------------------
// Stable ID: aa_008575e0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_createNDUI
// Address:   0x008575e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0040e490×4, FUN_008575e0.
//  - Return sites: 2.
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mis_008575e0(void)
...

{
  ...
  if (unaff_EDI[0x197] != 0) {
    ...
    if (cVar1 == '\0') {
      ...
      puVar2 = (uint32_t /* width from decompiler */ *)FUN_0040e490(unaff_EDI + 0x194);
