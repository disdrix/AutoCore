// =============================================================================
// Named_CalleeOf_Mission_Received_Connect_Request_8x_0042e5b0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Mission_Received_Connect_Request_8x: mission/objective helper. Evidence string: "LogNetInterface". Supports parent flow (not a free-standing entry point). Mission_Received_Connect_Request_8x (+1 other named callers).
...
void Named_CalleeOf_Mission_Received_Connect_Request_8x_0042e5b0(uint32_t /* width from decompiler */ param_1,int param_2)
