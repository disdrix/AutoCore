// =============================================================================
// Named_CalleeOf_Named_Client_Constructor_00405560
// -----------------------------------------------------------------------------
// Stable ID: aa_00405560
// Callee of Named_Client_Constructor
// Address:   0x00405560  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00405560, FUN_004088f0.
//  - Return sites: 1.
...
int __fastcall Named_CalleeOf_Named_Client_Constructor_00405560(int param_1)
