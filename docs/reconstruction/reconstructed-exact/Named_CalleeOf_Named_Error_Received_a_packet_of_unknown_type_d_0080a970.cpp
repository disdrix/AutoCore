// =============================================================================
// Named_CalleeOf_Named_Error_Received_a_packet_of_unknown_type_d_0080a970
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_Error_Received_a_packet_of_unknown_type_d: packet/network helper. Evidence string: "has been registered". Supports parent flow (not a free-standing entry point).
...
//   - "Your level is insufficient to register a clan."
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~78 non-empty decompiler lines.
//  - Control keywords: if×4, goto×3, for×1, switch×1, do×1, return×1.
//  - Notable callees: FUN_007a6de0×5, FUN_007fdfb0×2, sprintf×2, FUN_007a69d0, FUN_007fca10, FUN_008073b0, FUN_0080a970.
...
void Named_CalleeOf_Named_Error_Received_a_packet_of_unknown_type_d_0080a970(int param_1)
