...
// =============================================================================
// Client_HandleConvoyInviteDeclined
// -----------------------------------------------------------------------------
// Purpose:  Client convoy invitation failure handler. Maps decline reason codes to localized strings (self-invite, full convoy, already in convoy, enemy, pending, busy, non-leader) and shows chat toasts.
//
...
//   - "Only the leader of the convoy can invite other members."
//   - "has declined your convoy invitation"
//
// Notable callees:
...
//   - sprintf
//
// Notes:    Social/auth-adjacent; reason enum at packet+0x14.
//
...
void Client_HandleConvoyInviteDeclined(void)
