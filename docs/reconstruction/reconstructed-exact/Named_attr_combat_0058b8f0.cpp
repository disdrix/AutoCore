...
/*
 * Behavioral notes:
 * String-driven rename evidence: "attr_combat"
 *
...
uint32_t /* width from decompiler */ Named_attr_combat_0058b8f0(int param_1,char *param_2,char *param_3,float param_4)
