...
// PURPOSE (auto): Scaffold unit for FUN_005e0cd0 @ 0x005e0cd0
// Stable ID: aa_005e0cd0
...
FUN_005e0cd0(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,int param_4,int param_5,int param_6)
