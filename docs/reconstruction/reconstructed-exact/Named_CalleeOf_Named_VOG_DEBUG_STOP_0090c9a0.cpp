...
// PURPOSE (auto): Called from Named_VOG_DEBUG_STOP: callee helper. Evidence string: "i_d_a_2d_btn_achievement.xml". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Named_VOG_DEBUG_STOP_0090c9a0(void)
