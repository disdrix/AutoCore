...
// PURPOSE (auto): Scaffold unit for FUN_0075e9f0 @ 0x0075e9f0
// Stable ID: aa_0075e9f0
...
FUN_0075e9f0(uint32_t /* width from decompiler */ *param_1,int param_2,int param_3,int param_4,uint32_t /* width from decompiler */ param_5,int param_6)
