// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Auth_No_authentication_key_005a1f50
// -----------------------------------------------------------------------------
// Stable ID: aa_005a1f50
// Callee of Named_CalleeOf_Auth_No_authentication_key (+1 other named callers)
...
// PURPOSE (auto): Called from Named_CalleeOf_Auth_No_authentication_key: input/binding helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_CalleeOf_Auth_No_authentication_key (+1 other named callers).
...
Named_CalleeOf_Named_CalleeOf_Auth_No_authentication_key_005a1f50(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4,
