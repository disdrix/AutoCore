...
// PURPOSE (auto): Scaffold unit for FUN_00955eb0 @ 0x00955eb0
// Stable ID: aa_00955eb0
// Embedded strings (evidence for future rename):
//   - "C(%d) T(%d) COID(%I64d) UName(%s) Name(%s) F(%d) T(%d) I(%d) Fx(%d)\n"
//   - "Distance: %0.2f, Pos: %0.2f %0.2f %0.2f\n"
//   - "AI: State(%d)\n"
//   - "AI: State(%d) SkillsInState(%d)\n"
//   - "Skill:(%d) Level(%d)"
//   - "Owner(%d) COID(%I64d) UName(%s) Name(%s) F(%d) T(%d) FX(%d)\n"
...
uint32_t /* width from decompiler */ __thiscall FUN_00955eb0(int param_1,uint32_t /* width from decompiler */ param_2,char *param_3)
