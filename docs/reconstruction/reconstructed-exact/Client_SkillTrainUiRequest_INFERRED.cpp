...
//  - Control keywords: if×20, return×6, goto×3, do×2, for×1, while×1.
//  - Notable callees: FUN_007fdfb0×3, CNDHash_LookupByKey×2, CVOGCharacter_SetQuickBarSkill, Client_MaybeShowFirstTimeTip, Client_SendSectorPacket, Client_SkillTrainUiRequest_INFERRED, EMSG_Sector_QuickBarUpdate, EMSG_Sector_SkillIncrement.
//  - Strings: "That skill is unavailable!"; "You do not have enough skill points to train in this skill!"; "You are not a high enough level to train in this skill!"; "You cannot train any further in this skill!".
//  - Return sites: 6.
...
// Address:   0x00897170  (autoassault.exe, image base 0x400000)
...
{
    (void)pUi; (void)skillId;
    /* train gates → optional QB auto-slot → send 0x2062/0x2059 - see raw */
}
...

{
  ...
  uint32_t /* decomp width */ uStack_10;
