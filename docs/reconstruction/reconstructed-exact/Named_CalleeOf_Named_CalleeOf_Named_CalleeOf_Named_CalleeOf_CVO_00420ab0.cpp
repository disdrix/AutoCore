// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO_00420ab0
// -----------------------------------------------------------------------------
// Stable ID: aa_00420ab0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGReaction_GiveI
// Address:   0x00420ab0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0043fae0×2, FUN_004cb2e0×2, FUN_005dd920×2, CONCAT44, FUN_0041d5a0, FUN_00420ab0, FUN_00422000, FUN_004540b0.
//  - Return sites: 4.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO_00420ab0(int param_1,int param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
...

{
  ...
  if (param_3 != 0) {
    ...
    if ((uint)(iVar7 - param_2 >> 4) < param_3) {
      ...
      FUN_0043fae0(param_2,iVar7,param_3 * 0x10 + param_2);
    ...
    iVar3 = iVar7 + param_3 * -0x10;

    uVar6 = FUN_0043fae0(iVar3,iVar7,iVar7);

    *(uint32_t /* width from decompiler */ *)(param_1 + 8) = uVar6;

    FUN_00422000(param_2,iVar3,iVar7);

    FUN_004cb2e0(param_2,param_3 * 0x10 + param_2,&local_24);
