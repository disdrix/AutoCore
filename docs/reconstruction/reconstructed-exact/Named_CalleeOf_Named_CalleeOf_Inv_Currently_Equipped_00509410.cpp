// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Inv_Currently_Equipped_00509410
// -----------------------------------------------------------------------------
// Stable ID: aa_00509410
// Callee of Named_CalleeOf_Inv_Currently_Equipped
...
// PURPOSE (auto): Called from Named_CalleeOf_Inv_Currently_Equipped: callee helper. Evidence string: "CVOGLootGenerator::GetTypeFromIDPrefix() passed an invalid prefix (%d), couldn\'t find typ". Supports parent flow (not a free-standing entry point).
...
uint8_t * Named_CalleeOf_Named_CalleeOf_Inv_Currently_Equipped_00509410(int param_1)
