// =============================================================================
// Named_CalleeOf_Skill_Skill_d_had_no_skill_elements_it_won_t_wor_0054e9a0
// -----------------------------------------------------------------------------
// Stable ID: aa_0054e9a0
// Callee of Skill_Skill_d_had_no_skill_elements_it_won_t_work
// Address:   0x0054e9a0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0054da10×2, FUN_0054d5c0, FUN_0054e9a0.
//  - Return sites: 3.
...
void __thiscall Named_CalleeOf_Skill_Skill_d_had_no_skill_elements_it_won_t_wor_0054e9a0(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3)
...

{
  ...
  if (bVar2) {
    ...
    if (puVar5 == (uint32_t /* width from decompiler */ *)**(int **)(param_1 + 4)) {
      ...
      puVar5 = (uint32_t /* width from decompiler */ *)FUN_0054da10(&param_3,1,puVar5,piVar3);
  ...
  if (param_3[3] < *piVar3) {
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)FUN_0054da10(&param_3,bVar2,puVar5,piVar3);
