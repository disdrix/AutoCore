...
// PURPOSE (auto): Scaffold unit for FUN_004c25b0 @ 0x004c25b0
// Stable ID: aa_004c25b0
...
FUN_004c25b0(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,int param_4,int param_5)
