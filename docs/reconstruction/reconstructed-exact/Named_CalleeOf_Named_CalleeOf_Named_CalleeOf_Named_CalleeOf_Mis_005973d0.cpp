// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mis_005973d0
// -----------------------------------------------------------------------------
// Stable ID: aa_005973d0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_Uses_Clien
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_Uses_Clien: mission/objective helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mis_005973d0(int param_1,int param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
