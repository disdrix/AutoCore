// =============================================================================
// Named_CalleeOf_Skill_i_d_skilltrainer_xml_008943c0
// -----------------------------------------------------------------------------
// Stable ID: aa_008943c0
// Callee of Skill_i_d_skilltrainer_xml
// Address:   0x008943c0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Skill_i_d_skilltrainer_xml: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~27 non-empty decompiler lines.
//  - Control keywords: if×1, return×1.
//  - Notable callees: FUN_008943c0.
//  - Return sites: 1.
...
void __fastcall Named_CalleeOf_Skill_i_d_skilltrainer_xml_008943c0(int param_1)
