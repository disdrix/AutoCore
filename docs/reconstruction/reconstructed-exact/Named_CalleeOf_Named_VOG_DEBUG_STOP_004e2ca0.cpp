// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_004e2ca0
// -----------------------------------------------------------------------------
// Stable ID: aa_004e2ca0
// Callee of Named_VOG_DEBUG_STOP (+1 other named callers)
// Address:   0x004e2ca0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00537d30×3, FUN_004e2ca0.
//  - Return sites: 3.
...
int __thiscall Named_CalleeOf_Named_VOG_DEBUG_STOP_004e2ca0(int param_1,int param_2)
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      *(uint32_t /* width from decompiler */ *)(param_1 + 4) = *(uint32_t /* width from decompiler */ *)(iVar3 + 0xc);
