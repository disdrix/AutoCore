// =============================================================================
// Mission_q_tab_convoy
// -----------------------------------------------------------------------------
// Stable ID: aa_008a5fe0
// Address:   0x008a5fe0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for Mission_q_tab_convoy @ 0x008a5fe0
// Stable ID: aa_008a5fe0
// Embedded strings (evidence for future rename):
//   - "i_d_q_2d_btn_set_active.xml"
//   - "i_d_q_2d_btn_set_active_all.xml"
//   - "i_d_q_2d_btn_abandon.xml"
//   - "i_d_q_2d_wnd_tab_self.xml"
//   - "i_d_q_2d_wnd_tab_shared.xml"
//   - "i_d_q_2d_wnd_tab_convoy.xml"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~697 non-empty decompiler lines.
//  - Control keywords: if×41, do×2, while×2, goto×1, return×1.
//  - Notable callees: FUN_007b5dd0×7, FUN_0079c860×4, FUN_008a27e0×3, FUN_0078f890×2, FUN_008a3510×2, CNDHash_LookupByKey, CVOGCharacter_WeaponAllowsKillXpBonus, FUN_00574730.
//  - Strings: "i_d_q_2d_btn_set_active.xml"; "i_d_q_2d_btn_set_active_all.xml"; "i_d_q_2d_btn_abandon.xml"; "i_d_q_2d_wnd_tab_self.xml".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "i_d_q_2d_wnd_tab_convoy.xml"
 * Domain alias of FUN_008a5fe0 (FUN_* retained)
 *
...
void __fastcall Mission_q_tab_convoy(int *param_1)
...

{
  ...
  uint32_t /* width from decompiler */ uStack_2d8;
  ...
  uint32_t /* width from decompiler */ *puStack_2a8;

  uint32_t /* width from decompiler */ ***pppuStack_2a4;
  ...
  uint32_t /* width from decompiler */ *puStack_294;

  uint32_t /* width from decompiler */ *puStack_290;

  uint32_t /* width from decompiler */ uStack_28c;

  uint32_t /* width from decompiler */ **ppuStack_288;

  uint32_t /* width from decompiler */ uStack_284;

  uint32_t /* width from decompiler */ **ppuStack_280;

  uint32_t /* width from decompiler */ **ppuStack_27c;

  uint32_t /* width from decompiler */ uStack_278;

  int iStack_274;

  uint32_t /* width from decompiler */ ***pppuStack_270;

  uint32_t /* width from decompiler */ uStack_26c;

  uint32_t /* width from decompiler */ uStack_268;

  uint32_t /* width from decompiler */ *puStack_264;

  uint32_t /* width from decompiler */ **ppuStack_260;
  ...
  uint32_t /* width from decompiler */ *puStack_250;

  uint32_t /* width from decompiler */ *puStack_24c;

  uint32_t /* width from decompiler */ uStack_248;

  uint32_t /* width from decompiler */ *puStack_244;
  ...
  uint32_t /* width from decompiler */ *puStack_22c;

  uint32_t /* width from decompiler */ uStack_228;

  uint32_t /* width from decompiler */ uStack_224;

  uint32_t /* width from decompiler */ ***pppuStack_220;
  ...
  uint32_t /* width from decompiler */ ***pppuStack_204;

  uint32_t /* width from decompiler */ *puStack_200;
  ...
  uint32_t /* width from decompiler */ ***pppuStack_1e8;
  ...
  uint32_t /* width from decompiler */ ***pppuStack_1cc;
  ...
  uint32_t /* width from decompiler */ *puStack_1bc;

  uint32_t /* width from decompiler */ uStack_1b8;

  uint32_t /* width from decompiler */ uStack_1b4;

  uint32_t /* width from decompiler */ **ppuStack_1b0;
  ...
  if (cVar1 == '\0') {
    ...
    puStack_190 = (uint32_t /* width from decompiler */ *)0x8a67c3;
  ...
  if ((DAT_00d1b6d8 == 0) || (*(int *)(DAT_00d1b6d8 + 0xcb0) == 0)) {
    ...
    *(uint8_t *)(param_1 + 0x14a) = 0;
    ...
    puStack_194 = (uint32_t /* width from decompiler */ *)0x8a689a;

    puVar7 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)*piVar3 + 0x120))();
    ...
    ppuStack_1b0 = (uint32_t /* width from decompiler */ **)0x8a68e6;

    puStack_194 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)param_1[0x156] + 0x120))();

    puStack_194 = (uint32_t /* width from decompiler */ *)*puStack_194;

    ppuStack_1b0 = &puStack_194;

    uStack_1b4 = 0x8a6903;

    puStack_190 = (uint32_t /* width from decompiler */ *)(iVar4 + iVar9);
    ...
    pppuStack_1cc = (uint32_t /* width from decompiler */ ***)0x8a6936;

    puVar7 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)param_1[0x15a] + 0x120))();

    ppuStack_1b0 = (uint32_t /* width from decompiler */ **)*puVar7;
    ...
    pppuStack_1e8 = (uint32_t /* width from decompiler */ ***)0x8a6986;

    puVar7 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)param_1[0x15b] + 0x120))();

    pppuStack_1cc = (uint32_t /* width from decompiler */ ***)*puVar7;

    pppuStack_1e8 = &pppuStack_1cc;

    uStack_1ec = 0x8a69a3;

    puStack_1c8 = (uint32_t /* width from decompiler */ *)(iVar4 + iVar9);
    ...
    pppuStack_204 = (uint32_t /* width from decompiler */ ***)0x8a69d6;

    puVar7 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)param_1[0x15c] + 0x120))();

    pppuStack_1e8 = (uint32_t /* width from decompiler */ ***)*puVar7;

    pppuStack_204 = &pppuStack_1e8;

    uStack_208 = 0x8a69f3;

    puStack_1e4 = (uint32_t /* width from decompiler */ *)(iVar4 + iVar9);
    ...
    pppuStack_220 = (uint32_t /* width from decompiler */ ***)0x8a6a26;

    puVar7 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)param_1[0x15d] + 0x120))();

    pppuStack_204 = (uint32_t /* width from decompiler */ ***)*puVar7;

    pppuStack_220 = &pppuStack_204;

    uStack_224 = 0x8a6a43;

    puStack_200 = (uint32_t /* width from decompiler */ *)(iVar4 + iVar9);
    ...
    pppuStack_23c = (uint32_t /* width from decompiler */ ***)0x8a6a76;

    puVar7 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)param_1[0x15e] + 0x120))();

    pppuStack_220 = (uint32_t /* width from decompiler */ ***)*puVar7;

    pppuStack_23c = &pppuStack_220;

    uStack_240 = 0x8a6a93;

    puStack_21c = (uint32_t /* width from decompiler */ *)(iVar4 + iVar9);
    ...
    puStack_250 = (uint32_t /* width from decompiler */ *)0x8a6ac2;

    puVar7 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)param_1[0x15c] + 0x140))();
    ...
    puStack_264 = (uint32_t /* width from decompiler */ *)0x8a6b1a;

    puVar7 = (uint32_t /* width from decompiler */ *)(**(code **)(**(int **)(param_1[0x15c] + 0x944) + 0x140))();
    ...
    puStack_244 = (uint32_t /* width from decompiler */ *)(iVar4 - iVar9);
    ...
    ppuStack_280 = (uint32_t /* width from decompiler */ **)0x8a6b7c;

    puStack_264 = (uint32_t /* width from decompiler */ *)(**(code **)(**(int **)(param_1[0x15c] + 0x950) + 0x120))();

    puStack_264 = (uint32_t /* width from decompiler */ *)*puStack_264;

    ppuStack_280 = &puStack_264;

    uStack_284 = 0x8a6b9f;

    ppuStack_260 = (uint32_t /* width from decompiler */ **)(iVar4 - iVar9);
    ...
    *(int *)(param_1[0x15c] + 0x514) = *(int *)(param_1[0x15c] + 0x514) - iVar9;
    ...
    puStack_294 = (uint32_t /* width from decompiler */ *)0x8a6bda;

    puVar7 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)param_1[0x15d] + 0x140))();
    ...
    puStack_2a8 = (uint32_t /* width from decompiler */ *)0x8a6c26;

    puVar7 = (uint32_t /* width from decompiler */ *)(**(code **)(*(int *)param_1[0x15e] + 0x140))();
    ...
    ppuStack_288 = (uint32_t /* width from decompiler */ **)(iVar4 - iVar9);
