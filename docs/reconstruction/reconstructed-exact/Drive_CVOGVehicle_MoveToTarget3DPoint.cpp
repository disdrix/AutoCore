...
// =============================================================================
// Drive_CVOGVehicle_MoveToTarget3DPoint
// -----------------------------------------------------------------------------
...
//           bulk thr at +0x614; PushDriveAxes). UF-007: gate parenthesization vs
//           SetSteerInput three-load chain may differ — see UNRESOLVED_FINDINGS.
//
...
Drive_CVOGVehicle_MoveToTarget3DPoint(int param_1,float param_2,float param_3,uint32_t /* width from decompiler */ param_4,char param_5)
{
  float fVar1;
  float fVar2;
  float *pfVar3;
