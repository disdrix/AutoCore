// =============================================================================
// Named_CalleeOf_Mission_Look_in_your_Mission_Inventory_008a8040
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Mission_Look_in_your_Mission_Inventory: mission/objective helper. Evidence string: "Return to". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Mission_Look_in_your_Mission_Inventory_008a8040(uint32_t /* width from decompiler */ param_1)
