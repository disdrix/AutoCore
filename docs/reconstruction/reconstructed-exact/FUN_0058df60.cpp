...
// PURPOSE (auto): Scaffold unit for FUN_0058df60 @ 0x0058df60
// Stable ID: aa_0058df60
...
void __thiscall FUN_0058df60(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3,int *param_4)
