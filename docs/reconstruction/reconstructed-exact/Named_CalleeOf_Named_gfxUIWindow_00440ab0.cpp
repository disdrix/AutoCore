// =============================================================================
// Named_CalleeOf_Named_gfxUIWindow_00440ab0
// -----------------------------------------------------------------------------
...
void Named_CalleeOf_Named_gfxUIWindow_00440ab0(void *param_1)
...

{
  ...
  if (*(char *)((int)param_1 + 0x3d) == '\0') {
    ...
    Named_CalleeOf_Named_gfxUIWindow_00440ab0(*(uint32_t /* width from decompiler */ *)((int)param_1 + 8));
