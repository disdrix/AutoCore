// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Skill_DbLoadSkills_0041f740
// -----------------------------------------------------------------------------
// Stable ID: aa_0041f740
// Callee of Named_CalleeOf_Named_CalleeOf_Skill_DbLoadSkillsCharacters
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Skill_DbLoadSkillsCharacters: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Skill_DbLoadSkills_0041f740(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ *param_2,int param_3,int param_4,uint param_5)
