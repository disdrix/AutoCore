// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_VOGClient_0040ed60
// -----------------------------------------------------------------------------
// Stable ID: aa_0040ed60
// Callee of Named_CalleeOf_Named_VOGClient
// Address:   0x0040ed60  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0040f100×2, FUN_0040ed60, FUN_005a2850.
//  - Return sites: 3.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_VOGClient_0040ed60(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3)
...

{
  ...
  if (bVar2) {
    ...
    if (puVar5 == (uint32_t /* width from decompiler */ *)**(int **)(param_1 + 4)) {
      ...
      puVar5 = (uint32_t /* width from decompiler */ *)FUN_0040f100(&param_3,1,puVar5,piVar3);
  ...
  if (param_3[3] < *piVar3) {
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)FUN_0040f100(&param_3,bVar2,puVar5,piVar3);
