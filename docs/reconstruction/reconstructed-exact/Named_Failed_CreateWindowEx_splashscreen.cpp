// =============================================================================
// Named_Failed_CreateWindowEx_splashscreen
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_Failed_CreateWindowEx_splashscreen @ 0x00932af0
// Stable ID: aa_00932af0
...
//  - Notable callees: PeekMessageA×2, CreateWindowExA, DispatchMessageA, FUN_007a4480, Named_Failed_CreateWindowEx_splashscreen, GetDesktopWindow, GetStockObject, GetWindowRect.
//  - Strings: "XutoAssaultSplash"; "Auto Assault"; "Failed to CreateWindowEx for splashscreen!".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Failed to CreateWindowEx for splashscreen!"
 * Domain alias of FUN_00932af0 (FUN_* retained)
 *
...
void Named_Failed_CreateWindowEx_splashscreen(void)
