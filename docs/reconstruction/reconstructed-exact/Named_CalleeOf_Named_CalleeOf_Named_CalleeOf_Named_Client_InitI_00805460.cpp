// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_Client_InitI_00805460
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance: callee helper. Evidence string: "CLCDManager::Initialize(): failed to initialize graphics component.\n". Supports parent flow (not a free-standing entry point).
...
int __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_Client_InitI_00805460(int *param_1)
