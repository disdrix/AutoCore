// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_Error_Receiv_0090ed80
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Named_Error_Received_a_packet_of: packet/network helper. Evidence string: "allocatenewobjectfromcbid failed %d Get a programmer". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: CVOGReaction_GiveItemByCbid×4, Vehicle_AttachWeapon×2, FUN_004f8ce0, FUN_004faaf0, FUN_004fab40, FUN_004fd970, FUN_007a4480, FUN_0090ed80.
...
int __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_Error_Receiv_0090ed80(int param_1,int param_2)
