// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO_0041bd60
// -----------------------------------------------------------------------------
// Stable ID: aa_0041bd60
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGHBAIDriver_DoL
// Address:   0x0041bd60  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0041da90×2, FUN_0041dae0×2, FUN_00401a40, FUN_0041bd60, FUN_0041db40, _CxxThrowException.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO_0041bd60(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ param_4)
...

{
  ...
  piVar3 = (int *)FUN_0041db40(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4),param_1,*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  do {
    ...
    if (cVar1 != '\0') {
      ...
      *(uint8_t *)(*(int *)(*(int *)(unaff_EDI + 4) + 4) + 100) = 1;
...
LAB_0041be3a:
        ...
        *(uint8_t *)(*piVar4 + 100) = 1;

        *(uint8_t *)(piVar5 + 0x19) = 1;

        *(uint8_t *)(*(int *)(*piVar4 + 4) + 100) = 0;
        ...
        *(uint8_t *)(piVar6[1] + 100) = 1;

        *(uint8_t *)(*(int *)(piVar6[1] + 4) + 100) = 0;

        FUN_0041dae0(*(uint32_t /* width from decompiler */ *)(piVar6[1] + 4));
      ...
      *(uint8_t *)(*(int *)(piVar6[1] + 4) + 100) = 0;
      ...
      FUN_0041da90(*(uint32_t /* width from decompiler */ *)(piVar6[1] + 4));
