// =============================================================================
// Named_ignore_name_to_ignore_someone_0094d700
// -----------------------------------------------------------------------------
// Stable ID: aa_0094d700
// Address:   0x0094d700  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for Named_ignore_name_to_ignore_someone_0094d700 @ 0x0094d700
// Stable ID: aa_0094d700
...
//  - Control keywords: if×11, return×7, do×5, while×5, goto×2, for×1.
//  - Notable callees: FUN_00573af0×2, FUN_008073b0, FUN_008f8200, FUN_0094c630, Named_ignore_name_to_ignore_someone_0094d700, _stricmp.
//  - Strings: "No matter how hard you try, you cannot ignore yourself.".
//  - Return sites: 7.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Either select someone and type /ignore or type /ignore [name] to ignore someone."
 * Domain alias of FUN_0094d700 (FUN_* retained)
 *
...
void Named_ignore_name_to_ignore_someone_0094d700(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2)
...
LAB_0094d75e:
    ...
    if (pcVar2 == unaff_EBX + 1) goto LAB_0094d75e;
  ...
  if (pcVar2 != (char *)((int)&local_108 + 1)) {
    ...
    iVar4 = FUN_00573af0(&local_108);

    if (iVar4 != 0) {

      iVar4 = FUN_00573af0(&local_108);

      FUN_0094c630(*(uint32_t /* width from decompiler */ *)(iVar4 + 8),*(uint32_t /* width from decompiler */ *)(iVar4 + 0xc));
