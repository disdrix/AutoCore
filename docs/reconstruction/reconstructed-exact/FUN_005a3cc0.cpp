...
// FUN_005a3cc0
// -----------------------------------------------------------------------------
// Stable ID: aa_005a3cc0
// Address:   0x005a3cc0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_005a3cc0 @ 0x005a3cc0
// Stable ID: aa_005a3cc0
...
//  - Notable callees: FUN_006753b0×2, FUN_004e22d0, FUN_005a3810, FUN_005a3cc0, _CxxThrowException, exception::exception.
...
FUN_005a3cc0(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ *param_4,uint32_t /* width from decompiler */ param_5)
...

{
  ...
  piVar4 = (int *)FUN_005a3810(*(uint32_t /* width from decompiler */ *)(param_1 + 4),param_4,*(uint32_t /* width from decompiler */ *)(param_1 + 4),
...
LAB_005a3dc6:
      ...
      if ((char)piVar6[5] == '\0') goto LAB_005a3dc6;
