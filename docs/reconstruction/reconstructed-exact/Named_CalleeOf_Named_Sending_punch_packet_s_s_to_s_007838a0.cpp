// =============================================================================
// Named_CalleeOf_Named_Sending_punch_packet_s_s_to_s_007838a0
// -----------------------------------------------------------------------------
// Stable ID: aa_007838a0
// Callee of Named_Sending_punch_packet_s_s_to_s (+5 other named callers)
...
// PURPOSE (auto): Called from Named_Sending_punch_packet_s_s_to_s: packet/network helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_Sending_punch_packet_s_s_to_s (+5 other named callers).
...
void Named_CalleeOf_Named_Sending_punch_packet_s_s_to_s_007838a0(void)
