// READABILITY (auto CF):
//  - Body size: ~388 non-empty decompiler lines.
//  - Control keywords: if×20, return×10, for×5, do×4, while×4.
//  - Notable callees: CVOGTerrainChunk_GetCornerData×8, FUN_007464e0×4, FUN_00414bc0×2, FUN_00414c20×2, FUN_00746520×2, CVOGReaction_RandomUnitScalar, CVOGTerrainChunk_BuildVertexBuffer, FUN_004148e0.
//  - Return sites: 10.

// =============================================================================
// CVOGTerrainChunk_BuildVertexBuffer
// -----------------------------------------------------------------------------
// Stable ID: aa_005c01e0
// Address:   0x005c01e0  (autoassault.exe, image base 0x400000)
// System:    unknown
  ...
  if (param_3 == 1) {
    ...
    *(uint *)(param_1 + 0xbc) = *(uint *)(param_1 + 0xbc) | 1;
    ...
    if ((*(int *)(iVar4 + 0x10) == 0) ||
       ...
       (pfVar5 = (float *)FUN_00746520(*(uint32_t /* width from decompiler */ *)(iVar4 + 0x14),*(uint32_t /* width from decompiler */ *)(iVar4 + 0x18),0
    ...
    *(uint32_t /* width from decompiler */ *)(param_1 + 0xac) = 4;
    ...
    uVar3 = *(uint32_t /* width from decompiler */ *)(param_2 + 0x50);
    ...
    *(uint32_t /* width from decompiler */ *)(param_1 + 0xac) = 4;
    ...
    uVar3 = *(uint32_t /* width from decompiler */ *)(param_2 + 0x4c);
