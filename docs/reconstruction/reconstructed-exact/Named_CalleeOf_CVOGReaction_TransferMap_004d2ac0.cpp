// =============================================================================
// Named_CalleeOf_CVOGReaction_TransferMap_004d2ac0
// -----------------------------------------------------------------------------
...
bool __thiscall Named_CalleeOf_CVOGReaction_TransferMap_004d2ac0(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,uint param_4)
