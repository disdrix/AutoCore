...
// PURPOSE (auto): Scaffold unit for Mission_tContinentExploredAreas @ 0x007dd5e0
// Stable ID: aa_007dd5e0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tContinentExploredAreas/row"
 * Domain alias of FUN_007dd5e0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __fastcall Mission_tContinentExploredAreas(char *param_1)
