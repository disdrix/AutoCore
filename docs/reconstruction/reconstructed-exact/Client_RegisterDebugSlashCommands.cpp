...
// =============================================================================
// Client_RegisterDebugSlashCommands
// -----------------------------------------------------------------------------
// Purpose:  Registers client debug slash commands (castskill, debugmissions, quickbar, etc.).
//
// Address:  0x00959230  (autoassault.exe, image base 0x400000)
// Stable:   aa_00959230
// System:   missions-progression
//
// String evidence: "debugmissions" / "debugcompleteobjective" / "castskill" / "quickbar"
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_00959230.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_00959230 using string evidence: "debugmissions" / "debugcompleteobjective" / "castskill" / "quickbar"
