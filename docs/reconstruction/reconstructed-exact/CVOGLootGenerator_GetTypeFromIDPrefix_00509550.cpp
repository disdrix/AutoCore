// =============================================================================
// CVOGLootGenerator_GetTypeFromIDPrefix_00509550
// -----------------------------------------------------------------------------
// Stable ID: aa_00509550
// Address:   0x00509550  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for CVOGLootGenerator_GetTypeFromIDPrefix_00509550 @ 0x00509550
// Stable ID: aa_00509550
...
//  - Notable callees: CVOGLootGenerator::GetTypeFromIDPrefix, FUN_00508ac0, FUN_00508b10, FUN_00508b60, FUN_00508bb0, FUN_00508c00, FUN_00508c50, CVOGLootGenerator_GetTypeFromIDPrefix_00509550.
//  - Return sites: 7.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "CVOGLootGenerator::GetTypeFromIDPrefix() passed an invalid prefix (%d), couldn't find typ"
 * Domain alias of FUN_00509550 (FUN_* retained)
 *
...
uint8_t * CVOGLootGenerator_GetTypeFromIDPrefix_00509550(int param_1)
