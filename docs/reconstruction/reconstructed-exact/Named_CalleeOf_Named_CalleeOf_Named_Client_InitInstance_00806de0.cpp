// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance_00806de0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_Client_InitInstance: callee helper. Evidence string: "CLCDManager::Initialize(): failed to initialize graphics component.\n". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_00418700×6, FUN_00418790×6, LoadImageA×2, CLCDManager::Initialize, FUN_007a4480, FUN_00805900, FUN_00806de0.
//  - Return sites: 2.
...
int __fastcall Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance_00806de0(int *param_1)
