// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli_005bc3c0
// -----------------------------------------------------------------------------
// Stable ID: aa_005bc3c0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_Input_PollB
// Address:   0x005bc3c0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_Input_PollB: input/binding helper. Evidence string: "Emitter found at 0,0,0: %d %I64d". Supports parent flow (not a free-standing entry point).
// Embedded strings (evidence):
//   - "Emitter found at 0,0,0: %d %I64d"
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~686 non-empty decompiler lines.
//  - Control keywords: if×70, return×11, goto×3, do×2, while×2.
//  - Notable callees: FUN_004e88e0×4, FUN_005b83e0×4, CVOGReaction_RandomUnitScalar×3, FUN_004a6930×3, FUN_0040cf00×2, FUN_004ba6f0×2, FUN_005bb1d0×2, FUN_007a4480×2.
//  - Strings: "Emitter found at 0,0,0: %d %I64d".
//  - Return sites: 11.
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Cli_005bc3c0(int *param_1,float *param_2,int param_3,int param_4)
...

{
  ...
  *(int *)(DAT_00d17958 + 0x148) = *(int *)(DAT_00d17958 + 0x148) + 1;
  ...
  puVar10 = (uint32_t /* width from decompiler */ *)*param_1;

  if ((((puVar10 == (uint32_t /* width from decompiler */ *)0x0) ||

       (puVar9 = (uint32_t /* width from decompiler */ *)(**(code **)*puVar10)(), puVar9 != puVar10)) ||
    ...
    if (((*(byte *)(iVar8 + 0x90e) & 1) == 0) || ((*(byte *)((int)param_1 + 0x989) & 8) != 0)) {
      ...
      if (*(int **)(iVar8 + 0x914) == (int *)0x0) {
        ...
        if (iVar8 != 0) {
          ...
          puVar10 = (uint32_t /* width from decompiler */ *)FUN_004a6930(param_1 + 0x220);

          *(uint32_t /* width from decompiler */ *)(iVar8 + 0x2c) = *puVar10;

          *(uint32_t /* width from decompiler */ *)(iVar8 + 0x30) = puVar10[1];

          *(uint32_t /* width from decompiler */ *)(iVar8 + 0x34) = puVar10[2];
      ...
      if ((cVar7 != '\0') && (DAT_00b03e64 == '\0')) {
        ...
        if ((param_1[1] != 0) && (iVar8 = *(int *)(param_1[1] + 0x10), iVar8 != 0)) {
          ...
          uVar11 = *(uint32_t /* width from decompiler */ *)(iVar8 + 0x160);

          uVar14 = *(uint32_t /* width from decompiler */ *)(iVar8 + 0x164);

          uVar15 = *(uint32_t /* width from decompiler */ *)(*(int *)(iVar8 + 0xa8) + 0x34);
  ...
  if (((uint)piVar12[0x5f] >> 6 & 1) != 0) {
    ...
    if ((iVar8 == 0) || (*(int *)(iVar8 + 8) == 0)) {
      ...
      if (iVar5 != 0) {
        ...
        *(uint32_t /* width from decompiler */ *)(iVar5 + 0x2c) = *puVar10;

        *(uint32_t /* width from decompiler */ *)(iVar5 + 0x30) = puVar10[1];

        *(uint32_t /* width from decompiler */ *)(iVar5 + 0x34) = puVar10[2];
  ...
  *pfVar1 = fVar3 * *pfVar1;
  ...
  if (*(char *)((int)param_1 + 0x7fe) == '\0') {
    ...
    *pfVar1 = fVar18 * *pfVar1;
    ...
    FUN_005c4f00(*(uint32_t /* width from decompiler */ *)(param_1[2] + 0x914));
