...
// =============================================================================
// Mission_Client_HandleEndQuest
// -----------------------------------------------------------------------------
// Purpose:  Client end-quest / complete-mission reaction path. Tears down objective hash state, sends UI logic packets, plays mission-complete audio (Client_GetMissionCompleteAudioTable), and emits gen_end_quest debug/status strings.
//
...
//   - FUN_00538000 / FUN_00537d30 / FUN_00537f30
//   - FUN_004e2ca0 / FUN_004de9f0 / FUN_0052d8b0
//   - FUN_007a4480
//
// Notes:    __fastcall param_1 = mission/objective reaction context.
//
...
void __fastcall Mission_Client_HandleEndQuest(int param_1)
