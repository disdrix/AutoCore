// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_0041eab0
// -----------------------------------------------------------------------------
// Stable ID: aa_0041eab0
// Callee of Named_CalleeOf_Named_VOG_DEBUG_STOP (+1 other named callers)
// Address:   0x0041eab0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00401a40, FUN_0041eab0, _CxxThrowException.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_0041eab0(uint param_1,int param_2)
...

{
  ...
  if ((uint)((int)&DAT_00c0c0c0 - *(int *)(param_2 + 8)) < param_1) {
