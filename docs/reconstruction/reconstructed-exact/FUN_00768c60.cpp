...
// Address:   0x00768c60  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00768c60 @ 0x00768c60
// Stable ID: aa_00768c60
...
//  - Notable callees: vog_LogMessage×2, FUN_00435df0, FUN_00436250, FUN_00767600, FUN_00768c60, FUN_0076cec0, isspace.
//  - Strings: ");
    ...
    if (bVar3) {
      ...
      vog_LogMessage("; ",0x2a0,3,
                     ...
                     "; "Expected int16 but got \"%s\" in chunk \"%s\""; "C:\\vog\\1_code\\palantir\\arda2\\storage\\stoChunk.cpp".
//  - Return sites: 2.
...
//   - ",0x2a0,3,
                     ...
                     "
//   - "Expected int16 but got \"%s\" in chunk \"%s\""
...
LAB_00768cc5:
    ...
    if (bVar3) {
      ...
      *(uint32_t /* width from decompiler */ *)(unaff_EDI + 0x402c) = 0xffffffff;
      ...
      iVar4 = FUN_00767600(param_1,2,1);
...
LAB_00768d23:
  ...
  uVar5 = FUN_0076cec0(&param_1,"Expected int16 but got \"%s\" in chunk \"%s\"",local_40[0],iVar4);

  vog_LogMessage("C:\\vog\\1_code\\palantir\\arda2\\storage\\stoChunk.cpp",0x402,3,uVar5);
