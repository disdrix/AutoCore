...
// =============================================================================
// Client_SetAnnouncementLabelTextures
// -----------------------------------------------------------------------------
// Purpose:  Sets announce-window label textures (mission/level/item/medal .dds).
//
// Address:  0x0090b9c0  (autoassault.exe, image base 0x400000)
// Stable:   aa_0090b9c0
// System:   missions-progression
//
// String evidence: "i_d_announce_wnd_label_mission.dds" (+ level/item/medal)
//
// Exactness: Behavior-preserving rewrite of decompiler control flow (scaffold).
// Bit-for-bit vs retail EXE: DEFERRED.
// Source:    Prefer over FUN_0090b9c0.cpp; FUN_* left intact as raw scaffold twin.
// =============================================================================

/*
 * Behavioral notes:
 * - Renamed from FUN_0090b9c0 using string evidence: "i_d_announce_wnd_label_mission.dds" (+ level/item/medal)
