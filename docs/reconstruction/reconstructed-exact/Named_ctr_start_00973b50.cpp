...
/*
 * Behavioral notes:
 * String-driven rename evidence: "ctr_start"
 *
...
int Named_ctr_start_00973b50(int param_1,int param_2,int param_3,uint32_t /* width from decompiler */ param_4,uint32_t /* width from decompiler */ param_5)
