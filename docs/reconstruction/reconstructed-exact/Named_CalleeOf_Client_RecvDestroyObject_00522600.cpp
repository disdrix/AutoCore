// =============================================================================
// Named_CalleeOf_Client_RecvDestroyObject_00522600
// -----------------------------------------------------------------------------
// Stable ID: aa_00522600
// Callee of Client_RecvDestroyObject
...
// PURPOSE (auto): Called from Client_RecvDestroyObject: packet/network helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __thiscall Named_CalleeOf_Client_RecvDestroyObject_00522600(int param_1,int *param_2)
