// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_ShowLoginFa_00912b20
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Client_ShowLoginFailureDialog: auth/session helper. Evidence string: "allocatenewobjectfromcbid failed %d Get a programmer". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: CVOGReaction_GiveItemByCbid, FUN_00540350, FUN_007a4480, FUN_00912b20.
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_ShowLoginFa_00912b20(uint32_t /* width from decompiler */ param_1)
