// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_004eb4a0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_VOG_DEBUG_STOP: callee helper. Evidence string: "Unsupported shape". Supports parent flow (not a free-standing entry point). Named_CalleeOf_Named_VOG_DEBUG_STOP (+1 other named callers).
...
void Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_004eb4a0(int *param_1,float param_2,float param_3,float param_4,uint32_t /* width from decompiler */ param_5)
