// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_RecvInventoryEquip_004fdcb0
// -----------------------------------------------------------------------------
...
//  - Control keywords: if×12, while×3, return×3, do×2.
//  - Notable callees: CVOGReaction_ResolveSkillTargets×2, FUN_00411900×2, FUN_00509940×2, CONCAT22, FUN_00402c40, FUN_00404d70, FUN_004ce940, FUN_004fdcb0.
//  - Return sites: 3.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Client_RecvInventoryEquip_004fdcb0(int param_1,int *param_2)
