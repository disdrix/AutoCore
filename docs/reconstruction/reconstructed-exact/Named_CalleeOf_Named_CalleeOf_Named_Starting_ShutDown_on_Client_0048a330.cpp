// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Starting_ShutDown_on_Client_0048a330
// -----------------------------------------------------------------------------
// Stable ID: aa_0048a330
// Callee of Named_CalleeOf_Named_Starting_ShutDown_on_Client
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_Starting_ShutDown_on_Client: callee helper. Evidence string: "SetNotebookLEDSettings() - Enter". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_CalleeOf_Named_Starting_ShutDown_on_Client_0048a330(uint8_t *param_1,uint param_2)
