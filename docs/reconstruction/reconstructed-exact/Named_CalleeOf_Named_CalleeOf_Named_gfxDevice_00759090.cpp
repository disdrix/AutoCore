// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_gfxDevice_00759090
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_gfxDevice: callee helper. Evidence string: "UIMap0". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ __fastcall Named_CalleeOf_Named_CalleeOf_Named_gfxDevice_00759090(int param_1)
