...
// PURPOSE (auto): Scaffold unit for FUN_00799350 @ 0x00799350
// Stable ID: aa_00799350
...
char FUN_00799350(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,int *param_3,int *param_4,
