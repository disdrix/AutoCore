...
// PURPOSE (auto): Scaffold unit for FUN_005242d0 @ 0x005242d0
// Stable ID: aa_005242d0
...
uint32_t /* width from decompiler */ * __thiscall FUN_005242d0(int param_1,uint32_t /* width from decompiler */ *param_2)
