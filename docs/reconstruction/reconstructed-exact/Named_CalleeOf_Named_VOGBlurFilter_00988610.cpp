// =============================================================================
// Named_CalleeOf_Named_VOGBlurFilter_00988610
// -----------------------------------------------------------------------------
// Stable ID: aa_00988610
// Callee of Named_VOGBlurFilter (+3 other named callers)
// Address:   0x00988610  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004148e0, FUN_00988610.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_VOGBlurFilter_00988610(uint32_t /* width from decompiler */ param_1)
