...
// PURPOSE (auto): Scaffold unit for FUN_0044c4a0 @ 0x0044c4a0
// Stable ID: aa_0044c4a0
...
uint32_t /* width from decompiler */ * FUN_0044c4a0(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
