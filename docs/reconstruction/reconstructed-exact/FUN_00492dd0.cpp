// =============================================================================
// FUN_00492dd0 — clean twin of PalantirEnv_Ctor_Inferred
// Stable ID: aa_00492dd0 | W31-P
// =============================================================================
// See PalantirEnv_Ctor_Inferred.cpp for the sealed reconstruction body.
// This twin keeps the Ghidra symbol name for path stability.
...
void *__thiscall FUN_00492dd0(void *self, uint32_t arg0, void *parent)
{
  // Body identical to PalantirEnv_Ctor_Inferred — include named file at build time
  // or keep parallel: call through named symbol if linked together.
  // Standalone twin mirrors named source (generated 2026-07-29).
  ...
  *reinterpret_cast<void **>(s + 0x00) = &PTR_FUN_009c7928;
  s[0x80] = 1; s[0x81] = 1; s[0x82] = 1; s[0x83] = 1;
  s[0x84] = 1; s[0x85] = 1; s[0x86] = 1;
  s[0x87] = static_cast<uint8_t>(p[0x7D] == 0);
  s[0x88] = 1; s[0x89] = 0; s[0x8A] = 0; s[0x8B] = 1;
  s[0x8C] = 1; s[0x8E] = 1; s[0x8F] = 1; s[0x90] = 0;
  ...
  *reinterpret_cast<uint16_t *>(s + 0xA0) = 0xFFFF;
  ...
  FUN_0096ef70();
  FUN_0096ef70();
  *reinterpret_cast<uint32_t *>(s + 0xBC) = arg0;
  *reinterpret_cast<void **>(s + 0xB8) = parent;
  ...
  *reinterpret_cast<void **>(s + 0xD4) = &PTR_LAB_009c7744;
  *reinterpret_cast<void **>(s + 0xD8) = self;
  FUN_0096ef70();
  FUN_0096ef70();
  *reinterpret_cast<void **>(s + 0xE8) = FUN_004933f0();
  *reinterpret_cast<uint32_t *>(s + 0xEC) = 0;
  *reinterpret_cast<void **>(s + 0xF4) = FUN_004933f0();
  *reinterpret_cast<uint32_t *>(s + 0xF8) = 0;
  s[0xFC] = 0;
  *reinterpret_cast<uint32_t *>(s + 0x104) = 0;
  *reinterpret_cast<uint32_t *>(s + 0x108) = 0;
  *reinterpret_cast<uint32_t *>(s + 0x11C) = 0;
  ...
  *reinterpret_cast<uint32_t *>(s + 0x194) = 0;
  {
