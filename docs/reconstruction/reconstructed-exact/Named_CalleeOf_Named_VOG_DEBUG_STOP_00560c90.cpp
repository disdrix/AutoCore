// =============================================================================
// Named_CalleeOf_Named_VOG_DEBUG_STOP_00560c90
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_VOG_DEBUG_STOP: callee helper. Evidence string: "LthkWorld::getPenetrations". Supports parent flow (not a free-standing entry point).
...
void __thiscall Named_CalleeOf_Named_VOG_DEBUG_STOP_00560c90(int param_1,int *param_2,uint32_t /* width from decompiler */ param_3,int *param_4)
