// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_ShowInvento_00573810
// -----------------------------------------------------------------------------
...
//  - Notable callees: FUN_00573510×2, FUN_00573810, FUN_005ae050.
//  - Return sites: 3.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_ShowInvento_00573810(int param_1,uint32_t /* width from decompiler */ *param_2,uint *param_3)
...

{
  ...
  if (bVar5) {
    ...
    if (puVar4 == (uint32_t /* width from decompiler */ *)**(int **)(param_1 + 4)) {
      ...
      puVar4 = (uint32_t /* width from decompiler */ *)FUN_00573510(&param_3,1,puVar4,puVar2);
  ...
  if (param_3[3] < *puVar2) {
    ...
    puVar4 = (uint32_t /* width from decompiler */ *)FUN_00573510(&param_3,bVar5,puVar4,puVar2);
