...
// Address:   0x007cf0c0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for Inv_vPrefixRaceItem @ 0x007cf0c0
// Stable ID: aa_007cf0c0
...
//  - Notable callees: block×88, FUN_004231d0×30, FUN_0041a3e0×4, _com_issue_error×3, CONCAT31×2, CoTaskMemAlloc×2, FUN_00423170×2, wcscpy×2.
//  - Strings: "//vPrefixRaceItem/row".
//  - Return sites: 5.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//vPrefixRaceItem/row"
 * Domain alias of FUN_007cf0c0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __thiscall Inv_vPrefixRaceItem(char *param_1,int *param_2,int *param_3)
...

{
  ...
  *param_2 = 0;
  ...
  if (DAT_00d1793c == '\0') {
    ...
    local_15c = (uint32_t /* width from decompiler */ *)0x0;
      ...
      if (iVar3 == 0) {
        ...
        *param_3 = (int)pvVar4;
        ...
        do {
          ...
          *(uint16_t *)(iVar3 + 0x108 + *param_3) = local_110;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x10c + *param_3) = local_c4;

          *(uint16_t *)(iVar3 + 0x110 + *param_3) = local_12c;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x114 + *param_3) = local_cc;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x84 + *param_3) = local_fc;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x10 + *param_3) = local_bc;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 8 + *param_3) = local_f0;

          *(uint32_t /* width from decompiler */ *)(iVar3 + *param_3) = local_100;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x14 + *param_3) = local_d0;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x18 + *param_3) = local_e8;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x88 + *param_3) = local_c0;

          *(uint *)(iVar3 + 0xc + *param_3) = (uint)(local_128 == -1);

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x8c + *param_3) = local_e0;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x90 + *param_3) = local_c8;

          *(BSTR *)(iVar3 + 0x94 + *param_3) = local_d8;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x98 + *param_3) = local_f8;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0x9c + *param_3) = local_f4;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0xa0 + *param_3) = local_ec;

          *(uint *)(iVar3 + 0xa4 + *param_3) = (uint)(local_118 == -1);

          *(uint16_t *)(iVar3 + 0xa8 + *param_3) = local_108;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0xac + *param_3) = local_e4;

          *(uint16_t *)(iVar3 + 0xb0 + *param_3) = local_114;

          *(uint16_t *)(iVar3 + 0xb2 + *param_3) = (uint16_t)local_124;

          *(uint16_t *)(iVar3 + 0xb4 + *param_3) = local_130;

          *(uint16_t *)(iVar3 + 0xb6 + *param_3) = local_11c;

          *(uint32_t /* width from decompiler */ *)(iVar3 + 0xbc + *param_3) = local_dc;
