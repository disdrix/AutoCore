// =============================================================================
// Named_CalleeOf_Named_gfxBodyMassageMachine_009a00d0
// -----------------------------------------------------------------------------
...
int Named_CalleeOf_Named_gfxBodyMassageMachine_009a00d0(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3)
