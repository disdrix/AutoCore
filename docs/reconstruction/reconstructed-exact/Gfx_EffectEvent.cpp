...
// PURPOSE (auto): Scaffold unit for Gfx_EffectEvent @ 0x0048a280
// Stable ID: aa_0048a280
...
//  - Notable callees: FUN_0056f570×3, GetCapabilities×3, CreateEventA, Gfx_EffectEvent, FUN_0048ac10.
//  - Strings: "GetCapabilities() - Enter"; "426"; "462"; "GetCapabilities(), capability = %d\n".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "EffectEvent"
 * Domain alias of FUN_0048a280 (FUN_* retained)
 *
...
void Gfx_EffectEvent(int *param_1)
