// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST_0041a570
// -----------------------------------------------------------------------------
// Stable ID: aa_0041a570
// Callee of Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP
// Address:   0x0041a570  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_0041ba30×2, FUN_0041a570, FUN_005adff0.
//  - Return sites: 3.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST_0041a570(int param_1,uint32_t /* width from decompiler */ *param_2,char *param_3)
...

{
  ...
  if (bVar2) {
    ...
    if (puVar5 == (uint32_t /* width from decompiler */ *)**(int **)(param_1 + 4)) {
      ...
      puVar5 = (uint32_t /* width from decompiler */ *)FUN_0041ba30(&param_3,1,puVar5,pcVar3);
  ...
  if (*(char *)((int)param_3 + 0xc) < *pcVar3) {
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)FUN_0041ba30(&param_3,bVar2,puVar5,pcVar3);
