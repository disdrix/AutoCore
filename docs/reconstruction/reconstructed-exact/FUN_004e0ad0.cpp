...
// Address:   0x004e0ad0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_004e0ad0 @ 0x004e0ad0
// Stable ID: aa_004e0ad0
...
//  - Control keywords: if×19, goto×5, while×1, return×1.
//  - Notable callees: FUN_005815a0×3, FUN_0040b020×2, CVOGReaction_RemoveObject, FUN_0041b1e0, FUN_004bc180, FUN_004bfa80, FUN_004d5110, FUN_004e09e0.
//  - Return sites: 1.
...

{
  ...
  uint32_t /* width from decompiler */ local_70 [6];
  ...
  if (((*(int *)((int)param_1 + 0xe4e8) != 0) && (*(int *)((int)param_1 + 0xe64c) != 0)) &&
    ...
    if ((*(char *)((int)param_1 + 0x7e) != '\0') &&
      ...
      *(uint32_t /* width from decompiler */ *)((int)param_1 + 0x118) = local_50;

      *(uint32_t /* width from decompiler */ *)((int)param_1 + 0x120) = local_48;
...
LAB_004e0c2a:
      ...
      if (*(short *)(*(int *)(iVar4 + 0x3c) + 0x3f4) == 3) {
        ...
        if (iVar4 == 0) {
          ...
          local_70[0] = *(uint32_t /* width from decompiler */ *)(iVar4 + 0x34);
        ...
        if (iVar4 == 0) {
          ...
          local_50 = *(uint32_t /* width from decompiler */ *)(iVar4 + 0x34);
