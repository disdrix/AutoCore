...
/*
 * Behavioral notes:
 * String-driven rename evidence: "thrThread"
 *
...
uint32_t /* width from decompiler */ __fastcall Named_thrThread_0071aef0(uint32_t /* width from decompiler */ param_1,SIZE_T param_2)
