// =============================================================================
// Inv_Failed_drop_item_get_programmer
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Inv_Failed_drop_item_get_programmer @ 0x008136b0
// Stable ID: aa_008136b0
...
//  - Notable callees: Client_RefreshOpenMissionUiWindows, FUN_007fc150, FUN_007fdfb0, Inv_Failed_drop_item_get_programmer, FUN_0092ce90, FUN_009440e0.
//  - Strings: "Failed to drop the item, get a programmer!".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Failed to drop the item, get a programmer!"
 * Domain alias of FUN_008136b0 (FUN_* retained)
 *
...
void __fastcall Inv_Failed_drop_item_get_programmer(uint32_t /* width from decompiler */ param_1)
