...
// PURPOSE (auto): Scaffold unit for Gfx_MapNameGlobalFxLog @ 0x00956fd0
// Stable ID: aa_00956fd0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "MapName: %s, Map Global FX: %s, Daytime Effect:%s, Weather Effect:%s, Music: %s, Environme"
 * Domain alias of FUN_00956fd0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ __fastcall Gfx_MapNameGlobalFxLog(int param_1)
