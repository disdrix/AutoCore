// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Skill_GatherTargetsInArea_0058da40
// -----------------------------------------------------------------------------
// Stable ID: aa_0058da40
// Callee of Named_CalleeOf_Skill_GatherTargetsInArea
// Address:   0x0058da40  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Named_CalleeOf_Skill_GatherTargetsInArea: skill/cast helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~120 non-empty decompiler lines.
//  - Control keywords: if×14, return×2, do×1, goto×1, while×1.
//  - Notable callees: FUN_004192f0×2, FUN_004192a0, FUN_0058da40, FUN_005a2de0, _CxxThrowException, exception::exception.
...
Named_CalleeOf_Named_CalleeOf_Skill_GatherTargetsInArea_0058da40(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ *param_4,uint32_t /* width from decompiler */ param_5)
...

{
  ...
  piVar4 = (int *)FUN_005a2de0(*(uint32_t /* width from decompiler */ *)(param_1 + 4),param_4,*(uint32_t /* width from decompiler */ *)(param_1 + 4),
  ...
  *(int *)(param_1 + 8) = *(int *)(param_1 + 8) + 1;
  ...
  do {
    ...
    if (cVar1 != '\0') {
      ...
      *(uint8_t *)(*(int *)(*(int *)(param_1 + 4) + 4) + 0x28) = 1;
...
LAB_0058db46:
        ...
        *(uint8_t *)(piVar7[1] + 0x28) = 1;

        *(uint8_t *)(*(int *)(piVar7[1] + 4) + 0x28) = 0;

        FUN_004192f0(*(uint32_t /* width from decompiler */ *)(piVar7[1] + 4));
