...
// PURPOSE (auto): Scaffold unit for FUN_00757ff0 @ 0x00757ff0
// Stable ID: aa_00757ff0
...
FUN_00757ff0(int *param_1,uint32_t /* width from decompiler */ param_2,int param_3,int *param_4,uint32_t /* width from decompiler */ param_5,
