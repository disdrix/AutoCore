// =============================================================================
// Skill_FilterTargetForResolveList_Inferred  (was FUN_0054ff00)
// Address:  0x0054ff00  Stable: aa_0054ff00
// System:   skills-abilities
// Sole caller: Skill_ResolveTargetList @ 0x00550300
// Sealed: ORs *outFlags with bits 4, 8, 0x10 on reject paths (closes skills open Q).
// Exact OR insn VAs (read_memory 2026-07-29 residual):
//   |= 8    @ 0x0054ff72  (83 08 08)
//   |= 0x10 @ 0x0055007c  (83 08 10)
//   |= 4    @ 0x005502c1  (83 08 04)  LAB_005502bd fallthrough
// Name INFERRED from caller + outFlags writers — not original symbol.
// Body below is industrial reconstruction of raw decompile (behavior-preserving).
// Dual: reviews/A|B_aa_0054ff00_Skill_FilterTargetForResolveList_Inferred.md
// Residual: tmp/a_0054ff00.md
// =============================================================================
// =============================================================================
// Skill_FilterTargetForResolveList_Inferred
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Skill_FilterTargetForResolveList_Inferred @ 0x0054ff00
// Stable ID: aa_0054ff00
...
//  - Control keywords: ifÃ—33, returnÃ—18, gotoÃ—5.
//  - Notable callees: FUN_0040aff0Ã—3, FUN_005749d0Ã—2, FUN_004bb0d0, FUN_005130e0, Skill_FilterTargetForResolveList_Inferred, TFID_EqualsObjectId, TFID_NotEquals.
//  - Return sites: 18.
...
int * __thiscall Skill_FilterTargetForResolveList_Inferred(int param_1,int *param_2,int *param_3,uint *param_4)
