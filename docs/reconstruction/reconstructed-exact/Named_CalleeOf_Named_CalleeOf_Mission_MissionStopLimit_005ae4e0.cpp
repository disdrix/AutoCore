// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Mission_MissionStopLimit_005ae4e0
// -----------------------------------------------------------------------------
// Stable ID: aa_005ae4e0
// Callee of Named_CalleeOf_Mission_MissionStopLimit
...
// PURPOSE (auto): Called from Named_CalleeOf_Mission_MissionStopLimit: mission/objective helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~120 non-empty decompiler lines.
//  - Control keywords: if×14, return×2, do×1, goto×1, while×1.
//  - Notable callees: FUN_00418c10×2, FUN_00573170, FUN_005ae220, FUN_005ae4e0, _CxxThrowException, exception::exception.
...
Named_CalleeOf_Named_CalleeOf_Mission_MissionStopLimit_005ae4e0(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ *param_4,uint32_t /* width from decompiler */ param_5)
