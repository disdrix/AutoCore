...
int Named_ecc_sys_0077ad80(int param_1,uint32_t /* width from decompiler */ param_2,int param_3,uint *param_4,uint32_t /* width from decompiler */ param_5,
