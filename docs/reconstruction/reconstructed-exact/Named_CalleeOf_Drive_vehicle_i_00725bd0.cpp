// =============================================================================
// Named_CalleeOf_Drive_vehicle_i_00725bd0
// -----------------------------------------------------------------------------
// Stable ID: aa_00725bd0
// Callee of Drive_vehicle_i
...
// PURPOSE (auto): Called from Drive_vehicle_i: drive/input helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
uint __thiscall Named_CalleeOf_Drive_vehicle_i_00725bd0(int param_1,int *param_2,float *param_3,float param_4)
