// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_006bf8c0
// -----------------------------------------------------------------------------
// Stable ID: aa_006bf8c0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam
// Address:   0x006bf8c0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Control keywords: if×20, do×8, while×8, return×2.
//  - Notable callees: FUN_006bc990×4, FUN_005b3370×3, FUN_006bf8c0×3, FUN_006c0520×2, CONCAT31, FUN_006bda60, FUN_006bee60, FUN_006c0020.
//  - Return sites: 2.
...
void Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_006bf8c0(uint32_t /* width from decompiler */ param_1,int *param_2,int param_3,int param_4,int *param_5)
...

{
  ...
  uint32_t /* width from decompiler */ *local_83c;

  uint local_838;

  uint local_834;

  uint32_t /* width from decompiler */ local_830 [3];
    ...
    *param_5 = *param_2;
    ...
    do {
      ...
      do {
        ...
        Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_006bf8c0(param_1,param_2,param_3,iVar2,&local_410);
      ...
      do {
        ...
        Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_006bf8c0(param_1,param_2,iVar2 + 1,param_4,&local_820);
    ...
    if (local_408 == 0) {
      ...
      if (0 < local_818) {
        ...
        do {
          ...
          puVar6 = (uint32_t /* width from decompiler */ *)(local_81c + iVar2 * 8);
          ...
          *(uint32_t /* width from decompiler */ *)(iVar1 + iVar5 * 8) = *puVar6;

          *(uint32_t /* width from decompiler */ *)(iVar1 + 4 + iVar5 * 8) = puVar6[1];
      ...
      if (0 < local_408) {
        ...
        do {
          ...
          puVar6 = (uint32_t /* width from decompiler */ *)(local_40c + iVar2 * 8);
