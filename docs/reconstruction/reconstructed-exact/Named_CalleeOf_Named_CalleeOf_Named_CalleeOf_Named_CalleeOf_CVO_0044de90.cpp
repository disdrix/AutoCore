// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO_0044de90
// -----------------------------------------------------------------------------
// Stable ID: aa_0044de90
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_Cre
// Address:   0x0044de90  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00401a40, FUN_0044de90, _CxxThrowException.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO_0044de90(uint param_1,int param_2)
...

{
  ...
  if (0x4924924U - *(int *)(param_2 + 8) < param_1) {
