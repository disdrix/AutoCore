// =============================================================================
// Named_CalleeOf_CVOGReaction_CompleteObjective_00537d30
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from CVOGReaction_CompleteObjective: mission/objective helper. Evidence string: "HashListError: Went to node we already touched! Attempting repair!". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_00537d30, FUN_007a4480.
//  - Return sites: 3.
...
void __fastcall Named_CalleeOf_CVOGReaction_CompleteObjective_00537d30(int param_1)
