...
// Address:   0x00658990  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_00658990 @ 0x00658990
// Stable ID: aa_00658990
...
//  - Notable callees: FUN_00636220, FUN_00658990.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ * __thiscall FUN_00658990(uint32_t /* width from decompiler */ *param_1,int param_2)
...

{
  ...
  *param_1 = &PTR_FUN_009e5e88;
  ...
  param_1[0x13] = *(uint32_t /* width from decompiler */ *)(param_2 + 0x3c);

  param_1[0x12] = *(uint32_t /* width from decompiler */ *)(param_2 + 0x38);
