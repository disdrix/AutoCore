...
uint32_t /* width from decompiler */ __thiscall Named_AudioOutStream_00678f80(int *param_1,uint32_t /* width from decompiler */ param_2,uint param_3)
