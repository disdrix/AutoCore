...
// FUN_006e9dc0
// -----------------------------------------------------------------------------
// Stable ID: aa_006e9dc0
// Address:   0x006e9dc0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006e9dc0 @ 0x006e9dc0
// Stable ID: aa_006e9dc0
...
//  - Notable callees: FUN_006e9ba0×2, FUN_006e9dc0.
//  - Return sites: 2.
...
void FUN_006e9dc0(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ *param_3,uint32_t /* width from decompiler */ param_4,
...

{
  ...
  if (param_5 != 0) {
    ...
    FUN_006e9ba0(param_2,param_1,&local_a0,&local_70,&local_40);

    return;

  }

  FUN_006e9ba0(param_2,param_1,&local_a0,&local_70,0);
