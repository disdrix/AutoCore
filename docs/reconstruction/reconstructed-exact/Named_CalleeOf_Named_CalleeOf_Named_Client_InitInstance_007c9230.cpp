// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance_007c9230
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_Client_InitInstance: callee helper. Evidence string: "IDColor". Supports parent flow (not a free-standing entry point).
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance_007c9230(char *param_1,int param_2,int param_3,int param_4)
