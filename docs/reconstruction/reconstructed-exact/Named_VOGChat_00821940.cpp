...
uint32_t /* width from decompiler */ Named_VOGChat_00821940(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,int param_3)
