...
// PURPOSE (auto): Scaffold unit for FUN_0058e1a0 @ 0x0058e1a0
// Stable ID: aa_0058e1a0
...
uint32_t /* width from decompiler */ __thiscall FUN_0058e1a0(int param_1,uint32_t /* width from decompiler */ param_2,char param_3)
