// =============================================================================
// Named_CreateRawDataFromFile_error_HOLE_indicates_there
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_CreateRawDataFromFile_error_HOLE_indicates_there @ 0x0071f140
// Stable ID: aa_0071f140
...
//  - Notable callees: _vbase_destructor_×2, Named_CreateRawDataFromFile_error_HOLE_indicates_there, FUN_007a4480, FUN_007b6a20, FUN_007b70e0, close, open.
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "CreateRawDataFromFile error OV_HOLE: indicates there was an interruption in the data.
"
 * Domain alias of FUN_0071f140 (FUN_* retained)
 *
...
uint8_t __fastcall Named_CreateRawDataFromFile_error_HOLE_indicates_there(char *param_1)
