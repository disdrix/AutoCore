// =============================================================================
// Map_EraseRange_Isnil15
// -----------------------------------------------------------------------------
// Stable ID: aa_0051d7c0
// Address:   0x0051d7c0–0x0051d873 inclusive (180 B; autoassault.exe base 0x400000)
// System:    STL map/set (MSVC red-black range erase; isnil@+0x15)
// Generated: 2026-08-04 WQ9E-J OWN dual A/B seal
// Exactness: Behavior-preserving rewrite of live decompile + sealed bytes.
//            Not modernization. Bit-for-bit vs retail EXE: DEFERRED.
// Supersedes: FUN_0051d7c0.cpp scaffold.
// Dual: reviews/A|B_aa_0051d7c0_Map_EraseRange_Isnil15.md
// Peer: Map_EraseRange (isnil@+0x29 @ 0x0051c7c0); StdMap_EraseRange_Inferred
//       (isnil@+0x15 @ 0x004bacf0; different free/erase callees).
// =============================================================================
//
// PURPOSE:
//   Erase [first, last) from an MSVC-style map/set whose nodes use isnil@+0x15.
//   Full-range fast path frees the whole tree via FUN_0051be50(root).
//   Partial path precomputes successor then calls FUN_0051ce00 per node
//   (STL single-erase; throws "invalid map/set<T> iterator" on isnil).
//
...
extern "C" void FUN_0051be50(TreeNode_Isnil15* root); // free non-nil subtree (isnil@+0x15)
