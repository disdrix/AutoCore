// =============================================================================
// Named_CalleeOf_CVOGTacArc_InitializeMesh_00748960
// -----------------------------------------------------------------------------
...
//  - Notable callees: CONCAT31, FUN_00437680, FUN_00748960, _eh_vector_constructor_iterator_.
//  - Return sites: 1.
...
uint32_t /* width from decompiler */ * __fastcall Named_CalleeOf_CVOGTacArc_InitializeMesh_00748960(uint32_t /* width from decompiler */ *param_1)
