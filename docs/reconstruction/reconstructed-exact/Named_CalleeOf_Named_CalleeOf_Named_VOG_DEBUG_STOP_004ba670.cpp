// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_004ba670
// -----------------------------------------------------------------------------
// Stable ID: aa_004ba670
// Callee of Named_CalleeOf_Named_VOG_DEBUG_STOP (+1 other named callers)
// Address:   0x004ba670  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004ba670, _CxxThrowException, exception::exception.
...
void Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_004ba670(void)
