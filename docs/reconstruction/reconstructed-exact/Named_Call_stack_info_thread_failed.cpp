// =============================================================================
// Named_Call_stack_info_thread_failed
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_Call_stack_info_thread_failed @ 0x00633fc0
// Stable ID: aa_00633fc0
...
//  - Notable callees: FUN_00633720×4, GetCurrentThread×2, StackWalk×2, info×2, FUN_00633a90, FUN_00633e60, Named_Call_stack_info_thread_failed, GetCurrentProcess.
//  - Strings: "Call stack info(thread=0x%X) failed.%s"; "Call stack info(thread=0x%X) : %s%s"; "     %s : %s \t\t"; "Params(1:%x 2:%x 3:%x 4:%x)%s".
//  - Return sites: 2.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Call stack info(thread=0x%X) failed.%s"
 * Domain alias of FUN_00633fc0 (FUN_* retained)
 *
...
void Named_Call_stack_info_thread_failed(HANDLE param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4,
