// =============================================================================
// Named_CalleeOf_CVOGCreature_SetupGraphics_0096dc80
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_CVOGCreature_SetupGraphics_0096dc80(int *param_1,int param_2,uint32_t /* width from decompiler */ param_3,int param_4)
