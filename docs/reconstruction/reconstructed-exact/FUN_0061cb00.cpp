...
// PURPOSE (auto): Scaffold unit for FUN_0061cb00 @ 0x0061cb00
// Stable ID: aa_0061cb00
// Embedded strings (evidence for future rename):
//   - "success_chance] (chance to make item)\n"
...
FUN_0061cb00(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,int param_3,char *param_4,int param_5)
