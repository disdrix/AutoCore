...
// PURPOSE (auto): Scaffold unit for FUN_00568530 @ 0x00568530
// Stable ID: aa_00568530
...
uint32_t /* width from decompiler */ __thiscall FUN_00568530(int *param_1,uint32_t /* width from decompiler */ param_2,int param_3,int *param_4)
