// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_RefreshOpenMissionUiWindow_008e3820
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_RefreshOpenMissionUiWindows: mission/objective helper. Evidence string: "You need more discipline training to craft this item!". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_007a69d0×2, FUN_007a6de0×2, sprintf×2, FUN_00403450, FUN_0052b040, FUN_008e3820, block.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Client_RefreshOpenMissionUiWindow_008e3820(int param_1)
