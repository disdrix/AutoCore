// =============================================================================
// Named_CalleeOf_Named_generator_00680c50
// -----------------------------------------------------------------------------
// Stable ID: aa_00680c50
// Callee of Named_generator (+5 other named callers)
// Address:   0x00680c50  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Named_generator_00680c50(uint32_t /* width from decompiler */ *param_1)
