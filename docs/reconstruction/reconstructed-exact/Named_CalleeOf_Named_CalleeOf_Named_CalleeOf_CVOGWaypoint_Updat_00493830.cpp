// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGWaypoint_Updat_00493830
// -----------------------------------------------------------------------------
// Stable ID: aa_00493830
// Callee of Named_CalleeOf_Named_CalleeOf_CVOGWaypoint_UpdateState
// Address:   0x00493830  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_CVOGWaypoint_UpdateState: AI/path helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
// Readability: control flow preserved from Ghidra decompile; types tentative.

// READABILITY (auto CF):
//  - Body size: ~99 non-empty decompiler lines.
//  - Control keywords: if×13, return×4.
//  - Notable callees: FUN_004e2e80×2, FUN_004e2f70×2, FUN_005739b0×2, memmove×2, CONCAT44, FUN_004932e0, FUN_00493830, FUN_004e24d0.
//  - Return sites: 4.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVOGWaypoint_Updat_00493830(int param_1,void *param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
