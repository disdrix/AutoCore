...
// PURPOSE (auto): Scaffold unit for FUN_00511b40 @ 0x00511b40
// Stable ID: aa_00511b40
...
//  - Notable callees: FUN_00511950×2, FUN_00511b40, FUN_005adff0.
//  - Return sites: 3.
...
void __thiscall FUN_00511b40(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3)
...

{
  ...
  if (bVar2) {
    ...
    if (puVar5 == (uint32_t /* width from decompiler */ *)**(int **)(param_1 + 4)) {
      ...
      puVar5 = (uint32_t /* width from decompiler */ *)FUN_00511950(&param_3,1,puVar5,piVar3);
  ...
  if (param_3[3] < *piVar3) {
    ...
    puVar5 = (uint32_t /* width from decompiler */ *)FUN_00511950(&param_3,bVar2,puVar5,piVar3);
