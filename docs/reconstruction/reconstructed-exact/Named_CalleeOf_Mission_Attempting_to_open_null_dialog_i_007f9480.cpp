// =============================================================================
// Named_CalleeOf_Mission_Attempting_to_open_null_dialog_i_007f9480
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Mission_Attempting_to_open_null_dialog_i: mission/objective helper. Evidence string: ");

  if (_File != (FILE *)0x0) {

    fprintf(_File,". Supports parent flow (not a free-standing entry point).
...
uint32_t /* width from decompiler */ Named_CalleeOf_Mission_Attempting_to_open_null_dialog_i_007f9480(int param_1)
