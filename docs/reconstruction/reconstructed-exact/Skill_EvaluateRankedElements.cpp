// READABILITY (auto CF):
//  - Body size: ~853 non-empty decompiler lines.
//  - Control keywords: if×97, goto×24, for×3, return×2, do×1, while×1.
//  - Notable callees: FUN_006a3db0×2, FUN_0054b2c0, FUN_0054d9a0, Skill_EvaluateRankedElements, charge, cooldown, offset.
//  - Return sites: 2.
...
// Address:   0x0054b4a0  (autoassault.exe, image base 0x400000)
...
void Skill_EvaluateRankedElements
               ...
               (uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,short *param_3,uint32_t /* width from decompiler */ param_4)
...

{
  ...
  uint32_t /* width from decompiler */ local_540;
  ...
  uint32_t /* width from decompiler */ local_534;
  ...
  puVar8 = (uint32_t /* width from decompiler */ *)(*piVar3 + 0x10);
...
LAB_0054c1d5:
  ...
  *(uint8_t *)(psVar1 + 0x10) = local_53a;

  psVar1[0x29] = local_53c;

  *(float *)(psVar1 + 2) = local_504;

  *(uint8_t *)((int)psVar1 + 0x21) = local_539;

  *(uint8_t *)(psVar1 + 0x11) = local_538;
  ...
  *(uint32_t /* width from decompiler */ *)(psVar1 + 0xa6) = local_534;

  *(uint8_t *)(psVar1 + 0xa4) = local_52b;
  ...
  *(uint32_t /* width from decompiler */ *)(psVar1 + 6) = local_540;
