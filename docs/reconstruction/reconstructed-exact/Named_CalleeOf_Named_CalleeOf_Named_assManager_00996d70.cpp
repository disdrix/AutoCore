// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_assManager_00996d70
// -----------------------------------------------------------------------------
...
//  - Notable callees: FUN_00415e90, FUN_00449a90, FUN_009899a0, FUN_00989b00, FUN_00996d70.
//  - Return sites: 1.
...
void Named_CalleeOf_Named_CalleeOf_Named_assManager_00996d70(uint8_t param_1)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(in_EAX + 0x48) = 1;

  *(uint32_t /* width from decompiler */ *)(in_EAX + 0x4c) = 1;
