...
// Address:   0x00598040  (autoassault.exe, image base 0x400000)
// System:    unknown
    ...
    do {
      if (*(int *)(*(int *)(*(int *)(*(int *)(*(int *)(param_1 + 0x44) + 4) + 4) + 0xa8 +
        ...
        if (*(char *)(iVar4 + 0x80) == '\0') {
          *(uint32_t /* width from decompiler */ *)(*(int *)(iVar5 + 0x28) + iVar7 * 4) = 0;
        }
        else {
          ...
          fVar8 = (float10)VehicleEngine_torqueCurve2D
                                     (*(uint32_t /* width from decompiler */ *)(iVar4 + 0x20),*(uint32_t /* width from decompiler */ *)(iVar4 + 0x28));
