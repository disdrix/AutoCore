...
// PURPOSE (auto): Scaffold unit for FUN_0041e540 @ 0x0041e540
// Stable ID: aa_0041e540
...
FUN_0041e540(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ *param_2,int param_3,int param_4,uint param_5)
