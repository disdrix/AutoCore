...
// =============================================================================
// Named_missileExplosion_004a34f0
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ Named_missileExplosion_004a34f0(int *param_1,uint32_t /* width from decompiler */ param_2,int *param_3)
