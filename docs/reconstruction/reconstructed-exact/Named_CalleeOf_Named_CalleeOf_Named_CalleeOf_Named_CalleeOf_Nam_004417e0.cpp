// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_004417e0
// -----------------------------------------------------------------------------
// Stable ID: aa_004417e0
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_ST
// Address:   0x004417e0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004422d0×2, FUN_00442340×2, FUN_00401a40, FUN_004417e0, FUN_004423d0, _CxxThrowException.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_004417e0(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,char param_3)
...

{
  ...
  piVar3 = (int *)FUN_004423d0(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4),param_1,*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  if (param_1 == *(uint32_t /* width from decompiler */ **)(unaff_EDI + 4)) {
    ...
    **(uint32_t /* width from decompiler */ **)(unaff_EDI + 4) = piVar3;
    ...
    if (param_1 != *(uint32_t /* width from decompiler */ **)(iVar4 + 8)) goto LAB_0044188e;
...
LAB_0044188e:
  ...
  do {
    ...
    if (cVar1 != '\0') {
      ...
      *(uint8_t *)(*(int *)(*(int *)(unaff_EDI + 4) + 4) + 0x1c) = 1;
...
LAB_004418b6:
        ...
        *(uint8_t *)(piVar7[1] + 0x1c) = 1;

        *(uint8_t *)(*(int *)(piVar7[1] + 4) + 0x1c) = 0;
