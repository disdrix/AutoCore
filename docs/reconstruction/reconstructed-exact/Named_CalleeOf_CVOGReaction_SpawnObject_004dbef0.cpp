// =============================================================================
// Named_CalleeOf_CVOGReaction_SpawnObject_004dbef0
// -----------------------------------------------------------------------------
...
void Named_CalleeOf_CVOGReaction_SpawnObject_004dbef0(int *param_1,uint32_t /* width from decompiler */ param_2,int param_3,int param_4,int param_5)
