// =============================================================================
// Named_CalleeOf_Mission_bActiveObjectiveOverride_00421110
// -----------------------------------------------------------------------------
// Stable ID: aa_00421110
// Callee of Mission_bActiveObjectiveOverride (+1 other named callers)
// Address:   0x00421110  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00421110, FUN_00421bf0, FUN_0046eda0.
//  - Return sites: 2.
...
uint32_t /* width from decompiler */ * Named_CalleeOf_Mission_bActiveObjectiveOverride_00421110(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
