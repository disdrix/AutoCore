...
// Address:   0x00979730  (autoassault.exe, image base 0x400000)
// System:    unknown
...
uint32_t /* width from decompiler */ __thiscall ClientSpecialEvent_Respawn_Update(int param_1,float param_2)
...

{
  ...
  if (*(char *)(param_1 + 8) == '\0') {
    ...
    *(float *)(param_1 + 0x60) = param_2 + *(float *)(param_1 + 0x60);
    ...
    (**(code **)(**(int **)(param_1 + 0x10) + 0x28))(*(uint32_t /* width from decompiler */ *)(iVar2 + 0x238));
    ...
    if (*(char *)(param_1 + 0x6c) != '\0') {
      ...
      if (pvVar1 != (void *)0x0) {
        ...
        puVar3 = (uint32_t /* width from decompiler */ *)FUN_004e9530(auStack_30,&fStack_3c);
      ...
      if ((*(float *)(param_1 + 0x60) < fVar8) || (*(char *)(param_1 + 0x6d) != '\x04')) {
          ...
          if ((*(float *)(param_1 + 0x60) < fVar9) || (*(char *)(param_1 + 0x6d) != '\x02')) {
            ...
            *(float *)(param_1 + 100) = fVar9;
            ...
            if (pvVar1 != (void *)0x0) {
              ...
              CVOGReaction_TeleportTarget(pvVar1,(uint32_t /* width from decompiler */ *)(param_1 + 0x40));
        ...
        *(uint8_t *)(param_1 + 0x6c) = 0;
        ...
        if ((pvVar1 != (void *)0x0) &&
          ...
          *(uint32_t /* width from decompiler */ *)(DAT_00d1b778 + 0x60c) = *(uint32_t /* width from decompiler */ *)(param_1 + 0xc);
