...
// PURPOSE (auto): Scaffold unit for FUN_007679e0 @ 0x007679e0
// Stable ID: aa_007679e0
...
FUN_007679e0(int *param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ param_3,int param_4)
