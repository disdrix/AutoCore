...
// PURPOSE (auto): Scaffold unit for FUN_009572e0 @ 0x009572e0
// Stable ID: aa_009572e0
// Embedded strings (evidence for future rename):
//   - "Missions Still To Complete:\n"
//   - "%s - (ID: %d)\n"
...
uint32_t /* width from decompiler */ FUN_009572e0(uint32_t /* width from decompiler */ param_1,char *param_2)
