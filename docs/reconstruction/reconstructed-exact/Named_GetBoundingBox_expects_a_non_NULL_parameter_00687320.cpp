...
// =============================================================================
// Named_GetBoundingBox_expects_a_non_NULL_parameter_00687320
// -----------------------------------------------------------------------------
...
/*
 * Behavioral notes:
 * String-driven rename evidence: "GetBoundingBox() expects a non-NULL parameter"
 *
...
void __thiscall Named_GetBoundingBox_expects_a_non_NULL_parameter_00687320(int param_1,uint32_t /* width from decompiler */ *param_2)
