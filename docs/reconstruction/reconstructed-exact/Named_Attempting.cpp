...
// PURPOSE (auto): Scaffold unit for Named_Attempting @ 0x0080dcc0
// Stable ID: aa_0080dcc0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Attempting... Failed!"
 * Domain alias of FUN_0080dcc0 (FUN_* retained)
 *
