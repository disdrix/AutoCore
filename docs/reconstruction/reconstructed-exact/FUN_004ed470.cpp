...
// PURPOSE (auto): Scaffold unit for FUN_004ed470 @ 0x004ed470
// Stable ID: aa_004ed470
...
int FUN_004ed470(int param_1,float param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4,char param_5,
