// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00447260
// -----------------------------------------------------------------------------
// Stable ID: aa_00447260
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_effDeviceEff
// Address:   0x00447260  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00447260, FUN_00448960, FUN_004540b0.
//  - Return sites: 1.
...
int __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00447260(int param_1,int param_2)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_2 + 0xc) = 0;
  ...
  if (uVar1 != 0) {
    ...
    pvVar2 = operator_new(uVar1 * 0x24);
    ...
    *(void **)(param_2 + 0xc) = (void *)(uVar1 * 0x24 + (int)pvVar2);

    uVar3 = FUN_00448960(*(uint32_t /* width from decompiler */ *)(param_1 + 4),*(uint32_t /* width from decompiler */ *)(param_1 + 8),param_2);
