...
uint32_t /* width from decompiler */ Skill_skill_accuracy_percent(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3)
