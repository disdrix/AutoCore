...
//  - Control keywords: if×14, return×7, for×1.
//  - Notable callees: CONCAT31, CVOGReaction_SpawnObject, FUN_004bcda0, FUN_004c00f0, FUN_004dbef0, FUN_004e23d0, FUN_004e2600, FUN_00518370.
//  - Return sites: 7.
...
// Address:   0x004de550  (autoassault.exe, image base 0x400000)
// System:    unknown
...
char __thiscall CVOGReaction_SpawnObject(void *this,uint32_t /* width from decompiler */ uObjectID,uint32_t /* width from decompiler */ uInstanceID)
...

{
  ...
  if (iVar2 == 0) {
    ...
    *(byte *)((int)piVar4 + 0x17d) = *(byte *)((int)piVar4 + 0x17d) | 2;
    ...
    (**(code **)(*piVar4 + 0x2a4))(*(uint32_t /* width from decompiler */ *)((int)this + 0xe4e8));
    ...
    if (*(int *)(piVar4[0x2a] + 0x38) != 0x36) {
      ...
      if ((iVar2 != 0) && (iVar2 = (**(code **)(*piVar4 + 0x1cc))(), *(int *)(iVar2 + 8) != 0)) {
        ...
        *(uint32_t /* width from decompiler */ *)(*(int *)(iVar2 + 8) + 0x148) = 0xffffffff;
