// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs_008c8ad0
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Mission_createNDUIDialogs: mission/objective helper. Evidence string: "i_d_g.xml". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_0087b890, FUN_008c51b0, FUN_008c8ad0, FUN_0097c720, NDUIWindow_ReloadInterface.
...
int * Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs_008c8ad0(int *param_1)
