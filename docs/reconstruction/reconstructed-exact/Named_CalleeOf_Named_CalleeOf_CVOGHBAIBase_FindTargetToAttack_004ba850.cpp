// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGHBAIBase_FindTargetToAttack_004ba850
// -----------------------------------------------------------------------------
// Stable ID: aa_004ba850
// Callee of Named_CalleeOf_CVOGHBAIBase_FindTargetToAttack
...
// PURPOSE (auto): Called from Named_CalleeOf_CVOGHBAIBase_FindTargetToAttack: callee helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_CVOGHBAIBase_FindTargetToAttack_004ba850(int param_1,void *param_2,uint param_3,uint32_t /* width from decompiler */ *param_4)
