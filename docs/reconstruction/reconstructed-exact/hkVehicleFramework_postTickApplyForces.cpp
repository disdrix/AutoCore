// =============================================================================
// hkVehicleFramework_postTickApplyForces
// -----------------------------------------------------------------------------
// Stable ID: aa_0064bc70
// Address:   0x0064bc70  (autoassault.exe, image base 0x400000)
// System:    unknown
...

{
  ...
  float local_3d4;
  float fStack_3d0;
  uint8_t auStack_3cc [16];
  uint32_t /* width from decompiler */ auStack_3bc [57];
  uint8_t auStack_2d8 [12];
  float afStack_2cc [6];
  float afStack_2b4 [4];
  float afStack_2a4 [9];
  char acStack_280 [84];
  ...
  uStack_22c = *(uint32_t /* width from decompiler */ *)((int)param_1 + 0x34c);
  iStack_430 = 0;
    ...
    do {
      ...
      *pfVar13 = fVar20 * *pfVar13;
      ...
      if ((iVar18 == 0) || (*(char *)(iVar18 + 0x40) != '\0')) {
        *puVar1 = 2;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x2c) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x28) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x24) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x20) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0xc) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 8) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 4) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x1c) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x18) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x14) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x10) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x3c) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x38) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x34) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x30) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x4c) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x48) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x44) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x40) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x5c) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x58) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x54) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x50) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x6c) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x68) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 100) = 0;
        *(uint32_t /* width from decompiler */ *)((int)auStack_3bc + iVar17 + 0x60) = 0;
      }
...
LAB_0064c542:
  ...
  uStack_1f8 = *(uint32_t /* width from decompiler */ *)((int)param_1 + 800);
  uStack_1f4 = *(uint32_t /* width from decompiler */ *)((int)param_1 + 0x324);
  uStack_1f0 = *(uint32_t /* width from decompiler */ *)((int)param_1 + 0x328);
  uStack_1ec = *(uint32_t /* width from decompiler */ *)((int)param_1 + 0x32c);
  ...
  uStack_17c = 0;
  uStack_198 = *(uint32_t /* width from decompiler */ *)(iVar17 + 0xc0);
  uStack_194 = *(uint32_t /* width from decompiler */ *)(iVar17 + 0xc4);
  uStack_190 = *(uint32_t /* width from decompiler */ *)(iVar17 + 200);
  uStack_18c = *(uint32_t /* width from decompiler */ *)(iVar17 + 0xcc);
  ...
  if (0 < *(int *)((int)fVar24 + 0xc)) {
    ...
    do {
      ...
      *(uint32_t /* width from decompiler */ *)(iVar18 + 0x94) = uVar22;
      *(uint32_t /* width from decompiler */ *)(iVar18 + 0x98) = puVar2[3];
      *(uint32_t /* width from decompiler */ *)(iVar18 + 0xa0) = puVar2[1];
      iVar17 = iVar17 + 1;
      *(uint32_t /* width from decompiler */ *)(iVar18 + 0x9c) = *puVar2;
