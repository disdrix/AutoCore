// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_createNDUI_008fb880
// -----------------------------------------------------------------------------
// Stable ID: aa_008fb880
// Callee of Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs
// Address:   0x008fb880  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_createNDUI_008fb880(int param_1)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x660) = 0xffffffff;
