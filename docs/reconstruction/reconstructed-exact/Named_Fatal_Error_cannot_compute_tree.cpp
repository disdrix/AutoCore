// =============================================================================
// Named_Fatal_Error_cannot_compute_tree
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_Fatal_Error_cannot_compute_tree @ 0x005b7250
// Stable ID: aa_005b7250
...
"
 * Domain alias of FUN_005b7250 (FUN_* retained)
 *
...
Named_Fatal_Error_cannot_compute_tree(int param_1,uint32_t /* width from decompiler */ param_2,int param_3,uint32_t /* width from decompiler */ param_4,float param_5,
