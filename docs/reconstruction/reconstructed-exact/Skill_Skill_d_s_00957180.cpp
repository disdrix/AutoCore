...
/*
 * Behavioral notes:
 * String-driven rename evidence: "Skill %d: (%s)
...
uint32_t /* width from decompiler */ __thiscall Skill_Skill_d_s_00957180(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2,char *param_3)
