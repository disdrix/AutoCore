...
/*
 * Behavioral notes:
 * String-driven rename evidence: "VOGBlurFilter"
 *
...
uint32_t /* width from decompiler */ __fastcall Named_VOGBlurFilter_0055cf60(uint32_t /* width from decompiler */ *param_1)
