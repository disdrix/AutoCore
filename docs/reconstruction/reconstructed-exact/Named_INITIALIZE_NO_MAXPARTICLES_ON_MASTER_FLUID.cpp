...
// =============================================================================
// Named_INITIALIZE_NO_MAXPARTICLES_ON_MASTER_FLUID
// -----------------------------------------------------------------------------
...
uint32_t /* width from decompiler */ __fastcall Named_INITIALIZE_NO_MAXPARTICLES_ON_MASTER_FLUID(uint32_t /* width from decompiler */ *param_1)
