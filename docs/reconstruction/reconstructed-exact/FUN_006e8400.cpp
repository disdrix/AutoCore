...
// FUN_006e8400
// -----------------------------------------------------------------------------
// Stable ID: aa_006e8400
// Address:   0x006e8400  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006e8400 @ 0x006e8400
// Stable ID: aa_006e8400
...
//  - Notable callees: FUN_0063a190, FUN_006e8400.
//  - Return sites: 1.
...
void FUN_006e8400(int *param_1,uint32_t /* width from decompiler */ *param_2,int *param_3,uint32_t /* width from decompiler */ param_4,
...

{
  ...
  (**(code **)(*param_3 + 0x318c + (iVar2 * 0x20 + iVar3) * 4))
            ...
            (&local_80,param_2,param_3,param_4,param_5);
