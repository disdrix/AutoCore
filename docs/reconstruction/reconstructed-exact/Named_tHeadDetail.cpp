...
// PURPOSE (auto): Scaffold unit for Named_tHeadDetail @ 0x007ddac0
// Stable ID: aa_007ddac0
...
/*
 * Behavioral notes:
 * Plate-driven rename evidence: "//tHeadDetail/row[@lIDCloneBase='"
 * Domain alias of FUN_007ddac0 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ Named_tHeadDetail(int param_1)
