// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGCreature_SetupGraphics_00586060
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_CVOGCreature_SetupGraphics: creature/setup helper. Evidence string: "CVOGGraphicsBase::InitializeGraphics() - attempting to load asset more than once <%s>.. re". Supports parent flow (not a free-standing entry point).
// Embedded strings (evidence):
//   - "CVOGGraphicsBase::InitializeGraphics() - attempting to load asset more than once <%s>.. re"
//   - "Loading %s"
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Named_CalleeOf_CVOGCreature_SetupGraphics_00586060(int *param_1,uint32_t /* width from decompiler */ param_2)
