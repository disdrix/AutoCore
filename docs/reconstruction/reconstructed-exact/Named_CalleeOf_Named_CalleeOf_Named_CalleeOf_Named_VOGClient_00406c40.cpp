// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOGClient_00406c40
// -----------------------------------------------------------------------------
// Stable ID: aa_00406c40
// Callee of Named_CalleeOf_Named_CalleeOf_Named_VOGClient
// Address:   0x00406c40  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004192a0×2, FUN_004192f0×2, FUN_00401a40, FUN_00406c40, FUN_00407e30, _CxxThrowException.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOGClient_00406c40(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ *param_4,uint32_t /* width from decompiler */ param_5)
...

{
  ...
  piVar3 = (int *)FUN_00407e30(*(uint32_t /* width from decompiler */ *)(param_1 + 4),param_4,*(uint32_t /* width from decompiler */ *)(param_1 + 4),
...
LAB_00406d25:
        ...
        *(uint8_t *)(*(int *)(piVar6[1] + 4) + 0x28) = 0;
        ...
        FUN_004192f0(*(uint32_t /* width from decompiler */ *)(piVar6[1] + 4));
      ...
      *(uint8_t *)(*(int *)(piVar6[1] + 4) + 0x28) = 0;
      ...
      FUN_004192a0(*(uint32_t /* width from decompiler */ *)(piVar6[1] + 4));
