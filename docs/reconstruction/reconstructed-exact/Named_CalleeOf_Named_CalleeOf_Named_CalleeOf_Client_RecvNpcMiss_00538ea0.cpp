// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_RecvNpcMiss_00538ea0
// -----------------------------------------------------------------------------
...
//  - Notable callees: FUN_005681a0×2, FUN_005380d0, FUN_00538ea0, FUN_00568b70, _CxxThrowException, exception::exception.
...
Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_RecvNpcMiss_00538ea0(int param_1,uint32_t /* width from decompiler */ *param_2,char param_3,uint32_t /* width from decompiler */ *param_4,uint32_t /* width from decompiler */ param_5)
...

{
  ...
  piVar4 = (int *)FUN_005380d0(*(uint32_t /* width from decompiler */ *)(param_1 + 4),param_4,*(uint32_t /* width from decompiler */ *)(param_1 + 4),
  ...
  *(int *)(param_1 + 8) = *(int *)(param_1 + 8) + 1;
  ...
  do {
    ...
    if (cVar1 != '\0') {
      ...
      *(uint8_t *)(*(int *)(*(int *)(param_1 + 4) + 4) + 0x48) = 1;
...
LAB_00538fa6:
        ...
        *(uint8_t *)(piVar7[1] + 0x48) = 1;

        *(uint8_t *)(*(int *)(piVar7[1] + 4) + 0x48) = 0;

        FUN_005681a0(*(uint32_t /* width from decompiler */ *)(piVar7[1] + 4));
