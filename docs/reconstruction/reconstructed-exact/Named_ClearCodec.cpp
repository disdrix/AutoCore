...
uint32_t /* width from decompiler */ __thiscall Named_ClearCodec(int param_1,uint32_t /* width from decompiler */ *param_2,uint32_t /* width from decompiler */ *param_3,uint param_4)
