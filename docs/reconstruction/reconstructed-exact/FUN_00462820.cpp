...
// PURPOSE (auto): Scaffold unit for FUN_00462820 @ 0x00462820
// Stable ID: aa_00462820
...
uint32_t /* width from decompiler */ * FUN_00462820(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
