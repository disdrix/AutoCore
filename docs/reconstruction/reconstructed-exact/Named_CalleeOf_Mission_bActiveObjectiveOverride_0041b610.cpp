// =============================================================================
// Named_CalleeOf_Mission_bActiveObjectiveOverride_0041b610
// -----------------------------------------------------------------------------
// Stable ID: aa_0041b610
// Callee of Mission_bActiveObjectiveOverride (+1 other named callers)
// Address:   0x0041b610  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __fastcall Named_CalleeOf_Mission_bActiveObjectiveOverride_0041b610(int param_1)
...

{
  ...
  if ((puVar3 != *(uint32_t /* width from decompiler */ **)(param_1 + 4)) && ((int)puVar3[3] <= *unaff_EBX)) {
