// =============================================================================
// Named_CalleeOf_Client_SendInventoryUnequip_004f6a80
// -----------------------------------------------------------------------------
// Stable ID: aa_004f6a80
// Callee of Client_SendInventoryUnequip (+1 other named callers)
...
// PURPOSE (auto): Called from Client_SendInventoryUnequip: inventory/item helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Client_SendInventoryUnequip (+1 other named callers).
...
uint32_t /* width from decompiler */ __thiscall Named_CalleeOf_Client_SendInventoryUnequip_004f6a80(int param_1,int *param_2)
