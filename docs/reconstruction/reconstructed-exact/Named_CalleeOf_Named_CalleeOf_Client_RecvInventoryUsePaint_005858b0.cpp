// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Client_RecvInventoryUsePaint_005858b0
// -----------------------------------------------------------------------------
// Stable ID: aa_005858b0
// Callee of Named_CalleeOf_Client_RecvInventoryUsePaint
...
// PURPOSE (auto): Called from Named_CalleeOf_Client_RecvInventoryUsePaint: inventory/item helper. Evidence string: "MatColorPrimary". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Named_CalleeOf_Client_RecvInventoryUsePaint_005858b0(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ param_3,int param_4,uint32_t /* width from decompiler */ param_5,
