...
uint32_t /* width from decompiler */ __thiscall Named_VOG_DEBUG_STOP_005453b0(int param_1,uint32_t /* width from decompiler */ param_2,uint32_t /* width from decompiler */ *param_3)
