// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00462a60
// -----------------------------------------------------------------------------
// Stable ID: aa_00462a60
// Callee of Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxIndexBuff
// Address:   0x00462a60  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004014f0×2, FUN_0040e880×2, FUN_00401a40, FUN_00462a60, FUN_00463340, _CxxThrowException.
...
void __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00462a60(uint32_t /* width from decompiler */ *param_1,uint32_t /* width from decompiler */ *param_2,char param_3)
...

{
  ...
  piVar3 = (int *)FUN_00463340(*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4),param_1,*(uint32_t /* width from decompiler */ *)(unaff_EDI + 4)
  ...
  *(int *)(unaff_EDI + 8) = *(int *)(unaff_EDI + 8) + 1;
  ...
  if (param_1 == *(uint32_t /* width from decompiler */ **)(unaff_EDI + 4)) {
    ...
    **(uint32_t /* width from decompiler */ **)(unaff_EDI + 4) = piVar3;
    ...
    if (param_1 != *(uint32_t /* width from decompiler */ **)(iVar4 + 8)) goto LAB_00462b0e;
