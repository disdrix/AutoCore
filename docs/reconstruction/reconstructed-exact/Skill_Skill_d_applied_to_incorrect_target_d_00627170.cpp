...
// =============================================================================
// Skill_Skill_d_applied_to_incorrect_target_d_00627170
// -----------------------------------------------------------------------------
...
/*
 * Behavioral notes:
 * String-driven rename evidence: "Skill %d applied to incorrect target %d"
 *
...
Skill_Skill_d_applied_to_incorrect_target_d_00627170(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,uint param_4,int param_5,char param_6)
