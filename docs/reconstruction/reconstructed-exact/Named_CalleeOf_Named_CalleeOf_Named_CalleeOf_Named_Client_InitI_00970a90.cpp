// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_Client_InitI_00970a90
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Named_CalleeOf_Named_CalleeOf_Named_Client_InitInstance: callee helper. Evidence string: "Waiting for preload thread to shut down (%d)...\n". Supports parent flow (not a free-standing entry point).
...
//  - Notable callees: FUN_0076c130×2, WaitForSingleObject×2, FUN_00970a90, InterlockedDecrement, SetEvent, TerminateThread, down.
...
uint32_t /* width from decompiler */ Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_Client_InitI_00970a90(void)
