...
// Address:   0x0062fad0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_0062fad0 @ 0x0062fad0
// Stable ID: aa_0062fad0
...
//  - Control keywords: if×13, while×7, do×6, for×2, return×1.
//  - Notable callees: FUN_005d4370, FUN_0062c000, FUN_0062d8e0, FUN_0062d960, FUN_0062fad0.
//  - Return sites: 1.
...

{
  ...
  if (0 < iVar7) {
    ...
    do {
      ...
      puVar8 = (uint32_t /* width from decompiler */ *)(*(int *)(param_1 + 0x40) + iVar6);

      puVar9 = (uint32_t /* width from decompiler */ *)(iVar6 + local_14);
      ...
      *(uint32_t /* width from decompiler */ *)(local_28 + iVar1 * 8) =
  ...
  if (0 < *(int *)(param_1 + 0x44)) {
    ...
    do {
      ...
      *(int *)(local_3c + *piVar2 * 4) = iVar7;
      ...
      puVar8 = (uint32_t /* width from decompiler */ *)(local_14 + *piVar2 * 0x1c);

      puVar9 = (uint32_t /* width from decompiler */ *)(*(int *)(param_1 + 0x40) + iVar1);
  ...
  if (0 < *(int *)(param_1 + 0x70)) {
    ...
    do {
      ...
      while (iVar6 = iVar6 + -1, -1 < iVar6) {
        ...
        *(uint32_t /* width from decompiler */ *)(iVar5 + iVar6 * 4) =

             *(uint32_t /* width from decompiler */ *)(local_3c + *(int *)(iVar5 + iVar6 * 4) * 4);
