...
//  - Control keywords: if×20, return×7, for×1.
//  - Notable callees: FUN_004e23d0×3, FUN_004e2600×3, FUN_007a4480×3, CVOGReaction_RemoveObject, CVOGReaction_ResolveObjectTarget, FUN_004bc580, FUN_004d0e90, FUN_004e2360.
...
// Address:   0x004db8b0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
CVOGReaction_RemoveObject(void *this,uint uObjectID,uint32_t /* width from decompiler */ uInstanceID,char bRemoveType)
...

{
  ...
  if ((iVar4 == 1) || (iVar4 == 3)) {
    ...
    *(byte *)((int)piVar3 + 0x17d) = *(byte *)((int)piVar3 + 0x17d) & 0xef;
    ...
    if (*(int *)((int)this + 0xe500) != 0) {
      ...
      (**(code **)**(uint32_t /* width from decompiler */ **)((int)this + 0xe500))(piVar3);
  ...
  (**(code **)(*piVar3 + 0x2a8))(*(uint32_t /* width from decompiler */ *)((int)this + 0xe4e8));
