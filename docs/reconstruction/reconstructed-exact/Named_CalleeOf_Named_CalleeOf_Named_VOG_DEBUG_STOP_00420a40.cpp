// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_00420a40
// -----------------------------------------------------------------------------
// Stable ID: aa_00420a40
// Callee of Named_CalleeOf_Named_VOG_DEBUG_STOP
// Address:   0x00420a40  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00401a40, FUN_00420a40, _CxxThrowException.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_00420a40(uint param_1,int param_2)
...

{
  ...
  if (0x810204U - *(int *)(param_2 + 8) < param_1) {
