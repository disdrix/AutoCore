// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxVertexBuf_0045ff00
// -----------------------------------------------------------------------------
// Stable ID: aa_0045ff00
// Callee of Named_CalleeOf_Named_CalleeOf_Named_gfxVertexBufferImpl
// Address:   0x0045ff00  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004540b0, FUN_0045ff00, FUN_00460c10.
//  - Return sites: 1.
...
int __thiscall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxVertexBuf_0045ff00(int param_1,int param_2)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_2 + 0xc) = 0;
  ...
  if (uVar1 != 0) {
    ...
    pvVar2 = operator_new(uVar1 * 0x20);
    ...
    *(void **)(param_2 + 0xc) = (void *)(uVar1 * 0x20 + (int)pvVar2);

    uVar3 = FUN_00460c10(*(uint32_t /* width from decompiler */ *)(param_1 + 4),*(uint32_t /* width from decompiler */ *)(param_1 + 8),pvVar2,param_2);
