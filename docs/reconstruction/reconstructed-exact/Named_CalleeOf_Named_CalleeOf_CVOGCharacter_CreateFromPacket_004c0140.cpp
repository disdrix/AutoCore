// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGCharacter_CreateFromPacket_004c0140
// -----------------------------------------------------------------------------
// Stable ID: aa_004c0140
// Callee of Named_CalleeOf_CVOGCharacter_CreateFromPacket
...
// PURPOSE (auto): Called from Named_CalleeOf_CVOGCharacter_CreateFromPacket: packet/network helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve.
...
uint Named_CalleeOf_Named_CalleeOf_CVOGCharacter_CreateFromPacket_004c0140(int param_1,int param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4,uint32_t /* width from decompiler */ param_5,
