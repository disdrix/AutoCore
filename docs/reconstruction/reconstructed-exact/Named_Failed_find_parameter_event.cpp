// =============================================================================
// Named_Failed_find_parameter_event
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_Failed_find_parameter_event @ 0x005b8500
// Stable ID: aa_005b8500
...
//  - Notable callees: Named_Failed_find_parameter_event, FUN_007a4480, Map_LowerBoundFindByIntKey.
//  - Strings: "Failed to find parameter %d for event %d.".
//  - Return sites: 3.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "Failed to find parameter %d for event %d."
 * Domain alias of FUN_005b8500 (FUN_* retained)
 *
...
uint32_t /* width from decompiler */ * __thiscall Named_Failed_find_parameter_event(int param_1,int param_2,uint32_t /* width from decompiler */ param_3)
