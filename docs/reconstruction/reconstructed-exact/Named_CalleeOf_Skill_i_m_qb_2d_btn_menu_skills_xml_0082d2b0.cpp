// =============================================================================
// Named_CalleeOf_Skill_i_m_qb_2d_btn_menu_skills_xml_0082d2b0
// -----------------------------------------------------------------------------
// Stable ID: aa_0082d2b0
// Callee of Skill_i_m_qb_2d_btn_menu_skills_xml (+1 other named callers)
...
// PURPOSE (auto): Called from Skill_i_m_qb_2d_btn_menu_skills_xml: skill/cast helper. Evidence string: "i_d_pop_2d_wnd_blocker.xml". Supports parent flow (not a free-standing entry point). Skill_i_m_qb_2d_btn_menu_skills_xml (+1 other named callers).
...
//  - Notable callees: FUN_00416920, FUN_007b5dd0, FUN_0082d2b0.
...
void __fastcall Named_CalleeOf_Skill_i_m_qb_2d_btn_menu_skills_xml_0082d2b0(int *param_1)
