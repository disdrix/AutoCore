...
// FUN_006e0e20
// -----------------------------------------------------------------------------
// Stable ID: aa_006e0e20
// Address:   0x006e0e20  (autoassault.exe, image base 0x400000)
// System:    unknown
...
// PURPOSE (auto): Scaffold unit for FUN_006e0e20 @ 0x006e0e20
// Stable ID: aa_006e0e20
...
//  - Notable callees: ABS×3, rdtsc×2, FUN_005d69a0, FUN_006e0e20, SQRT.
//  - Strings: "TtSphereBox".
//  - Return sites: 1.
...
void FUN_006e0e20(int *param_1,int *param_2,int param_3,int *param_4)
...

{
  ...
  if ((g_flZero <= local_58 && g_flZero <= local_5c) && g_flZero <= local_60) {
    ...
    if (fVar6 <= fVar7) {
      ...
      if (fVar7 <= fVar8) goto LAB_006e1149;
...
LAB_006e1149:
    ...
    if (*(float *)(param_3 + 8) < local_34) goto LAB_006e120f;
