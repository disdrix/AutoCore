...
// PURPOSE (auto): Scaffold unit for FUN_0040f2a0 @ 0x0040f2a0
// Stable ID: aa_0040f2a0
...
void __thiscall FUN_0040f2a0(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3,int *param_4)
