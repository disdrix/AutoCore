...
// Address:   0x00929ec0  (autoassault.exe, image base 0x400000)
// System:    unknown
...
LAB_0092a0be:
    ...
    *(uint32_t /* width from decompiler */ *)((int)outWaypointTfid + 8) = DAT_00a158a8;
    *(uint32_t /* width from decompiler */ *)((int)outWaypointTfid + 0xc) = DAT_00a158ac;
    return;
  }
  if (-1 < in_EAX) {
...
LAB_0092a1a8:
        ...
        *(uint32_t /* width from decompiler */ *)((int)outWaypointTfid + 8) = *(uint32_t /* width from decompiler */ *)&pTfid->bGlobal;
        *(uint32_t /* width from decompiler */ *)((int)outWaypointTfid + 0xc) = *(uint32_t /* width from decompiler */ *)&pTfid->bPad3;
        return;
      }
      ...
      pTfid->bGlobal = (uint8_t)DAT_00a158a8;
      pTfid->bPad0 = uVar1;
      pTfid->bPad1 = uVar2;
      pTfid->bPad2 = uVar3;
      ...
      pTfid->bPad3 = (uint8_t)DAT_00a158ac;
      pTfid->bPad4 = uVar1;
      pTfid->bPad5 = uVar2;
      pTfid->bPad6 = uVar3;
      *(uint8_t *)((int)patrolManager + 4) = 1;
