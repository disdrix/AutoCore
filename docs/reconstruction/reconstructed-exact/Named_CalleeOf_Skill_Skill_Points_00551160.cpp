// =============================================================================
// Named_CalleeOf_Skill_Skill_Points_00551160
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Skill_Skill_Points: skill/cast helper. Evidence string: " Self,". Supports parent flow (not a free-standing entry point).
...
char __thiscall Named_CalleeOf_Skill_Skill_Points_00551160(int param_1,char *param_2)
