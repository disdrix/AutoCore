...
//  - Control keywords: if×27, return×3, goto×3, for×1.
//  - Notable callees: CVOGReaction_RandomUnitScalar×2, FUN_00512440×2, FUN_005134e0×2, FUN_005172d0×2, FUN_007a4480×2, fails×2, owner×2, CVOGHBAIBase_FindTargetToAttack.
//  - Strings: "CVOGHBAIBase::FindTargetToAttack"; "VOG_DEBUG_STOP".
//  - Return sites: 3.

// =============================================================================
// CVOGHBAIBase_FindTargetToAttack
// -----------------------------------------------------------------------------
// Purpose:  Spatial scan for a valid attack target around the HBAI owner. Filters dead/
//           respawn owners, hostiles, team bit, aggro, level-scaled radius;
//           commits selection via FUN_005172d0.
//
// Address:  0x00639210  (autoassault.exe, image base 0x400000)
// Stable:   aa_00639210
// System:   npc-ai / HBAI
//
// Convention: __fastcall this = CVOGHBAIBase* (int* decomp).
// Scoped string: "CVOGHBAIBase::FindTargetToAttack".
//
// Control flow summary:
//   1) Bail if owner this[6] null
//   2) Owner vtbl+0x214 / +0x19c validate (debug-stop if fail)
//   3) Seed this[2] from RandomUnitScalar % this[10]/2 + this[10]
//   4) Root race == -100 OR owner+0x278==2 (dead) -> no target
//   5) owner+0x278==3 (respawn) -> no target
//   6) Else spatial FUN_004ea350(attackRadius from profile +0x4cc)
//   7) Iterate hits: hostile FUN_005134e0, clear bit10 of +0x180, aggro
//      vtbl+0x298, alive vtbl+0x198, race!=-100; level-delta shrinks r^2
//   8) FUN_005172d0(selected); FUN_00639710 cleanup
//
// Key owner offsets: +0x278 death/respawn; profile radius +0x4cc.
...
// Dual reviews:
//   reviews/A_aa_00639210_CVOGHBAIBase_FindTargetToAttack.md
//   reviews/B_aa_00639210_CVOGHBAIBase_FindTargetToAttack.md
// =============================================================================
      ...
      if (iVar7 == 0) {
        ...
        *(int *)(iVar8 + 0xc) = *(int *)(iVar8 + 0xc) + 1;
        ...
        if ((RVar9 == 0xffffff9c) || (*(char *)(iVar6 + 0x278) == '\x02')) {
          ...
          uVar4 = *(uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(iVar7 + 4) + 4) + 0xa8 + iVar7);
