...
// PURPOSE (auto): Scaffold unit for FUN_0053a7e0 @ 0x0053a7e0
// Stable ID: aa_0053a7e0
...
uint32_t /* width from decompiler */ * FUN_0053a7e0(int param_1,int param_2,uint32_t /* width from decompiler */ *param_3)
