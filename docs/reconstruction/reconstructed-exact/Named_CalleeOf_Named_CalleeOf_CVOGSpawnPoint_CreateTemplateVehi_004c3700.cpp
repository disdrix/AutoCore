// =============================================================================
// Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_CreateTemplateVehi_004c3700
// -----------------------------------------------------------------------------
// Stable ID: aa_004c3700
// Callee of Named_CalleeOf_CVOGSpawnPoint_CreateTemplateVehicle
// Address:   0x004c3700  (autoassault.exe, image base 0x400000)
// System:    unknown
...
void __thiscall Named_CalleeOf_Named_CalleeOf_CVOGSpawnPoint_CreateTemplateVehi_004c3700(int param_1,int param_2)
