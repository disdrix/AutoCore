// =============================================================================
// Named_CalleeOf_Named_Invalid_Packet_0042fe60
// -----------------------------------------------------------------------------
// Stable ID: aa_0042fe60
// Callee of Named_Invalid_Packet (+2 other named callers)
...
// PURPOSE (auto): Called from Named_Invalid_Packet: packet/network helper with no high-value strings in clean/raw. Role inferred from parent name only; refine when decompile strings or xrefs improve. Named_Invalid_Packet (+2 other named callers).
...
void __fastcall Named_CalleeOf_Named_Invalid_Packet_0042fe60(uint32_t /* width from decompiler */ param_1,int *param_2)
