...
// PURPOSE (auto): Scaffold unit for FUN_006bf8c0 @ 0x006bf8c0
// Stable ID: aa_006bf8c0
...
void FUN_006bf8c0(uint32_t /* width from decompiler */ param_1,int *param_2,int param_3,int param_4,int *param_5)
