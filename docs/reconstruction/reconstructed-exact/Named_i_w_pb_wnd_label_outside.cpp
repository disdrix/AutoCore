// =============================================================================
// Named_i_w_pb_wnd_label_outside
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Scaffold unit for Named_i_w_pb_wnd_label_outside @ 0x00854a20
// Stable ID: aa_00854a20
...
//  - Notable callees: FUN_007b5dd0×4, FUN_00792600, Named_i_w_pb_wnd_label_outside, FUN_0097ffa0.
//  - Strings: "i_w_pb_wnd_bg_texture.xml"; "i_w_pb_gauge.xml"; "i_w_pb_wnd_label_inside.xml"; "i_w_pb_wnd_label_outside.xml".
//  - Return sites: 1.

/*
 * Behavioral notes:
 * Plate-driven rename evidence: "i_w_pb_wnd_label_outside.xml"
 * Domain alias of FUN_00854a20 (FUN_* retained)
 *
...
void __fastcall Named_i_w_pb_wnd_label_outside(int *param_1)
