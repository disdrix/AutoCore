// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_createNDUI_008df710
// -----------------------------------------------------------------------------
// Stable ID: aa_008df710
// Callee of Named_CalleeOf_Named_CalleeOf_Mission_createNDUIDialogs
// Address:   0x008df710  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_004133c0×2, FUN_008df710.
//  - Return sites: 1.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_createNDUI_008df710(int param_1)
...

{
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x550) = 0;
  ...
  puVar2 = (uint32_t /* width from decompiler */ *)(param_1 + 0x598);
  ...
  *(uint32_t /* width from decompiler */ *)(param_1 + 0x6a8) = 0xffffffff;
