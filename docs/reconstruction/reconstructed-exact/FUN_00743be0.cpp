...
// PURPOSE (auto): Scaffold unit for FUN_00743be0 @ 0x00743be0
// Stable ID: aa_00743be0
...
uint32_t /* width from decompiler */ __thiscall FUN_00743be0(int *param_1,int param_2,int param_3,uint param_4)
