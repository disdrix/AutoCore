...
// PURPOSE (auto): Scaffold unit for FUN_007c6110 @ 0x007c6110
// Stable ID: aa_007c6110
...
uint32_t /* width from decompiler */ __thiscall FUN_007c6110(char *param_1,uint32_t /* width from decompiler */ *param_2,int param_3)
