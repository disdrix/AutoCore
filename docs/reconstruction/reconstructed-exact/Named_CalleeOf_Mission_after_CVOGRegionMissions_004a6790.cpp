// =============================================================================
// Named_CalleeOf_Mission_after_CVOGRegionMissions_004a6790
// -----------------------------------------------------------------------------
...
// PURPOSE (auto): Called from Mission_after_CVOGRegionMissions: mission/objective helper. Evidence string: "system_LightningEmitter". Supports parent flow (not a free-standing entry point).
...
void Named_CalleeOf_Mission_after_CVOGRegionMissions_004a6790(void)
