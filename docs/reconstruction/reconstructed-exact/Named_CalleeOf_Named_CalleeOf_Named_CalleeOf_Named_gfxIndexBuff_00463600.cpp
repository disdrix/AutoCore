// =============================================================================
// Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxIndexBuff_00463600
// -----------------------------------------------------------------------------
// Stable ID: aa_00463600
// Callee of Named_CalleeOf_Named_CalleeOf_Named_gfxIndexBufferImpl
// Address:   0x00463600  (autoassault.exe, image base 0x400000)
// System:    unknown
...
//  - Notable callees: FUN_00460380, FUN_00462fc0, FUN_00463600.
//  - Return sites: 1.
...
void __fastcall Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_gfxIndexBuff_00463600(uint32_t /* width from decompiler */ *param_1,int param_2,uint32_t /* width from decompiler */ *param_3)
