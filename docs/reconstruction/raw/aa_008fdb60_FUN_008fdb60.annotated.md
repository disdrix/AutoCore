# Annotated low-level: FUN_008fdb60
...
- Source: raw capture for `aa_008fdb60`.
...
LAB_008fde97:
  ...
  if ((DAT_00d1b6d8 == 0) || (*(int *)(DAT_00d1b6d8 + 0x250) == 0)) {
    ...
    lStack_1e4 = FUN_004f5930(*(undefined1 *)(param_1 + 0x528));
  }
  if ((DAT_00d1b6d8 == 0) || (*(int *)(DAT_00d1b6d8 + 0x250) == 0)) {
    uStack_1dc = 0;
  }
  else {
    uStack_1dc = FUN_004f5970(*(undefined4 *)(param_1 + 0x7c8),*(undefined4 *)(param_1 + 0x7e0));
  }
  uVar15 = (undefined4)uStack_1dc;
  if (*(int *)(param_1 + 0x740) == 0) {
LAB_008fdf4b:
    lStack_1f0 = 0;
    uVar2 = uStack_1dc;
  ...
  uStack_1dc._4_4_ = (undefined4)((ulonglong)uVar2 >> 0x20);
...
LAB_008fe24f:
      ...
      do {
        ...
        if (0 < iVar9) {
          uVar15 = FUN_007a6de0(*(undefined4 *)((int)&PTR_s_Pipes_00af9180 + iVar6),0xffffffff);
...
LAB_008fe336:
      ...
      FUN_00977a30(DAT_00d1ad30,iStack_1e8,(undefined4)lStack_1e4);
      (**(code **)(**(int **)(param_1 + 0x71c) + 0x250))(&DAT_00a15104);
    }
    else {
      iVar9 = **(int **)(param_1 + 0x71c);
