# Annotated low-level: CVOGHBRegeneration_OnHeartBeat

| Field | Value |
|---|---|
| Stable ID | a_005fbea0 |
| VA | 0x005fbea0 |
| System | unknown |
| Date | 2026-07-23 |
...
Combat-pool pulse: HP/power/heat/shield regen. Period 3s race 0-2 else 5s.
...
- Source: raw capture for a_005fbea0.
...

{
  ...
  if (pVehicle == (VehicleCombatPools_Inferred *)0x0) {
    ...
    uVar1 = __RTDynamicCast(*(undefined4 *)
