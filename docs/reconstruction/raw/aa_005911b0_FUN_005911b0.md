...
undefined4 __thiscall FUN_005911b0(int *param_1,char param_2)
  ...
  if (param_1[0x245] != 0) {
    ...
    if ((char)param_1[0x21e] != '\0') {
      ...
      local_4f8 = (int *)CONCAT22(local_4f8._2_2_,
                                  ...
                                  *(undefined2 *)(*(int *)(iVar7 + 8) + *(int *)(iVar7 + 0xc) * 2));
...
LAB_00591885:
  ...
  if (((char)param_1[0x243] < '\0') || ((*(byte *)((int)param_1 + 0x90d) & 1) != 0)) {
    ...
    if ((char)param_1[0x243] < '\0') {
      ...
      uVar23 = (undefined4)((ulonglong)uVar21 >> 0x20);
    ...
    if ((((DAT_00b036d4 != (int *)0x0) && (*DAT_00b036d4 != 0)) && (param_1[5] != 0)) &&
      ...
      local_4f8 = (int *)FUN_0058fd30((int)param_1 + 0x2be,piVar9,param_1[0x2d],param_1[0x2e],
                                      ...
                                      CONCAT31((int3)((uint)uVar23 >> 8),
                                               ...
                                               *(undefined1 *)((int)param_1 + 0x90d)) & 0xffffff01,
          ...
          do {
            ...
            *(int *)(iVar17 + 0xc) = *(int *)(iVar17 + 0xc) + 1;
            ...
            local_4f8 = (int *)FUN_0058fd30((int)param_1 + 0x2be,piStack_4e4,param_1[0x2d],
                                            ...
                                            CONCAT31((int3)((uint)*(undefined4 *)(param_1[5] + 0x2c)

                                                           >> 8),

                                                     *(undefined1 *)((int)param_1 + 0x90d)) &

                                            0xffffff01,*(undefined4 *)(param_1[5] + 0x2c));
    ...
    if (param_1[0x98] == 0) {
      ...
      if ((param_1[0x9a] == 0) ||
        ...
        if (cVar5 == '\0') {
          ...
          *(undefined4 *)((int)pvVar11 + 0x100) = 0;
        ...
        *(undefined4 *)((int)pvVar11 + 0x108) = uVar23;
        ...
        *(float *)((int)pvVar11 + 0x170) = fVar18;
        ...
        if (cVar5 == '\0') {
          ...
          puVar4 = *(undefined4 **)((int)pvVar11 + 0x108);
...
LAB_005927a4:
      ...
      if (param_1[0x98] == 0) {
        ...
        puVar4 = (undefined4 *)param_1[0x9a];
...
**Tools:** Ghidra `decompile_function` + `analyze_function_complete` + `read_memory` + `get_function_callers` + `get_function_callees` + `get_function_by_address`. **No** `disassemble_bytes`. No Launcher.

| Field | Value |
|---|---|
| Body | `0x005911b0`–`0x00593233` (8324 B / `0x2083`) |
| ABI | **`__thiscall`**: ECX = object*; stack `char force_or_mode`; **`ret 4`**; AL/EAX = 1 success / 0 early abort |
| Profiler root | `FUN_0076cf00("Just created")` |
| Nested profiler | `"skyboxphase"`, `"ragdoll"`, `"rigidbody"`, `"addEntity"` |
| Callers | `FUN_00594290` (batch, passes `1`), `FUN_00595230` (tick, passes `0`) |
| Role | Object **Just-created** physics/gfx finalize: pose, skybox particles, ragdoll, rigidbody, entity add |

### Signature (live)

```c
undefined4 __thiscall FUN_005911b0(int *param_1 /*this*/, char param_2);
// returns 1 at LAB_0059320b; returns 0 on early abort path via FUN_004a7a20
```

### Entry / gate CF (sealed)

1. Install SEH (`LAB_009a595f`); open profiler `"Just created"`.
2. If `*(byte*)(this + 0x910) & 1` (`param_1[0x244]` as int* → byte @ `+0x910`) → **goto** `LAB_0059320b` (return **1**, already done).
3. Else if `param_2 == 0` AND (`*(byte*)(this+0x90d) & 1` OR (`*(byte*)(this+0x90c)` bit7 / `param_1[0x243]&0x80` AND global `DAT_00b036d4` live)):
   - `FUN_004a7a20(&this)` then return **0**.
4. Else continue full init: copy pending pos `this[0x209..0x20b]` → `this[0x206..0x208]` (`+0x818..+0x824` dword indices).

### Phase map (structural)

| Phase | Gate / string | Work |
|---|---|---|
| Gfx pose | `this[0x245]` (gfx body ptr @ `+0x914`) nonzero | Build orientation (flags @ `+0x90d` bits `0x20/0x40/0x80`), random unit scalars via `CVOGReaction_RandomUnitScalar` + `DAT_00aaa638` (= `1/65535`), apply via vfunc `+0x10` + sealed `CVOGPhysics_SetPosition`/`SetRotation` helpers |
| Skybox | profiler `"skyboxphase"` | Walk gfx particle list `@gfx+0xc0..+0xc4`; optional `"SkyBoxParticles"` log |
| Attach FX | flags `@+0x90e bit7` etc. | `FUN_0096dc80` once (`@+0x90f \|= 1`) |
| Scale | clonebase `@this[10]` flags `0x200/0x400` @ `+0x3c8` | Optional random scale into `this[0xa2]` |
| Ragdoll | `@+0x90d` bit2 set, bit3 clear | profiler `"ragdoll"`; load ragdoll; error string `"RagDoll file read error..."` |
| Rigidbody | needs `@+0x90c bit7` OR `@+0x90d bit0`, plus owner phys | profiler `"rigidbody"`; build/attach RB, multi-body clones, impulse vectors |
| Add entity | `this[0x98]` RB present | profiler `"addEntity"`; `FUN_00560ec0` |
| Exit | `LAB_0059320b` | close profiler; return **1** |

### Constants (read_memory)

| Symbol | VA | Value |
|---|---|---|
| `DAT_00aaa638` | `0x00aaa638` | float `1.525902e-05` ≈ **1/65535** (u16→unit scale) |
| Entry prolog | `0x005911b0` | `push ebp; mov ebp,esp; and esp,-0x10; SEH; sub esp,0x4e8` |
| Epilogue | `0x0059320b+` | `mov al,1`; restore SEH; **`ret 4`** (`C2 04 00`) |

### Callers (live)

| Caller | Site | Mode |
|---|---|---|
| `FUN_00594290` | `0x005942a4` | Batch over `DAT_00b04e68..6c`; calls with **`1`**; then `*(this+0x910) \|= 1` |
| `FUN_00595230` | `0x00595d07` | Object update; when `@+0x90e & 8`, calls with **`0`**; if return 0, abort tick early |

### Notable sealed callees used

`CVOGReaction_RandomUnitScalar`, `FUN_0040cf90` / `FUN_0040d1a0` / `FUN_0040d2a0` (`CVOGPhysics_SetPosition`), `FUN_00404dc0` (`CVOGPhysics_SetRotation`), `FUN_004e8bf0` (quat transform), `FUN_004e9530` / `FUN_004e88e0` / `FUN_004e96e0` math pods, `FUN_0076cf00`/`FUN_0076cef0` profiler pair.

### Gaps (not sealed this dual)

- Full product English for every flag bit @ `+0x90c..+0x911`.
- Exact type name of `this` beyond CVOG object-with-gfx/RB (likely `CVOGObject` family).
- Bit-exact / runtime golden of multi-RB spawn path.
- Deep dual of every nested callee body (OWN-ONLY this VA).
