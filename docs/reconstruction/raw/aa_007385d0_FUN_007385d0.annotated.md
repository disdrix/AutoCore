# Annotated low-level: FUN_007385d0
...
- Source: raw capture for `aa_007385d0`.
...

{
  ...
  if (iVar18 != *(int *)(iVar11 + 0x2c)) {
    ...
    if ((*(int *)(iVar11 + 0x10) == 0) ||
       (pfVar8 = (float *)FUN_00746520(*(undefined4 *)(iVar11 + 0x14),*(undefined4 *)(iVar11 + 0x18)
                                       ,4), pfVar8 == (float *)0x0)) {
      FUN_00414a50();
      return;
    }
...
LAB_007387e0:
      ...
      case 10:
        for (iVar10 = *(int *)(*(int *)(param_1 + 0x14) + 0x28);
          ...
          if ((*(char *)(iVar10 + 6) == *(char *)(iVar18 + 6)) &&
             (*(char *)(iVar10 + 7) == *(char *)(iVar18 + 7))) {
            puVar15 = (undefined4 *)((uint)*(ushort *)(iVar18 + 2) + (int)DAT_00d1ed14);
            uVar24 = FUN_007467b0();
            if (-1 < local_2c + -1) {
              local_1c = local_2c;
              puVar13 = (undefined4 *)((ulonglong)uVar24 >> 0x20);
              do {
                puVar17 = puVar13;
                puVar20 = puVar15;
                ...
                puVar13 = (undefined4 *)((int)puVar13 + local_28);
                puVar15 = (undefined4 *)((int)puVar15 + iVar11);
              } while (local_1c != 0);
            }
            break;
          }
...
LAB_00738a54:
    ...
    if (pfVar8 != (float *)0x0) {
      ...
      for (uVar14 = local_4 & 3; uVar14 != 0; uVar14 = uVar14 - 1) {
        *(undefined1 *)pfVar8 = *(undefined1 *)pfVar19;
