# Annotated low-level: FUN_007b4730
...
- Source: raw capture for `aa_007b4730`.
...
```c
void FUN_007b4730(int param_1,int param_2,undefined4 param_3,byte param_4,byte *param_5,int param_6,
...
LAB_007b47c3:
      ...
      if (bVar10 || param_2 < local_b4) {
        ...
        if (param_5 != (byte *)0x0) {
          bVar1 = param_5[3];
          bVar2 = *param_5;
          local_a4 = (undefined1 *)(((uint)param_5[1] * (uVar7 >> 8 & 0xff)) / 0xff);
          *(char *)((int)piVar9 + 0x1e) = (char)(((uint)param_5[2] * (uVar7 >> 0x10 & 0xff)) / 0xff)
          ;
          *(undefined1 *)((int)piVar9 + 0x1d) = local_a4._0_1_;
        ...
        if (cVar4 != '\0') {
          if (piVar9[4] == 0) {
            if (((undefined1 *)piVar9[8] != (undefined1 *)0x0) &&
              ...
              puStack_e8 = (undefined1 *)piVar9[8];
            ...
            if ((param_8 == 0) || (param_8 <= (uint)piVar9[4])) {
              ...
              local_90 = local_8c;
              puStack_e8 = (undefined1 *)0x7b4a15;
              puStack_e8 = (undefined1 *)(*(code *)PTR_FUN_00af8c9c)();
              local_ec = piVar6;
              FUN_00403450();
              uStack_4 = 0;
              puStack_e8 = local_90 + param_8;
              local_a4 = (undefined1 *)&local_ec;
