# Annotated low-level: FUN_00756460
...
- Source: raw capture for `aa_00756460`.
...
```c
undefined4 __thiscall FUN_00756460(int param_1,void *param_2)

{
  ...
  *(undefined1 *)(DAT_00d1f048 + 0xf) = *(undefined1 *)(param_1 + 0x78);
  ...
  iStack_138 = *(undefined4 *)(param_1 + 0x68);
