# Annotated low-level: Vehicle_buildHavokVehicleFramework

| Field | Value |
|---|---|
| Stable ID | a_005fd390 |
| VA | 0x005fd390 |
...
Build Havok vehicle from aero/steer/trans/suspension descriptors.
...
- Source: raw capture for a_005fd390.
...
int Vehicle_buildHavokVehicleFramework
              (float *param_1,undefined4 param_2,undefined4 param_3,int param_4,undefined4 param_5)

{
  ...
  puStack_234 = (undefined4 *)0x5fd3bd;
  ...
  local_1bc = param_5;
  local_1d8 = param_4;
  puStack_234 = (undefined4 *)0x5fd3fa;
  FUN_0064ff90();
  ...
  *(undefined2 *)(iVar2 + 4) = 0x390;
  ...
  puStack_244 = (undefined1 *)0x5fd487;
  iVar2 = (**(code **)(*DAT_00b05060 + 0x10))();
  *(undefined2 *)(iVar2 + 4) = 0x40;
  ...
  uStack_24 = 1;
  puStack_244 = (undefined1 *)0x5fd4ba;
  FUN_0064fd30();
  ...
  uStack_24 = 4;
  Vehicle_BuildSteeringDescriptor();
  puStack_244 = (undefined1 *)0xa;
  uStack_248 = 0x38;
  if (*(char *)(*(int *)(*(int *)(*(int *)((int)param_1[1] + 4) + 0xac + (int)param_1) + 0x3c) +
               0x4c0) == '\x04') {
    pfStack_24c = (float *)0x5fd4f9;
    puStack_234 = (undefined4 *)(**(code **)(*DAT_00b05060 + 0x10))();
    *(undefined2 *)((int)puStack_234 + 4) = 0x38;
  ...
  *(undefined2 *)((int)pfStack_23c + 4) = 0x3c;
  uStack_34 = 7;
  ...
  puStack_244 = (undefined1 *)(**(code **)(*DAT_00b05060 + 0x10))(0x60,10);
  *(undefined2 *)((int)puStack_244 + 4) = 0x60;
  uStack_3c = 9;
