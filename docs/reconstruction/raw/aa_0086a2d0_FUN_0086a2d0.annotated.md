# Annotated low-level: FUN_0086a2d0
...
- Source: raw capture for `aa_0086a2d0`.
...
LAB_0086a570:
    ...
    for (uVar10 = uVar8 >> 2; uVar10 != 0; uVar10 = uVar10 - 1) {
      *(undefined4 *)pcVar7 = *(undefined4 *)pcVar13;
      pcVar13 = pcVar13 + 4;
      pcVar7 = pcVar7 + 4;
    }
...
LAB_0086a67b:
  ...
  if (uVar8 < 0x20) {
    ...
    if (uVar8 < 0x40) {
      ...
      *(undefined4 *)pcVar13 = DAT_00a5a674;
      goto LAB_0086a6f6;
    }
    if (uVar8 < 0x60) {
      do {
      ...
      *(undefined4 *)pcVar13 = DAT_00a5a670;
      goto LAB_0086a6f6;
    }
    do {
      pcVar7 = pcVar13 + 1;
