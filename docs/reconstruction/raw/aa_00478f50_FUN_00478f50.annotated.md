# Annotated low-level: FUN_00478f50
...
- Source: raw capture for `aa_00478f50`.
...
LAB_00479cfe:
        *puVar2 = 0xb;
        ...
        for (uVar9 = local_2c >> 2; uVar9 != 0; uVar9 = uVar9 - 1) {
          *(undefined4 *)pbVar17 = *(undefined4 *)pbVar6;
          pbVar6 = pbVar6 + 4;
          pbVar17 = pbVar17 + 4;
        }
        ...
        do {
          ...
          if (0xf < uVar5) {
            if (uVar5 == 0x10) {
              ...
              if (puVar2[0x18] != 0) {
                uVar1 = *(undefined2 *)((int)puVar2 + puVar2[0x18] * 2 + 0x66);
...
LAB_00479a33:
              if (puVar2[0x18] + local_2c <= puVar2[0x17] + puVar2[0x16]) {
                if (local_2c != 0) {
                  local_10 = local_2c;
                  do {
                    *(undefined2 *)((int)puVar2 + puVar2[0x18] * 2 + 0x68) = uVar1;
                    puVar2[0x18] = puVar2[0x18] + 1;
                    local_10 = local_10 + -1;
                  } while (local_10 != 0);
                }
