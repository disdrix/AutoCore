# Annotated low-level: FUN_0051c510
...
- Source: raw capture for `aa_0051c510`.
...
```c
void __thiscall
FUN_0051c510(int param_1,undefined4 *param_2,char param_3,undefined4 *param_4,undefined4 param_5)
