# Annotated low-level: FUN_0042ccf0
...
- Source: raw capture for `aa_0042ccf0`.
  ...
  if (0 < param_1[9]) {
    do {
      ...
      if (*(int *)(*(int *)(param_1[0xb] + iVar1 * 4) + 0x10c) != 0) {
        while( true ) {
          iVar2 = FUN_00785070(*(undefined4 *)(*(int *)(param_1[0xb] + iVar1 * 4) + 0x10c),
  ...
  if (0 < param_1[3]) {
    do {
      ...
      if (*(int *)(*(int *)(param_1[5] + iVar1 * 4) + 0x10c) != 0) {
        while( true ) {
          iVar2 = FUN_00785070(*(undefined4 *)(*(int *)(param_1[5] + iVar1 * 4) + 0x10c),&local_74c,
  ...
  while (param_1[0x1b] != 0) {
    ...
    if ((uint)param_1[0xd] < uVar5) {
      ...
      if ((void *)param_1[0xc] != (void *)0x0) {
        ...
        do {
          if ((undefined4 *)(param_1[0xe] + iVar1) != (undefined4 *)0x0) {
            puVar7 = (undefined4 *)((int)pvVar3 + iVar1);
            puVar8 = (undefined4 *)(param_1[0xe] + iVar1);
    ...
    puVar7 = (undefined4 *)(param_1[0xe] + -0x1c + param_1[0xc] * 0x1c);
  ...
  if (0 < param_1[0xc]) {
    ...
    do {
      ...
      if ((uint)(param_1[0x1e] - *(int *)(param_1[0xe] + 0x18 + local_754)) < 0x7531) {
        local_755 = '\0';
        while( true ) {
          iVar1 = FUN_00785070(*(undefined4 *)(SVar6 + param_1[0xe]),&local_74c,local_5d4,0x5d2,
                               &local_750);
          if (local_6f8 != '\0') {
            local_6f8 = '\0';
            free(local_700);
          ...
          iVar1 = (**(code **)(*param_1 + 0x14))
                             ...
                             *(undefined4 *)(param_1[0xe] + SVar6));
          if (iVar1 != 0) {
            *(undefined4 *)(iVar1 + 0x10c) = *(undefined4 *)(SVar6 + param_1[0xe]);
            local_755 = '\x01';
          }
        }
...
LAB_0042d227:
        if (local_75c != (void *)(param_1[0xc] + -1)) {
          puVar7 = (undefined4 *)(param_1[0xe] + -0x1c + param_1[0xc] * 0x1c);
          puVar8 = (undefined4 *)(param_1[0xe] + local_754);
  ...
  while (local_708 != (undefined4 *)0x0) {
    puVar7 = (undefined4 *)local_708[2];
    *local_708 = 0;
    local_708[1] = 0;
    local_708[2] = 0;
    local_708 = puVar7;
