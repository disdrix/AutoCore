# Annotated low-level: FUN_00574470
...
- Source: raw capture for `aa_00574470`.
...
```c
void __thiscall FUN_00574470(int param_1,void *param_2,uint param_3,undefined4 *param_4)
