# Annotated low-level: FUN_0053c760
...
- Source: raw capture for `aa_0053c760`.
...
```c
undefined4 __thiscall FUN_0053c760(void *param_1,uint param_2,int param_3,char param_4)
