# Annotated low-level: FUN_0055c450
...
- Source: raw capture for `aa_0055c450`.
...
```c
void __thiscall FUN_0055c450(int param_1,int param_2,uint param_3,undefined4 *param_4)
