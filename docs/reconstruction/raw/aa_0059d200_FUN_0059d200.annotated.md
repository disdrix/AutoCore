# Annotated low-level: FUN_0059d200
...
- Source: raw capture for `aa_0059d200`.
...
```c
undefined4 __thiscall FUN_0059d200(void *param_1,uint param_2,int param_3,char param_4)
