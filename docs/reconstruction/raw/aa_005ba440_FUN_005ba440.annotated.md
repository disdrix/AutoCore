# Annotated low-level: FUN_005ba440
...
- Source: raw capture for `aa_005ba440`.
...
```c
undefined4 __thiscall FUN_005ba440(int *param_1,float param_2)
    ...
    if ((-1 < (char)param_1[0x5e]) &&
      ...
      if (((param_1[0x5e] & 0x200U) == 0) && (param_1[0x23] < param_1[0x22])) {
        ...
        if (piVar9 == (int *)0x0) {
          ...
          *(undefined1 *)((int)piVar9 + 0x2e) = 0xff;
          *(undefined1 *)((int)piVar9 + 0x2d) = 0xff;
          *(undefined1 *)(piVar9 + 0xb) = 0xff;
          *(undefined1 *)((int)piVar9 + 0x2f) = 0xff;
        }
        ...
        **(undefined4 **)(param_1[0x31] + 4) = piVar9;
