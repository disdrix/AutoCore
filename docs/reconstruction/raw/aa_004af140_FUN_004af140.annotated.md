# Annotated low-level: FUN_004af140
...
- Source: raw capture for `aa_004af140`.
...
```c
void __thiscall
FUN_004af140(int param_1,undefined4 *param_2,char param_3,undefined4 *param_4,undefined4 param_5)
