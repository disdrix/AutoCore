# Annotated low-level: FUN_0069e2c0
...
- Source: raw capture for `aa_0069e2c0`.
...
```c
void __thiscall FUN_0069e2c0(int param_1,undefined4 param_2,int param_3,int param_4)
      ...
      if (piVar9 != (int *)*local_7c) {
        do {
          ...
          if ((*(byte *)(param_1 + 0x74) & 2) != 0) {
            FUN_006a26c0(param_2,&local_6c,*(undefined4 *)(param_1 + 0x70));
          }
          piVar9 = piVar9 + 1;
