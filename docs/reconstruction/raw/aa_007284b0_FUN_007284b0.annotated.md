# Annotated low-level: FUN_007284b0
...
- Source: raw capture for `aa_007284b0`.
...
```c
undefined4 FUN_007284b0(int param_1)

{
  ...
  if (*(int *)(unaff_EDI + 0x18) != 0) {
    (**(code **)(**(int **)(unaff_EDI + 0x18) + 0x2c))(*(undefined1 *)(param_1 + 0x10));
  }
  ExceptionList = local_c;
  return 0;
}
