# Annotated low-level: QuickBar_UpdateSlotCooldownOverlay
...
- Source: raw capture for `aa_00827ab0`.
...

{
  ...
  if (*(int *)((int)pButton + 0x548) == 2) {
    if ((((DAT_00d1b6d8 == (void *)0x0) || (*(int *)((int)DAT_00d1b6d8 + 0x250) == 0)) ||
       ...
       ((piVar3 = (int *)FUN_005710c0(*(undefined4 *)((int)pButton + 0x550),0,0),
        piVar3 == (int *)0x0 &&
        (piVar3 = (int *)FUN_005710c0(*(undefined4 *)((int)pButton + 0x550),0,0),
        piVar3 == (int *)0x0)))) goto LAB_00827e44;
    iVar4 = (**(code **)(*piVar3 + 0x234))(*(undefined4 *)(*(int *)(piVar3[0x2a] + 0x3c) + 0x3bc));
  }
  else {
  ...
  if (iVar4 == 0) {
LAB_00827e44:
    *(undefined4 *)((int)pButton + 0x50c) = *(undefined4 *)((int)pButton + 0x508);
