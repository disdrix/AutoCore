...

{
  ...
  if (*(char *)((int)DAT_00d1ad10 + 9) == '\0') {
    ...
    if (local_29c == 0) {
      ...
      *(undefined1 *)((int)DAT_00d1ad10 + 4) = 1;
    ...
    if (*(char *)((int)DAT_00d1ad10 + 7) == '\0') {
      (**(code **)(*(int *)param_1[0x1a2] + 0x1d8))(*(undefined4 *)((int)pvVar7 + 4),1,1);
    }
    else {
      ...
      if (-1 < local_2a0) {
        do {
          ...
          if (piVar13 != (int *)0x0) {
            ...
            if (iVar9 == 3) {
              (**(code **)(*piVar13 + 0x14))();
              puVar10 = *(undefined1 **)((int)pvVar7 + 4);
LAB_008a8a82:
  ...
  if (iVar9 < 1) {
    ...
    *(undefined1 *)((int)puVar11 + 2) = 0;
    if (((DAT_00d1b6d8 != 0) && (*(uint *)((int)pvVar7 + 0x10) != 0)) &&
      ...
      if ((*(char *)((int)DAT_00d1ad10 + 7) != '\0') &&
         (cVar5 = FUN_0052b420(*(undefined4 *)((int)pvVar7 + 0x14c),0), cVar5 != '\0')) {
...
LAB_008a9444:
      ...
      if (bVar4) {
        ...
        if (*(int *)(DAT_00d1b644 + 0xfc) == *piVar13) {
          ...
          puVar11 = (undefined4 *)FUN_00402d50();
          puStack_18._0_1_ = 2;
  ...
  puVar11 = (undefined4 *)(auStack_224 + 2);
  for (iVar9 = 0x3f; iVar9 != 0; iVar9 = iVar9 + -1) {
    *puVar11 = 0;
    puVar11 = puVar11 + 1;
  }
  *(undefined2 *)puVar11 = 0;
  if ((*(char *)(DAT_00d1b6d8 + 0x6b9) != '\0') &&
     (iVar9 = __RTDynamicCast(*(undefined4 *)
...
| **Live body** | 0x008a8770–0x008a9618 (3752 bytes / 0xEA8) |
| **Live decompile** | Identical to authoritative raw body above (W20-F re-pull) |
| **Entry bytes** | 55 8B EC 83 E4 F0 6A FF 68 D9 03 9B 00 ... A1 D8 B6 D1 00 85 C0 53 56 57 8B F1 |
| **Epilogue** | SEH restore + 5B 8B E5 5D C3 (ret, no stack cleanup) near 0x008a9610 |
| **ABI** | __fastcall/__thiscall: host in ECX (mov esi,ecx); no stack args |
| **DATA xref** | 0x00a4b55c -> dword 0x008a8770 (slot table; no CODE callers) |
| **Early gates** | DAT_00d1b6d8==0 ret; byte[client+0x4f1]!=0 ret; widgets param_1[0x1a2/0x1a5/0x1a4] (byte offs 0x688/0x694/0x690) |
| **Promote name** | Client_MissionTrackerHud_Refresh_Inferred (role High; product class/method open) |
| **Reject sole name** | Mission_Look_in_your_Mission_Inventory — one branch string only, not whole function |
