# Annotated low-level: FUN_009615c0
...
- Source: raw capture for `aa_009615c0`.
...

{
  ...
  switch(*(undefined4 *)(*(int *)(*(int *)(param_2 + 0x4034) + uVar10 * 4) + 8)) {
  case 0:
    break;
  case 1:
      ...
      if (cVar4 != '\0') {
        ...
        while (local_40ec = local_40ec + -1, -1 < (int)local_40ec) {
          ...
          if (iVar5 == 0x47454f4d) {
            ...
            local_40dc = 0;
            local_40d8 = 0;
            local_40cc = (undefined4 *******)0x0;
            local_40c8 = (undefined4 *******)0x0;
            local_40c4 = 0;
            local_4._0_1_ = 6;
