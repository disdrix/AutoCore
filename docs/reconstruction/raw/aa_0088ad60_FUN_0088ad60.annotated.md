# Annotated low-level: FUN_0088ad60
...
- Source: raw capture for `aa_0088ad60`.
      ...
      if (piVar21 != (int *)param_1[0x149]) {
        do {
          ...
          if ((iStack_258 != 0) && (piStack_268 != (int *)0x0)) {
            ...
            {
              *(undefined4 *)pcVar22 = *(undefined4 *)pcVar17;
              pcVar17 = pcVar17 + 4;
              pcVar22 = pcVar22 + 4;
            }
            ...
            *(undefined4 *)pcVar9 = DAT_00a540cc;
            pcVar9 = &cStack_209;
            do {
              pcVar8 = pcVar9;
              pcVar9 = pcVar8 + 1;
            } while (pcVar8[1] != '\0');
            *(undefined4 *)(pcVar8 + 1) = DAT_00a2c53c;
...
LAB_0088aff6:
      ...
      puVar20 = (undefined4 *)param_1[0x14c];
      if (puVar20 != (undefined4 *)param_1[0x14d]) {
        do {
          puVar1 = *(undefined4 **)param_1[0x149];
          while (puVar1 != (undefined4 *)param_1[0x149]) {
            ...
            if (*(char *)((int)puVar1 + 0x15) == '\0') {
              ...
              if (*(char *)((int)puVar2 + 0x15) == '\0') {
                ...
                puVar2 = puVar1;
                while ((puVar1 = puVar5, cVar6 == '\0' && (puVar2 == (undefined4 *)puVar1[2]))) {
                  cVar6 = *(char *)((int)puVar1[1] + 0x15);
                  puVar5 = (undefined4 *)puVar1[1];
                  puVar2 = puVar1;
                }
          ...
          FUN_0088a700();
          puVar1 = (undefined4 *)param_1[0x14d];
          puVar5 = puVar20;
          puVar2 = puVar20;
          ...
          cStack_2c1 = '\x01';
LAB_0088b128:
        } while (puVar20 != (undefined4 *)param_1[0x14d]);
      }
    }
    piStack_2c0 = (int *)0x0;
    iStack_2ac = 0;
