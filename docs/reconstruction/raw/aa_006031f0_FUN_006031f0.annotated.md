# Annotated low-level: FUN_006031f0
...
- Source: raw capture for `aa_006031f0`.
...
```c
void __thiscall
FUN_006031f0(int *param_1,undefined4 param_2,uint *param_3,uint *param_4,undefined4 param_5,
