# Annotated low-level: FUN_004bd1d0
...
- Source: raw capture for `aa_004bd1d0`.
...
```c
undefined4 __thiscall FUN_004bd1d0(void *param_1,uint param_2,int param_3,char param_4)
