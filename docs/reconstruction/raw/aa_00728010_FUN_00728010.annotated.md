# Annotated low-level: FUN_00728010
...
- Source: raw capture for `aa_00728010`.
...
```c
undefined4 FUN_00728010(int param_1)

{
  ...
  if (*(int *)(unaff_EDI + 0x18) != 0) {
    (**(code **)(**(int **)(unaff_EDI + 0x18) + 0x24))(*(undefined1 *)(param_1 + 0x10));
  }
  ExceptionList = local_c;
  return 0;
}
