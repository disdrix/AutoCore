# Raw capture: Client_MissionDialogHandleButton
  ...
  if (*(int *)(in_EAX + 0x708 + (int)pDialogContext * 4) != 0) {
    if ((*(int **)(in_EAX + 0x6e0) != (int *)0x0) &&
      ...
      return '\0';
                    ...
                    /* // Route by dialog state (pDialogContext+0x648) */
    ...
    if (iVar5 == 2) {
      ...
      if (iVar5 == 0) {
                    /* // State 0: Send sector packet 0x206f (accept mission request) */
        ...
        return '\x01';
                    ...
                    /* // State 3: Show NPC mission dialog UI */
      if (iVar5 == 3) {
