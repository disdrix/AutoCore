# Annotated low-level: FUN_00446860
...
- Source: raw capture for `aa_00446860`.
...
```c
void __thiscall FUN_00446860(int param_1,void *param_2,uint param_3,undefined1 *param_4)
