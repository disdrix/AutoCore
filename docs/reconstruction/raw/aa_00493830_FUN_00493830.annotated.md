# Annotated low-level: FUN_00493830
...
- Source: raw capture for `aa_00493830`.
...
```c
void __thiscall FUN_00493830(int param_1,void *param_2,uint param_3,undefined4 *param_4)
