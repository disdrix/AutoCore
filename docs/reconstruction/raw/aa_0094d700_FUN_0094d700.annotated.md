# Annotated low-level: FUN_0094d700
...
- Source: raw capture for `aa_0094d700`.
...
```c
void FUN_0094d700(undefined4 param_1,undefined4 param_2)
...
LAB_0094d75e:
  ...
  if (pcVar2 != (char *)((int)&local_108 + 1)) {
    ...
    if (iVar4 != 0) {
      iVar4 = FUN_00573af0(&local_108);
      FUN_0094c630(*(undefined4 *)(iVar4 + 8),*(undefined4 *)(iVar4 + 0xc));
      return;
    }
    iVar4 = 0;
    uStack_12c = 0;
