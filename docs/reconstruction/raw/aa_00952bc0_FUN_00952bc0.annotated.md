# Annotated low-level: FUN_00952bc0
...
- Source: raw capture for `aa_00952bc0`.
...
```c
undefined4 __fastcall FUN_00952bc0(int param_1)
          ...
          if (cVar7 != '\0') {
            ...
            if (iVar10 != 0) {
              ...
              if (cVar7 == '\0') {
                ...
                uStack_20 = (undefined1)piVar2[0x5a];
                ...
                uStack_40 = (undefined1)piVar2[0x5a];
