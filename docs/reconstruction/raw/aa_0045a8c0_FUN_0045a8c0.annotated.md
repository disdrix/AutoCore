# Annotated low-level: FUN_0045a8c0
...
- Source: raw capture for `aa_0045a8c0`.
...
```c
undefined4 __thiscall FUN_0045a8c0(int param_1,undefined4 *param_2)

{
  ...
  FUN_00439810();
  if (iVar9 != 0) {
    FUN_0045e450(*(undefined4 *)(param_1 + 0x20),iVar9);
  }
  local_4 = 0xffffffff;
