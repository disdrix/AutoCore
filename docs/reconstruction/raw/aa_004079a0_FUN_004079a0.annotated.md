# Annotated low-level: FUN_004079a0
...
- Source: raw capture for `aa_004079a0`.
...
```c
undefined4 * FUN_004079a0(undefined4 *param_1,int *param_2,int *param_3)
