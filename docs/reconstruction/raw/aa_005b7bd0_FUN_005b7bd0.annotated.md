# Annotated low-level: FUN_005b7bd0
...
- Source: raw capture for `aa_005b7bd0`.
...
```c
void __thiscall FUN_005b7bd0(int param_1,void *param_2,uint param_3,undefined4 *param_4)
