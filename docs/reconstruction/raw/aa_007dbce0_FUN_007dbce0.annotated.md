# Annotated low-level: FUN_007dbce0
...
- Source: raw capture for `aa_007dbce0`.
...
void __thiscall FUN_007dbce0(char *param_1,int param_2)

{
  ...
  local_294 = (undefined4 *)FUN_0041c5a0();
  local_290 = 0;
  local_4 = 0;
  if (DAT_00d1793c == '\0') {
    if (*param_1 == '\0') {
