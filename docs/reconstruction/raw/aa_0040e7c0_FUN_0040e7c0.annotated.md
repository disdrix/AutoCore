# Annotated low-level: FUN_0040e7c0
...
- Source: raw capture for `aa_0040e7c0`.
...
```c
undefined4 * FUN_0040e7c0(undefined4 *param_1,int *param_2,int *param_3)
