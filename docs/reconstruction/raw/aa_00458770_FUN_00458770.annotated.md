# Annotated low-level: FUN_00458770
...
- Source: raw capture for `aa_00458770`.
...
```c
undefined4 __thiscall FUN_00458770(int param_1,undefined4 *param_2)

{
  ...
  FUN_00439810();
  if (iVar9 != 0) {
    FUN_0045d790(*(undefined4 *)(param_1 + 0x20));
  }
  local_4 = 0xffffffff;
