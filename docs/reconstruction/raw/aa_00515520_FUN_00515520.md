...
FUN_00515520(int *param_1,int *param_2,char param_3,char param_4,undefined4 param_5,int param_6,
...
LAB_005158ea:
  ...
  uStack_7c = *(undefined4 *)(iVar4 + 0x48c);
        ...
        if ((0 < sVar3) || (0 < *(short *)((int)asStack_9c + iVar14))) {
          ...
          *(short *)((int)asStack_9c + iVar14) = (short)(int)fVar19;
          ...
          if ((short)(int)fVar5 < 1) {
            ...
            *(undefined2 *)((int)&uStack_90 + iVar14) = 1;

          }

          if ((short)(int)fVar19 < 2) {

            *(undefined2 *)((int)asStack_9c + iVar14) = 2;
  ...
  if ((param_3 != '\0') && (iVar14 != 0)) {
    ...
    uStack_44 = *(undefined4 *)(iVar14 + 0x1a0);

    uStack_38 = *(undefined4 *)(iVar14 + 0x188);

    uStack_40 = *(undefined4 *)(iVar14 + 0x1a4);

    uStack_34 = *(undefined4 *)(iVar14 + 0x18c);

    uStack_3c = *(undefined4 *)(iVar14 + 0x1a8);
  ...
  if (iVar4 != 0) {
    ...
    if ((iVar7 != 0) && (iVar7 = (**(code **)(*param_1 + 0x1d4))(), *(int *)(iVar7 + 0x254) != 0)) {
      ...
      puVar8 = (undefined4 *)(**(code **)(**(int **)(iVar7 + 0x254) + 0x38))();
    ...
    *(short *)((int)&iStack_64 + (int)fVar5 * 2) = sVar16;
    ...
    if (0 < sVar3) {
      ...
      if (param_7 != 0) {
        ...
        *(undefined1 *)(param_7 + (int)fVar5) = 1;
    ...
    if (sVar3 < 0) {
      ...
      *(undefined2 *)((int)&iStack_64 + (int)fVar5 * 2) = 0;
...
LAB_0051636f:
      ...
      if (iStack_70 != 0) {
        ...
        if (*(char *)(*(int *)(*(int *)(iStack_70 + 4) + 4) + 0x24 + iStack_70) != '\0') {
          ...
          FUN_004e2600(&LAB_00512fa0,&piStack_c0,0);
        ...
        if ((iVar7 != 0) && (*(char *)(*(int *)(*(int *)(iVar7 + 4) + 4) + 0x24 + iVar7) != '\0')) {
          ...
          FUN_004e2600(&LAB_00512fa0,&piStack_ac,0);
      ...
      FUN_004e2600(&LAB_00512fa0,&piStack_b4,0);
...
LAB_0051647a:
      ...
      if (iVar14 != 0) {
        ...
        if (*(char *)(*(int *)(*(int *)(iVar14 + 4) + 4) + 0x25 + iVar14) != '\0') {
          ...
          FUN_004e2600(&LAB_00512fe0,&uStack_84,0);
        ...
        if ((iVar14 != 0) && (*(char *)(*(int *)(*(int *)(iVar14 + 4) + 4) + 0x25 + iVar14) != '\0')
          ...
          FUN_004e2600(&LAB_00512fe0,&piStack_c0,0);
      ...
      FUN_004e2600(&LAB_00512fe0,&piStack_b4,0);
...
| **Tools** | `decompile_function` + `read_memory` + `analyze_function_complete` + `get_function_by_address` + xrefs/callees. **No** `disassemble_bytes` |
| **Live decompile** | equiv raw scaffold CF shape (2026-07-23); large function — unaff_*/float-as-pointer noise |
| **Body** | `0x00515520`–`0x00516706` (**4583 B**) |
| **Prologue** | `81 EC C0 00 00 00` (`sub esp, 0xC0`); `mov ebp, ecx` |
| **Epilogue** | `81 C4 C0 00 00 00`; `C2 28 00` (**ret 0x28** = **10** stack dwords) |
| **Metrics** | ~1186 insns; 255 BBs; cyclomatic ~156; worker |
| **Xrefs** | **26 DATA** vtable installs; **0 CODE** direct callers — pure virtual |
| **Callees** | FUN_004f4e50 (GetLinkedActorLevel), FUN_004c4140 (Theory), FUN_0040aff0, TFID_NotEquals, Object_ResolveFromTFID, FUN_0056add0, FUN_0056b340, CVOGReaction_RandomUnitScalar x3, CNDDoubleList_InvokePredicateAndRemove_Inferred, FUN_00535ed0, ceil |
| **Constants** | `_DAT_009cdf80` = **0.004f**; `DAT_00af1b70` = **0.5f**; `DAT_009cdf9c[]` first four: **1.35, 1.15, 1.0, 1.23** |
| **Shared float note** | Ghidra `g_flMultiKillCountBlend` is shared **0.1f** pool — do not invent multi-kill product semantics from the symbol alone |
| **Name** | `CVOGObject_ComputeOutcomeRolls_Inferred` |

### ABI note

ret 0x28 seals **10** stack slots; decompiler recovers a subset. Full live body: `docs/reconstruction/tmp/w27m_00515520_live_decomp.txt`.
