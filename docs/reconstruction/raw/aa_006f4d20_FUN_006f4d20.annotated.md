# Annotated low-level: FUN_006f4d20
...
- Source: raw capture for `aa_006f4d20`.
...
```c
int * __thiscall FUN_006f4d20(int param_1,int param_2,undefined4 *param_3,int *param_4,int param_5)

{
  ...
  if (param_3[1] == 1) {
    if (*(int *)(param_1 + 0x1c) == 0) {
      (**(code **)(**(int **)(param_1 + 0x24) + 0xc))(*(undefined4 *)(param_1 + 0x2c),param_1,0x800)
      ;
    }
...
LAB_006f4f06:
  ...
  if (param_3 != (undefined4 *)piVar2[0x2e]) {
