# Annotated low-level: FUN_0068fb10
...
- Source: raw capture for `aa_0068fb10`.
...
```c
void __thiscall FUN_0068fb10(int param_1,undefined4 *param_2)

{
  ...
  float local_194;
  float local_190;
  undefined4 local_18c [12];
  undefined1 local_15c [48];
      ...
      do {
        ...
        if (*(short *)(iVar8 + 0xc) != 0) {
          ...
          do {
            ...
            local_194 = local_208;
            local_190 = local_1fc;
            puVar7 = (undefined4 *)FUN_0069f950(local_15c,&local_198);
            puVar10 = local_18c;
            ...
            local_1a0 = local_208;
            local_19c = local_1fc;
            puVar7 = (undefined4 *)FUN_0069f950(local_6c,&local_1a4);
            puVar10 = local_18c;
            for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
              *puVar10 = *puVar7;
              puVar7 = puVar7 + 1;
            ...
            local_1d4 = local_1e4;
            local_1cc = local_1fc;
            puVar7 = (undefined4 *)FUN_0069f950(local_cc,&local_1d4);
            puVar10 = local_18c;
            for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
              *puVar10 = *puVar7;
              puVar7 = puVar7 + 1;
            ...
            local_1b0 = local_1e4;
            local_1a8 = local_1fc;
            puVar7 = (undefined4 *)FUN_0069f950(local_12c,&local_1b0);
            puVar10 = local_18c;
            for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
              *puVar10 = *puVar7;
              puVar7 = puVar7 + 1;
            ...
            local_1c8 = local_1e4;
            local_1c4 = local_208;
            puVar7 = (undefined4 *)FUN_0069f950(local_fc,&local_1c8);
            puVar10 = local_18c;
            for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
              *puVar10 = *puVar7;
              puVar7 = puVar7 + 1;
            ...
            local_1bc = local_1e4;
            local_1b8 = local_208;
            puVar7 = (undefined4 *)FUN_0069f950(local_9c,&local_1bc);
            puVar10 = local_18c;
            for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
              *puVar10 = *puVar7;
              puVar7 = puVar7 + 1;
            ...
            local_4._0_1_ = 1;
            FUN_0056f570();
            puVar7 = (undefined4 *)FUN_0069f850(local_3c,local_18c);
            puVar10 = param_2;
            for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
              *puVar10 = *puVar7;
              puVar7 = puVar7 + 1;
