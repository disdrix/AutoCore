# Annotated low-level: FUN_00937d50
...
- Source: raw capture for `aa_00937d50`.
...
LAB_009380ba:
          ...
          if ((-1 < local_30[local_80 * 6 + 4]) && (-1 < local_30[local_80 * 6 + 5])) {
            ...
            if (puVar3[0x17] == 0) {
              ...
              FUN_00759730(*(undefined4 *)(*(int *)(param_1 + 0xde8) + 0x2c),&iStack_64,puVar3 + 9);
            }
            else {
              ...
              uStack_ac = CONCAT31((int3)((uint)piStack_a0 >> 8),*(undefined1 *)((int)puVar3 + 0x27)
                                  );
              iStack_a8 = 0;
