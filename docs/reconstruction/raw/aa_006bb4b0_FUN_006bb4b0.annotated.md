# Annotated low-level: FUN_006bb4b0
...
- Source: raw capture for `aa_006bb4b0`.
...
```c
void FUN_006bb4b0(undefined1 *param_1,float param_2,int *param_3,int param_4)

{
  ...
  if ((param_3[2] < 3) && (*(int *)(param_4 + 8) < 3)) {
    ...
    if (param_3[2] == 2) {
      ...
      if (*(int *)(param_4 + 8) != 2) {
        FUN_006c0080(*(undefined2 *)param_3[1],**(undefined2 **)(param_4 + 4));
        goto LAB_006bba31;
      }
