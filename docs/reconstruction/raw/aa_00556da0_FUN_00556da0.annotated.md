# Annotated low-level: FUN_00556da0
...
- Source: raw capture for `aa_00556da0`.
...
```c
void __thiscall FUN_00556da0(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  float local_ae4;
  float local_ae0;
  undefined1 auStack_adc [8];
  char local_ad4;
  undefined1 local_ad0 [1076];
  void *local_69c;
  char local_570 [1080];
  void *local_138;
  void *pvStack_c;
...
LAB_00556f81:
  do {
    ...
    break;
    *(undefined4 *)(iVar9 + *(int *)((int)fVar8 + 0x444) + 0x128) =
         *(undefined4 *)(iVar9 + 0x120 + *(int *)((int)fVar8 + 0x444));
  ...
  do {
    if (*pcVar12 == '\0') {
      *(undefined4 *)(pcVar12 + 0x104) = *(undefined4 *)(pcVar10 + 0x104);
      if (*pcVar10 == '\0') {
        *pcVar12 = '\0';
      }
      else {
  ...
  if ((*(int *)((int)fVar8 + 0x444) != 0) &&
    ...
    *(int *)((int)fVar8 + 0x568) = iVar9;
    if ((*(int *)(pcVar12 + 0x104) == 0) && (*pcVar12 != '\0')) {
      ...
      *(void **)(pcVar12 + 0x104) = pvVar6;
      ...
      if (*(int *)(pcVar12 + 0x104) != 0) {
        *(undefined1 *)(*(int *)(pcVar12 + 0x104) + 9) = 1;
        FUN_004b8dc0(0,0);
        FUN_004b9270(*(undefined4 *)(pcVar12 + 0x104));
      }
    }
    ...
    if ((iVar9 != 0) && (iVar7 = *(int *)(local_aec + 0x188), iVar7 != 0)) {
      ...
      *(undefined4 *)(iVar9 + 0x2c) = *(undefined4 *)(local_aec + 0x40);
    }
  }
  ...
  if ((-1 < iVar9) && (iVar9 < 4)) {
    ...
    if ((iVar7 != 0) && (iVar3 = *(int *)(iVar9 + 0x188), iVar3 != 0)) {
      ...
      *(undefined4 *)(iVar7 + 0x2c) = *(undefined4 *)(iVar9 + 0x40);
    }
  }
LAB_005573c2:
  iVar7 = local_aec;
  ...
  if ((-1 < iVar9) && (iVar9 < 4)) {
      ...
      if (*pcVar1 != '\0') {
        ...
        *(void **)(pcVar1 + 0x104) = pvVar6;
        ...
        if (*(int *)(pcVar1 + 0x104) != 0) {
          *(undefined1 *)(*(int *)(pcVar1 + 0x104) + 9) = 1;
          FUN_004b8dc0(0,0);
          FUN_004b9270(*(undefined4 *)(pcVar1 + 0x104));
        }
      }
    ...
    if ((iVar9 != 0) && (iVar3 = *(int *)(iVar7 + 0x188), iVar3 != 0)) {
      ...
      *(undefined4 *)(iVar9 + 0x2c) = *(undefined4 *)(iVar7 + 0x40);
    }
  }
LAB_005574e6:
  ...
  if ((*(int *)((int)fVar8 + 0x554) == 0) && (*pcVar1 != '\0')) {
    ...
    *(void **)((int)fVar8 + 0x554) = pvVar6;
    ...
    if (*(int *)((int)fVar8 + 0x554) != 0) {
      *(undefined1 *)(*(int *)((int)fVar8 + 0x554) + 9) = 1;
      FUN_004b8dc0(0,0);
      FUN_004b9270(*(undefined4 *)((int)fVar8 + 0x554));
    }
  }
