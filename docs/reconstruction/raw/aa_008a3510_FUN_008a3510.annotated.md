# Annotated low-level: FUN_008a3510
...
- Source: raw capture for `aa_008a3510`.
...

{
  ...
  undefined4 uVar18;
  int iStack_d54;
  undefined1 auStack_d50 [4];
  undefined4 local_d4c;
  void *pvStack_d48;
  undefined1 auStack_d44 [8];
  ...
  *(undefined4 *)(param_1 + 0x518) = uVar5;
...
joined_r0x008a367c:
  ...
  *(undefined2 *)puVar15 = 0;
  ...
  if ((char)param_2[0x140] == '\x02') {
    ...
    *(undefined4 *)(pcVar7 + 1) = DAT_00a4cb90;
...
LAB_008a382f:
    ...
    if (*(char *)(*(int *)(param_2[0x141] + 0x14c) + 0x169) == '\0') {
      if (*(short *)(*(int *)(param_2[0x141] + 0x14c) + 0xac) == -1) {
        ...
        *(undefined4 *)(pcVar7 + 1) = s_repeat_00a4cb18._0_4_;
        *(undefined2 *)(pcVar7 + 5) = s_repeat_00a4cb18._4_2_;
      ...
      *(undefined4 *)(pcVar7 + 1) = s_story_00a4cb6c._0_4_;
      *(undefined2 *)(pcVar7 + 5) = s_story_00a4cb6c._4_2_;
    }
    goto LAB_008a382f;
  }
  if ((*(int *)(param_1 + 0x50c) == 0) && (cVar4 = FUN_008a2020(), cVar4 != '\0')) {
    ...
    iVar10 = *(int *)(param_1 + 0x578);
    *(undefined4 *)(pcVar7 + 1) = s__done_00a4cac4._0_4_;
    *(undefined2 *)(pcVar7 + 5) = s__done_00a4cac4._4_2_;
...
LAB_008a396a:
  if (*(int *)(*(int *)(param_1 + 0x578) + 0x504) != 0) {
    ...
    FUN_007a6de0(*(undefined4 *)(*(int *)(param_2[0x141] + 0x14c) + 0x14c));
  ...
  if (*(int *)(*(int *)(param_1 + 0x578) + 0x508) != 0) {
    ...
    if (*(int *)param_2[0x141] != 0) {
      ...
      pcVar7 = (char *)FUN_007a6de0(*(undefined4 *)param_2[0x141],0xffffffff);
      pcVar13 = acStack_c1c;
      do {
        cVar4 = *pcVar7;
        *pcVar13 = cVar4;
      ...
      FUN_008aab00(*(undefined4 *)(*(int *)(param_1 + 0x578) + 0x508));
  ...
  if (*(int *)(*(int *)(param_1 + 0x578) + 0x514) != 0) {
    ...
    if (((*(int *)(param_1 + 0x50c) != 1) && (pvStack_d48 != (void *)0x0)) &&
      ...
      pcVar13 = (char *)FUN_007a6de0(*(undefined4 *)(*(int *)(param_2[0x141] + 0x14c) + 0x150));
  ...
  if (puVar9 == (uint *)0x0) {
    uVar5 = *(undefined4 *)(param_1 + 0x578);
    uVar18 = 0;
  }
  else {
    uVar5 = *(undefined4 *)(param_1 + 0x578);
  ...
  if (*(int *)(*(int *)(param_1 + 0x578) + 0x518) != 0) {
    ...
    (**(code **)(iVar10 + 0x250))();
    cVar4 = FUN_008ab9b0(*(undefined4 *)(param_2[0x141] + 0x14c));
