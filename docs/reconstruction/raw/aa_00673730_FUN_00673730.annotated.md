# Annotated low-level: FUN_00673730
...
- Source: raw capture for `aa_00673730`.
...
```c
void __thiscall FUN_00673730(int param_1,int param_2,uint param_3,undefined4 *param_4)
