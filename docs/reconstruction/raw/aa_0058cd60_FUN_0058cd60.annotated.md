# Annotated low-level: FUN_0058cd60
...
- Source: raw capture for `aa_0058cd60`.
...
void FUN_0058cd60(int *param_1,int param_2,int param_3,int *param_4,float *param_5,float param_6,
                 int param_7,int param_8,undefined4 param_9,char param_10,char param_11)

{
  ...
  local_48 = (undefined4 *)FUN_0058d9c0();
  *(undefined1 *)((int)local_48 + 0x29) = 1;
  local_48[1] = local_48;
  *local_48 = local_48;
  local_48[2] = local_48;
  local_44 = 0;
...
LAB_0058d1d9:
    ...
    if (*(char *)(local_54 + 0x28) != '\0') {
      *(undefined1 *)(local_54 + 0x28) = 0;
      LeaveCriticalSection((LPCRITICAL_SECTION)(local_54 + 4));
    }
    FUN_004badf0();
    if ((param_11 == '\0') ||
       (puVar8 = (undefined4 *)*local_48, iVar5 = local_68, puVar8 == local_48)) {
        ...
        *piVar7 = puVar8[6];
        ...
        if (*(char *)((int)puVar8 + 0x29) == '\0') {
          ...
          if (*(char *)((int)puVar1 + 0x29) == '\0') {
            ...
            puVar1 = puVar8;
            while ((puVar8 = puVar2, cVar3 == '\0' && (puVar1 == (undefined4 *)puVar8[2]))) {
              cVar3 = *(char *)((int)puVar8[1] + 0x29);
              puVar2 = (undefined4 *)puVar8[1];
              puVar1 = puVar8;
            }
