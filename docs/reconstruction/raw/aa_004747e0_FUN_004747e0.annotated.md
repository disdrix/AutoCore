# Annotated low-level: FUN_004747e0
...
- Source: raw capture for `aa_004747e0`.
    ...
    if (*(byte *)(in_EAX + 0x127) < 9) {
      ...
      *(void **)(in_EAX + 0x164) = pvVar5;
      do {
        _CIpow();
        uVar3 = FUN_006a3db0();
        *(undefined1 *)(iVar12 + *(int *)(in_EAX + 0x164)) = uVar3;
        iVar12 = iVar12 + 1;
      } while (iVar12 < 0x100);
      if ((*(uint *)(in_EAX + 0x70) & 0x600080) != 0) {
        ...
        *(void **)(in_EAX + 0x16c) = pvVar5;
        do {
          _CIpow();
          uVar3 = FUN_006a3db0();
          *(undefined1 *)(iVar12 + *(int *)(in_EAX + 0x16c)) = uVar3;
          iVar12 = iVar12 + 1;
        } while (iVar12 < 0x100);
        if (*(code **)(in_EAX + 0x248) == (code *)0x0) {
          pvVar5 = malloc(0x100);
        ...
        *(void **)(in_EAX + 0x168) = pvVar5;
        ...
        do {
          _CIpow();
          uVar3 = FUN_006a3db0();
          *(undefined1 *)(iVar12 + *(int *)(in_EAX + 0x168)) = uVar3;
          iVar12 = iVar12 + 1;
        } while (iVar12 < 0x100);
        return;
      }
      ...
      if ((*(uint *)(in_EAX + 0x70) & 0x480) == 0) {
          ...
          do {
            ...
            *(void **)(*(int *)(in_EAX + 0x170) + local_38 * 4) = pvVar5;
            ...
            do {
              _CIpow();
              uVar4 = FUN_006a3db0();
              *(undefined2 *)(iVar10 + *(int *)(*(int *)(in_EAX + 0x170) + local_38 * 4)) = uVar4;
              iVar10 = iVar10 + 2;
            } while (iVar10 < 0x200);
            local_38 = local_38 + 1;
        ...
        if (uVar13 < uVar7) {
          do {
            ...
            uVar11 = uVar13 >> (bVar9 & 0x1f);
            uVar13 = uVar13 + 1;
            *(undefined2 *)(*(int *)(*(int *)(in_EAX + 0x170) + uVar8 * 4) + uVar11 * 2) = 0xffff;
          } while (uVar13 < uVar7);
        }
      }
      if ((*(uint *)(in_EAX + 0x70) & 0x600080) != 0) {
          ...
          do {
            ...
            *(void **)(*(int *)(in_EAX + 0x178) + local_38 * 4) = pvVar5;
            ...
            do {
              _CIpow();
              uVar4 = FUN_006a3db0();
              *(undefined2 *)(iVar10 + *(int *)(*(int *)(in_EAX + 0x178) + local_38 * 4)) = uVar4;
              iVar10 = iVar10 + 2;
            } while (iVar10 < 0x200);
            local_38 = local_38 + 1;
          } while ((int)local_38 < iVar12);
          ...
          do {
            ...
            *(void **)(*(int *)(in_EAX + 0x174) + local_38 * 4) = pvVar5;
            ...
            do {
              _CIpow();
              uVar4 = FUN_006a3db0();
              *(undefined2 *)(iVar10 + *(int *)(*(int *)(in_EAX + 0x174) + local_38 * 4)) = uVar4;
              iVar10 = iVar10 + 2;
            } while (iVar10 < 0x200);
            local_38 = local_38 + 1;
          } while ((int)local_38 < iVar12);
