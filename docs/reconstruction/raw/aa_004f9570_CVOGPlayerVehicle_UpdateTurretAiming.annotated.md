# Annotated low-level: CVOGPlayerVehicle_UpdateTurretAiming
...
- Source: raw capture for `aa_004f9570`.
...

{
  ...
  if (cVar1 != '\x02') {
    ...
    uStack_b4 = *(undefined4 *)(iVar2 + 0x98);
    iVar2 = (**(code **)(**(int **)(param_1 + 0x48) + 0xc))();
...
LAB_004f991b:
  ...
  if (*(int *)(param_1 + 0x1a0) == 0) {
    ...
    CVOGVehicle_GetWeaponSlotTransform
              (*(undefined4 *)(iVar2 + 0x30),*(undefined4 *)(iVar2 + 0x28),0,&local_d0,local_40);
    iVar2 = *(int *)(*(int *)(param_1 + 0x1a0) + 4);
