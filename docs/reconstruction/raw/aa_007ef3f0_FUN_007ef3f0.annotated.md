# Annotated low-level: FUN_007ef3f0
...
- Source: raw capture for `aa_007ef3f0`.
...
int __thiscall FUN_007ef3f0(char *param_1,int *param_2,undefined4 param_3,undefined4 *param_4)
      ...
      if (DAT_00d1793c == '\0') {
        ...
        if (((((iVar1 < 0) || (iVar1 = FUN_004231d0(&uStack_84), iVar1 < 0)) ||
          ...
          if (iVar1 == 0) {
            *param_4 = uStack_4c;
            param_4[1] = uStack_3c;
            *(undefined1 *)(param_4 + 2) = uStack_89;
            *(undefined1 *)((int)param_4 + 9) = uStack_8a;
            param_4[3] = uStack_38;
            param_4[4] = uStack_50;
