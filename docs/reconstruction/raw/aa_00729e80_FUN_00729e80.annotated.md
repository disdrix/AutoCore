# Annotated low-level: FUN_00729e80
...
- Source: raw capture for `aa_00729e80`.
...
```c
undefined4 __fastcall FUN_00729e80(int param_1)
      ...
      if (piStack_38 != piStack_c) {
        do {
             ...
             (iStack_14 = (*(int *)(iVar10 + 0xcc) - *(int *)(iVar10 + 200)) / 0x24, 0 < iStack_14))
          {
            ...
            if (local_20 != iVar12) {
              if (iVar12 != 0) {
                FUN_0074f200(*(undefined4 *)(iVar12 + 0xc));
                iVar8 = DAT_00d1f614;
              }
              local_20 = iVar12;
              if (iVar8 != 0) {
...
LAB_0072a391:
          ...
          *(undefined4 *)(&DAT_00afe00c + iVar8 * 0xc) = 0xffffffff;
          (&DAT_00afe010)[iVar8 * 3] = 0;
          *(undefined4 *)(&DAT_00afe014 + iVar8 * 0xc) = 0;
        }
      }
