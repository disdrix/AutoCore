# Annotated low-level: FUN_00819f20
...
- Source: raw capture for `aa_00819f20`.
...
undefined4 __thiscall FUN_00819f20(int param_1,int param_2,uint param_3)
      ...
      if (DAT_00afa2dc != uVar9) {
        if (DAT_00d1b644 != 0) {
          if (uVar9 == 0) {
            ...
            *(undefined1 *)(*(int *)(DAT_00d1b644 + 0xe894) + 0x78) = 1;
          }
        }
        bVar1 = true;
        DAT_00afa2dc = uVar9;
