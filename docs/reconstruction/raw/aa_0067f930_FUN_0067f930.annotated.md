# Annotated low-level: FUN_0067f930
...
- Source: raw capture for `aa_0067f930`.
...
```c
void __thiscall FUN_0067f930(int param_1,void *param_2,uint param_3,undefined4 *param_4)
