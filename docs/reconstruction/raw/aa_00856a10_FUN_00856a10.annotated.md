# Annotated low-level: FUN_00856a10
...
- Source: raw capture for `aa_00856a10`.
...

{
  ...
  undefined1 auStack_238 [39];
  char cStack_211;
  char acStack_210 [2];
  undefined4 auStack_20e [58];
  undefined1 auStack_124 [8];
  undefined1 auStack_11c [280];
  
  puStack_24c = (undefined1 *)0x856a26;
  (**(code **)(*param_1 + 0x58))();
  param_1[0x122] = 0;
  *(undefined1 *)(param_1 + 0x123) = 1;
  if (param_2 == (int *)0x0) {
LAB_00856e63:
    puStack_24c = (undefined1 *)0x0;
...
LAB_00856aef:
  ...
  *(undefined2 *)puVar11 = 0;
  if ((uVar8 >> 0x13 & 1) != 0) {
    puStack_24c = (undefined1 *)0xffffffff;
  ...
  puStack_258 = (undefined1 *)0x856bbd;
  (**(code **)(iVar7 + 0x1d8))();
  puStack_258 = auStack_11c;
  piStack_25c = param_2;
  iStack_260 = 0x856bce;
  FUN_0085d970();
  puStack_258 = (undefined1 *)(uint)*(byte *)(*(int *)(param_2[0x2a] + 0x3c) + 0x407);
