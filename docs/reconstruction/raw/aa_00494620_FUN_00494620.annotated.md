# Annotated low-level: FUN_00494620
...
- Source: raw capture for `aa_00494620`.
...
```c
void __thiscall FUN_00494620(int param_1,undefined4 param_2,float param_3,int *param_4)
