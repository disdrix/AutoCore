# Annotated low-level: FUN_004afd00
...
- Source: raw capture for `aa_004afd00`.
...
```c
void __thiscall FUN_004afd00(int param_1,int param_2,uint param_3,undefined4 *param_4)
