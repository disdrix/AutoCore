# Annotated low-level: FUN_00692090
...
- Source: raw capture for `aa_00692090`.
...
LAB_00692877:
          ...
          FUN_0068c910(&local_1b0,*(undefined1 *)(param_2 + 0x18));
          ...
          if (*(char *)(*piVar3 + 8) != '\0') {
            ...
            FUN_0068cac0(*(undefined4 *)(iVar4 + 0x30),*(undefined1 *)(iVar4 + 0x34));
          }
        ...
        *(short *)(*param_1 + 0x1a) = SUB42(local_200,0) + 2;
        if (1 < uVar5) {
          ...
          do {
            puVar8 = (undefined4 *)FUN_0068bad0(*(int *)(param_2 + 0x28) + uVar10 * 2);
            local_fc = *puVar8;
            ...
            *(short *)(*param_1 + 0x1a) = *(short *)(*param_1 + 0x1a) + 1;
            puVar8 = (undefined4 *)FUN_0068bad0(*(int *)(param_2 + 0x28) + 1 + uVar10 * 2);
            local_f4 = *puVar8;
            local_f0 = local_224 * *local_244 * _DAT_009eb1b4;
            FUN_0068c910(&local_f4,*(undefined1 *)(param_2 + 0x18));
            *(short *)(*param_1 + 0x1a) = *(short *)(*param_1 + 0x1a) + 1;
            uVar10 = uVar10 + 1;
