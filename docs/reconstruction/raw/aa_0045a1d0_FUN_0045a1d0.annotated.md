# Annotated low-level: FUN_0045a1d0
...
- Source: raw capture for `aa_0045a1d0`.
...
```c
undefined4 __thiscall FUN_0045a1d0(int param_1,undefined4 *param_2)

{
  ...
  FUN_00439810();
  if (iVar9 != 0) {
    FUN_0045e210(*(undefined4 *)(param_1 + 0x20));
  }
  local_4 = 0xffffffff;
