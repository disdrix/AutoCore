# Annotated low-level: FUN_0083c110
...
- Source: raw capture for `aa_0083c110`.
...
```c
undefined4 FUN_0083c110(int *param_1,uint param_2)
  ...
  *(undefined1 *)(param_1[0x14e] + 0x1d) = 0;
  ...
  if (piVar6 != (int *)0x0) {
    ...
    if (iVar3 == 0) {
      ...
      puVar4 = (undefined4 *)FUN_00416ff0();
      puVar4[3] = 0;
      puVar4[5] = 0;
      puVar4[6] = 0;
      ...
      *(undefined4 **)(iVar3 + 4) = puVar4;
      ...
      if (*(int *)(iVar9 + 0x18) == 0) {
        ...
        *(undefined4 **)(*(int *)(iVar9 + 0x18) + 0x14) = puVar4;
        puVar4[5] = 0;
        puVar4[6] = *(undefined4 *)(iVar9 + 0x18);
        *(undefined4 **)(iVar9 + 0x18) = puVar4;
      }
      *(int *)(iVar9 + 0xc) = *(int *)(iVar9 + 0xc) + 1;
      ...
      if ((DAT_00d1d8e0 != 0) && (*(int *)(DAT_00d1d8e0 + 0x514) == iStack_8)) {
        ...
        puVar4 = (undefined4 *)(**(code **)(*piVar6 + 0x140))(&pcStack_48,1);
