# Annotated low-level: FUN_005307e0
...
- Source: raw capture for `aa_005307e0`.
...

{
  ...
  undefined4 auStack_670 [7];
  undefined4 uStack_654;
  undefined4 auStack_538 [7];
...
LAB_0053085c:
    if (local_728 != 0) {
      uVar10 = *(undefined4 *)(iVar9 + uVar12 * 4);
      if (*(char *)(iVar1 + 0x1d) != '\0') {
        FUN_007a4480(0,"HashError:remove, already locked for traversal");
        FUN_007a4480(0,"VOG_DEBUG_STOP");
      }
      puVar8 = (undefined4 *)FUN_004e2ca0(uVar10);
      if (puVar8 != (undefined4 *)0x0) {
        puVar8[2] = 0;
        if (puVar8 == *(undefined4 **)(iVar1 + 0x14)) {
          *(undefined4 *)(iVar1 + 0x14) = puVar8[5];
        }
        else {
          *(undefined4 *)(puVar8[6] + 0x14) = puVar8[5];
        }
        if (puVar8 == *(undefined4 **)(iVar1 + 0x18)) {
          *(undefined4 *)(iVar1 + 0x18) = puVar8[6];
        }
        else {
          *(undefined4 *)(puVar8[5] + 0x18) = puVar8[6];
        }
        *puVar8 = &PTR_LAB_009cf024;
        *puVar8 = *(undefined4 *)(iVar1 + 0x20);
        *(undefined4 **)(iVar1 + 0x20) = puVar8;
        *(int *)(iVar1 + 0xc) = *(int *)(iVar1 + 0xc) + -1;
      }
      iVar9 = *(int *)(param_1 + 0x544);
      uVar10 = *(undefined4 *)(*(int *)(param_1 + 0x564) + uVar12 * 4);
      ...
      if (puVar8 != (undefined4 *)0x0) {
        puVar8[2] = 0;
        if (puVar8 == *(undefined4 **)(iVar9 + 0x14)) {
          *(undefined4 *)(iVar9 + 0x14) = puVar8[5];
        }
        else {
          *(undefined4 *)(puVar8[6] + 0x14) = puVar8[5];
        }
        if (puVar8 == *(undefined4 **)(iVar9 + 0x18)) {
          *(undefined4 *)(iVar9 + 0x18) = puVar8[6];
        }
        else {
          *(undefined4 *)(puVar8[5] + 0x18) = puVar8[6];
        }
        *puVar8 = &PTR_LAB_009cf024;
        *puVar8 = *(undefined4 *)(iVar9 + 0x20);
        *(undefined4 **)(iVar9 + 0x20) = puVar8;
...
LAB_005309f8:
          ...
          while (puVar5 = puVar6, puVar5 != (undefined4 *)0x0) {
            if (uVar2 == puVar5[4]) {
              if (puVar5 != (undefined4 *)0x0) {
                if (puVar8 == (undefined4 *)0x0) {
                  *(undefined4 *)(iVar1 + 4) = puVar5[3];
                }
                else {
                  puVar8[3] = puVar5[3];
                }
          ...
          if (puVar5 != (undefined4 *)0x0) {
            ...
            if (puVar5 == *(undefined4 **)(iVar9 + 0x14)) {
              *(undefined4 *)(iVar9 + 0x14) = puVar5[5];
            }
            else {
              *(undefined4 *)(puVar5[6] + 0x14) = puVar5[5];
            }
            if (puVar5 == *(undefined4 **)(iVar9 + 0x18)) {
              *(undefined4 *)(iVar9 + 0x18) = puVar5[6];
            }
            else {
      ...
      if ((*(int *)(*(int *)(iVar9 + 0xa8 + param_1) + 0xe8a0) == iVar9 + param_1 + 4) &&
        ...
        FUN_007a69d0();
        auStack_670[0] = *(undefined4 *)(*(int *)(param_1 + 0x564) + uVar12 * 4);
        uStack_654 = 0xd;
        Client_SendLogicUiPacket(auStack_670);
        uVar10 = FUN_007a6de0(*(undefined4 *)(local_728 + 0x14c),0xffffffff);
