# Annotated low-level: FUN_0099b230
...
- Source: raw capture for `aa_0099b230`.
...
```c
void FUN_0099b230(undefined4 *param_1,int param_2,uint *param_3,int param_4,int param_5)
