# Annotated low-level: FUN_008096c0
...
- Source: raw capture for `aa_008096c0`.
...

{
  ...
  FUN_007a4480(0,"Got global connect succeed:%d reconnecting:%d coid:%I64d str:%s",param_2,
               *(undefined1 *)(param_3 + 0x854),*(undefined4 *)(param_3 + 0x508),
               *(undefined4 *)(param_3 + 0x50c),piVar2);
  if (param_2 != '\0') {
    if (*(char *)(param_3 + 0x854) == '\0') {
      ...
      local_460 = *(undefined4 *)(param_3 + 0x508);
      local_45c = *(undefined4 *)(param_3 + 0x50c);
      local_458 = *(undefined4 *)(param_3 + 0x134);
      puVar13 = local_468;
      *(undefined1 *)(param_3 + 0x854) = 0;
      local_468[0] = 0x8003;
      uVar12 = 0x18;
    }
