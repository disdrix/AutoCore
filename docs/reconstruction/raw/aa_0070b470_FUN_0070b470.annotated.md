# Annotated low-level: FUN_0070b470
...
- Source: raw capture for `aa_0070b470`.
...
void FUN_0070b470(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int *param_5,
...

{
  ...
  iVar36 = iVar36 + (-iVar36 & 3U) + iVar8;
  puVar27 = (undefined4 *)(iVar36 + local_74 * -4);
  iVar36 = iVar36 + (-iVar36 & 3U) + iVar8;
  puVar28 = (undefined4 *)(iVar36 + local_74 * -4);
  ...
  if (0 < local_74) {
    ...
    do {
      ...
      *(int *)(((int)piVar19 - (int)piVar20) + (int)piVar29) = iVar8;
      ...
      if (0 < iVar30) {
        do {
          *(undefined4 *)(*(int *)(((int)piVar19 - (int)piVar20) + (int)piVar29) + iVar9 * 4) =
               0xffffffff;
          *(undefined4 *)(*piVar29 + iVar9 * 4) = 0xffffffff;
          iVar9 = iVar9 + 1;
        } while (iVar9 < iVar30);
      }
      piVar29 = piVar29 + 1;
  ...
  if (3 < param_7) {
    ...
    iVar8 = iVar9 * 4;
    puVar10 = (undefined4 *)(iVar35 + 4);
    do {
      puVar10[-1] = puVar18[-3];
      *puVar10 = *(undefined4 *)((param_1 - iVar35) + (int)puVar10);
      puVar10[1] = puVar18[-1];
      puVar10[2] = *puVar18;
      puVar10 = puVar10 + 4;
      puVar18 = puVar18 + 4;
  ...
  if (iVar8 < param_7) {
    puVar18 = (undefined4 *)(iVar35 + iVar8 * 4);
    iVar8 = param_7 - iVar8;
    do {
      *puVar18 = *(undefined4 *)((int)puVar18 + (param_1 - iVar35));
      puVar18 = puVar18 + 1;
      iVar8 = iVar8 + -1;
    } while (iVar8 != 0);
  }
  if (0 < local_74) {
    ...
    do {
      ...
      if (3 < param_7) {
        ...
        iVar8 = iVar9 * 4;
        local_2c = 8;
        puVar18 = (undefined4 *)(iVar35 + 8);
        do {
          *(undefined4 *)((int)puVar18 + *piVar29 + (-8 - iVar35)) = puVar18[-2];
          *(undefined4 *)((int)puVar18 + *piVar29 + 4 + (-8 - iVar35)) = puVar18[-1];
          *(undefined4 *)(local_2c + *piVar29) = *puVar18;
          *(undefined4 *)(*piVar29 + (4 - iVar35) + (int)puVar18) = puVar18[1];
      ...
      for (; iVar8 < param_7; iVar8 = iVar8 + 1) {
        *(undefined4 *)(*piVar29 + iVar8 * 4) = *(undefined4 *)(iVar35 + iVar8 * 4);
      }
      piVar29 = piVar29 + 1;
      ...
      if (0 < local_74) {
        ...
        do {
          ...
          do {
            ...
            iVar11 = iVar8;
            if (3 < iVar9 - iVar8) {
              puVar18 = (undefined4 *)(iVar14 + 0xc + iVar8 * 4);
              iVar13 = ((iVar9 - iVar8) - 4U >> 2) + 1;
              puVar10 = (undefined4 *)(iVar35 + 4 + iVar8 * 4);
              iVar11 = iVar8 + iVar13 * 4;
              do {
                puVar10[-1] = puVar18[-3];
                *puVar10 = *(undefined4 *)((iVar14 - iVar35) + (int)puVar10);
                puVar10[1] = puVar18[-1];
                puVar10[2] = *puVar18;
                puVar10 = puVar10 + 4;
                puVar18 = puVar18 + 4;
            ...
            if (iVar11 < iVar9) {
              puVar18 = (undefined4 *)(iVar35 + iVar11 * 4);
              iVar11 = iVar9 - iVar11;
              do {
                *puVar18 = *(undefined4 *)((int)puVar18 + (iVar14 - iVar35));
                puVar18 = puVar18 + 1;
                iVar11 = iVar11 + -1;
              } while (iVar11 != 0);
            }
            ...
            if ((fVar4 < (float)puVar27[local_74 + -1]) ||
              ...
              iVar11 = iVar9;
              if (3 < iVar13) {
                puVar18 = (undefined4 *)(iVar14 + 0xc + iVar9 * 4);
                iVar33 = ((param_7 - iVar9) - 4U >> 2) + 1;
                puVar10 = (undefined4 *)(iVar35 + 4 + iVar9 * 4);
                iVar11 = iVar9 + iVar33 * 4;
                do {
                  puVar10[-1] = puVar18[-3];
                  *puVar10 = *(undefined4 *)((int)puVar10 + (iVar14 - iVar35));
                  puVar10[1] = puVar18[-1];
                  puVar10[2] = *puVar18;
                  puVar10 = puVar10 + 4;
                  puVar18 = puVar18 + 4;
...
LAB_0070bf18:
              ...
              if (iVar11 < iVar14) {
                ...
                do {
                  ...
                  if (3 < iVar13) {
                    do {
                      *(undefined4 *)(piVar17[1] + iVar14 * 4) =
                           *(undefined4 *)(*piVar17 + iVar14 * 4);
                      *(undefined4 *)(piVar17[1] + 4 + iVar14 * 4) =
                           *(undefined4 *)(*piVar17 + 4 + iVar14 * 4);
                      *(undefined4 *)(piVar17[1] + 8 + iVar14 * 4) =
                           *(undefined4 *)(*piVar17 + 8 + iVar14 * 4);
                      *(undefined4 *)(piVar17[1] + 0xc + iVar14 * 4) =
                           *(undefined4 *)(*piVar17 + 0xc + iVar14 * 4);
                      iVar14 = iVar14 + 4;
                  ...
                  *puVar18 = *(undefined4 *)(((int)puVar27 - (int)local_64) + (int)piVar17);
                  piVar17 = piVar17 + -1;
                  puVar18 = puVar18 + -1;
                  local_28 = (float *)((int)local_28 + -1);
                } while (local_28 != (float *)0x0);
              ...
              if (3 < iVar13) {
                local_2c = iVar9 * 4 + 8;
                puVar18 = (undefined4 *)(local_2c + iVar35);
                iVar13 = ((param_7 - iVar9) - 4U >> 2) + 1;
                iVar14 = iVar9 + iVar13 * 4;
                do {
                  *(undefined4 *)((int)puVar18 + local_64[iVar11] + (-8 - iVar35)) = puVar18[-2];
                  *(undefined4 *)((int)puVar18 + local_64[iVar11] + 4 + (-8 - iVar35)) = puVar18[-1]
                  ;
                  *(undefined4 *)(local_64[iVar11] + local_2c) = *puVar18;
                  *(undefined4 *)((int)puVar18 + (4 - iVar35) + local_64[iVar11]) = puVar18[1];
                  local_2c = local_2c + 0x10;
                  puVar18 = puVar18 + 4;
                  iVar13 = iVar13 + -1;
                } while (iVar13 != 0);
              ...
              for (; iVar14 < param_7; iVar14 = iVar14 + 1) {
                *(undefined4 *)(local_64[iVar11] + iVar14 * 4) =
                     *(undefined4 *)(iVar35 + iVar14 * 4);
              }
              iVar14 = 0;
              do {
                *(undefined4 *)(piVar20[iVar11] + iVar14 * 4) =
                     *(undefined4 *)(piVar19[local_6c] + iVar14 * 4);
                iVar14 = iVar14 + 1;
              } while (iVar14 < iVar30);
...
LAB_0070bf4c:
      ...
      if (0 < local_74) {
        ...
        do {
          iVar8 = 0;
          do {
            *(undefined4 *)(*piVar29 + iVar8 * 4) =
                 *(undefined4 *)(*(int *)(((int)piVar20 - (int)piVar19) + (int)piVar29) + iVar8 * 4)
            ;
            iVar8 = iVar8 + 1;
          } while (iVar8 < iVar30);
          piVar29 = piVar29 + 1;
      ...
      if (3 < local_74) {
        ...
        do {
          puVar18[-1] = puVar10[-3];
          *puVar18 = *(undefined4 *)(((int)puVar27 - (int)puVar28) + (int)puVar18);
          puVar18[1] = puVar10[-1];
          puVar18[2] = *puVar10;
          puVar18 = puVar18 + 4;
          puVar10 = puVar10 + 4;
      ...
      if (iVar8 < local_74) {
        ...
        do {
          *puVar18 = *(undefined4 *)((int)puVar18 + ((int)puVar27 - (int)puVar28));
          puVar18 = puVar18 + 1;
          iVar8 = iVar8 + -1;
        } while (iVar8 != 0);
      }
  ...
  if (0 < iVar30) {
    do {
      uVar7 = *(undefined4 *)(*piVar20 + iVar8 * 4);
      *(undefined4 *)(iVar25 + iVar8 * 4) = uVar7;
