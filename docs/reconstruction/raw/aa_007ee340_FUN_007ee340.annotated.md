# Annotated low-level: FUN_007ee340
...
- Source: raw capture for `aa_007ee340`.
...
int __thiscall FUN_007ee340(char *param_1,int *param_2,undefined4 param_3,undefined4 *param_4)
  ...
  if (*param_1 == '\0') {
    ...
    if (-1 < iVar1) {
      ...
      if (DAT_00d1793c == '\0') {
        ...
        *(undefined1 *)(param_4 + 0x1d) = uStack_d9;
        *param_4 = uStack_40;
        param_4[0x1a] = uStack_58;
        param_4[1] = uStack_60;
        param_4[0x1b] = uStack_38;
        *(undefined2 *)(param_4 + 0x1c) = uStack_8c;
        *(undefined2 *)((int)param_4 + 0x72) = uStack_94;
        param_4[2] = uStack_48;
        *(undefined1 *)((int)param_4 + 0x75) = uStack_da;
        param_4[0x14] = uStack_70;
        *(undefined1 *)((int)param_4 + 0x77) = uStack_db;
        param_4[0x16] = uStack_6c;
        param_4[0x18] = uStack_64;
        param_4[0x17] = uStack_5c;
        param_4[0x1f] = uStack_4c;
        param_4[0x19] = uStack_54;
        *(undefined2 *)(param_4 + 0x1e) = pOStack_a4._0_2_;
