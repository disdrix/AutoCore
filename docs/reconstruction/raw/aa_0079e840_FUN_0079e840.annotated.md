# Annotated low-level: FUN_0079e840
...
- Source: raw capture for `aa_0079e840`.
...
```c
undefined4 __thiscall FUN_0079e840(int param_1,float param_2)
...
LAB_0079ec3b:
      ...
      switch(*(undefined1 *)((int)piVar3 + 10)) {
      case 3:
