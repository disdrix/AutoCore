# Annotated low-level: FUN_005e7cf0
...
- Source: raw capture for `aa_005e7cf0`.
...

{
  ...
  local_334 = (float *)SQRT(((float)param_2[3] - (float)param_2[5]) *
                            ...
                            ((float)param_2[2] - (float)param_2[4]));
  local_374 = (undefined1 *)(1 - (int)ROUND((float)local_334 * _DAT_009dca08));
  local_378 = (undefined1 *)((int)local_374 * 2);
  local_370 = (undefined1 *)(DAT_00a0f298 / (float)(int)local_374);
  ...
  if (0 < (int)local_374) {
    ...
    do {
      ...
      while( true ) {
        ...
        local_374 = (undefined1 *)((int)local_374 + 0x14);
      }
      local_374 = (undefined1 *)&ppfStack_3ac;
      FUN_004b08b0();
      local_374 = (undefined1 *)&ppfStack_3ac;
    ...
    } while (local_378 != (undefined1 *)0x0);
    puVar3 = (undefined1 *)0.0;
    if ((local_30c != (void *)0x0) &&
       (puVar2 = (undefined1 *)(((int)local_308 - (int)local_30c) / 0x14), local_370 = puVar2,
       0 < (int)puVar2)) {
      local_2b4 = (void *)((int)puVar2 / 3);
      if ((undefined1 *)((int)local_2b4 * 3) != puVar2) {
      ...
      *param_3 = iVar5;
      ...
      puVar9 = (undefined4 *)(auStack_220 + 3);
      do {
        puVar17 = puVar9;
        puVar9 = (undefined4 *)((int)puVar17 + 1);
      } while (*(char *)((int)puVar17 + 1) != '\0');
      *(undefined4 *)((int)puVar17 + 1) = DAT_00a2c53c;
      *(undefined1 *)((int)puVar17 + 5) = DAT_00a2c540;
      ...
      *(undefined4 *)(pcVar16 + 1) = s__bump_dds_009dcc34._0_4_;
      *(undefined4 *)(pcVar16 + 5) = s__bump_dds_009dcc34._4_4_;
      *(undefined2 *)(pcVar16 + 9) = s__bump_dds_009dcc34._8_2_;
      ...
      if (-1 < iVar5) {
        if (*(int *)(piVar6[5] + 0x10) != 0) {
          ...
          puVar9 = (undefined4 *)FUN_00746520();
          if (puVar9 != (undefined4 *)0x0) {
            ...
            for (iVar5 = 0; iVar5 != 0; iVar5 = iVar5 + -1) {
              *(undefined1 *)puVar9 = *(undefined1 *)puVar17;
            ...
            if (*(int *)(piVar6[3] + 0x10) != 0) {
              ...
              if (puVar10 != (ushort *)0x0) {
                ...
                *(undefined1 **)(iVar5 + 0x98) = puStack_8;
                *(undefined1 *)(*piVar6 + 0x139) = 1;
                fStack_2d8 = 0.0;
      ...
      if ((undefined4 *)*unaff_retaddr != (undefined4 *)0x0) {
        ppfStack_3a4 = (float **)0x1;
        (*(code *)**(undefined4 **)*unaff_retaddr)();
      }
      *unaff_retaddr = 0;
      ppfStack_3a4 = (float **)0x1;
      (**(code **)*piVar6)();
