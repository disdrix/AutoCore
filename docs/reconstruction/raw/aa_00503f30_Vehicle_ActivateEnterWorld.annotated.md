# Annotated low-level: Vehicle_ActivateEnterWorld
...
- Source: raw capture for `aa_00503f30`.
...

{
  ...
  if (*(int *)(param_1->pPad_158_1DF_Inferred + 0x48) == 0) {
    ...
    fVar11 = (float10)FUN_004cd220(*(undefined4 *)(param_1->pOpaqueHeader_Inferred + iVar9 + 0x84),
                                   *(undefined4 *)(param_1->pOpaqueHeader_Inferred + iVar9 + 0x8c));
    iVar9 = *(int *)(*(int *)(param_1->pOpaqueHeader_Inferred + 4) + 4);
  ...
  if ((char)((uint)iVar4 >> 0x18) != '\0') {
    ...
    if (*(char *)(*(int *)(param_1->pOpaqueHeader_Inferred +
      ...
      if (piVar10 != (int *)0x0) {
        ...
        (**(code **)(*piVar8 + 0xac))(*(undefined2 *)(iVar9 + 0x12e));
      }
  ...
  if (*(int *)(param_1->pPad_248_267_Inferred + 0x10) != 0) {
    *(undefined1 *)(*(int *)(param_1->pPad_248_267_Inferred + 0x10) + 0x11c) = 1;
  }
  if ((char)((uint)iVar4 >> 0x18) != '\0') {
    (**(code **)(*(int *)(param_1->pOpaqueHeader_Inferred +
  ...
  if ((char)((uint)iVar4 >> 0x18) != '\0') {
    ...
    (**(code **)(*(int *)(param_1->pOpaqueHeader_Inferred + iVar4 + 4) + 0x218))
              (*(undefined4 *)(param_1->pOpaqueHeader_Inferred + iVar4 + 0xa8));
    ...
    if (*(int *)(param_1->pOpaqueHeader_Inferred +
      ...
      if (iVar4 != 0) {
        ...
        (**(code **)(*(int *)(param_1->pOpaqueHeader_Inferred +
                             *(int *)(*(int *)(param_1->pOpaqueHeader_Inferred + 4) + 4) + 4) +
                    0x210))(0,*(undefined4 *)(iVar4 + 0xd64),1);
