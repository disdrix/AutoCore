# Annotated low-level: FUN_008cd200
...
- Source: raw capture for `aa_008cd200`.
...

{
  ...
  void *apvStack_30c [2];
  char acStack_304 [4];
  undefined1 auStack_300 [60];
  char acStack_2c4 [8];
  undefined1 auStack_2bc [496];
  ...
  do {
    ...
    if ((undefined4 *)piVar13[-0xc] != (undefined4 *)0x0) {
      pcStack_32c = (char *)0x8cd252;
      (*(code *)**(undefined4 **)piVar13[-0xc])();
    }
    piVar13[-0xc] = 0;
    if (*piVar13 != 0) {
  ...
  do {
    ...
    *piVar13 = iVar3;
    ...
    if (pcStack_344 == (char *)0x0) {
      ...
      puStack_348 = (undefined1 *)0x8cd39c;
      iVar5 = FUN_007b5dd0();
    }
...
LAB_008cd440:
      ...
      puStack_348 = (undefined1 *)0x8cd44d;
      ...
      puStack_348 = (undefined1 *)0x8cd3e7;
      (**(code **)(*(int *)piVar13[0x18] + 0x28))();
    }
    else {
      ...
      if (*(char *)(*(int *)(*(int *)(*(int *)(*(int *)(iVar5 + 4) + 4) + 0xac + iVar5) + 0x3c) +
        ...
        puStack_348 = (undefined1 *)0x8cd413;
        (**(code **)(*(int *)piVar13[0x18] + 0x28))();
      }
      else {
        if ((iVar5 == 0) ||
        ...
        puStack_348 = (undefined1 *)0x8cd43e;
        (**(code **)(*(int *)piVar13[0x18] + 0x28))();
      }
    }
    piVar8 = (int *)*piVar13;
    puStack_348 = auStack_2bc;
    puStack_34c = (undefined1 *)0x8cd462;
    ...
    puVar7 = (undefined4 *)(**(code **)(*(int *)*piVar13 + 0x120))();
