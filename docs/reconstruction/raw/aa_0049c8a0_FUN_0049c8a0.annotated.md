# Annotated low-level: FUN_0049c8a0
...
- Source: raw capture for `aa_0049c8a0`.
...
```c
void __thiscall FUN_0049c8a0(int param_1,void *param_2,uint param_3,undefined4 *param_4)
