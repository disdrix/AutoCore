...

{
  ...
  *(undefined1 *)(param_1[0x167] + 0x48b) = 1;
  ...
  *(undefined1 *)(param_1[0x16a] + 0x48c) = 1;
  ...
  *(undefined4 *)(param_1[0x16e] + 0x498) = 0;
  ...
  *(undefined4 *)(param_1[0x16f] + 0x498) = 0;
  ...
  *(undefined1 *)(param_1[0x177] + 0x48b) = 1;
  ...
  *(undefined1 *)(param_1[0x178] + 0x48b) = 1;
  ...
  *(undefined1 *)(param_1[0x179] + 0x48b) = 1;
  ...
  *(undefined1 *)(param_1[0x17a] + 0x48b) = 1;
  ...
  *(undefined1 *)(param_1[0x180] + 0x48b) = 1;
  ...
  *(undefined1 *)(param_1[0x181] + 0x48b) = 1;
  ...
  *(undefined1 *)(param_1[0x183] + 0x48b) = 1;
...
## R13-011 re-verify (2026-08-05) - OWN-ONLY dual seal

| Field | Value |
|---|---|
| **Agent** | R13-011 |
| **Tools** | decompile_function + analyze_function_complete + read_memory + callers/xrefs + get_function_by_address (no disassemble_bytes) |
| **Body** | 0x00879ea0-0x0087b38a inclusive (5355 B / 0x14EB) |
| **ABI** | thiscall ECX=host (MOV EBP,ECX); void; RET (C3) |
| **Dispatch** | DATA vtbl 0x00a59500 = 0x00879ea0; callers empty |
| **Entry hex** | 6A FF 68 CD 92 9B 00 ... 8B E9 33 DB 57 88 9D 24 05 00 00 |
| **Exit hex** | ... 5F 5E 5D 5B 64 89 0D 00 00 00 00 83 C4 10 C3 |
| **Semantics** | Arena Advanced host CreateChildWidgets: clear host+0x524; prep 00792600; 56x i_d_arena_adv_* children; tabs +0x630/+0x634/+0x638 via dualed 00822cb0/00756c90; tail 00879240 + host vtbl+0x448/+0x34c |
| **Name** | UI_ArenaAdvHost_CreateChildWidgets_Inferred |
| **Verdict** | accept-with-gaps |
| **Terminal** | false |
| **Integrity** | Scaffold raw body above unchanged; this section appended only |

Live decompile 2026-08-05 matches frozen raw CF for child tree / XML / slot stores / tab pairing / tail.
