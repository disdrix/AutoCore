# Annotated low-level: FUN_005a3b00
...
- Source: raw capture for `aa_005a3b00`.
...
```c
void __thiscall FUN_005a3b00(int param_1,undefined4 *param_2,uint *param_3)

{
  ...
  if (bVar2) {
    if (puVar5 == (undefined4 *)**(int **)(param_1 + 4)) {
      puVar5 = (undefined4 *)FUN_005a3310(&param_3,1,puVar5,puVar3);
      uVar1 = *puVar5;
  ...
  if (((int)param_3[5] <= (int)puVar3[1]) &&
    ...
    puVar5 = (undefined4 *)FUN_005a3310(&param_3,local_4,puVar5,puVar3);
    *param_2 = *puVar5;
    *(undefined1 *)(param_2 + 1) = 1;
    return;
  }
