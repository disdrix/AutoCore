# Annotated low-level: FUN_0070f400
...
- Source: raw capture for `aa_0070f400`.
...
```c
float10 __fastcall FUN_0070f400(undefined4 param_1,int param_2,int param_3,float param_4)

{
  ...
  puVar7 = (undefined4 *)((-in_EAX & 3U) + in_EAX);
  param_2 = param_2 >> 1;
  puVar7[1] = param_4;
  *puVar7 = 0x3f800000;
