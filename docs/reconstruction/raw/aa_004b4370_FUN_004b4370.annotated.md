# Annotated low-level: FUN_004b4370
...
- Source: raw capture for `aa_004b4370`.
...

{
  ...
  *(undefined1 *)((int)param_1 + 0xaa) = 0xff;
  *(undefined1 *)((int)param_1 + 0xa9) = 0xff;
  *(undefined1 *)(param_1 + 0x2a) = 0xff;
  *(undefined1 *)((int)param_1 + 0xab) = 0xff;
  *(undefined1 *)((int)param_1 + 0xae) = 0xff;
  *(undefined1 *)((int)param_1 + 0xad) = 0xff;
  *(undefined1 *)(param_1 + 0x2b) = 0xff;
  *(undefined1 *)((int)param_1 + 0xaf) = 0xff;
  *(undefined1 *)((int)param_1 + 0x11e) = 0xff;
  *(undefined1 *)((int)param_1 + 0x11d) = 0xff;
  *(undefined1 *)(param_1 + 0x47) = 0xff;
  *(undefined1 *)((int)param_1 + 0x11f) = 0xff;
  *(undefined1 *)((int)param_1 + 0x122) = 0xff;
  *(undefined1 *)((int)param_1 + 0x121) = 0xff;
  *(undefined1 *)(param_1 + 0x48) = 0xff;
  *(undefined1 *)((int)param_1 + 0x123) = 0xff;
  ...
  *(undefined1 *)((int)param_1 + 0x242) = 0;
  piVar3 = param_1 + 0x21;
