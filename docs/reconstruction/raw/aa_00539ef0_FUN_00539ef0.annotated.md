# Annotated low-level: FUN_00539ef0
...
- Source: raw capture for `aa_00539ef0`.
...
```c
void __thiscall FUN_00539ef0(int param_1,int param_2,uint param_3,undefined4 *param_4)
