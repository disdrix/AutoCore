# Annotated low-level: FUN_007c6c50
...
- Source: raw capture for `aa_007c6c50`.
...
undefined4 __thiscall FUN_007c6c50(char *param_1,short *param_2,int *param_3,int *param_4)
