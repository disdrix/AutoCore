# Annotated low-level: FUN_0043dc70
...
- Source: raw capture for `aa_0043dc70`.
...
```c
undefined4 * FUN_0043dc70(undefined4 *param_1)

{
  ...
  if (bVar4) {
    if (puVar3 == (undefined4 *)**(int **)(in_EAX + 4)) {
      puVar3 = (undefined4 *)FUN_0043ddf0(&param_1,1,puVar3,unaff_EBX);
      *puVar1 = *puVar3;
  ...
  if ((uint)param_1[3] < *unaff_EBX) {
    puVar3 = (undefined4 *)FUN_0043ddf0(&param_1,bVar4,puVar3,unaff_EBX);
    *puVar1 = *puVar3;
    *(undefined1 *)(puVar1 + 1) = 1;
    return puVar1;
  }
