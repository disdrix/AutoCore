# Annotated low-level: FUN_006f63e0
...
- Source: raw capture for `aa_006f63e0`.
...
```c
void FUN_006f63e0(undefined4 *param_1,undefined4 *param_2,int *param_3,int *param_4,int *param_5)
