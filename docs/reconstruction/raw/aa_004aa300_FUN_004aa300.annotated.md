# Annotated low-level: FUN_004aa300
...
- Source: raw capture for `aa_004aa300`.
...

{
  ...
  *(undefined4 *)(param_1 + 0x3f8) = uVar3;
  ...
  FUN_004a9800(2,*(undefined4 *)(*(int *)(*(int *)(param_1 + 0x340) + 0x78) + 0x154),local_318);
  FUN_004a9800(1,*(undefined4 *)(*(int *)(*(int *)(param_1 + 0x340) + 0x78) + 0x154),local_214);
  local_320 = local_318;
  do {
    cVar1 = *local_320;
