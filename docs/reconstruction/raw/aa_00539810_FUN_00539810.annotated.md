# Annotated low-level: FUN_00539810
...
- Source: raw capture for `aa_00539810`.
...
```c
void __thiscall FUN_00539810(int param_1,void *param_2,uint param_3,undefined4 *param_4)
