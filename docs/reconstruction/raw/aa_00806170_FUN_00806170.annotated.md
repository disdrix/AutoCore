# Annotated low-level: FUN_00806170
...
- Source: raw capture for `aa_00806170`.
...

{
  ...
  switch(*(undefined1 *)(in_EAX + 0xd1c)) {
  case 0:
    *(undefined4 *)(in_EAX + 0xcd4) = 0xff;
    (**(code **)(*piVar3 + 0x2c))(1);
    (**(code **)(*piVar3 + 0xa4))(1);
    (**(code **)(*piVar3 + 0xc))(0,0);
    iVar5 = *piVar3;
  ...
  case 3:
    *(undefined4 *)(in_EAX + 0xcd4) = 0x80;
    ...
    uVar1 = DAT_00b00228;
    *(undefined4 *)(in_EAX + 0x940) = DAT_00b0022c;
    *(undefined4 *)(in_EAX + 0x944) = uVar1;
    iVar5 = 9;
    bVar7 = true;
