# Annotated low-level: FUN_00742630
...
- Source: raw capture for `aa_00742630`.
...
undefined4 __thiscall FUN_00742630(int param_1,int *param_2)

{
  ...
  *(undefined4 *)(param_1 + 4) = 0;
  ...
  local_d8 = (undefined1 *)((int)pcVar1 * 0x11);
  local_dc = 300;
  local_ac = pcVar1;
  (**(code **)(*param_2 + 8))();
  ...
  puStack_fc = (undefined1 *)&pcStack_14c;
  ...
  puStack_fc = (undefined1 *)((float)((int)pcStack_d0 - (int)local_d8) * _DAT_00aaab94);
  fStack_e4 = fVar7;
        ...
        *(char *)((int)uStack_f0 + 3) = (char)iStack_bc;
        ...
        fStack_d4 = fStack_b8 -
                    (float)*(int *)(*(int *)(*(int *)(local_f4 + 4) + uVar5 * 4) +
                                   (uVar6 + iVar3) * 4) * fVar7;
        local_d8 = (undefined1 *)(float)(int)pcStack_10c;
  ...
  if (0.0 < fVar7) {
    ...
    do {
      ...
      puStack_b4 = (undefined1 *)(fStack_b8 * fStack_b0);
      ...
      *piVar9 = iStack_c0;
      ...
      if (*(char *)((int)piVar9 + 9) != '\0') {
        ...
        local_d8 = (undefined1 *)(piVar9[3] - (int)local_ac / 2);
        if ((int)local_d8 < 0) {
          local_d8 = (undefined1 *)0x0;
        }
        if (iStack_e0 < (int)(local_d8 + (int)local_ac)) {
          local_d8 = (undefined1 *)(iStack_e0 - (int)local_ac);
        }
        iVar4 = param_2[0x1a] + 1;
