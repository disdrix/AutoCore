# Annotated low-level: FUN_00793130
...
- Source: raw capture for `aa_00793130`.
...
```c
void FUN_00793130(undefined4 param_1)

{
  ...
  if (*(int *)(unaff_EDI + 0x4d0) != 0) {
    ...
    (**(code **)(*piVar2 + 0x28))(0);
    iVar3 = FUN_004287e0(*(undefined4 *)(unaff_EDI + 0x4d0),piVar2,0);
    if (-1 < iVar3) {
