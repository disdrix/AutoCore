# Annotated low-level: FUN_008da870
...
- Source: raw capture for `aa_008da870`.
...

{
  ...
  *(undefined1 *)(param_1[0x152] + 0x48c) = 1;
  *(undefined1 *)(param_1[0x152] + 0x48d) = 1;
  pvVar1 = operator_new(0x4a4);
  iVar2 = 0;
  if (pvVar1 != (void *)0x0) {
    iVar2 = FUN_00795f20();
  ...
  *(undefined1 *)(param_1[0x153] + 0x48c) = 1;
  *(undefined1 *)(param_1[0x153] + 0x48d) = 1;
  pvVar1 = operator_new(0x4cc);
  iVar2 = 0;
  if (pvVar1 != (void *)0x0) {
    iVar2 = FUN_0079c860();
