# Annotated low-level: FUN_0081f380
...
- Source: raw capture for `aa_0081f380`.
  ...
  *(undefined4 *)(iVar2 + 0x70c) = 0;
  ...
  do {
    if ((byte)piVar12 < 0x78) {
      ...
      iVar2 = uVar10 * 0x34;
      if (((&DAT_00d1bbee + uVar10 * 0x1a != (undefined2 *)0x0) && ((&DAT_00d1bbf5)[iVar2] != '\0'))
        ...
        *(undefined2 *)(piVar11 + 0x206) = (&DAT_00d1bbee)[uVar10 * 0x1a];
        *(undefined2 *)((int)piVar11 + 0x81a) = uVar1;
        ...
        *(undefined2 *)((int)piVar11 + 0x81e) = (&DAT_00d1bc1a)[uVar10 * 0x1a];
        *(undefined2 *)(piVar11 + 0x207) = uVar1;
        cVar4 = (**(code **)(*piVar11 + 0x3d8))();
        if (cVar4 != '\0') {
          piVar8 = piVar12;
          FUN_00816860();
    ...
    *piVar8 = (int)piVar12;
    if (piVar12[0x180] != 0) {
      (**(code **)(*(int *)piVar12[0x180] + 0x1d8))
                (*(undefined4 *)(&stack0xffffff04 + iVar6 * 4),1,1);
