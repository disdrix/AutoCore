# Annotated low-level: Vehicle_SetWheelset
...
- Source: raw capture for `aa_004fea90`.
...
## Human refine (2026-07-23, priority_013)

- human-refined clean: +0x258 slot, type 0x10, wheel loop +0xb0, scale chassis+0x600
