# Annotated low-level: CVOGHBAIDriver_DoLogic

| Field | Value |
|---|---|
| Stable ID | a_005d7750 |
| VA | 0x005d7750 |
| System | unknown |
| Date | 2026-07-23 |
...
NPC vehicle driver AI main tick. State at owner+0x26c: 0 idle/patrol, 1 engage, 2 combat.
...
- Source: raw capture for a_005d7750.
