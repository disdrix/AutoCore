# Annotated low-level: FUN_009440e0
...
- Source: raw capture for `aa_009440e0`.
...

{
  ...
  if (param_1[0x2a] == 0) {
    ...
    local_4 = *(undefined4 *)(param_1[0x2a] + 0x34);
  }
  ...
  if (piVar5 == (int *)0x0) {
    FUN_007a4480(1,
                 ...
                 ,param_1[0x58],param_1[0x59],*(undefined4 *)(param_1[0x2a] + 0x34));
  }
  ...
  if (iVar7 == 0xe) {
    ...
    if (((piVar1 != (int *)0x0) && (iVar8 = (**(code **)(*piVar1 + 0x1d8))(), iVar8 != 0)) &&
      ...
      if (*(int *)(*(int *)(*(int *)(*(int *)(iVar8 + 4) + 4) + 0xac + iVar8) + 0x38) == 0x14) {
        ...
        if ((((int *)unaff_EDI[0x433] != (int *)0x0) &&
          ...
          FUN_008718a0(*(undefined4 *)(iVar7 + 0x164 + iVar8),*(undefined4 *)(iVar7 + 0x168 + iVar8)
                      );
          piVar11 = piVar5;
        }
      }
    ...
    if (iVar7 != 0) {
      ...
      if ((((int *)unaff_EDI[0x433] != (int *)0x0) &&
        ...
        FUN_008718a0(*(undefined4 *)(iVar8 + 0x164 + iVar7),*(undefined4 *)(iVar8 + 0x168 + iVar7));
        piVar11 = piVar5;
      }
