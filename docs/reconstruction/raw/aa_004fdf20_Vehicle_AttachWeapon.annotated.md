# Annotated low-level: Vehicle_AttachWeapon
...
- Source: raw capture for `aa_004fdf20`.
...

{
  ...
  if (param_3 < 3) {
    ...
    *(undefined4 *)(param_1 + 0x630 + param_3 * 8) = 0xffffffff;
    *(undefined4 *)(param_1 + 0x634 + param_3 * 8) = 0xffffffff;
    if (param_2 != 0) {
      if (*(int *)(*(int *)(*(int *)(*(int *)(param_2 + 4) + 4) + 0xac + param_2) + 0x38) != 0xc) {
        ...
        FUN_007a4480(1,"Set weapon of unhappy type: CBID:%d COID:%I64d Slot:%u",
                     *(undefined4 *)(*(int *)(iVar3 + param_2 + 0xac) + 0x34),
                     *(undefined4 *)(iVar3 + 0x164 + param_2),
                     *(undefined4 *)(iVar3 + 0x168 + param_2),param_3);
      }
      ...
      FUN_0056be70();
      iVar3 = *(int *)(*(int *)(param_2 + 4) + 4);
      *(undefined4 *)(param_1 + 0x630 + param_3 * 8) = *(undefined4 *)(iVar3 + 0x164 + param_2);
      *(undefined4 *)(param_1 + 0x634 + param_3 * 8) = *(undefined4 *)(iVar3 + 0x168 + param_2);
    }
