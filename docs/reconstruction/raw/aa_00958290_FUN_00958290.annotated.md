# Annotated low-level: FUN_00958290
...
- Source: raw capture for `aa_00958290`.
...
```c
undefined4 __thiscall FUN_00958290(int param_1,undefined4 param_2,char *param_3)
...
LAB_00958363:
  ...
  case '8':
    ...
    if (*(int *)(*(int *)(*(int *)(iVar15 + 4) + 4) + 0xa4 + iVar15) != 0) {
      uVar7 = (**(code **)(**(int **)(*(int *)(*(int *)(iVar15 + 4) + 4) + 0xa4 + iVar15) + 0x1d8))
                        ();
      FUN_004de760(*(undefined4 *)(param_1 + 0xe98),uVar7);
    }
    break;
  case '9':
    iVar15 = *(int *)(param_1 + 0xe98);
    if (*(int *)(*(int *)(*(int *)(iVar15 + 4) + 4) + 0xa4 + iVar15) != 0) {
      if (*(int *)(*(int *)(*(int *)(*(int *)(iVar15 + 4) + 4) + 0xa4 + iVar15) + 0x11c) == 0) {
        ...
        (**(code **)(**(int **)(*(int *)(*(int *)(*(int *)(param_1 + 0xe98) + 4) + 4) + 0xa4 +
                               *(int *)(param_1 + 0xe98)) + 0x160))
                  (*(undefined4 *)(iVar15 + 0x10),*(undefined4 *)(iVar15 + 0x18),
  ...
  case 't':
    ...
    do {
      iVar14 = *(int *)(param_1 + 0xe98);
      iVar2 = *(int *)(*(int *)(*(int *)(iVar14 + 0x250) + 0x260) + 4);
      iStack_480 = *(undefined4 *)(iVar2 + 0xdc);
      uVar7 = *(undefined4 *)(iVar2 + 0xe8);
      iVar14 = (**(code **)(*(int *)(*(int *)(*(int *)(iVar14 + 4) + 4) + 4 + iVar14) + 0x19c))();
      (**(code **)(*(int *)(*(int *)(*(int *)(*(int *)(param_1 + 0xe98) + 4) + 4) + 4 +
                           *(int *)(param_1 + 0xe98)) + 0x1a0))
                (*(undefined4 *)(iVar14 + 0x34),uVar7,piVar13,auStack_440,iStack_480);
      fVar17 = (float10)FUN_004e9aa0();
      puStack_488 = (undefined4 *)(float)fVar17;
      iVar15 = iVar15 + -1;
    } while (iVar15 != 0);
    ...
    puStack_488 = (undefined4 *)(LStack_478.s.LowPart - LStack_468._0_4_);
  ...
  case 'v':
    ...
    *piVar13 = (int)pvVar8;
    ...
    puVar4 = (undefined4 *)*piVar13;
    *puVar4 = DAT_00a28ca4;
    *(undefined2 *)(puVar4 + 1) = DAT_00a28ca8;
    *(undefined1 *)((int)puVar4 + 6) = DAT_00a28caa;
    puVar4 = (undefined4 *)piVar13[1];
    *puVar4 = DAT_00a28c9c;
    *(undefined2 *)(puVar4 + 1) = DAT_00a28ca0;
    *(undefined1 *)((int)puVar4 + 6) = DAT_00a28ca2;
