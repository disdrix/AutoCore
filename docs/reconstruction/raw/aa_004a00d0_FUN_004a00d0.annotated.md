# Annotated low-level: FUN_004a00d0
...
- Source: raw capture for `aa_004a00d0`.
...
```c
undefined4 FUN_004a00d0(int param_1,int *param_2)
  ...
  if (param_2 != (int *)0x0) {
    ...
    if ((iVar2 == 0) && (local_2a4 != (int *)0x0)) {
      *(float *)(param_1 + 800) = g_flOne;
      puVar1 = (undefined1 *)(param_1 + 0x318);
      ...
      *(undefined1 *)(param_1 + 0x31b) = (undefined1)uStack_2a0;
      *(byte *)(param_1 + 0x3c4) =
      ...
      *(undefined1 *)(param_1 + 799) = (undefined1)uStack_29c;
