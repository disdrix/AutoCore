# Annotated low-level: FUN_004a76e0
...
- Source: raw capture for `aa_004a76e0`.
...
```c
void __thiscall FUN_004a76e0(int param_1,int param_2,uint param_3,undefined4 *param_4)
