# Annotated low-level: FUN_00844c00
...
- Source: raw capture for `aa_00844c00`.
...

{
  ...
  if (iStack_34 < 0) {
    ...
    if (*(int *)(iVar7 + 4) < iVar6 + iStack_3c) {
      ...
      puVar4 = (undefined1 *)(**(code **)(*unaff_ESI + 0x140))(&iStack_30,1);
  ...
  if ((char)((uint)puVar10 >> 0x18) == '\0') {
    piVar2 = (int *)(**(code **)(*(int *)*DAT_00d1b780 + 0x140))(&iStack_30,1);
    puVar5 = (undefined1 *)(*piVar2 - unaff_EDI);
    piVar2 = (int *)(**(code **)(*unaff_ESI + 0x140))(&iStack_30,1);
