# Annotated low-level: FUN_006d31d0
...
- Source: raw capture for `aa_006d31d0`.
...
```c
void __thiscall FUN_006d31d0(int param_1,undefined4 *param_2,int *param_3,int *param_4,int *param_5)

{
  ...
  FUN_006d3040(*(undefined4 *)(param_1 + 0x10));
  local_1a8 = param_3[2];
  local_1b4 = local_150;
  local_1a4 = param_3;
  local_1d4 = 0;
  ...
  if (0 < (int)local_1cc) {
    ...
    do {
      ...
      puVar12 = (undefined4 *)(local_1d4 + local_1d0);
      iVar13 = local_1dc;
      iVar8 = local_1dc;
      ...
      iVar8 = iVar8 * 0x30;
      uStack_138 = *(undefined4 *)(iVar8 + 8 + local_1d0);
      uVar10 = *(undefined4 *)(iVar8 + local_1d0);
      uStack_118 = *(undefined4 *)(iVar8 + 0x28 + local_1d0);
      uVar2 = *(undefined4 *)(iVar8 + 4 + local_1d0);
      puVar11 = (undefined4 *)(iVar8 + local_1d0);
      uVar5 = puVar11[9];
      ...
      if (iStack_198 < (int)piVar14) {
        ...
        do {
          if (((*(int *)(local_1d0 + 0x2c + iVar8) != 2) ||
            ...
            *(undefined4 *)(local_1d0 + 0x2c + iVar8) = 0;
            puVar12 = (undefined4 *)(iVar13 + -0x30 + local_1d0);
            uVar10 = *(undefined4 *)(local_1d0 + iVar8);
            uStack_170 = *(undefined4 *)(local_1d0 + 0x10 + iVar8);
            uVar2 = *(undefined4 *)(local_1d0 + 4 + iVar8);
            puStack_190 = (undefined4 *)(local_1d0 + 8 + iVar8);
            uStack_178 = *puStack_190;
            puStack_184 = (undefined4 *)(local_1d0 + 0xc + iVar8);
            uStack_174 = *puStack_184;
            uStack_16c = *(undefined4 *)(local_1d0 + 0x14 + iVar8);
            puVar11 = (undefined4 *)(local_1d0 + 0x10 + iVar8);
            uStack_168 = puVar11[2];
            uStack_164 = puVar11[3];
            puStack_188 = (undefined4 *)(local_1d0 + 0x20 + iVar8);
            uStack_160 = *puStack_188;
            puStack_1a0 = (undefined4 *)(local_1d0 + 0x24 + iVar8);
            uStack_15c = *puStack_1a0;
            puStack_194 = (undefined4 *)(local_1d0 + 0x28 + iVar8);
            uStack_158 = *puStack_194;
            puStack_18c = (undefined4 *)(local_1d0 + 0x2c + iVar8);
            uStack_154 = *puStack_18c;
            *(undefined4 *)(local_1d0 + iVar8) = *puVar12;
            *(undefined4 *)(local_1d0 + 4 + iVar8) = puVar12[1];
    ...
    do {
      if (*(int *)(iVar8 + 0x2c + local_1d0) == 0) {
        ...
        if (sVar3 != -1) {
          ...
          *(undefined2 *)(*(int *)(iVar8 + 0x20 + local_1d0) + 0xc) = 0xffff;
        }
      }
      else {
        piVar14 = (int *)*param_5;
        ...
        puVar12 = (undefined4 *)(piVar14[1] * 0x30 + *piVar14);
        piVar14[1] = piVar14[1] + 1;
        iVar13 = iVar8 + local_1d0;
        *puVar12 = *(undefined4 *)(iVar8 + local_1d0);
        puVar12[1] = *(undefined4 *)(iVar13 + 4);
        puVar12[2] = *(undefined4 *)(iVar13 + 8);
        puVar12[3] = *(undefined4 *)(iVar13 + 0xc);
        puVar12[4] = *(undefined4 *)(iVar13 + 0x10);
        puVar12[5] = *(undefined4 *)(iVar13 + 0x14);
        puVar12[6] = *(undefined4 *)(iVar13 + 0x18);
        puVar12[7] = *(undefined4 *)(iVar13 + 0x1c);
        if (*(short *)(*(int *)(iVar8 + 0x20 + local_1d0) + 0xc) == -1) {
          local_1a8 = param_3[2];
          local_1a4 = param_3;
          local_1b8 = (int *)(**(code **)(**(int **)(local_1b4 + 0xc) + 0x34))
                                       (*(undefined4 *)(iVar8 + 0x28 + local_1d0),local_110);
          local_1b4 = *(int *)(iVar8 + iStack_1d8 + 0x28);
          uVar7 = (**(code **)(**(int **)(iStack_1c4 + 8) + 4))(param_2,&local_1b8,param_4,puVar12);
          *(undefined2 *)(*(int *)(iVar8 + iStack_1d8 + 0x20) + 0xc) = uVar7;
        }
        sVar3 = *(short *)(*(int *)(iVar8 + 0x20 + local_1d0) + 0xc);
        if (sVar3 == -1) {
