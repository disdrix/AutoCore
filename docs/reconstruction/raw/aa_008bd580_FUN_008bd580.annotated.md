# Annotated low-level: FUN_008bd580
...
- Source: raw capture for `aa_008bd580`.
...

{
  ...
  undefined1 auStack_11c [2];
  undefined1 auStack_11a [6];
  ...
  if (param_3 != (int *)0x0) {
    ...
    if (*(int *)(param_1 + 0x56c + param_2 * 4) != 0) {
      ...
      puVar11 = (undefined4 *)(auStack_11c + 2);
...
LAB_008bd735:
            ...
            if ((*(int *)(iVar2 + 0x10) == *(int *)(*(int *)(iStack_4 + 0xa8) + 0x34)) &&
              ...
              uVar3 = FUN_007a6de0(*(undefined4 *)(*(int *)(iStack_130 + 0x14c) + 0x14c),0xffffffff)
              ;
    ...
    if (*(int *)(param_1 + 0x57c + param_2 * 4) != 0) {
      ...
      if (((*(byte *)(*(int *)(param_3[0x2a] + 0x3c) + 0x3f2) & 0x80) != 0) &&
         (iVar9 = (**(code **)(*param_3 + 0x234))
                            (*(undefined4 *)(*(int *)(param_3[0x2a] + 0x3c) + 0x3bc)), iVar9 != 0))
      {
