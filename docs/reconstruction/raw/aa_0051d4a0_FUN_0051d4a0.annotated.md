# Annotated low-level: FUN_0051d4a0
...
- Source: raw capture for `aa_0051d4a0`.
...
```c
void __thiscall FUN_0051d4a0(int param_1,int param_2,uint param_3,undefined4 *param_4)
