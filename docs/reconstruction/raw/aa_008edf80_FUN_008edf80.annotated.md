# Annotated low-level: FUN_008edf80
...
- Source: raw capture for `aa_008edf80`.
...

{
  ...
  undefined1 auStack_444 [8];
  undefined1 auStack_43c [3];
  char cStack_439;
  char *local_438;
  char local_434 [259];
  undefined1 auStack_331 [3];
  undefined4 uStack_32e;
  char cStack_229;
  char acStack_228 [2];
  undefined4 auStack_226 [65];
  char cStack_121;
  char local_120 [2];
  ...
  *(undefined4 *)(pcVar15 + 1) = s__hidden_dds_00a395d0._0_4_;
  *(undefined4 *)(pcVar15 + 5) = s__hidden_dds_00a395d0._4_4_;
  *(undefined4 *)(pcVar15 + 9) = s__hidden_dds_00a395d0._8_4_;
  _strlwr(local_120);
...
LAB_008ee1b7:
  ...
  *(undefined4 *)(pcVar15 + 1) = s__revealed_dds_00a395c0._0_4_;
  *(undefined4 *)(pcVar15 + 5) = s__revealed_dds_00a395c0._4_4_;
  *(undefined4 *)(pcVar15 + 9) = s__revealed_dds_00a395c0._8_4_;
  *(undefined2 *)(pcVar15 + 0xd) = s__revealed_dds_00a395c0._12_2_;
  _strlwr(acStack_228);
  fStack_484 = (float)FUN_007b6a20();
  if ((*(byte *)((int)fStack_484 + 4) & 1) == 0) {
LAB_008ee3bc:
      ...
      *(char **)(param_1 + 0x680) = pcVar8;
      ...
      if (*(char **)(DAT_00d1b644 + 0xfc) != param_2) {
        ...
        if (piStack_494 == *(int **)(param_1 + 0x560)) {
          ...
          local_490 = param_2;
          puVar13 = (undefined4 *)FUN_0040e180();
          piVar10 = (int *)*puVar13;
            ...
            if (0 < iStack_458) {
              ...
              do {
                ...
                if ((uStack_454 == '\0') || (bVar21 != false)) {
                  if (cVar3 == '\0') {
                    FUN_0040ead0(*(undefined4 *)(*piStack_480 + 0x24));
                    goto LAB_008ee804;
                  }
                  puVar13 = (undefined4 *)
                            FUN_0099b230(auStack_444,*(undefined4 *)(*piStack_480 + 0x24),
                                         &iStack_47c,iStack_460,*(undefined4 *)(*piStack_480 + 0x40)
                                        );
                }
                else if (cStack_485 == '\0') {
                  FUN_0040ead0(*(undefined4 *)(*local_48c + 0x24));
LAB_008ee804:
                  puVar13 = (undefined4 *)FUN_0099b010();
                  pfVar19 = pfStack_46c;
                  iVar14 = iStack_468;
                }
                else {
                  puVar13 = (undefined4 *)
                            FUN_0099b230(auStack_43c,*(undefined4 *)(*local_48c + 0x24),&iStack_47c,
                                         iStack_464,*(undefined4 *)(*local_48c + 0x40));
                }
                uStack_474 = *puVar13;
                iVar1 = iStack_47c * 4;
      ...
      if (uVar11 == 1) {
        ...
        if (uVar11 == 2) {
          (**(code **)(**(int **)(iVar14 + 0x10) + 0x50))
                    (*(int **)(iVar14 + 0x10),*(undefined4 *)(iVar14 + 0x3c),0);
          *(undefined4 *)(iVar14 + 0x38) = 0xffffffff;
          *(undefined4 *)(iVar14 + 0x3c) = 0xffffffff;
          *(undefined4 *)(iVar14 + 0x40) = 0;
          *(undefined4 *)(iVar14 + 0x44) = 0;
          goto LAB_008ee935;
        }
        if (uVar11 == 4) {
          (**(code **)(**(int **)(iVar14 + 0x10) + 0x50))(*(int **)(iVar14 + 0x10),0);
...
LAB_008ee935:
  ...
  *(undefined2 *)puVar13 = 0;
  ...
  puVar13 = (undefined4 *)auStack_331;
  do {
    puVar20 = puVar13;
    puVar13 = (undefined4 *)((int)puVar20 + 1);
  } while (*(char *)((int)puVar20 + 1) != '\0');
  *(undefined4 *)((int)puVar20 + 1) = DAT_00a2c53c;
  *(undefined1 *)((int)puVar20 + 5) = DAT_00a2c540;
...
LAB_008eebaf:
  ...
  uStack_c = 0xffffffff;
  *(undefined4 **)(param_1 + 0x680) = puVar13;
