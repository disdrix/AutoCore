# Annotated low-level: FUN_007a2fd0
...
- Source: raw capture for `aa_007a2fd0`.
...
```c
void __fastcall FUN_007a2fd0(int param_1)

{
  ...
  *(int *)(unaff_ESI + 0x170) = iVar4;
  ...
  local_4 = 0xffffffff;
  *(undefined4 *)(unaff_ESI + 0x174) = uVar5;
  ...
  *puVar1 = *puVar1 | 1;
  ...
  local_4._0_1_ = 3;
  iVar4 = FUN_00414c20(*(undefined4 *)(unaff_ESI + 0x164),uVar5,3,0);
  local_4 = CONCAT31(local_4._1_3_,2);
  FUN_00414b60();
  if (-1 < iVar4) {
    *(undefined4 *)(*(int *)(unaff_ESI + 0x174) + 0xa8) = 0;
    *(undefined4 *)(*(int *)(unaff_ESI + 0x174) + 0xac) = 4;
    puVar1 = (uint *)(*(int *)(unaff_ESI + 0x174) + 0xbc);
    *puVar1 = *puVar1 & 0xfffffffe;
    FUN_007647c0(*(undefined4 *)(unaff_ESI + 0x174));
    ...
    *(int *)(unaff_ESI + 0x184) = iVar4;
    ...
    local_4._0_1_ = 2;
    *(undefined4 *)(unaff_ESI + 0x188) = uVar5;
    ...
    *puVar1 = *puVar1 | 1;
    uVar5 = FUN_00414bc0(0x10142);
    local_4._0_1_ = 6;
    iVar4 = FUN_00414c20(*(undefined4 *)(unaff_ESI + 0x178),uVar5,3,0);
    local_4 = CONCAT31(local_4._1_3_,2);
    FUN_00414b60();
    if (-1 < iVar4) {
      *(undefined4 *)(*(int *)(unaff_ESI + 0x188) + 0xa8) = 0;
      *(undefined4 *)(*(int *)(unaff_ESI + 0x188) + 0xac) = 4;
      puVar1 = (uint *)(*(int *)(unaff_ESI + 0x188) + 0xbc);
      *puVar1 = *puVar1 & 0xfffffffe;
      FUN_007647c0(*(undefined4 *)(unaff_ESI + 0x188));
      ...
      *(void **)(unaff_ESI + 0x194) = pvVar3;
      ...
      local_4._0_1_ = 2;
      *(undefined4 *)(unaff_ESI + 0x198) = uVar5;
      FUN_007638d0(1);
      puVar6 = &local_3c;
      puVar8 = &local_48;
      local_3c = DAT_00a1401c;
      ...
      local_4._0_1_ = 2;
      *(undefined4 *)(unaff_ESI + 0x19c) = uVar5;
      ...
      *puVar1 = *puVar1 | 1;
      uVar5 = FUN_00414bc0(0x10142);
      local_4._0_1_ = 9;
      iVar4 = FUN_00414c20(*(undefined4 *)(unaff_ESI + 0x18c),uVar5,3,0);
      local_4 = CONCAT31(local_4._1_3_,2);
      FUN_00414b60();
      if (-1 < iVar4) {
        *(undefined4 *)(*(int *)(unaff_ESI + 0x19c) + 0xa8) = 0;
        *(undefined4 *)(*(int *)(unaff_ESI + 0x19c) + 0xac) = 4;
        puVar1 = (uint *)(*(int *)(unaff_ESI + 0x19c) + 0xbc);
        *puVar1 = *puVar1 & 0xfffffffe;
        FUN_007647c0(*(undefined4 *)(unaff_ESI + 0x19c));
        ...
        *(void **)(unaff_ESI + 0x1bc) = pvVar3;
        ...
        local_4._0_1_ = 2;
        *(undefined4 *)(unaff_ESI + 0x1c0) = uVar5;
        FUN_007638d0(1);
        puVar6 = &local_3c;
        puVar8 = &local_48;
        local_3c = DAT_00a1401c;
        ...
        local_4._0_1_ = 2;
        *(undefined4 *)(unaff_ESI + 0x1c4) = uVar5;
        ...
        *puVar1 = *puVar1 | 1;
        uVar5 = FUN_00414bc0(0x10142);
        local_4._0_1_ = 0xc;
        iVar4 = FUN_00414c20(*(undefined4 *)(unaff_ESI + 0x1b4),uVar5,3,0);
        local_4 = CONCAT31(local_4._1_3_,2);
        FUN_00414b60();
        if (-1 < iVar4) {
          *(undefined4 *)(*(int *)(unaff_ESI + 0x1c4) + 0xa8) = 0;
          *(undefined4 *)(*(int *)(unaff_ESI + 0x1c4) + 0xac) = 4;
          puVar1 = (uint *)(*(int *)(unaff_ESI + 0x1c4) + 0xbc);
          *puVar1 = *puVar1 & 0xfffffffe;
          FUN_007647c0(*(undefined4 *)(unaff_ESI + 0x1c4));
          ...
          *(void **)(unaff_ESI + 0x1a8) = pvVar3;
          ...
          local_4._0_1_ = 2;
          *(undefined4 *)(unaff_ESI + 0x1ac) = uVar5;
          FUN_007638d0(1);
          puVar6 = &local_3c;
          puVar8 = &local_48;
          local_3c = DAT_00a1401c;
          ...
          local_4._0_1_ = 2;
          *(undefined4 *)(unaff_ESI + 0x1b0) = uVar5;
          ...
          *puVar1 = *puVar1 | 1;
          uVar5 = FUN_00414bc0(0x10142);
          local_4._0_1_ = 0xf;
          iVar4 = FUN_00414c20(*(undefined4 *)(unaff_ESI + 0x1a0),uVar5,3,0);
          local_4 = CONCAT31(local_4._1_3_,2);
          FUN_00414b60();
          if (-1 < iVar4) {
            *(undefined4 *)(*(int *)(unaff_ESI + 0x1b0) + 0xa8) = 0;
            *(undefined4 *)(*(int *)(unaff_ESI + 0x1b0) + 0xac) = 4;
            puVar1 = (uint *)(*(int *)(unaff_ESI + 0x1b0) + 0xbc);
            *puVar1 = *puVar1 & 0xfffffffe;
            FUN_007647c0(*(undefined4 *)(unaff_ESI + 0x1b0));
            ...
            *(void **)(unaff_ESI + 0x1ec) = pvVar3;
            ...
            local_4._0_1_ = 2;
            *(undefined4 *)(unaff_ESI + 0x1f0) = uVar5;
            FUN_007638d0(1);
            puVar6 = &local_3c;
            puVar8 = &local_48;
            local_3c = DAT_00a1401c;
            ...
            local_4._0_1_ = 2;
            *(undefined4 *)(unaff_ESI + 500) = uVar5;
            ...
            *puVar1 = *puVar1 | 1;
            uVar5 = FUN_00414bc0(0x10142);
            local_4._0_1_ = 0x12;
            iVar4 = FUN_00414c20(*(undefined4 *)(unaff_ESI + 0x1e4),uVar5,3,0);
            local_4 = CONCAT31(local_4._1_3_,2);
            FUN_00414b60();
            if (-1 < iVar4) {
              *(undefined4 *)(*(int *)(unaff_ESI + 500) + 0xa8) = 0;
              *(undefined4 *)(*(int *)(unaff_ESI + 500) + 0xac) = 4;
              puVar1 = (uint *)(*(int *)(unaff_ESI + 500) + 0xbc);
              *puVar1 = *puVar1 & 0xfffffffe;
              FUN_007647c0(*(undefined4 *)(unaff_ESI + 500));
              ...
              *(void **)(unaff_ESI + 0x1d0) = pvVar3;
              ...
              local_4._0_1_ = 2;
              *(undefined4 *)(unaff_ESI + 0x1d4) = uVar5;
              FUN_007638d0(1);
              puVar6 = &local_3c;
              puVar8 = &local_48;
              local_3c = DAT_00a1401c;
              ...
              local_4._0_1_ = 2;
              *(undefined4 *)(unaff_ESI + 0x1d8) = uVar5;
              ...
              *(undefined4 **)(unaff_ESI + 0x1e0) = puVar6;
              ...
              FUN_004148e0(*(undefined4 *)(unaff_ESI + 0x1e0));
              puVar1 = (uint *)(*(int *)(unaff_ESI + 0x1d8) + 0xbc);
              *puVar1 = *puVar1 | 1;
              uVar5 = FUN_00414bc0(0x10142);
              local_4._0_1_ = 0x15;
              iVar7 = FUN_00414c20(*(undefined4 *)(unaff_ESI + 0x1c8),uVar5,3,0);
              local_4 = CONCAT31(local_4._1_3_,2);
              FUN_00414b60();
              if (-1 < iVar7) {
                *(undefined4 *)(*(int *)(unaff_ESI + 0x1d8) + 0xa8) = 0;
                *(undefined4 *)(*(int *)(unaff_ESI + 0x1d8) + 0xac) = 4;
                puVar1 = (uint *)(*(int *)(unaff_ESI + 0x1d8) + 0xbc);
                *puVar1 = *puVar1 & 0xfffffffe;
                FUN_007647c0(*(undefined4 *)(unaff_ESI + 0x1d8));
              }
            }
          }
        }
