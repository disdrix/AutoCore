# Annotated low-level: FUN_00975870
...
- Source: raw capture for `aa_00975870`.
    ...
    while( true ) {
      ...
      if (param_1[0x7c] + 0x7e < piVar2[1]) {
        ...
        if (*(char *)(DAT_00d20bac + 4) != '\0') {
          ...
          uVar9 = FUN_007845c0();
          FUN_00783aa0("EventConnection %s: Full %d %d",uVar9,*(undefined4 *)(param_1[0x74] + 4),
                       param_1[0x7c]);
          DAT_00d179a0 = 0;
        }
        break;
