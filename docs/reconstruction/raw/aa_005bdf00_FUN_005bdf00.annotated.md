# Annotated low-level: FUN_005bdf00
...
- Source: raw capture for `aa_005bdf00`.
...
```c
undefined4 * __thiscall FUN_005bdf00(undefined4 *param_1,undefined4 *param_2)

{
  ...
  *(undefined1 *)((int)param_1 + 0x7f9) = *(undefined1 *)((int)param_2 + 0x7f9);
  *(undefined1 *)((int)param_1 + 0x7fa) = *(undefined1 *)((int)param_2 + 0x7fa);
  *(undefined1 *)((int)param_1 + 0x7fb) = *(undefined1 *)((int)param_2 + 0x7fb);
  *(undefined1 *)(param_1 + 0x1ff) = *(undefined1 *)(param_2 + 0x1ff);
  *(undefined1 *)((int)param_1 + 0x7fd) = *(undefined1 *)((int)param_2 + 0x7fd);
  *(undefined1 *)((int)param_1 + 0x7fe) = *(undefined1 *)((int)param_2 + 0x7fe);
  *(undefined1 *)((int)param_1 + 0x7ff) = *(undefined1 *)((int)param_2 + 0x7ff);
  ...
  if (param_1 + 0x288 != param_2 + 0x288) {
    FUN_005bdea0(*(undefined4 *)param_2[0x289],(undefined4 *)param_2[0x289],param_2);
  }
  return param_1;
}
```
