# Annotated low-level: FUN_00567950
...
- Source: raw capture for `aa_00567950`.
...
```c
void __thiscall FUN_00567950(int param_1,int param_2,uint param_3,undefined4 *param_4)
