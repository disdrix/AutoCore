# Annotated low-level: FUN_005b1fd0
...
- Source: raw capture for `aa_005b1fd0`.
...
undefined8 __thiscall FUN_005b1fd0(int param_1,undefined4 param_2,uint param_3)

{
  ...
  if (DAT_00d1798c != '\0') {
    if (DAT_00b051e0 != '\0') {
      FUN_007a4480(0xffffffff,"Packing initial update for object %I64d",
                   *(undefined4 *)(iVar4 + 0x160),*(undefined4 *)(iVar4 + 0x164));
    }
    iVar4 = *(int *)(param_1 + 0x50);
    local_2c = *(float *)(iVar4 + 0x164);
    fVar1 = *(float *)(iVar4 + 0x160);
    local_38 = (float)CONCAT31(local_38._1_3_,*(undefined1 *)(iVar4 + 0x168));
    ...
    if (cVar3 == '\0') {
      ...
      FUN_007a4480(0,"Global coid pack for %I64d, %d. Hopefully GM only",fVar1,local_2c,
                   *(undefined4 *)(*(int *)(*(int *)(param_1 + 0x50) + 0xa8) + 0x34));
    }
  }
  ...
  if (cVar3 != '\0') {
    ...
    if (cVar3 != '\0') {
      ...
      cVar3 = BitStream_writeFlag(local_38);
      if (cVar3 != '\0') {
        BitStream_writeInt(*(undefined4 *)(*(int *)(param_1 + 0x50) + 0xcc),3);
        iVar4 = *(int *)(param_1 + 0x50);
        fStack_18 = *(float *)(iVar4 + 0x48);
        fStack_14 = *(float *)(iVar4 + 0x4c);
        FUN_0042be20(*(undefined4 *)(iVar4 + 0x40),*(undefined4 *)(iVar4 + 0x44));
        iVar4 = *(int *)(param_1 + 0x50);
        uStack_20 = *(undefined4 *)(iVar4 + 0x40);
        fStack_1c = *(float *)(iVar4 + 0x44);
        fStack_14 = *(float *)(iVar4 + 0x4c);
        BitStream_writeFlag(*(undefined4 *)(iVar4 + 0x48));
      }
    }
  }
