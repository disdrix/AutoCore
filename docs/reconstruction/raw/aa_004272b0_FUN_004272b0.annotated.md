# Annotated low-level: FUN_004272b0
...
- Source: raw capture for `aa_004272b0`.
...
```c
void __fastcall FUN_004272b0(undefined4 param_1,uint param_2,int param_3,int param_4)
