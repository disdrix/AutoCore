# Annotated low-level: FUN_007e7df0
...
- Source: raw capture for `aa_007e7df0`.
...
```c
int __thiscall
FUN_007e7df0(char *param_1,undefined4 param_2,undefined4 param_3,int param_4,undefined4 *param_5)

{
  ...
  if (DAT_00d1793c == '\0') {
    ...
    if (-1 < iVar2) {
      param_2 = *puVar1;
      param_5 = (undefined4 *)CONCAT31(param_5._1_3_,*(undefined1 *)(param_4 + 8));
      param_3 = CONCAT31(param_3._1_3_,*(undefined1 *)(param_4 + 9));
      local_24 = 0;
      local_20 = 0;
      local_1c = 0;
      local_18 = 0;
