# Annotated low-level: DB_ReadPowerPlantSpecific
...
- Source: raw capture for `aa_007f4c50`.
...

{
  ...
  local_70 = *(undefined4 *)pDbContext;
  if (*(char *)this == '\0') {
    return -0x7fffbffc;
  }
  ...
  if (-1 < iVar1) {
    if (DAT_00d1793c == '\0') {
      ...
      if ((((iVar1 < 0) || (iVar1 = FUN_004231d0(&uStack_40), iVar1 < 0)) ||
        ...
        iVar1 = FUN_0041a9b0();
        if (iVar1 == 0) {
          *(undefined4 *)pDbContext = local_70;
          *(undefined4 *)(pDbContext + 4) = uStack_6c;
          *(undefined2 *)(pDbContext + 8) = puStack_4._0_2_;
          *(undefined2 *)(pDbContext + 10) = unaff_retaddr;
          FUN_0041a990();
          FUN_00423170();
          local_c = (void *)0xffffffff;
          FUN_0041a3e0();
