# Annotated low-level: FUN_0068f520
...
- Source: raw capture for `aa_0068f520`.
    ...
    if (param_2 != 0) {
      ...
      do {
        ...
        *(void **)(iVar10 + 0x10) = pvVar3;
        ...
        if (*(short *)(iVar10 + 0xc) != 0) {
          do {
            *(undefined1 *)(uVar9 + *(int *)(iVar10 + 0x10)) =
                 *(undefined1 *)(*(int *)(*piVar11 + uVar9 * 4) + 0x40);
            uVar9 = uVar9 + 1;
          } while (uVar9 < *(ushort *)(iVar10 + 0xc));
        }
        pvVar3 = operator_new__((uint)*(ushort *)(iVar10 + 0xc));
        ...
        *(void **)(iVar10 + 0x24) = pvVar3;
        if (*(short *)(iVar10 + 0xc) != 0) {
          do {
            *(undefined4 *)(uVar9 * 4 + *(int *)(iVar10 + 0x24)) =
                 *(undefined4 *)(*(int *)(*piVar11 + uVar9 * 4) + 0x14);
            uVar9 = uVar9 + 1;
          } while (uVar9 < *(ushort *)(iVar10 + 0xc));
        }
        if (*param_1 == '\0') {
            ...
            if (*(short *)(iVar10 + 0xc) != 0) {
              ...
              do {
                ...
                *(float *)(iVar6 + iVar4) = -*(float *)(iVar7 + 0x28);
                iVar6 = iVar6 + iVar4;
                *(undefined4 *)(iVar6 + 4) = *(undefined4 *)(iVar7 + 0x30);
                *(undefined4 *)(iVar6 + 8) = *(undefined4 *)(iVar7 + 0x2c);
                iVar7 = *(int *)(*piVar11 + uVar9 * 4);
