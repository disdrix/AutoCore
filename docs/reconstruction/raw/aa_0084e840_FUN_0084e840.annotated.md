# Annotated low-level: FUN_0084e840
...
- Source: raw capture for `aa_0084e840`.
...
LAB_0084e93e:
  *(bool *)(param_1 + 0x143) = local_2bc == 0;
  ...
  acStack_2f0[2] = '\0';
  acStack_2f0[3] = '\0';
  auStack_2f4 = (undefined1  [4])&stack0xfffffd24;
  uStack_2f8 = 0x84e990;
  puVar7 = (undefined4 *)(**(code **)(*(int *)param_1[0x146] + 0x140))();
  uStack_2b4 = *puVar7;
  uStack_2b0 = puVar7[1];
  *(undefined4 *)(param_1[0x146] + 0x214) = 1;
  uStack_300 = *(undefined4 *)(iVar4 + 4);
  uStack_2f8 = 1;
  iStack_2fc = 1;
  uStack_304 = 0x84e9c3;
  ...
  uStack_2d0 = *(undefined4 *)(iVar6 + 4);
  uStack_310 = 1;
  piStack_314 = &iStack_2fc;
  puStack_318 = (undefined1 *)0x84ea09;
  ...
  *(undefined2 *)puVar7 = 0;
  ...
  if (*(int *)(iVar4 + 0x14) == -1) {
    ...
    puVar7 = CVOGReaction_ResolveSkillTargets
                       (*(void **)(iVar4 + 0x14),*(undefined4 *)(iVar4 + 0x18));
    if (puVar7 != (undefined4 *)0x0) {
      auStack_2f4 = *(undefined1 (*) [4])param_1[0x147];
  ...
  puVar7 = (undefined4 *)(**(code **)(*(int *)param_1[0x147] + 0x120))();
  uStack_2f8 = *puVar7;
  auStack_2f4 = (undefined1  [4])puVar7[1];
  puStack_334 = (undefined *)0x1;
  puStack_338 = &uStack_320;
  puStack_33c = (undefined4 *)0x84eb8f;
  ...
  *(undefined4 *)(param_1[0x148] + 0x214) = 3;
  ...
  puVar13 = (undefined2 *)(auStack_2f4 + 3);
  do {
  ...
  *puVar13 = DAT_00a15104;
  ...
  uStack_358 = 0x84ecb0;
  puVar7 = (undefined4 *)(**(code **)(*(int *)param_1[0x145] + 0x140))();
    ...
    if ((iStack_350 == 0) || (DAT_00d1b6d8 == 0)) {
      ...
      if (uStack_364 != 0) {
            ...
            if ((pvStack_35c != (void *)0x0) && (uVar14 = 0, uVar9 != 0)) {
              do {
                ...
                if (piVar5 != (int *)0x0) {
                  ...
                  ppuStack_354 = (undefined4 **)(float)(fVar15 + (float10)(float)ppuStack_354);
                }
                uVar14 = uVar14 + 1;
              } while (uVar14 < uVar9);
            }
        ...
        if (pcStack_34c != (char *)0x0) {
          ppuStack_354 = (undefined4 **)((float)ppuStack_354 / (float)(int)pcStack_34c);
        }
      }
      uStack_380 = 0x84ee22;
      ...
      puStack_3a8 = (undefined4 *)0x84eead;
      puVar7 = (undefined4 *)(**(code **)(*(int *)param_1[0x149] + 0x120))();
      uStack_394 = *puVar7;
      puStack_3a8 = &uStack_394;
      puStack_3ac = (undefined1 *)0x84eeca;
      ...
      if ((int *)param_1[0x14b] != (int *)0x0) {
        ...
        iVar4 = *(int *)(iVar4 + 4);
        puVar7 = (undefined4 *)(**(code **)(*(int *)param_1[0x14b] + 0x120))(&uStack_370,1,0);
        puStack_3ac = (undefined1 *)*puVar7;
        puStack_3a8 = (undefined4 *)(iVar6 + iVar4);
      ...
      if ((int *)param_1[0x14a] != (int *)0x0) {
        ...
        iVar6 = (int)(float)puStack_3a8;
        iVar4 = *(int *)(iVar4 + 4);
        puVar7 = (undefined4 *)(**(code **)(*(int *)param_1[0x14a] + 0x120))(&uStack_370,1,0);
        puStack_3ac = (undefined1 *)*puVar7;
        puStack_3a8 = (undefined4 *)(iVar6 + iVar4);
      ...
      if ((int *)param_1[0x14c] != (int *)0x0) {
        ...
        iVar6 = (int)(float)puStack_3a8;
        iVar4 = *(int *)(iVar4 + 4);
        puVar7 = (undefined4 *)(**(code **)(*(int *)param_1[0x14c] + 0x120))(&uStack_370,1,0);
        puStack_3ac = (undefined1 *)*puVar7;
        puStack_3a8 = (undefined4 *)(iVar6 + iVar4);
        (**(code **)(*(int *)param_1[0x14c] + 0x110))(&puStack_3ac);
        (**(code **)(*(int *)param_1[0x14c] + 4))(1);
      }
      puStack_3ac = (undefined1 *)0x1;
