# Annotated low-level: FUN_00596770
...
- Source: raw capture for `aa_00596770`.
...
```c
void __thiscall FUN_00596770(int param_1,void *param_2,uint param_3,undefined4 *param_4)
