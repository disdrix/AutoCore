# Annotated low-level: FUN_00472d10
...
- Source: raw capture for `aa_00472d10`.
...
```c
void __fastcall
FUN_00472d10(undefined4 param_1,byte *param_2,int *param_3,int param_4,int param_5,int param_6,
...

{
  ...
  if ((param_5 != 0) &&
    ...
    switch(bVar5) {
    case 0:
      switch(*(undefined1 *)((int)param_3 + 9)) {
      case 1:
        iVar10 = 7;
        ...
        if (((param_10 == 0) || (param_11 == 0)) || (param_12 == 0)) {
          if (iVar3 != 0) {
            ...
            do {
              ...
              if (uVar8 == 0xffff) {
                *(undefined4 *)(pbVar12 + -2) = *(undefined4 *)(param_2 + -7);
                *(undefined2 *)(pbVar12 + 2) = *(undefined2 *)(param_2 + -3);
              }
              else {
                if (uVar8 == 0) {
