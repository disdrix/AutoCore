# Annotated low-level: CVOGVariable_EvaluateComputed

| Field | Value |
|---|---|
| Stable ID | a_005afd40 |
| VA | 0x005afd40 |
...
Map logic variable eval by Type at var+0x40, Value at var+0x4c. Mission/active/objective hash lookups.
...
- Source: raw capture for a_005afd40.
...
switchD_005afe1f_caseD_5:
  ...
  switch(*(undefined1 *)((int)fVar8 + 0x40)) {
  case 1:
