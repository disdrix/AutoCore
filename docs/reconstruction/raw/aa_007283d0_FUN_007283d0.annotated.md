# Annotated low-level: FUN_007283d0
...
- Source: raw capture for `aa_007283d0`.
...
```c
undefined4 FUN_007283d0(int param_1)

{
  ...
  if (*(int *)(unaff_EDI + 0x18) != 0) {
    (**(code **)(**(int **)(unaff_EDI + 0x18) + 0x14))(*(undefined4 *)(param_1 + 0x10));
  }
  ExceptionList = local_c;
  return 0;
}
