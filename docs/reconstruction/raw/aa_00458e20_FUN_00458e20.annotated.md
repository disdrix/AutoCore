# Annotated low-level: FUN_00458e20
...
- Source: raw capture for `aa_00458e20`.
...
```c
undefined4 __thiscall FUN_00458e20(int param_1,undefined4 *param_2)

{
  ...
  FUN_00439810();
  if (iVar9 != 0) {
    FUN_0045da80(*(undefined4 *)(param_1 + 0x20),iVar9);
  }
  local_4 = 0xffffffff;
