# Annotated low-level: FUN_00978d20
...
- Source: raw capture for `aa_00978d20`.
...
undefined4 * __thiscall ClientSpecialEvent_TeleportIn_ctor(int param_1,undefined4 *param_2)
  ...
  if (piVar2 == (int *)0x0) {
    ...
    *(undefined1 *)(param_2 + 0x12) = 1;
    ...
    if (param_2[0xe] == DAT_00d1b6d8) {
      param_2[8] = *(undefined4 *)(DAT_00d1b778 + 0x60c);
