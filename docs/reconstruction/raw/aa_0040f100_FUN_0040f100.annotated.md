# Annotated low-level: FUN_0040f100
...
- Source: raw capture for `aa_0040f100`.
...
```c
void __thiscall
FUN_0040f100(int param_1,undefined4 *param_2,char param_3,undefined4 *param_4,undefined4 param_5)

{
  ...
  ExceptionList = &local_c;
  piVar3 = (int *)FUN_0040f360(*(undefined4 *)(param_1 + 4),param_4,*(undefined4 *)(param_1 + 4),
                               param_5,0);
