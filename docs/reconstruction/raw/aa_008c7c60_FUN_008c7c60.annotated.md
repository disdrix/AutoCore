# Annotated low-level: FUN_008c7c60
...
- Source: raw capture for `aa_008c7c60`.
      ...
      do {
        ...
        if (pvVar3 != (void *)0x0) {
          ...
          if ((iVar1 == 0) ||
            ...
            FUN_004073a0(*(undefined4 *)(iVar4 + 0x558),1,&stack0xfffffd7c);
          }
          else {
            puVar2 = *(undefined4 **)(iVar4 + 0x558);
            *puVar2 = pvVar3;
            *(undefined4 **)(iVar4 + 0x558) = puVar2 + 1;
          }
        }
        piVar5 = (int *)*piVar5;
