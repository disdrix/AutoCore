# Annotated low-level: FUN_008c40a0
...
- Source: raw capture for `aa_008c40a0`.
...
```c
undefined4 FUN_008c40a0(int param_1,int param_2)
    ...
    if (param_2 == 40000) {
      ...
      if ((param_2 == 0x9c41) && (ppvVar1 = &local_c, DAT_00d1b6d8 != 0)) {
        ...
        if (((DAT_00d1b778 != (int *)0x0) && (DAT_00d1b780 != (int *)0x0)) &&
          ...
          (**(code **)(*DAT_00d1b9a4 + 0x450))(*(undefined4 *)(*(int *)DAT_00d1b9a4[0x153] + 8));
