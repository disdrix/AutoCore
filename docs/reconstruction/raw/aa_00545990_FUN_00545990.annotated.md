# Annotated low-level: FUN_00545990
...
- Source: raw capture for `aa_00545990`.
...
```c
undefined4 __thiscall FUN_00545990(void *param_1,uint param_2,int param_3,char param_4)
