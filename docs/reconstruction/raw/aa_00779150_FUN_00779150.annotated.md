# Annotated low-level: FUN_00779150
...
- Source: raw capture for `aa_00779150`.
...
```c
undefined4 FUN_00779150(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  do {
    if (iVar1 == (&DAT_00a240d0)[iVar2 * 2]) {
      uVar4 = *(undefined4 *)(&UNK_00a240d4 + iVar2 * 8);
      goto LAB_007795c3;
    }
    iVar2 = iVar2 + 1;
  } while (iVar2 < 3);
