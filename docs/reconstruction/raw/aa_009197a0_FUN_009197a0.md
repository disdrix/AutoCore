...
## Residual section — 2026-07-29 dual A/B (append only)

**Do not replace the raw body above.** Fresh Ghidra `decompile_function 0x009197a0` body **≡** 2026-07-23 capture.

| Fact | Evidence |
|---|---|
| Epilogue `RET 4` | `read_memory` near end of body: `C2 04 00` |
| Callers push `0x41700000` (15.0f) | asm @ `00927b2a`, `00810029`, `00921338` before CALL |
| Parents | PollBoundActions, RecvCompleteDynamicObjective, FUN_009210e0 |
| Callees | EvalAutoPatrolWaypoint `00929ec0`, FUN_004e88e0, Object_ResolveFromTFID, FUN_007a4480 |
| FUN_004e88e0 | 3-float copy only (fresh decompile) |
| Proposed name | `Client_FindFirstObjectInRadius` (INFERRED; first-in-radius, not min-distance) |

Reviews: `A|B_aa_009197a0_Client_FindFirstObjectInRadius.md`.
