# Annotated low-level: FUN_005eced0
...
- Source: raw capture for `aa_005eced0`.
          ...
          if ((uVar7 < 0x20) && (uVar16 < 0x20)) {
            if (*(uint *)(param_1 + 0x58) <= *(uint *)(param_1 + 0x54)) {
              ...
              if (uVar16 < uVar7) {
                ...
                puVar13 = *(undefined4 **)(param_1 + 0x54);
                puVar14 = puVar3;
                for (puVar4 = *(undefined4 **)(param_1 + 0x50); puVar4 != puVar13;
                    puVar4 = puVar4 + 1) {
                  *puVar14 = *puVar4;
                  puVar14 = puVar14 + 1;
                  fVar22 = local_104;
...
LAB_005edd4c:
              ...
              if (puVar13 == (undefined4 *)0x0) {
                ...
                *puVar13 = &PTR_FUN_009cb228;
                ...
                uVar5 = DAT_00aaa668;
                puVar13[0xe] = 8;
                *(undefined2 *)(puVar13 + 0xf) = 0;
                *(undefined2 *)((int)puVar13 + 0x3e) = 0;
                puVar13[0x10] = 0;
                puVar13[0x13] = uVar5;
                puVar13[0x11] = fVar21;
                puVar13[0x12] = uVar5;
    ...
    if (*(uint *)(param_1 + 0x58) <= *(uint *)(param_1 + 0x54)) {
      ...
      if (uVar16 < uVar7) {
        ...
        puVar13 = *(undefined4 **)(param_1 + 0x54);
        puVar14 = puVar3;
        for (puVar4 = *(undefined4 **)(param_1 + 0x50); puVar4 != puVar13; puVar4 = puVar4 + 1) {
          *puVar14 = *puVar4;
          puVar14 = puVar14 + 1;
          fVar21 = local_104;
        }
