# Annotated low-level: FUN_00545590
...
- Source: raw capture for `aa_00545590`.
...
```c
undefined4 __thiscall FUN_00545590(void *param_1,uint param_2,int param_3,char param_4)
