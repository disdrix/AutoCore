# Annotated low-level: FUN_0041e540
...
- Source: raw capture for `aa_0041e540`.
...
```c
void __fastcall
FUN_0041e540(undefined4 param_1,undefined4 *param_2,int param_3,int param_4,uint param_5)
