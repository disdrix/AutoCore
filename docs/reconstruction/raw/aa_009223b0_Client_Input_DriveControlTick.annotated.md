# Annotated low-level: Client_Input_DriveControlTick
...
- Source: raw capture for `aa_009223b0`.
...
## Deep-refine note (2026-07-23)

Clean source now carries SECTION 1–15 markers for accel / reverse / steer / soft-steer / handbrake / push gates.
See `docs/reconstruction/reconstructed-exact/Client_Input_DriveControlTick.cpp` and dual reviews
`reviews/A_aa_009223b0_Client_Input_DriveControlTick.md` / `B_aa_009223b0_...`.
Soft L/R polarity vs hard remains open (UF-006).
