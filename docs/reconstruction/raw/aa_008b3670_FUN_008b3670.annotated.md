# Annotated low-level: FUN_008b3670
...
- Source: raw capture for `aa_008b3670`.
...

{
  ...
  undefined1 *puStack_964;
  undefined1 *puStack_960;
  float fStack_95c;
  undefined4 uStack_958;
  undefined1 *puStack_954;
  ...
  undefined1 auStack_7f4 [16];
  undefined1 auStack_7e4 [48];
  undefined1 auStack_7b4 [44];
  undefined1 auStack_788 [56];
  undefined1 *puStack_750;
  undefined1 auStack_74c [128];
  undefined1 *puStack_6cc;
  undefined1 auStack_6c8 [128];
  char acStack_648 [108];
  char acStack_5dc [148];
  char acStack_548 [299];
  undefined1 uStack_41d;
  ...
  do {
    ...
    puVar4 = (undefined4 *)(**(code **)(**(int **)(unaff_EBX + 0x6b8 + uVar8 * 4) + 0x120))();
    uStack_878 = *puVar4;
    ...
    puStack_900 = (undefined4 *)0x8b37b1;
    puVar4 = (undefined4 *)(**(code **)(**(int **)(unaff_EBX + 0x56c + uVar8 * 4) + 0x120))();
    uStack_85c = *puVar4;
    iStack_858 = (int)fStack_8a8;
    puStack_900 = &uStack_85c;
    puStack_904 = (undefined1 *)0x8b37de;
    ...
    puStack_914 = (undefined4 *)0x8b3835;
    puVar4 = (undefined4 *)(**(code **)(**(int **)(unaff_EBX + 0x58c + uVar8 * 4) + 0x120))();
    uStack_890 = *puVar4;
    fStack_88c = (float)(int)fVar12;
    puStack_914 = &uStack_890;
    puStack_918 = (undefined1 *)0x8b3862;
    ...
    puStack_928 = (undefined4 *)0x8b38b9;
    puVar4 = (undefined4 *)(**(code **)(**(int **)(unaff_EBX + 0x6d8 + uVar8 * 4) + 0x120))();
    uStack_86c = *puVar4;
    iStack_868 = (int)(float)puVar9;
    puStack_928 = &uStack_86c;
    puStack_92c = (undefined1 *)0x8b38e6;
    ...
    puStack_940 = (undefined1 *)0x8b396a;
    ...
    pfVar5 = (float *)(**(code **)(**(int **)(unaff_EBX + 0x68c + uVar8 * 4) + 0x120))
                                (&uStack_878,1,0);
    fStack_96c = *pfVar5;
    puStack_968 = (undefined1 *)(int)(float)puVar9;
    ...
    if ((((((uVar7 & uStack_824) == 0xffffffff) || ((int)uVar8 < *(int *)(unaff_EBX + 0x6ac))) ||
      ...
      uStack_90c = 0;
      puStack_910 = (undefined1 *)0x8b43fd;
      (**(code **)(**(int **)(unaff_EBX + 0x5ac + uVar8 * 4) + 4))();
      puStack_910 = (undefined1 *)0x0;
      puStack_914 = (undefined4 *)0x8b440b;
      (**(code **)(**(int **)(unaff_EBX + 0x5cc + uVar8 * 4) + 4))();
      puStack_914 = (undefined4 *)0x0;
      puStack_918 = (undefined1 *)0x8b4419;
      ...
      uStack_920 = 0;
      puStack_924 = (undefined1 *)0x8b4445;
      ...
      if ((piVar6 != (int *)0x0) &&
        ...
        puStack_900 = (undefined4 *)0x8b3e8e;
        puStack_900 = (undefined4 *)(**(code **)(*piVar6 + 0x15c))();
        puStack_904 = (undefined1 *)0x8b3ea0;
        (**(code **)(iVar3 + 0x1d8))();
        iVar3 = **(int **)(unaff_EBX + 0x58c + uVar8 * 4);
        puStack_904 = auStack_840;
        uStack_908 = 0x8b3eba;
        puStack_904 = (undefined1 *)FUN_00514050();
        uStack_908 = 1;
        uStack_90c = 0x8b3eca;
        (**(code **)(iVar3 + 0x15c))();
        uStack_90c = 1;
        puStack_910 = (undefined1 *)0x8b3edb;
        (**(code **)(**(int **)(unaff_EBX + 0x58c + uVar8 * 4) + 0xcc))();
        puStack_910 = (undefined1 *)0x1;
        puStack_914 = (undefined4 *)0x8b3eec;
        (**(code **)(**(int **)(unaff_EBX + 0x6d8 + uVar8 * 4) + 0xcc))();
        puStack_914 = (undefined4 *)0x1;
        puStack_918 = (undefined1 *)0x8b3efd;
        (**(code **)(**(int **)(unaff_EBX + 0x6d8 + uVar8 * 4) + 0xd4))();
        puStack_918 = (undefined1 *)0x1;
        uStack_91c = 0x8b3f0e;
        ...
        uStack_920 = 1;
        puStack_924 = (undefined1 *)0x8b3f2d;
        (**(code **)(**(int **)(unaff_EBX + 0x5ac + uVar8 * 4) + 4))();
        puStack_924 = (undefined1 *)0x1;
        puStack_928 = (undefined4 *)0x8b3f3b;
        (**(code **)(**(int **)(unaff_EBX + 0x5cc + uVar8 * 4) + 4))();
        puStack_928 = (undefined4 *)0x1;
        puStack_92c = (undefined1 *)0x8b3f4c;
        (**(code **)(**(int **)(unaff_EBX + 0x62c + uVar8 * 4) + 0xcc))();
        puStack_92c = (undefined1 *)0x1;
        uStack_930 = 0x8b3f5d;
        ...
        uStack_934 = 1;
        puStack_938 = (undefined1 *)0x8b3f7f;
        ...
        FUN_008e4430();
        (**(code **)(iVar3 + 0x15c))();
        puStack_900 = (undefined4 *)0x8b4244;
        (**(code **)(**(int **)(unaff_EBX + 0x62c + uVar8 * 4) + 0x1d8))();
        puStack_900 = (undefined4 *)0x8b4253;
        (**(code **)(**(int **)(unaff_EBX + 0x62c + uVar8 * 4) + 0x34c))();
        puStack_900 = (undefined4 *)0x8b4262;
        (**(code **)(**(int **)(unaff_EBX + 0x66c + uVar8 * 4) + 0x34c))();
        puStack_900 = (undefined4 *)0x8b4271;
        (**(code **)(**(int **)(unaff_EBX + 0x64c + uVar8 * 4) + 0x34c))();
        puStack_900 = (undefined4 *)0x8b4280;
        (**(code **)(**(int **)(unaff_EBX + 0x6b8 + uVar8 * 4) + 0x34c))();
        puStack_900 = (undefined4 *)0x8b428f;
        (**(code **)(**(int **)(unaff_EBX + 0x56c + uVar8 * 4) + 0x34c))();
        puStack_900 = (undefined4 *)0x8b429e;
        (**(code **)(**(int **)(unaff_EBX + 0x58c + uVar8 * 4) + 0x34c))();
        puStack_900 = (undefined4 *)0x8b42ad;
        (**(code **)(**(int **)(unaff_EBX + 0x6d8 + uVar8 * 4) + 0x34c))();
        puStack_900 = (undefined4 *)0x8b42be;
