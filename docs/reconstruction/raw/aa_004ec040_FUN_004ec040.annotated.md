# Annotated low-level: FUN_004ec040
...
- Source: raw capture for `aa_004ec040`.
...
int * __thiscall FUN_004ec040(int param_1,undefined4 param_2,float *param_3,float *param_4)

{
  ...
  if ((*(int *)(param_1 + 0xf0) != 0) && (*(int *)(param_1 + 0x90) != 0)) {
    ...
    FUN_004f3370(1);
    local_14 = 0;
    FUN_004f3120(*(undefined4 *)(param_1 + 0x90));
    local_134 = 0.0;
    local_28 = 1;
    local_f0 = 0;
    local_ec = 0;
    ...
    local_ac = 0;
    local_b0 = 0;
    local_a0 = *(undefined4 *)(param_1 + 0xf0);
    local_100 = local_88;
        ...
        do {
          ...
          (**(code **)(**(int **)(iVar4 + uVar6 * 4) + 8))
                    (CONCAT22((short)((uint)*(int *)(param_1 + 0x90) >> 0x10),
                              *(undefined2 *)(*(int *)(param_1 + 0x90) + 0x3c)));
          uVar6 = uVar6 + 1;
