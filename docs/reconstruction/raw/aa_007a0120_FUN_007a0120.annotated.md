# Annotated low-level: FUN_007a0120
...
- Source: raw capture for `aa_007a0120`.
...
```c
int * __thiscall
FUN_007a0120(int param_1,int param_2,undefined1 param_3,int param_4,uint param_5,float param_6,
            ...
            float param_25,float param_26,int param_27,int param_28,int param_29,undefined1 param_30
            )

{
  ...
  if (piVar3 == (int *)0x0) {
    ...
    *(undefined1 *)((int)piVar3 + 0xe) = 0xff;
    *(undefined1 *)((int)piVar3 + 0xd) = 0xff;
    *(undefined1 *)(piVar3 + 3) = 0xff;
    *(undefined1 *)((int)piVar3 + 0xf) = 0xff;
    *(undefined1 *)((int)piVar3 + 0x12) = 0xff;
    *(undefined1 *)((int)piVar3 + 0x11) = 0xff;
    *(undefined1 *)(piVar3 + 4) = 0xff;
    *(undefined1 *)((int)piVar3 + 0x13) = 0xff;
    *(undefined1 *)((int)piVar3 + 0x16) = 0xff;
    *(undefined1 *)((int)piVar3 + 0x15) = 0xff;
    *(undefined1 *)(piVar3 + 5) = 0xff;
    *(undefined1 *)((int)piVar3 + 0x17) = 0xff;
    piVar3[0x1b] = 0;
  }
  piVar7 = piVar3;
  ...
  *piVar3 = *piVar1;
  *piVar1 = (int)piVar3;
  *(undefined1 *)(piVar3 + 0x29) = param_30;
  *(char *)(piVar3 + 2) = (char)param_2;
  ...
  piVar3[3] = param_13;
  piVar3[0x20] = param_7;
  *(undefined1 *)((int)piVar3 + 9) = param_3;
  piVar3[4] = param_14;
  piVar3[0x24] = param_9;
