# Annotated low-level: FUN_00719ba0
...
- Source: raw capture for `aa_00719ba0`.
...

{
  ...
  *(undefined1 *)((int)local_58 + 0x25) = 1;
  ...
  *local_58 = (undefined *******)local_58;
  ...
  puVar2 = *(undefined4 **)(unaff_retaddr + 8);
  ppppppppuVar20 = (undefined ********)0x0;
  ppppppppuVar17 = ppppppppuStack_60;
  for (puVar3 = (undefined4 *)*puVar2; ppppppppuStack_60 = ppppppppuVar17, puVar3 != puVar2;
...
LAB_0071a2c0:
        ...
        uVar14 = extraout_var;
LAB_0071a319:
        uStack_3c = CONCAT22(uVar14,*(undefined2 *)(ppppuVar18 + 5));
