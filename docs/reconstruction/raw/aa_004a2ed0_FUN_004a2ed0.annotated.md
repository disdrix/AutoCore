# Annotated low-level: FUN_004a2ed0
...
- Source: raw capture for `aa_004a2ed0`.
...
```c
undefined4 FUN_004a2ed0(int param_1,int *param_2)
...
LAB_004a34a6:
    ...
    if ((iVar4 == 0) && (local_24c != 0)) {
      ...
      *(byte *)(param_1 + 0x98a) =
      ...
      FUN_00799300(local_24c,L"duration",(undefined4 *)(param_1 + 0x900));
      fStack_224 = g_flOne;
      ...
      *(undefined2 *)(param_1 + 0x8f8) = 1;
      FUN_007998d0(local_24c,L"numberOfEmitters",(undefined2 *)(param_1 + 0x8f8),10);
      FUN_00799300(local_24c,L"startDelay",(undefined4 *)(param_1 + 0x8fc));
      ...
      *(undefined4 *)(param_1 + 0x904) = DAT_00aaa680;
      *(byte *)(param_1 + 0x98c) =
