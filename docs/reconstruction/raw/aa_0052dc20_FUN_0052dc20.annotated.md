# Annotated low-level: FUN_0052dc20
...
- Source: raw capture for `aa_0052dc20`.
...
```c
undefined4 __thiscall FUN_0052dc20(int param_1,uint param_2,char param_3)
  ...
  *(short *)(param_1 + 0x6cc) = *(short *)(param_1 + 0x6cc) - *(short *)((int)pvVar3 + 2);
  Skill_SetRankAndReevaluate
            (pvVar3,(void *)(CONCAT22((short)((uint)key >> 0x10),
                                      *(undefined2 *)((int)pvVar3 + 0x5f6)) + 1),(short)unaff_EDI);
