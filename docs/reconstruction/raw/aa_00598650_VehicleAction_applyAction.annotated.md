# Annotated low-level: VehicleAction_applyAction

| Field | Value |
|---|---|
| Stable ID | a_00598650 |
| VA | 0x00598650 |
...
Havok vehicle action apply; wheel torque + air stab path.
...
- Source: raw capture for a_00598650.
    ...
    if (0.0 <= fVar10) {
      ...
      *(float *)(param_1 + 0x24) = fVar11;
      if (fVar11 < fVar12) {
        ...
        *(undefined4 *)(*(int *)(*(int *)(param_1 + 0x40) + 0x14) + 0x1c) =
...
LAB_00598999:
  ...
  if (*(char *)(*(int *)(*(int *)(*(int *)(*(int *)(*(int *)(iVar1 + 600) + 4) + 4) + 0xac +
    ...
    if (*(char *)(iVar1 + 0x102) == '\0') {
      *(undefined1 *)(*(int *)(param_1 + 0x3c) + 0x5c) = 1;
      ...
      *(undefined1 *)(*(int *)(param_1 + 0x3c) + 0x5c) = 0;
    }
  }
  else {
