# Annotated low-level: FUN_005dae50
...
- Source: raw capture for `aa_005dae50`.
...
```c
undefined4 __thiscall FUN_005dae50(CVOGHBBase *param_1,undefined4 param_2)

{
  ...
  if ((iVar3 == 0) || (*(int *)(iVar3 + 8) == 0)) {
    ...
    local_12c = 0;
    local_134 = 0;
    puVar2 = *(undefined4 **)(*(int *)(*(int *)(iVar3 + 8) + 8) + 0xcc);
    local_148 = *puVar2;
    local_144 = puVar2[1];
    local_140 = puVar2[2];
    local_13c = puVar2[3];
