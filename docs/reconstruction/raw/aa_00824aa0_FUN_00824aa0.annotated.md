# Annotated low-level: FUN_00824aa0
...
- Source: raw capture for `aa_00824aa0`.
...

{
  ...
  if (0 < *piVar1) {
    ...
    if (0 < *(int *)(iVar2 + 4)) {
      ...
      ppuStack_44 = (undefined1 **)0x824b1f;
      (**(code **)(*param_1 + 0x140))();
      if (param_1[0x142] != 0) {
        piStack_34 = (int *)0x1;
        puStack_38 = local_10;
        ...
        uStack_3c = 1;
        puStack_40 = auStack_18;
        ppuStack_44 = (undefined1 **)0x824b7d;
      ...
      if (param_1[0x143] != 0) {
        ...
        uStack_3c = 1;
        puStack_40 = auStack_18;
        ppuStack_44 = (undefined1 **)0x824c4e;
  ...
  puStack_38 = (undefined1 *)0x824c7c;
  FUN_007b08d0();
  return;
}
```
