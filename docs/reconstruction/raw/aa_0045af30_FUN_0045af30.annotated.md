# Annotated low-level: FUN_0045af30
...
- Source: raw capture for `aa_0045af30`.
...
```c
undefined4 __thiscall FUN_0045af30(int param_1,undefined4 *param_2)

{
  ...
  FUN_00439810();
  if (iVar9 != 0) {
    FUN_0045e6a0(*(undefined4 *)(param_1 + 0x20),iVar9);
  }
  local_4 = 0xffffffff;
