# Annotated low-level: FUN_0069b630
...
- Source: raw capture for `aa_0069b630`.
...
```c
void __thiscall FUN_0069b630(void *param_1,int param_2,uint param_3,undefined4 *param_4)
