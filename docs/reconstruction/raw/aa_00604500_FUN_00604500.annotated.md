# Annotated low-level: FUN_00604500
...
- Source: raw capture for `aa_00604500`.
...
```c
void __thiscall FUN_00604500(int param_1,void *param_2,uint param_3,undefined4 *param_4)
