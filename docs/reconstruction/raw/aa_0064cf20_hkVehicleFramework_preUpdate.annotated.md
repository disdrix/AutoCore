# Annotated low-level: hkVehicleFramework_preUpdate
...
- Source: raw capture for `aa_0064cf20`.
...

{
  ...
  if (0 < *(int *)(local_d0 + 0xc)) {
    ...
    local_d8 = 0.0;
    do {
      puVar6 = (undefined4 *)(*(int *)(param_1[3] + 0x80) + (int)local_d8);
  ...
  if (0 < *(int *)((int)local_d8 + 0xc)) {
    ...
    do {
      ...
      if (iStack_88 == 0) {
        pfVar7[0x2d] = 0.0;
        *(undefined1 *)(pfVar7 + 0x20) = 0;
        *(undefined1 *)(pfVar7 + 0x2a) = 1;
        pfVar7[0x29] = 0.0;
        pfVar7[0x2c] = fVar10;
        pfVar7[8] = pfVar7[4];
        pfVar7[9] = pfVar7[5];
...
LAB_0064d486:
        ...
        *(undefined1 *)(pfVar7 + 0x2a) = *(undefined1 *)((int)fStack_e0 + 0x40);
        *(undefined1 *)(pfVar7 + 0x20) = 1;
        pfVar1 = pfVar7 + 8;
  ...
  if (0 < *(int *)((int)local_d8 + 0xc)) {
    ...
    do {
      ...
      *(float *)(iVar4 + 0x70) = fStack_68;
      iVar2 = param_1[4];
      *(undefined4 *)(iVar4 + 0x40) = *(undefined4 *)(iVar2 + 0x30);
      *(undefined4 *)(iVar4 + 0x44) = *(undefined4 *)(iVar2 + 0x34);
      *(undefined4 *)(iVar4 + 0x48) = *(undefined4 *)(iVar2 + 0x38);
      *(undefined4 *)(iVar4 + 0x4c) = *(undefined4 *)(iVar2 + 0x3c);
      iVar4 = param_1[4];
