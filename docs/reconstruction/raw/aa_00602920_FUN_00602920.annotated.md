# Annotated low-level: FUN_00602920
...
- Source: raw capture for `aa_00602920`.
...
```c
void __thiscall FUN_00602920(int param_1,void *param_2,uint param_3,undefined4 *param_4)
