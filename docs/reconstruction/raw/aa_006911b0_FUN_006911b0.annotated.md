# Annotated low-level: FUN_006911b0
...
- Source: raw capture for `aa_006911b0`.
...
```c
void __thiscall FUN_006911b0(int param_1,int param_2,uint param_3,undefined4 *param_4)
