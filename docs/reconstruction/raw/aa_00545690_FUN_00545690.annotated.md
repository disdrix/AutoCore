# Annotated low-level: FUN_00545690
...
- Source: raw capture for `aa_00545690`.
...
```c
undefined4 __thiscall FUN_00545690(void *param_1,uint param_2,int param_3,char param_4)
