# Annotated low-level: FUN_00945540
...
- Source: raw capture for `aa_00945540`.
...
```c
undefined4 FUN_00945540(int param_1)
...
LAB_00945725:
    ...
    if (cVar4 != '\0') {
      ...
      (**(code **)(*unaff_EDI + 0x2ac))(*(undefined4 *)(param_1 + 0xd34));
    ...
    uVar6 = *(undefined4 *)(iVar8 + 0x164);
    uVar12 = *(undefined4 *)(iVar8 + 0x160);
