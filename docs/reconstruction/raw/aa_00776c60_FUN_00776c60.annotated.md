# Annotated low-level: FUN_00776c60
...
- Source: raw capture for `aa_00776c60`.
...
int FUN_00776c60(undefined4 param_1,int *param_2,undefined4 param_3,uint *param_4,int param_5)
...
LAB_007771d4:
  if (local_1004 != (void *)0x0) {
    ...
    if (0 < local_1010) {
      do {
        *(undefined4 *)((int)local_1004 + iVar7 * 4) = 0;
        iVar7 = iVar7 + 1;
...
LAB_00777224:
  if (local_fe4 != (void *)0x0) {
    ...
    if (0 < local_ff0) {
      do {
        *(undefined4 *)((int)local_fe4 + iVar7 * 4) = 0;
        iVar7 = iVar7 + 1;
