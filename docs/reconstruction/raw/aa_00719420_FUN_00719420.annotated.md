# Annotated low-level: FUN_00719420
...
- Source: raw capture for `aa_00719420`.
...
```c
void __thiscall FUN_00719420(int param_1,void *param_2,uint param_3,undefined2 *param_4)

{
  ...
  param_4 = (undefined2 *)CONCAT22((short)((uint)param_1 >> 0x10),*param_4);
  iVar5 = *(int *)(param_1 + 4);
  if (iVar5 == 0) {
    iVar1 = 0;
  }
