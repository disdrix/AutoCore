# Annotated low-level: FUN_00538000
...
- Source: raw capture for `aa_00538000`.
...
```c
undefined4 __thiscall FUN_00538000(int param_1,undefined4 param_2,undefined4 *param_3)
