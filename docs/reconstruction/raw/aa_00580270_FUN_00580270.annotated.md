# Annotated low-level: FUN_00580270
...
- Source: raw capture for `aa_00580270`.
...
```c
void __thiscall FUN_00580270(int param_1,int param_2,uint param_3,undefined4 *param_4)
