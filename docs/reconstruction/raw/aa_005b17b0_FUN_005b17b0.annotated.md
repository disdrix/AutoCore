# Annotated low-level: FUN_005b17b0
...
- Source: raw capture for `aa_005b17b0`.
...

{
  ...
  if (DAT_00b051e0 != '\0') {
    ...
    FUN_007a4480(0xffffffff,"unpacking update from net %I64d for ghost %d, %d, %I64d",
                 *(undefined4 *)(param_2 + 0x238),*(undefined4 *)(param_2 + 0x23c),uVar6,uVar10,
                 uVar11);
  }
  if (DAT_00d1798c != 0) {
  ...
  if (piVar8 != (int *)0x0) {
    if (local_db != '\0') {
      ...
      if ((cVar5 == '\0') || (cStack_ed != '\0')) {
        ...
        if ((cVar5 == '\0') && (bStack_e9 != false)) {
          if (local_d9 == '\0') {
            *(undefined4 *)(*(int *)(piVar8[1] + 4) + 0xd0 + (int)piVar8) = 0;
          }
          else {
    ...
    if (DAT_00b051e0 != '\0') {
      FUN_007a4480(0xffffffff,"Updated %I64d, %.2f %.2f %.2f - %.1f %.1f %.1f %.1f",
                   *(undefined4 *)(param_1[0x14] + 0x160),*(undefined4 *)(param_1[0x14] + 0x164),
