# Annotated low-level: FUN_006d8690
...
- Source: raw capture for `aa_006d8690`.
...
LAB_006d975d:
      ...
      do {
        if ((((uint)fVar18 | uVar21) & uVar23) == 0) {
          ...
          FUN_006df0b0(param_2,local_1e0,*(undefined4 *)(iVar4 + 0xc),local_a0);
        }
        uVar23 = (int)uVar23 >> 1;
        iVar17 = iVar17 + 1;
      } while (iVar17 < 3);
...
LAB_006d9217:
  ...
  do {
    if (*(float *)(param_4 + 8) <= (float)puVar20[1]) {
      ...
      puVar14 = (undefined4 *)(piVar5[1] * 0x30 + *piVar5);
      piVar5[1] = piVar5[1] + 1;
      *puVar14 = puVar20[-2];
      puVar14[1] = puVar20[-1];
      puVar14[2] = *puVar20;
