# Annotated low-level: FUN_00596f90
...
- Source: raw capture for `aa_00596f90`.
...
```c
void __thiscall FUN_00596f90(int param_1,int param_2,uint param_3,undefined4 *param_4)
