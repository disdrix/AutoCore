# Annotated low-level: FUN_0045bc40
...
- Source: raw capture for `aa_0045bc40`.
...
```c
undefined4 __thiscall FUN_0045bc40(int param_1,undefined4 *param_2)

{
  ...
  FUN_00439810();
  if (iVar9 != 0) {
    FUN_0045ebc0(*(undefined4 *)(param_1 + 0x20),iVar9);
  }
  local_4 = 0xffffffff;
