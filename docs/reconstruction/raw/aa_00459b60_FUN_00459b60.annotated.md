# Annotated low-level: FUN_00459b60
...
- Source: raw capture for `aa_00459b60`.
...
```c
undefined4 __thiscall FUN_00459b60(int param_1,undefined4 *param_2)

{
  ...
  FUN_00439810();
  if (iVar9 != 0) {
    FUN_0045dfe0(*(undefined4 *)(param_1 + 0x20),iVar9);
  }
  local_4 = 0xffffffff;
