# Annotated low-level: FUN_007e34b0
...
- Source: raw capture for `aa_007e34b0`.
...
undefined4 __fastcall FUN_007e34b0(char *param_1)

{
  ...
  undefined1 uStack_119f;
  undefined1 uStack_119e;
  undefined1 uStack_119d;
  undefined1 uStack_1199;
  ...
  local_125c = param_1;
  FUN_007d9440();
  uVar5 = (undefined1)((uint)unaff_EBX >> 0x18);
  if (DAT_00d1793c == '\0') {
    ...
    if ((((((((((-1 < iVar8) && (iVar8 = FUN_004231d0(), -1 < iVar8)) &&
      ...
      uVar2 = uStack_8d0;
      while (iVar8 == 0) {
        uStack_127c._3_1_ = (undefined1)((uint)uStack_127c >> 0x18);
        local_1270._3_1_ = (undefined1)((uint)local_1270 >> 0x18);
        uStack_8cc = (uint)((short)local_1288 == -1);
        local_11a4._0_2_ = CONCAT11(local_1270._3_1_,uStack_127c._3_1_);
        local_11a4 = CONCAT13(uVar5,CONCAT12((char)((uint)local_128c >> 0x18),(undefined2)local_11a4
                                            ));
        uStack_8d0._2_2_ = (undefined2)((uint)uVar2 >> 0x10);
        ...
        if (local_1290 < 1) {
          ...
          if ((local_8a8 != (void *)0x0) &&
             (puVar9 = (undefined4 *)FUN_0041ac60(), pcVar16 = wcscpy_exref,
            ...
            if (iVar8 == 0) {
              iVar8 = 0;
              do {
                if (local_12a0 == (undefined4 *)0x0) break;
                puVar14 = (undefined4 *)(iVar8 + (int)local_8a8);
                *puVar14 = *local_12a0;
...
LAB_007e4db5:
    ...
    local_12c8 = (int *)0x0;
    (**(code **)(*ppOVar15 + 0xe))();
    local_1298 = (undefined4 *)&stack0xffffed14;
    pOVar17 = SysAllocString(L"IDClass");
    if (pOVar17 == (BSTR)0x0) {
                    /* WARNING: Subroutine does not return */
      FUN_004048e0();
    }
    local_1298 = (undefined4 *)&stack0xffffed10;
    puVar9 = (undefined4 *)&stack0xffffed10;
    ...
    if (0 < local_1294) {
      do {
        ...
        uVar4 = FUN_007b8a60();
        uStack_8cc._0_2_ = CONCAT11(uVar4,(undefined1)uStack_8cc);
        ...
        if (pOVar17 == (BSTR)0x0) goto LAB_007e50f3;
        if (&stack0x00000000 != (undefined1 *)0x12f4) {
        ...
        if ((0 < sVar6) &&
           ...
           local_8a4 != (void *)0x0)) {
          iVar10 = 0x7e47b4;
          puVar9 = (undefined4 *)FUN_0041ac60();
          unaff_ESI = (BSTR *)&stack0xffffed10;
          if (puVar9 != (undefined4 *)0x0) {
            ...
            if (iVar8 == 0) {
              ...
              do {
                ...
                puVar14 = (undefined4 *)((int)local_8a4 + iVar8);
                *puVar14 = *(undefined4 *)local_129c;
                puVar14[1] = *(undefined4 *)(local_129c + 2);
                puVar14[2] = *(undefined4 *)(local_129c + 4);
                puVar14[3] = *(undefined4 *)(local_129c + 6);
                puVar14[4] = *(undefined4 *)(local_129c + 8);
                iVar8 = iVar8 + 0x14;
                iVar12 = FUN_00423f40();
              } while (iVar12 == 0);
            }
        ...
        local_1298 = (undefined4 *)((int)local_1298 + 1);
...
LAB_007e4956:
    if (DAT_00d1793c == '\0') {
      ...
      while (iVar8 == 0) {
        ...
        local_8b0 = local_1240;
        uStack_8cc = (uint)((short)local_1288 == -1);
        uStack_8d0._0_2_ = (undefined2)((uint)unaff_EBX >> 8);
        local_8ac = CONCAT22(local_8ac._2_2_,local_1290);
        local_8c8 = local_1248;
        local_8c4 = local_125c;
        if (local_1290 < 1) {
          ...
          local_8a8 = operator_new__(local_1290 * 0x14);
          if ((local_8a8 != (void *)0x0) &&
             (puVar9 = (undefined4 *)FUN_0041ac60(), puVar9 != (undefined4 *)0x0)) {
            FUN_004294f0();
            iVar8 = FUN_00423f40();
            if (iVar8 == 0) {
              iVar8 = 0;
...
LAB_007e50f3:
      ...
      puVar9 = (undefined4 *)FUN_00419ed0();
      ...
      if (0 < (int)local_129c) {
        do {
          ...
          if (local_12cc != (int *)0x0) {
            ...
            uVar5 = FUN_007b8a60();
            local_8c8._0_2_ = CONCAT11(uVar5,(undefined1)local_8c8);
            pOVar17 = SysAllocString(L"bitUseBodyForArc");
            if (pOVar17 == (BSTR)0x0) goto LAB_007e50f3;
            if (local_12cc != (int *)0x0) {
              (**(code **)(*local_12cc + 4))();
            ...
            if ((short)local_8a4 < 1) {
              ...
              if ((local_8a0 != (void *)0x0) &&
                ...
                if (iVar8 == 0) {
                  iVar8 = 0;
                  do {
                    if (local_1298 == (undefined4 *)0x0) break;
                    puVar14 = (undefined4 *)((int)local_8a0 + iVar8);
                    *puVar14 = *local_1298;
    ...
    pcVar3 = local_125c;
    if (*(undefined4 **)(local_125c + 0x558) != (undefined4 *)0x0) {
      (**(code **)**(undefined4 **)(local_125c + 0x558))();
    }
    pcVar3[0x558] = '\0';
    pcVar3[0x559] = '\0';
    pcVar3[0x55a] = '\0';
