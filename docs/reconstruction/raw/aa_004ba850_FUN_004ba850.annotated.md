# Annotated low-level: FUN_004ba850
...
- Source: raw capture for `aa_004ba850`.
...
```c
void __thiscall FUN_004ba850(int param_1,void *param_2,uint param_3,undefined4 *param_4)
