# Annotated low-level: FUN_006cfa90
...
- Source: raw capture for `aa_006cfa90`.
...
```c
void __thiscall
FUN_006cfa90(undefined4 *param_1,float *param_2,float *param_3,float *param_4,float param_5,
            undefined4 param_6)
