# Annotated low-level: FUN_005aede0
...
- Source: raw capture for `aa_005aede0`.
...
```c
void __thiscall FUN_005aede0(int param_1,int param_2,uint param_3,undefined4 *param_4)
