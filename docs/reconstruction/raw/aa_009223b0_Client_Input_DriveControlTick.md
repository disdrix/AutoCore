# Raw capture: Client_Input_DriveControlTick
...
## Re-decompile confirmation (2026-07-23, append-only)

| Field | Value |
|---|---|
| Tool | Ghidra MCP HTTP `GET /decompile_function?address=0x009223b0` |
| Result | Body markers match this capture (ActionMap DAT_* thr/steer/soft, setter call sites, `LAB_00922d94`, `PushDriveAxesToController`) |
| Notes | No raw body overwrite. Clean refined with SECTION 1–15; dual reviews A/B written. |

### Axis cross-links (caller of)
