# Annotated low-level: CVOGSpawnPoint_CreateCreature

| Field | Value |
|---|---|
| Stable ID | a_00564f60 |
| VA | 0x00564f60 |
| System | unknown |
| Date | 2026-07-23 |
...
Spawn creature from point; terrain height + flying height + foot offset path for IsNPC.
...
- Source: raw capture for a_00564f60.
