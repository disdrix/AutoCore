# Annotated low-level: QuickBar_UpdateSkillSlotCooldownGauge
...
| **Source raw** | `aa_00825520_QuickBar_UpdateSkillSlotCooldownGauge.md` |
...
| Offset / symbol | Role |
|---|---|
| `button+0x550` | bound skill / slot state |
| `skill+0x628` | charge-mode flag |
| `skill+0x5e8` | category cooldown key |
| `skill+0x178/+0x14/+0x10` | charge/CD floats |
| `DAT_00d1b6d8+0x6b8/0x6b9` | QB UI enable gates |
...

{
  ...
  if ((*(char *)(DAT_00d1b6d8 + 0x6b9) == '\0') ||
    ...
    *(undefined1 *)(*(int *)(*(int *)(*(int *)(iVar1 + 4) + 4) + 0x74 + iVar1) + 0x1d) = 0;
  ...
  if (iVar5 != 0) {
    ...
    if (*(char *)(iVar5 + 0x628) != '\0') {
      ...
      if (*(char *)((int)pButton + 0x4fe) == '\0') {
        ...
        if (local_c <= fStack_8) {
          ...
          if (0 < *(short *)(iVar5 + 0x14)) {
            ...
            fVar6 = (float10)(**(code **)(**(int **)((int)pButton + 0x550) + 0x3c4))
        ...
        *(undefined1 *)((int)pButton + 0x4fe) = 1;
      ...
      if (local_c <= fVar10 * g_flMsToSeconds_Inferred) {
        ...
        fVar6 = (float10)(**(code **)(**(int **)((int)pButton + 0x550) + 0x3c0))();

        (**(code **)(**(int **)((int)pButton + 0x550) + 0x3b4))

                  ((float)(fVar6 / (((float10)fStack_8 + (float10)fStack_10) - (float10)local_c)));
      ...
      (**(code **)(**(int **)((int)pButton + 0x550) + 0x3b4))
                ...
                ((float)(fVar6 / ((float10)fStack_10 - (float10)local_c)));

      return;

    }

    Skill_GetCategoryCooldownRemaining(*(float10 **)(iVar5 + 0x5e8),0,bAsSeconds);

    fStack_8 = (float)extraout_ST0;

    if (DAT_00aaa664 < fStack_8) {

      Skill_GetCategoryCooldownRemaining(*(float10 **)(iVar5 + 0x5e8),1,bAsSeconds);
      ...
      fVar6 = (float10)(**(code **)(iVar5 + 0x3c0))();

      (**(code **)(iVar5 + 0x3b4))((float)(fVar6 / (float10)fStack_14));
...
LAB_00825a0d:
  ...
  *(undefined4 *)((int)pButton + 0x508) = *(undefined4 *)((int)pButton + 0x504);

  *(undefined1 *)((int)pButton + 0x4fe) = 0;
...
- Confirm float units (seconds vs normalized 0..1) for gauge widget.
