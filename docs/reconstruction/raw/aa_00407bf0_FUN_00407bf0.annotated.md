# Annotated low-level: FUN_00407bf0
...
- Source: raw capture for `aa_00407bf0`.
...
```c
undefined4 * FUN_00407bf0(undefined4 *param_1,int *param_2,int *param_3)
