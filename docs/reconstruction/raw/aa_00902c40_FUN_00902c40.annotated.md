# Annotated low-level: FUN_00902c40
...
- Source: raw capture for `aa_00902c40`.
...

{
  ...
  int iStack_618;
  char acStack_608 [2];
  undefined4 auStack_606 [63];
  char acStack_508 [2];
  undefined4 auStack_506 [63];
  char acStack_408 [2];
  undefined4 auStack_406 [63];
  char acStack_308 [2];
  undefined4 auStack_306 [63];
  char acStack_208 [2];
  undefined4 auStack_206 [63];
  char acStack_108 [2];
...
LAB_00902cf0:
    ...
    piVar16 = (int *)CVOGReaction_ResolveObjectTarget
                               (1,*(undefined4 *)(iVar8 + 0x1f0),*(undefined4 *)(iVar8 + 500));
...
LAB_0090333f:
      if (bVar21 != bVar20) {
LAB_00903345:
        uVar28 = *(undefined4 *)(*(int *)(iVar3 + 0x18) + iVar9);
        *(undefined4 *)(*(int *)(iVar3 + 0x18) + iVar9) =
             *(undefined4 *)(*(int *)(iVar3 + 0x18) + iVar2);
        *(undefined4 *)(*(int *)(iVar3 + 0x18) + iVar2) = uVar28;
...
LAB_00904a92:
                      iVar8 = *(int *)(iVar3 + 0x18);
                      uVar28 = *(undefined4 *)(iVar8 + iVar9);
                      *(undefined4 *)(iVar8 + iVar9) = *(undefined4 *)(iVar8 + iVar2);
                      *(undefined4 *)(*(int *)(iVar3 + 0x18) + iVar2) = uVar28;
                    }
                    else {
                      iVar8 = (**(code **)(*piVar16 + 500))();
      ...
      do {
        ...
        while( true ) {
          ...
          if (((*(uint *)(iVar9 + 0x1f0) & *(uint *)(iVar9 + 500)) != 0xffffffff) &&
            ...
            piVar16 = (int *)CVOGReaction_ResolveObjectTarget
                                       (1,*(undefined4 *)(iVar9 + 0x1f0),
                                        *(undefined4 *)(iVar9 + 500));
...
LAB_0090425c:
                    ...
                    uVar28 = *(undefined4 *)(iVar9 + iVar8);
                    *(undefined4 *)(iVar9 + iVar8) = *(undefined4 *)(iVar9 + iVar2);
                    *(undefined4 *)(*(int *)(iVar3 + 0x18) + iVar2) = uVar28;
                  }
                }
                break;
