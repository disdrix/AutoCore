# Annotated low-level: FUN_0048eba0
...
- Source: raw capture for `aa_0048eba0`.
...

{
  ...
  if (((iVar2 != 0) && (DAT_00b04db8 != 0)) && (*(int *)(DAT_00b04db8 + 0x14) != 0)) {
    (**(code **)(*(int *)*DAT_00d1f044 + 0x88))
               ...
               *(undefined4 *)(*(int *)(param_1 + 0xdc) + 0x14),0,2);
    return;
  }
  iVar2 = 0;
  local_4 = 0;
  ...
  if (iVar2 != 0) {
    ...
    (**(code **)(*(int *)*puVar1 + 0x88))
              ((int *)*puVar1,iVar2,0,*(undefined4 *)(*(int *)(param_1 + 0xdc) + 0x14),0,2);
