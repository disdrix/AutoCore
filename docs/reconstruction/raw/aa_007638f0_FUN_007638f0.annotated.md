# Annotated low-level: FUN_007638f0
...
- Source: raw capture for `aa_007638f0`.
...
```c
void __thiscall FUN_007638f0(undefined4 param_1,int *param_2)

{
  ...
  *local_14 = (int)local_14;
  ...
  if (puVar4[7] == 0) {
    ...
    puVar4[1] = puVar4[1] | uVar8;
    piStack_44 = (int *)0x2;
    puVar13 = (undefined4 *)&DAT_00a97b84;
    uVar8 = (**(code **)(*(int *)*puVar4 + 0x18))();
    puVar4[8] = 0;
  ...
  if (puVar4[7] == 0) {
    ...
    puVar4[1] = puVar4[1] | uVar8;
    piVar14 = (int *)0x2;
    puVar19 = (undefined4 *)&DAT_00a97b84;
    uVar8 = (**(code **)(*(int *)*puVar4 + 0x18))();
    puVar4[8] = 0;
    puVar4[1] = uVar8 | puVar4[1];
  }
  ...
  if (puVar19[0x30] == 0) {
    ...
    puVar13 = (undefined4 *)((int)(puVar19[0x31] - puVar19[0x30]) >> 2);
  }
  if (puVar4[7] == 0) {
    local_1c = puVar13;
