# Annotated low-level: FUN_007407b0
...
- Source: raw capture for `aa_007407b0`.
...
undefined4 __thiscall FUN_007407b0(int param_1,int *param_2)

{
  ...
  *(undefined4 *)(iStack_3c + 0x68) = 0;
  *(undefined4 *)(iStack_3c + 0x54) = 0;
  *(undefined4 *)(iStack_3c + 0x74) = 0;
  while (iVar5 != iVar3) {
    FUN_0076c9d0();
