# Annotated low-level: FUN_004461c0
...
- Source: raw capture for `aa_004461c0`.
...
```c
void __fastcall
FUN_004461c0(undefined4 param_1,undefined4 *param_2,int param_3,int param_4,uint param_5)
