# Annotated low-level: FUN_009781d0
...
- Source: raw capture for `aa_009781d0`.
...
undefined4 * ClientSpecialEvent_TeleportOut_ctor(undefined4 *param_1,int param_2)
  ...
  *(undefined1 *)((int)param_1 + 0x31) = 0;
  ...
  if (piVar2 == (int *)0x0) {
    ...
    *(int *)(iVar4 + 0xc) = *(int *)(iVar4 + 0xc) + 1;
    ...
    FUN_0076f5f0();
    local_24 = (undefined1 *)(extraout_EDX & 0xffff);
    ...
    if (*(int *)(iVar4 + 8) == 0) {
      puVar5 = (undefined4 *)(*(int *)(*(int *)(iVar4 + 4) + 4) + 0x84 + iVar4);
    }
    else {
      puVar5 = (undefined4 *)(*(int *)(*(int *)(iVar4 + 8) + 0x3c) + 0xb0);
    }
    local_60 = *puVar5;
    local_5c = puVar5[1];
    local_58 = puVar5[2];
    ...
    if (iVar4 == DAT_00d1b6d8) {
      ...
      *(undefined4 *)(DAT_00d1b778 + 0x60c) = 4;
      FUN_0090dd50();
      iVar4 = DAT_00d1b778;
      *(undefined4 *)(DAT_00d1b778 + 0xce4) = local_30;
      *(undefined4 *)(iVar4 + 0xce8) = local_2c;
      *(undefined4 *)(iVar4 + 0xcec) = local_28;
