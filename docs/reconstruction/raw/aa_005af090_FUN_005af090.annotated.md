# Annotated low-level: FUN_005af090
...
- Source: raw capture for `aa_005af090`.
...
```c
void __thiscall FUN_005af090(int param_1,int param_2,uint param_3,undefined4 *param_4)
