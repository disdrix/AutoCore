# Annotated low-level: FUN_006eaf60
...
- Source: raw capture for `aa_006eaf60`.
...

{
  ...
  undefined1 local_214 [528];
  
  FUN_006ea1b0(param_2,param_3,param_4,&local_360);
  *(undefined4 *)(param_1 + 0x20) = local_360;
  *(undefined4 *)(param_1 + 0x24) = local_35c;
  *(undefined4 *)(param_1 + 0x28) = local_358;
  *(undefined4 *)(param_1 + 0x2c) = local_354;
  *(undefined4 *)(param_1 + 0x30) = local_350;
  *(undefined4 *)(param_1 + 0x34) = local_34c;
  *(undefined4 *)(param_1 + 0x3c) = local_344[0];
  local_220 = local_214;
  *(uint **)(param_1 + 0x38) = local_348;
  ...
  uStack_33c = *(undefined4 *)(param_2 + 8);
  iStack_338 = param_2;
  if (DAT_00d09691 != '\0') {
        ...
        if ((puVar15 == puVar10) || (*puVar12 != *puVar15)) {
          ...
          *(int *)(param_1 + 0x10) = *(int *)(param_1 + 0x10) + -1;
          ...
          if (iVar3 < *(int *)(param_1 + 0x10)) {
            iVar7 = iVar3 * 0xc;
            do {
              puVar8 = (undefined4 *)(iVar7 + *piVar1);
              *puVar8 = puVar8[3];
              puVar8[1] = puVar8[4];
              puVar8[2] = puVar8[5];
              iVar3 = iVar3 + 1;
      ...
      for (; puVar9 != puVar12; puVar9 = puVar9 + 1) {
        if ((puVar15 == puStack_394) || (*puVar15 != *puVar9)) {
          ...
          if (-1 < (int)puStack_394 + -1) {
            iVar2 = iVar3 + 0xc;
            puVar8 = (undefined4 *)(iVar2 + ((int)puStack_394 + -1) * 0xc);
            do {
              puVar14 = (undefined4 *)((iVar3 - iVar2) + (int)puVar8);
              *puVar8 = *puVar14;
              puVar8[1] = puVar14[1];
              puVar8[2] = puVar14[2];
              puVar8 = puVar8 + -3;
          ...
          *(int *)(param_1 + 0x10) = iVar7;
          ...
          local_348 = puVar10;
          pcVar5 = (char *)(**(code **)**(undefined4 **)(param_4 + 4))
...
joined_r0x006eb492:
  ...
  if ((int)uVar4 < iStack_378) {
    if (-1 < (int)*(uint *)(param_1 + 0x14)) {
      (**(code **)(*DAT_00b05060 + 0x14))(*(undefined4 *)(param_1 + 0xc),uVar4 * 0xc,0x12);
    }
