# Annotated low-level: FUN_0062c000
...
- Source: raw capture for `aa_0062c000`.
...
```c
void FUN_0062c000(int param_1,int param_2,int param_3,undefined4 param_4)

{
  ...
  do {
    ...
    if (param_2 < iVar5) {
      FUN_0062c000(param_1,param_2,iVar5,param_4);
    }
    param_2 = iVar6;
    if (param_3 <= iVar6) {
      return;
