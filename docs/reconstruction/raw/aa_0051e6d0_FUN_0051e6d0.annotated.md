# Annotated low-level: FUN_0051e6d0
...
- Source: raw capture for `aa_0051e6d0`.
...
```c
undefined4 __thiscall FUN_0051e6d0(void *param_1,uint param_2,int param_3,char param_4)
