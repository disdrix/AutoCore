# Annotated low-level: FUN_00640580
...
- Source: raw capture for `aa_00640580`.
...
undefined1 * FUN_00640580(undefined4 param_1,undefined4 *param_2,ushort param_3)

{
  ...
  local_28 = 0;
  iStack_68 = 2;
  puStack_6c = (undefined4 *)&param_3;
  *param_2 = 0;
  iStack_70 = 0x6405b1;
  FUN_00652910();
  puVar10 = (undefined4 *)(uint)param_3;
  iStack_64 = 5;
  iStack_68 = (int)puVar10 + 1;
  puStack_6c = (undefined4 *)0x6405c6;
  iVar2 = (**(code **)*DAT_00b05060)();
  puStack_74 = (undefined4 *)0x6405d5;
  iStack_70 = iVar2;
  puStack_6c = puVar10;
  iStack_40 = iVar2;
  FUN_00641860();
  ...
  *(undefined1 *)((int)puVar10 + iVar2) = 0;
  uStack_80 = 0x6405e9;
  FUN_00652910();
  puVar11 = (ushort *)(uint)auStack_4[0];
  puStack_74 = (undefined4 *)0x5;
  ...
  uStack_44 = uVar3;
  FUN_00641860();
  *(undefined1 *)((int)puVar11 + uVar3) = 0;
  ...
  *(undefined1 *)(uVar12 + uVar4) = 0;
  ...
  if (uVar12 != 0) {
    ...
    uStack_44 = uVar12;
    puStack_74 = (undefined4 *)(**(code **)*DAT_00b05060)(uVar12 << 4,5);
    iStack_70 = 0;
    puVar10 = puStack_74;
    uVar13 = uStack_44;
    if (uVar12 != 0) {
      do {
        ...
        *(undefined1 *)(uVar13 + iVar2) = 0;
        FUN_00652910(&stack0xffffffa8,2,1);
        if ((ushort)uVar4 < 0x100) {
          *(undefined1 *)(iStack_70 + iStack_48) = 0;
          uVar13 = uVar4;
        }
        else {
...
LAB_0064087c:
    if (puStack_7c != (ushort *)0x0) {
      ...
      *(undefined4 *)(iVar5 + 0x1c) = unaff_EDI;
