# Annotated low-level: FUN_00538b20
...
- Source: raw capture for `aa_00538b20`.
...
```c
undefined4 __thiscall FUN_00538b20(int param_1,undefined4 param_2,undefined4 *param_3)
