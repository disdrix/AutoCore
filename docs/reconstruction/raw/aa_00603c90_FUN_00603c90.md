...
```c
void __thiscall
FUN_00603c90(int param_1,undefined4 *param_2,char param_3,undefined4 *param_4,undefined4 param_5)

{
  ...
  ExceptionList = &local_c;
  piVar4 = (int *)FUN_00603b10(*(undefined4 *)(param_1 + 4),param_4,*(undefined4 *)(param_1 + 4),
                               param_5,0);
...
| **Live decompile** | equiv raw CF above |
| **Named role** | `StdTree_InsertAndRebalance_Val28_Isnil29_Inferred` |
| **Body (bytes)** | `0x00603c90`-`0x00603e7a` exclusive (**490 B** / `0x1EA`); pad `CC` |
| **ABI** | `__thiscall` ECX=map; stack `(Node** outIt, char addLeft, Node* where, Val28* value)`; **`ret 0x10`** (`C2 10 00`) |
| **Max size** | `size > 0x9249247` then `"map/set<T> too long"` / ThrowInfo `DAT_00acc388` |
| **Buynode** | `FUN_00603b10` -> `operator_new(0x2C)` + `FUN_00603730` (key@+0x0C, color@+0x28, isnil@+0x29=0) |
| **Rotates** | `FUN_004192a0` Lrotate / `FUN_004192f0` Rrotate (Isnil29); one arm inlines Lrotate CF |
| **Sole caller** | `FUN_00603f00` @ `0x00603f4a` (int-key lower-bound walk + always-insert) |
