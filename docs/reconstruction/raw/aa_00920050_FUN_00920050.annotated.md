# Annotated low-level: FUN_00920050
...
- Source: raw capture for `aa_00920050`.
...

{
  ...
  ExceptionList = &pvStack_c;
  *(undefined1 *)((int)unaff_EDI + 0xc65) = 0;
  *(undefined1 *)((int)unaff_EDI + 0xc66) = 0;
  if (unaff_EDI[0x31a] != 0) {
    (**(code **)(*unaff_EDI + 0xb0))(unaff_EDI[0x31a]);
    if ((undefined4 *)unaff_EDI[0x31a] != (undefined4 *)0x0) {
      (*(code *)**(undefined4 **)unaff_EDI[0x31a])(1);
    }
    unaff_EDI[0x31a] = 0;
  }
  if (unaff_EDI[0x31b] != 0) {
    (**(code **)(*unaff_EDI + 0xb0))(unaff_EDI[0x31b]);
    if ((undefined4 *)unaff_EDI[0x31b] != (undefined4 *)0x0) {
      (*(code *)**(undefined4 **)unaff_EDI[0x31b])(1);
    }
    unaff_EDI[0x31b] = 0;
  }
