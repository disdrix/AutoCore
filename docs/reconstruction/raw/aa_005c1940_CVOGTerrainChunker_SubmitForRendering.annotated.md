# Annotated low-level: CVOGTerrainChunker_SubmitForRendering
...
- Source: raw capture for `aa_005c1940`.
...

{
        ...
        do {
          ...
          if (iVar12 != 0) {
            ...
            *(int *)(iVar12 + 0xd8) = iVar10;
            if (iVar10 == param_1[6]) {
              *(undefined4 *)(iVar12 + 0xdc) = 0;
              FUN_005c18a0(param_1);
            }
            else if (*(int *)(iVar12 + 200) != 0) {
              *(undefined1 *)(*(int *)(iVar12 + 200) + 0xc5) = 1;
            }
          }
          iVar10 = param_1[1];
          local_38 = local_38 + 1;
  ...
  if (0 < param_1[0xb]) {
    ...
    do {
      ...
      local_38 = local_38 + 1;
      *(undefined1 *)(piVar14 + 0x31) = 0;
      *(undefined1 *)((int)piVar14 + 0xc5) = 0;
