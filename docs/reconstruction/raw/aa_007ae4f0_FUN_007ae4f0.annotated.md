# Annotated low-level: FUN_007ae4f0
...
- Source: raw capture for `aa_007ae4f0`.
      ...
      while (iVar3 == 0) {
        if (local_70 != (int *)0x0) {
          if (((*local_70 == 1) && (pcVar5 = (char *)local_70[1], pcVar5 != (char *)0x0)) &&
            ...
            sprintf(local_64,&DAT_00a96c40,(uint)*pbVar2,*(undefined4 *)(pbVar2 + 8),
                    *(undefined4 *)(pbVar2 + 0xc),*(undefined4 *)(pbVar2 + 0x10),
                    *(undefined4 *)(pbVar2 + 0x14));
            pcVar5 = local_64;
            do {
              cVar1 = *pcVar5;
              pcVar5 = pcVar5 + 1;
