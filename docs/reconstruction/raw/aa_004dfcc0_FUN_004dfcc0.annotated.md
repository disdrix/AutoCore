# Annotated low-level: FUN_004dfcc0
...
- Source: raw capture for `aa_004dfcc0`.
...
undefined4 __thiscall FUN_004dfcc0(int param_1,undefined4 param_2)

{
  ...
  undefined1 auStack_e3c [20];
  uint uStack_e28;
  undefined4 uStack_e24;
  undefined1 auStack_de8 [536];
  char local_bd0 [1036];
  ...
  *(undefined4 *)(param_1 + 0x84) = 0;
  ...
  if (*(int *)(param_1 + 0xe4f8) != 0) {
    ...
    *(undefined1 *)(*(int *)(param_1 + 0xe894) + 0x8b) = 1;
    ...
    if (piVar3 != (int *)0x0) {
      ...
      *(uint *)(param_1 + 0xe6dc) = local_e64 + (0xfffffffe < local_e68);
      ...
      FUN_00691630();
      local_eb8 = (undefined4 *)0x0;
      uVar10 = (undefined1)((uint)unaff_EBX >> 0x10);
      if (0 < local_e94) {
        do {
            ...
            if ((*(char *)(param_1 + 0x7d) == '\0') && (*(char *)(param_1 + 0x7e) != '\0')) {
              ...
              *(int *)(param_1 + 0x84) = *(int *)(param_1 + 0x84) + 1;
              if (local_ed8 < (int)(uint)*(ushort *)(param_1 + 0x940)) {
                ...
                piStack_eb0 = (int *)FUN_004e53a0(*(undefined4 *)
                                                   (param_1 + (local_ed8 * 3 + 300) * 8));
                if (piStack_eb0 != (int *)0x0) {
                  *(undefined4 *)(param_1 + 0xe6d8) =
                       *(undefined4 *)(param_1 + 0x958 + local_ed8 * 0x18);
                  *(undefined4 *)(param_1 + 0xe6dc) =
                       *(undefined4 *)(param_1 + 0x95c + local_ed8 * 0x18);
                  FUN_004db820();
                  iVar8 = *(int *)(*(int *)(local_eb4 + 4) + 4);
                  uStack_e50 = *(undefined4 *)(iVar8 + 0x84 + local_eb4);
                  uStack_e4c = *(undefined4 *)(iVar8 + 0x88 + local_eb4);
                  uStack_e48 = *(undefined4 *)(iVar8 + 0x8c + local_eb4);
                  uStack_e44 = *(undefined4 *)(iVar8 + 0x90 + local_eb4);
...
LAB_004e02a7:
          local_14 = local_14 & 0xffffff00;
          FUN_007a4390();
          local_eb8 = (undefined4 *)((int)local_eb8 + 1);
...
LAB_004e06d3:
            ...
            *(undefined1 *)(piVar5 + 0x5e) = uVar10;
            (*(code *)((undefined4 *)*piVar5)[0x86])(param_1);
            FUN_00512160(uStack_ee0,uStack_edc,0);
            ...
            cVar2 = (**(code **)(*piVar5 + 0xa4))
                              (piVar3,*(undefined4 *)(param_1 + 0x8c),&uStack_e90,0);
            if (cVar2 != '\0') {
...
LAB_004e0770:
      ...
      FUN_004d73c0(piVar3);
      local_ec0 = *(undefined4 **)(*(int *)(param_1 + 0xe8fc) + 4);
      local_eb8 = local_ec0;
      if (*(char *)((int)local_ec0 + 0x15) != '\0') {
        *(int *)(*(int *)(param_1 + 0xe8fc) + 4) = *(int *)(param_1 + 0xe8fc);
        *(undefined4 *)(param_1 + 0xe900) = 0;
        *(undefined4 *)*(undefined4 *)(param_1 + 0xe8fc) = *(undefined4 *)(param_1 + 0xe8fc);
      ...
      local_ec0 = (undefined4 *)*local_ec0;
