# Annotated low-level: FUN_006236a0
...
- Source: raw capture for `aa_006236a0`.
...
```c
int __thiscall FUN_006236a0(int param_1,undefined4 param_2,undefined4 param_3,int param_4)
