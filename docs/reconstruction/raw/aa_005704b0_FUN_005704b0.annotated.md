# Annotated low-level: FUN_005704b0
...
- Source: raw capture for `aa_005704b0`.
...
```c
undefined4 __thiscall FUN_005704b0(void *param_1,uint param_2,int param_3,char param_4)
