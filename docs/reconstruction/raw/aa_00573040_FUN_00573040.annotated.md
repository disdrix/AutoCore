# Annotated low-level: FUN_00573040
...
- Source: raw capture for `aa_00573040`.
...
```c
undefined4 __thiscall FUN_00573040(int *param_1,undefined4 param_2,undefined4 param_3)
