# Annotated low-level: FUN_0072cee0
...
- Source: raw capture for `aa_0072cee0`.
...
```c
undefined4 FUN_0072cee0(int param_1,int param_2)
...
LAB_0072cfd7:
  ...
  if (*(int *)(iVar13 + 0x10) == 0) {
    ...
    iVar13 = FUN_00746520(*(undefined4 *)(iVar13 + 0x14),*(undefined4 *)(iVar13 + 0x18),4);
  }
  if (*(int *)(param_1 + 0x14) == 0) {
    pfVar15 = (float *)0x0;
  }
