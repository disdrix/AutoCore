# Review A (reconstruction fidelity): `aa_004c2ee0` Object_SetU16_plus13c

| Field | Value |
|---|---|
| **Stable ID** | `aa_004c2ee0` |
| **VA** | `0x004c2ee0` |
| **Canonical name** | `Object_SetU16_plus13c` (inferred; Ghidra `FUN_004c2ee0`) |
| **Plate alias** | `Named_CalleeOf_CVOGCharacter_LevelUp_004c2ee0` |
| **Review date** | `2026-07-29` (OWN-ONLY dual A) |
| **Reviewer role** | Independent reconstruction review |
| **Counterpart** | `reviews/B_aa_004c2ee0_Object_SetU16_plus13c.md` |
| **System** | combat / character attrs / ghost unpack |
| **Evidence pass** | Live `batch_decompile` + `read_memory` (`mov word [ecx+0x13c], ax; ret 4`); callers LevelUp/UnpackGhost |
...
**Unguarded u16 store** to object field **`+0x13c`**.
...
| Artifact | Path |
|---|---|
| Raw | `docs/reconstruction/raw/aa_004c2ee0_FUN_004c2ee0.md` |
| Annotated | `docs/reconstruction/raw/aa_004c2ee0_FUN_004c2ee0.annotated.md` |
| Clean | `docs/reconstruction/reconstructed-exact/FUN_004c2ee0.cpp` |
| Function record | `docs/reconstruction/functions/aa_004c2ee0_FUN_004c2ee0.md` |
...
void Object_SetU16_plus13c(void *self, uint16_t value);
// *effectively*  *(uint16_t*)(self + 0x13c) = value;
```
...
|---|---|---|
| Unguarded u16@+0x13c | **High** | bytes |
...
1. Map `+0x13c` to product attr (str/end/acc/etc.) via LevelUp packet field order.
