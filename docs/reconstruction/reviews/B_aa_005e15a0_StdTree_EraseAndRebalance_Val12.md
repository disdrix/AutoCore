# Review B (skeptical / adversarial): `aa_005e15a0` StdTree_EraseAndRebalance_Val12
...
| **Counterpart** | `reviews/A_aa_005e15a0_StdTree_EraseAndRebalance_Val12.md` |
...
| 3 | Same binary as `StdMap_EraseIterator_Inferred` @ `004baa30` | **Falsified** — different VA, rotates (`00573170`/`00418c10` vs isnil15 pair), isnil offset |
| 4 | Function frees whole tree / range | **Falsified** — single-node erase; range is caller `FUN_005e1990` |
| 5 | Mission product method (because neighborhood) | **Narrow** — structural erase; mission is caller domain |
...
Port must keep **isnil@+0x19** and call the Val12 rotate pair (not the isnil@15 rotate pair). Do not merge with peer erase VAs; share algorithm only.

---

## 5. Open questions

1. Exact demangled map type for `FUN_005e1990`.  
