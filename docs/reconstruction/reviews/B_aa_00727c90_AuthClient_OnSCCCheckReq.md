# Review B (skeptical / adversarial): `AuthClient_OnSCCCheckReq` @ `0x00727c90`
...
| **Date** | `2026-07-23` |
| **Counterpart** | `reviews/A_aa_00727c90_AuthClient_OnSCCCheckReq.md` |
...
| # | Claim | Attack |
|---|---|---|
| 1 | Performs SCC crypto here | **Overstated — log+callback shell** |
| 2 | Formal param is sole this | **Weak — EDI framing** |
...
|---|---|---|
| Name from string "SCCCheckReq" | High | Wrong → protocol/UI mismatch risk |
...
| Primarily log+callback shell | High | Wrong → protocol/UI mismatch risk |
...
```
AuthClient_OnSCCCheckReq(packet): log SCCCheckReq; notify listener if present
```
