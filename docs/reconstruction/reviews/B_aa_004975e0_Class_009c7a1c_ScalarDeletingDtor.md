# Review B (skeptical / adversarial): `aa_004975e0` Class_009c7a1c_ScalarDeletingDtor
...
| **Counterpart** | `reviews/A_aa_004975e0_Class_009c7a1c_ScalarDeletingDtor.md` |
| **Scratch** | `tmp/a_004975e0.md` |
| **Verdict** | **accept** |
...
| # | Claim | Attack / result |
|---|---|---|
| 1 | This is the complete-object dtor body | **Falsified** — no vtbl install, no member frees; only calls `FUN_004970b0` then optional free |
...
| 7 | Same VA as element dtor | **Falsified** — element is `0x005b8000` |
| 8 | Not vtbl[0] | **Falsified** — dword @ `0x009c7a1c` = `0x004975e0` |
...
```
// FUN_004975e0 (vtbl[0] of PTR_FUN_009c7a1c):
push esi
mov  esi, ecx
call FUN_004970b0          ; complete body
...
void* Class_009c7a1c_ScalarDeletingDtor(void* self, uint8_t flags) {
  Class_009c7a1c_CompleteDtor(self);   // FUN_004970b0 — separate unit
  if (flags & 1) operator_delete(self);
  return self;
}
// vtbl[0] entry; ret 4
// Do not inline complete body or element dtor into this VA's port.
```
