...
```c
uint32_t /* width from decompiler */ __thiscall FUN_00571db0(int param_1,byte param_2,byte param_3)
```
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00571db0.cpp`
