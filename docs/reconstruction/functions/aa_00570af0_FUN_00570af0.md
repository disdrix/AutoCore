...
```c
uint32_t /* width from decompiler */ __thiscall FUN_00570af0(int param_1,int *param_2,uint32_t /* width from decompiler */ param_3,uint32_t /* width from decompiler */ param_4)
```
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00570af0.cpp`
