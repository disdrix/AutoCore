...
Human name: `Named_CalleeOf_Drive_i_d_shopveh_2d_wnd_list_vehicle_xml_0083ac90` (callee of `Drive_i_d_shopveh_2d_wnd_list_vehicle_xml`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0083ac90.cpp`
