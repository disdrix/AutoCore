# Function record: FUN_0044a4a0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0044a4a0` |
| **Canonical name** | `FUN_0044a4a0` |
| **Address** | `0x0044a4a0` |
...
- Raw: `docs/reconstruction/raw/aa_0044a4a0_FUN_0044a4a0.md`
- Annotated: `docs/reconstruction/raw/aa_0044a4a0_FUN_0044a4a0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0044a4a0.cpp`
