...
Human name: `UI_int_btn_generic` (from plate string `i_m_int_2d_btn_generic.xml`)
...
- Raw: `docs/reconstruction/raw/aa_0082f810_FUN_0082f810.md`
- Annotated: `docs/reconstruction/raw/aa_0082f810_FUN_0082f810.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0082f810.cpp`
