# Function record: FUN_004b67d0

| Field | Value |
|---|---|
| **Stable ID** | `aa_004b67d0` |
| **Canonical name** | `FUN_004b67d0` |
| **Address** | `0x004b67d0` |
...
Human name: `Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_PacketDispa_004b67d0` (callee of `Named_CalleeOf_Named_CalleeOf_Client_PacketDispatch`)
...
- Raw: `docs/reconstruction/raw/aa_004b67d0_FUN_004b67d0.md`
- Annotated: `docs/reconstruction/raw/aa_004b67d0_FUN_004b67d0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_004b67d0.cpp`
