...
Human name: `Named_CalleeOf_Named_CalleeOf_Drive_Loading_Vehicles_00833d50` (callee of `Named_CalleeOf_Drive_Loading_Vehicles`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00833d50.cpp`
