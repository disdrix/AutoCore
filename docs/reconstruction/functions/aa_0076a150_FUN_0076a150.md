# Function record: FUN_0076a150

| Field | Value |
|---|---|
| **Stable ID** | `aa_0076a150` |
| **Canonical name** | `FUN_0076a150` |
| **Address** | `0x0076a150` |
...
Human name: `Named_CalleeOf_Named_effDeviceEffect_0076a150` (callee of `Named_effDeviceEffect`)
...
- Raw: `docs/reconstruction/raw/aa_0076a150_FUN_0076a150.md`
- Annotated: `docs/reconstruction/raw/aa_0076a150_FUN_0076a150.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0076a150.cpp`
