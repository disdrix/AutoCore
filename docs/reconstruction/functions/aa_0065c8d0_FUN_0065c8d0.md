# Function record: FUN_0065c8d0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0065c8d0` |
| **Canonical name** | `FUN_0065c8d0` |
| **Address** | `0x0065c8d0` |
...
- Raw: `docs/reconstruction/raw/aa_0065c8d0_FUN_0065c8d0.md`
- Annotated: `docs/reconstruction/raw/aa_0065c8d0_FUN_0065c8d0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0065c8d0.cpp`
