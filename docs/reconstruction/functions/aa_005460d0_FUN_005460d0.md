# Function record: FUN_005460d0

| Field | Value |
|---|---|
| **Stable ID** | `aa_005460d0` |
| **Canonical name** | `FUN_005460d0` |
| **Address** | `0x005460d0` |
...
Human name: `Named_CalleeOf_Mission_Mission_lacking_child_nodes_s_005460d0` (callee of `Mission_Mission_lacking_child_nodes_s`)
