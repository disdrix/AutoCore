# Function record: rand

| Field | Value |
|---|---|
| **Stable ID** | `aa_006a3e32` |
| **Canonical name** | `rand` |
| **Address** | `0x006a3e32` |
...
- Raw: `docs/reconstruction/raw/aa_006a3e32_rand.md`
- Annotated: `docs/reconstruction/raw/aa_006a3e32_rand.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/rand.cpp`
