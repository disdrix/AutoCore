...
Human name: `Named_CalleeOf_CVOGHBAIBase_FindTargetToAttack_004bb0d0` (callee of `CVOGHBAIBase_FindTargetToAttack`)
...
```c
uint32_t /* width from decompiler */ FUN_004bb0d0(uint32_t /* width from decompiler */ *param_1)
```
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_004bb0d0.cpp`
