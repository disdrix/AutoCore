# Function record: FUN_0040d8d0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0040d8d0` |
| **Canonical name** | `FUN_0040d8d0` |
| **Address** | `0x0040d8d0` |
...
- Raw: `docs/reconstruction/raw/aa_0040d8d0_FUN_0040d8d0.md`
- Annotated: `docs/reconstruction/raw/aa_0040d8d0_FUN_0040d8d0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0040d8d0.cpp`
