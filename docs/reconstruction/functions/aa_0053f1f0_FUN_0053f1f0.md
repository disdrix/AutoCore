# Function record: FUN_0053f1f0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0053f1f0` |
| **Canonical name** | `FUN_0053f1f0` |
| **Address** | `0x0053f1f0` |
...
- Raw: `docs/reconstruction/raw/aa_0053f1f0_FUN_0053f1f0.md`
- Annotated: `docs/reconstruction/raw/aa_0053f1f0_FUN_0053f1f0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0053f1f0.cpp`
