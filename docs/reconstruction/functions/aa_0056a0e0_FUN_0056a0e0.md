# Function record: FUN_0056a0e0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0056a0e0` |
| **Canonical name** | `FUN_0056a0e0` |
| **Address** | `0x0056a0e0` |
...
- Raw: `docs/reconstruction/raw/aa_0056a0e0_FUN_0056a0e0.md`
- Annotated: `docs/reconstruction/raw/aa_0056a0e0_FUN_0056a0e0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0056a0e0.cpp`
