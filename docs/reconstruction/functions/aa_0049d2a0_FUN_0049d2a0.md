# Function record: FUN_0049d2a0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0049d2a0` |
| **Canonical name** | `FUN_0049d2a0` |
| **Address** | `0x0049d2a0` |
...
Human name: `Named_VOG_DEBUG_STOP_0049d2a0` (from string `VOG_DEBUG_STOP`)
...
- Raw: `docs/reconstruction/raw/aa_0049d2a0_FUN_0049d2a0.md`
- Annotated: `docs/reconstruction/raw/aa_0049d2a0_FUN_0049d2a0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0049d2a0.cpp`
