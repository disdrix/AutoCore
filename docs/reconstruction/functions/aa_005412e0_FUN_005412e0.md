# Function record: FUN_005412e0

| Field | Value |
|---|---|
| **Stable ID** | `aa_005412e0` |
| **Canonical name** | `FUN_005412e0` |
| **Address** | `0x005412e0` |
...
Human name: `Named_VOG_DEBUG_STOP_005412e0` (from string `VOG_DEBUG_STOP`)
...
- Raw: `docs/reconstruction/raw/aa_005412e0_FUN_005412e0.md`
- Annotated: `docs/reconstruction/raw/aa_005412e0_FUN_005412e0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_005412e0.cpp`
