...
Human name: `UI_cont_continent_map` (from plate string `i_d_cont_2d_wnd_continent-map.dds`)
...
- Raw: `docs/reconstruction/raw/aa_008ed8a0_FUN_008ed8a0.md`
- Annotated: `docs/reconstruction/raw/aa_008ed8a0_FUN_008ed8a0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_008ed8a0.cpp`
