...
```c
void __thiscall FUN_00407140(int param_1,uint32_t /* width from decompiler */ *param_2,int *param_3,int *param_4)
```
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00407140.cpp`
