# Function record: FUN_007db630

| Field | Value |
|---|---|
| **Stable ID** | `aa_007db630` |
| **Canonical name** | `FUN_007db630` |
| **Address** | `0x007db630` |
...
Human name: `Named_tRegion` (from plate string `//tRegion/row`)
...
- Raw: `docs/reconstruction/raw/aa_007db630_FUN_007db630.md`
- Annotated: `docs/reconstruction/raw/aa_007db630_FUN_007db630.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_007db630.cpp`
