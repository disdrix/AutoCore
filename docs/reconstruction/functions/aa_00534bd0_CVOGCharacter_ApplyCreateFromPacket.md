# Function record: CVOGCharacter_ApplyCreateFromPacket
...
See plate comments in raw decompile and system map for `unknown`.
...
| Kind | Path |
|---|---|
| Raw | `raw/aa_00534bd0_CVOGCharacter_ApplyCreateFromPacket.md` |
| Annotated | `raw/aa_00534bd0_CVOGCharacter_ApplyCreateFromPacket.annotated.md` |
| Clean | `reconstructed-exact/CVOGCharacter_ApplyCreateFromPacket.cpp` |
