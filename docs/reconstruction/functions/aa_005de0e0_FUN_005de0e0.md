# Function record: FUN_005de0e0

| Field | Value |
|---|---|
| **Stable ID** | `aa_005de0e0` |
| **Canonical name** | `FUN_005de0e0` |
| **Address** | `0x005de0e0` |
...
- Raw: `docs/reconstruction/raw/aa_005de0e0_FUN_005de0e0.md`
- Annotated: `docs/reconstruction/raw/aa_005de0e0_FUN_005de0e0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_005de0e0.cpp`
