...
Human name: `Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Nam_00588290` (callee of `Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_CVO`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00588290.cpp`
