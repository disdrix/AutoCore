# Function record: FUN_0076d1b0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0076d1b0` |
| **Canonical name** | `FUN_0076d1b0` |
| **Address** | `0x0076d1b0` |
...
Human name: `Named_CalleeOf_Named_gfxView_0076d1b0` (callee of `Named_gfxView`)
...
```c
int FUN_0076d1b0(uint32_t /* width from decompiler */ param_1,uint32_t /* width from decompiler */ param_2)
```
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0076d1b0.cpp`
