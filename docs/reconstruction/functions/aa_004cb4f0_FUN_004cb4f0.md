...
Human name: `Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Named_VOGClient_004cb4f0` (callee of `Named_CalleeOf_Named_CalleeOf_Named_VOGClient`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_004cb4f0.cpp`
