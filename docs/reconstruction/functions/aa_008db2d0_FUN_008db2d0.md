...
```c
void FUN_008db2d0(uint32_t /* width from decompiler */ param_1)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_008db2d0_FUN_008db2d0.md`
- Annotated: `docs/reconstruction/raw/aa_008db2d0_FUN_008db2d0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_008db2d0.cpp`
