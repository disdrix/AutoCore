# Function record: FUN_0060f8a0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0060f8a0` |
| **Canonical name** | `FUN_0060f8a0` |
| **Address** | `0x0060f8a0` |
...
- Raw: `docs/reconstruction/raw/aa_0060f8a0_FUN_0060f8a0.md`
- Annotated: `docs/reconstruction/raw/aa_0060f8a0_FUN_0060f8a0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0060f8a0.cpp`
