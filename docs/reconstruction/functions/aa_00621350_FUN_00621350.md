...
Human name: `Named_CalleeOf_Named_VOG_DEBUG_STOP_00621350` (callee of `Named_VOG_DEBUG_STOP`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00621350.cpp`
