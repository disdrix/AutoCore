# Function record: FUN_005834f0

| Field | Value |
|---|---|
| **Stable ID** | `aa_005834f0` |
| **Canonical name** | `FUN_005834f0` |
| **Address** | `0x005834f0` |
...
- Raw: `docs/reconstruction/raw/aa_005834f0_FUN_005834f0.md`
- Annotated: `docs/reconstruction/raw/aa_005834f0_FUN_005834f0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_005834f0.cpp`
