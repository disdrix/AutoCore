...
Human name: `Named_CalleeOf_Named_CalleeOf_Named_VOGClient_007ffef0` (callee of `Named_CalleeOf_Named_VOGClient`)
...
```c
void FUN_007ffef0(int param_1,TFID_16 *param_2)
```
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_007ffef0.cpp`
