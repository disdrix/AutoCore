# Function record: FUN_00790f80

| Field | Value |
|---|---|
| **Stable ID** | `aa_00790f80` |
| **Canonical name** | `FUN_00790f80` |
| **Address** | `0x00790f80` |
...
Human name: `Named_VOG_DEBUG_STOP_00790f80` (from string `VOG_DEBUG_STOP`)
...
- Raw: `docs/reconstruction/raw/aa_00790f80_FUN_00790f80.md`
- Annotated: `docs/reconstruction/raw/aa_00790f80_FUN_00790f80.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00790f80.cpp`
