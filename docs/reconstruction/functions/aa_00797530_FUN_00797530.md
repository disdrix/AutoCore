...
Human name: `Named_CalleeOf_Named_CalleeOf_Client_RecvBroadcast_00797530` (callee of `Named_CalleeOf_Client_RecvBroadcast`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00797530.cpp`
