# Function record: Vehicle_EquipFromCreate
...
| Kind | Path |
|---|---|
| Raw | `raw/aa_00504480_Vehicle_EquipFromCreate.md` |
| Annotated | `raw/aa_00504480_Vehicle_EquipFromCreate.annotated.md` |
| Clean | `reconstructed-exact/Vehicle_EquipFromCreate.cpp` |
