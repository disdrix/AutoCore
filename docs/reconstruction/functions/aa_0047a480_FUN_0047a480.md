# Function record: FUN_0047a480

| Field | Value |
|---|---|
| **Stable ID** | `aa_0047a480` |
| **Canonical name** | `FUN_0047a480` |
| **Address** | `0x0047a480` |
...
- Raw: `docs/reconstruction/raw/aa_0047a480_FUN_0047a480.md`
- Annotated: `docs/reconstruction/raw/aa_0047a480_FUN_0047a480.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0047a480.cpp`
