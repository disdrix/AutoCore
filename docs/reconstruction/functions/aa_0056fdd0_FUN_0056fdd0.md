...
```c
uint8_t FUN_0056fdd0(uint32_t /* width from decompiler */ param_1)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_0056fdd0_FUN_0056fdd0.md`
- Annotated: `docs/reconstruction/raw/aa_0056fdd0_FUN_0056fdd0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0056fdd0.cpp`
