...
Human name: `Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_Attempting_00401db0` (callee of `Named_CalleeOf_Named_CalleeOf_Mission_Attempting_to_open_null_d`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00401db0.cpp`
