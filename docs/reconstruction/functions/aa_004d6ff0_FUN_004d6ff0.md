...
Human name: `Snd_ReadMusicRegions` (from plate string `ReadMusicRegions`)
...
- Raw: `docs/reconstruction/raw/aa_004d6ff0_FUN_004d6ff0.md`
- Annotated: `docs/reconstruction/raw/aa_004d6ff0_FUN_004d6ff0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_004d6ff0.cpp`
