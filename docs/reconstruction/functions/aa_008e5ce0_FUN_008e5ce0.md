...
Human name: `Named_CalleeOf_Named_CalleeOf_Client_RefreshOpenMissionUiWindow_008e5ce0` (callee of `Named_CalleeOf_Client_RefreshOpenMissionUiWindows`)
...
```c
void FUN_008e5ce0(uint32_t /* width from decompiler */ param_1,uint param_2,uint param_3)
```
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_008e5ce0.cpp`
