# Function record: FUN_00462390

| Field | Value |
|---|---|
| **Stable ID** | `aa_00462390` |
| **Canonical name** | `FUN_00462390` |
| **Address** | `0x00462390` |
...
Human name: `Named_CalleeOf_Named_CalleeOf_Named_gfxIndexBufferImpl_00462390` (callee of `Named_CalleeOf_Named_gfxIndexBufferImpl`)
...
- Raw: `docs/reconstruction/raw/aa_00462390_FUN_00462390.md`
- Annotated: `docs/reconstruction/raw/aa_00462390_FUN_00462390.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00462390.cpp`
