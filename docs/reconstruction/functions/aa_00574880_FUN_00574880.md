...
Human name: `Named_CalleeOf_Mission_Client_BuildMissionDetailPanel_00574880` (callee of `Mission_Client_BuildMissionDetailPanel`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00574880.cpp`
