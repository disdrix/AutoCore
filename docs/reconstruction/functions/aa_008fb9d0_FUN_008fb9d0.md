# Function record: FUN_008fb9d0

| Field | Value |
|---|---|
| **Stable ID** | `aa_008fb9d0` |
| **Canonical name** | `FUN_008fb9d0` |
| **Address** | `0x008fb9d0` |
...
- Raw: `docs/reconstruction/raw/aa_008fb9d0_FUN_008fb9d0.md`
- Annotated: `docs/reconstruction/raw/aa_008fb9d0_FUN_008fb9d0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_008fb9d0.cpp`
