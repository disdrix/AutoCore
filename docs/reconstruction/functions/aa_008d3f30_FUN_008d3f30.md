# Function record: FUN_008d3f30

| Field | Value |
|---|---|
| **Stable ID** | `aa_008d3f30` |
| **Canonical name** | `FUN_008d3f30` |
| **Address** | `0x008d3f30` |
...
- Raw: `docs/reconstruction/raw/aa_008d3f30_FUN_008d3f30.md`
- Annotated: `docs/reconstruction/raw/aa_008d3f30_FUN_008d3f30.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_008d3f30.cpp`
