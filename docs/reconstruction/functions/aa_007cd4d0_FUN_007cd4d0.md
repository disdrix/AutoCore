# Function record: FUN_007cd4d0

| Field | Value |
|---|---|
| **Stable ID** | `aa_007cd4d0` |
| **Canonical name** | `FUN_007cd4d0` |
| **Address** | `0x007cd4d0` |
...
Human name: `Named_vConsumables` (from plate string `//vConsumables/row`)
...
- Raw: `docs/reconstruction/raw/aa_007cd4d0_FUN_007cd4d0.md`
- Annotated: `docs/reconstruction/raw/aa_007cd4d0_FUN_007cd4d0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_007cd4d0.cpp`
