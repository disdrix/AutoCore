# Function record: _CIasin

| Field | Value |
|---|---|
| **Stable ID** | `aa_006a3ff0` |
| **Canonical name** | `_CIasin` |
| **Address** | `0x006a3ff0` |
...
- Raw: `docs/reconstruction/raw/aa_006a3ff0__CIasin.md`
- Annotated: `docs/reconstruction/raw/aa_006a3ff0__CIasin.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/_CIasin.cpp`
