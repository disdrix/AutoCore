...
Human name: `Named_CalleeOf_Named_Could_not_get_Palantir_desktop_window_007fb0a0` (callee of `Named_Could_not_get_Palantir_desktop_window`)
...
- Raw: `docs/reconstruction/raw/aa_007fb0a0_FUN_007fb0a0.md`
- Annotated: `docs/reconstruction/raw/aa_007fb0a0_FUN_007fb0a0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_007fb0a0.cpp`
