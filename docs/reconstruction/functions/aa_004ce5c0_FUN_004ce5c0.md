...
Human name: `Named_CalleeOf_Client_SendInventoryUnequip_004ce5c0` (callee of `Client_SendInventoryUnequip`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_004ce5c0.cpp`
