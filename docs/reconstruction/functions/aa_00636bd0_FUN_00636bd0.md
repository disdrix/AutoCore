...
Human name: `Named_CalleeOf_Named_CalleeOf_Client_OnVehicleSwitchFailure_00636bd0` (callee of `Named_CalleeOf_Client_OnVehicleSwitchFailure`)
...
```c
uint32_t /* width from decompiler */ * __thiscall FUN_00636bd0(uint32_t /* width from decompiler */ *param_1,int param_2)
```
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00636bd0.cpp`
