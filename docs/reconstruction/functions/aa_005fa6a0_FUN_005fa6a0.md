...
```c
void __fastcall FUN_005fa6a0(uint32_t /* width from decompiler */ *param_1)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_005fa6a0_FUN_005fa6a0.md`
- Annotated: `docs/reconstruction/raw/aa_005fa6a0_FUN_005fa6a0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_005fa6a0.cpp`
