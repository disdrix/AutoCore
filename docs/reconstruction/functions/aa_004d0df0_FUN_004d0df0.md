...
Human name: `Inv_GenerateLootItem` (from plate string `GenerateLootItem (id)`)
...
- Raw: `docs/reconstruction/raw/aa_004d0df0_FUN_004d0df0.md`
- Annotated: `docs/reconstruction/raw/aa_004d0df0_FUN_004d0df0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_004d0df0.cpp`
