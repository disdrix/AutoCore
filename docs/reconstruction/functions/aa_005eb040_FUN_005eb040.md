...
Human name: `Named_CalleeOf_Named_CalleeOf_Named_VOG_DEBUG_STOP_005eb040` (callee of `Named_CalleeOf_Named_VOG_DEBUG_STOP`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_005eb040.cpp`
