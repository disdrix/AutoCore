# Function record: FUN_0055f7a0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0055f7a0` |
| **Canonical name** | `FUN_0055f7a0` |
| **Address** | `0x0055f7a0` |
...
- Raw: `docs/reconstruction/raw/aa_0055f7a0_FUN_0055f7a0.md`
- Annotated: `docs/reconstruction/raw/aa_0055f7a0_FUN_0055f7a0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0055f7a0.cpp`
