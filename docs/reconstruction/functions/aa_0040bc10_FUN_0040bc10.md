...
```c
uint32_t /* width from decompiler */ * FUN_0040bc10(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_0040bc10_FUN_0040bc10.md`
- Annotated: `docs/reconstruction/raw/aa_0040bc10_FUN_0040bc10.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0040bc10.cpp`
