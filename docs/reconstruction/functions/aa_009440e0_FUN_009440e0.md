...
Human name: `Named_VOGClient` (from string `VOGClient`)

## Alias

Human name: `Named_VOGClient_009440e0` (from string `VOGClient`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_009440e0.cpp`
