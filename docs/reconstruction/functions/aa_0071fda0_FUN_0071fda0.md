...
```c
uint8_t * FUN_0071fda0(int param_1)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_0071fda0_FUN_0071fda0.md`
- Annotated: `docs/reconstruction/raw/aa_0071fda0_FUN_0071fda0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0071fda0.cpp`
