...
Human name: `Named_CalleeOf_CVOGSpawnPoint_CreateCreature_004e9720` (callee of `CVOGSpawnPoint_CreateCreature`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_004e9720.cpp`
