...
Human name: `Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_RefreshOpen_005190c0` (callee of `Named_CalleeOf_Named_CalleeOf_Client_RefreshOpenMissionUiWindow`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_005190c0.cpp`
