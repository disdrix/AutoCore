...
```c
void FUN_0046cdb0(uint32_t /* width from decompiler */ *param_1)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_0046cdb0_FUN_0046cdb0.md`
- Annotated: `docs/reconstruction/raw/aa_0046cdb0_FUN_0046cdb0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0046cdb0.cpp`
