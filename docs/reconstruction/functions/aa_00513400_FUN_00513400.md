...
Human name: `Named_CalleeOf_Skill_You_do_not_possess_the_Tinkering_skill_to_00513400` (callee of `Skill_You_do_not_possess_the_Tinkering_skill_to_work_o`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00513400.cpp`
