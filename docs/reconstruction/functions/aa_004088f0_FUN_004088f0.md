...
Human name: `Named_CalleeOf_Named_CalleeOf_CVOGReaction_GiveItemByCbid_004088f0` (callee of `Named_CalleeOf_CVOGReaction_GiveItemByCbid`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_004088f0.cpp`
