...
```c
void __fastcall FUN_005fdda0(uint32_t /* width from decompiler */ *param_1)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_005fdda0_FUN_005fdda0.md`
- Annotated: `docs/reconstruction/raw/aa_005fdda0_FUN_005fdda0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_005fdda0.cpp`
