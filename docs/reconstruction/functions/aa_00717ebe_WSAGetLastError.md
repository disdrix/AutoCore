# Function record: WSAGetLastError

| Field | Value |
|---|---|
| **Stable ID** | `aa_00717ebe` |
| **Canonical name** | `WSAGetLastError` |
| **Address** | `0x00717ebe` |
...
- Raw: `docs/reconstruction/raw/aa_00717ebe_WSAGetLastError.md`
- Annotated: `docs/reconstruction/raw/aa_00717ebe_WSAGetLastError.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/WSAGetLastError.cpp`
