...
Human name: `Named_CalleeOf_Named_CalleeOf_CVOGHBAIFollowVehicle_FireWeapons_005fe6a0` (callee of `Named_CalleeOf_CVOGHBAIFollowVehicle_FireWeapons`)
...
```c
uint32_t /* width from decompiler */ * __thiscall FUN_005fe6a0(uint32_t /* width from decompiler */ *param_1,int *param_2)
```
