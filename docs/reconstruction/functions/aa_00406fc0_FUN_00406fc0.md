...
Human name: `Named_CalleeOf_Named_VOG_DEBUG_STOP_00406fc0` (callee of `Named_VOG_DEBUG_STOP`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00406fc0.cpp`
