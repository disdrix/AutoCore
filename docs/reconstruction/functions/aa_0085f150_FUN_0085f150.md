...
Human name: `Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Client_RecvInvento_0085f150` (callee of `Named_CalleeOf_Named_CalleeOf_Client_RecvInventoryEquip`)
