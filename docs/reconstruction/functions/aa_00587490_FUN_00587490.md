# Function record: FUN_00587490

| Field | Value |
|---|---|
| **Stable ID** | `aa_00587490` |
| **Canonical name** | `FUN_00587490` |
| **Address** | `0x00587490` |
...
Human name: `Named_CalleeOf_Named_CalleeOf_Named_Could_not_get_Palantir_desk_00587490` (callee of `Named_CalleeOf_Named_Could_not_get_Palantir_desktop_window`)
...
- Raw: `docs/reconstruction/raw/aa_00587490_FUN_00587490.md`
- Annotated: `docs/reconstruction/raw/aa_00587490_FUN_00587490.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00587490.cpp`
