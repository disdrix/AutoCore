...
Human name: `CVOGWaypoint_DoFollowObjectShortcutsUpdate` (from plate string `CVOGWaypoint::DoFollowObjectShortcutsUpdate`)

## Alias_prev

Human name: `Named_CalleeOf_CVOGWaypoint_UpdateState_005d5cc0` (callee of `CVOGWaypoint_UpdateState`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_005d5cc0.cpp`
