# Function record: CVOGCharacter_SetQuickBarItem
...
| Kind | Path |
|---|---|
| Raw | `raw/aa_00520890_CVOGCharacter_SetQuickBarItem.md` |
| Annotated | `raw/aa_00520890_CVOGCharacter_SetQuickBarItem.annotated.md` |
| Clean | `reconstructed-exact/CVOGCharacter_SetQuickBarItem.cpp` |
