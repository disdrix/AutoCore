# Function record: FUN_005701f0

| Field | Value |
|---|---|
| **Stable ID** | `aa_005701f0` |
| **Canonical name** | `FUN_005701f0` |
| **Address** | `0x005701f0` |
...
Human name: `Named_VOG_DEBUG_STOP_005701f0` (from string `VOG_DEBUG_STOP`)
...
- Raw: `docs/reconstruction/raw/aa_005701f0_FUN_005701f0.md`
- Annotated: `docs/reconstruction/raw/aa_005701f0_FUN_005701f0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_005701f0.cpp`
