# Function record: FUN_0045f1a0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0045f1a0` |
| **Canonical name** | `FUN_0045f1a0` |
| **Address** | `0x0045f1a0` |
...
- Raw: `docs/reconstruction/raw/aa_0045f1a0_FUN_0045f1a0.md`
- Annotated: `docs/reconstruction/raw/aa_0045f1a0_FUN_0045f1a0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0045f1a0.cpp`
