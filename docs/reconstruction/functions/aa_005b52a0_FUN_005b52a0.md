...
Human name: `Gfx_RenderLeavesForShadows` (from plate string `RenderLeavesForShadows`)
...
- Raw: `docs/reconstruction/raw/aa_005b52a0_FUN_005b52a0.md`
- Annotated: `docs/reconstruction/raw/aa_005b52a0_FUN_005b52a0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_005b52a0.cpp`
