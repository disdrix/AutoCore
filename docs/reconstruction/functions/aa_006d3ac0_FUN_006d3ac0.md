...
```c
void FUN_006d3ac0(uint8_t *param_1,float *param_2,float *param_3,int param_4)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_006d3ac0_FUN_006d3ac0.md`
- Annotated: `docs/reconstruction/raw/aa_006d3ac0_FUN_006d3ac0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_006d3ac0.cpp`
