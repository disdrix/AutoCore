...
```c
uint8_t FUN_004ccee0(uint32_t /* width from decompiler */ param_1)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_004ccee0_FUN_004ccee0.md`
- Annotated: `docs/reconstruction/raw/aa_004ccee0_FUN_004ccee0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_004ccee0.cpp`
