# Function record: ov_info

| Field | Value |
|---|---|
| **Stable ID** | `aa_006859f0` |
| **Canonical name** | `ov_info` |
| **Address** | `0x006859f0` |
...
- Raw: `docs/reconstruction/raw/aa_006859f0_ov_info.md`
- Annotated: `docs/reconstruction/raw/aa_006859f0_ov_info.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/ov_info.cpp`
