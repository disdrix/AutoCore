...
```c
uint8_t __fastcall FUN_0078fdd0(int *param_1)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_0078fdd0_FUN_0078fdd0.md`
- Annotated: `docs/reconstruction/raw/aa_0078fdd0_FUN_0078fdd0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0078fdd0.cpp`
