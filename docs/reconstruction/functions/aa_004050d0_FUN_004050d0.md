# Function record: FUN_004050d0

| Field | Value |
|---|---|
| **Stable ID** | `aa_004050d0` |
| **Canonical name** | `FUN_004050d0` |
| **Address** | `0x004050d0` |
...
- Raw: `docs/reconstruction/raw/aa_004050d0_FUN_004050d0.md`
- Annotated: `docs/reconstruction/raw/aa_004050d0_FUN_004050d0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_004050d0.cpp`
