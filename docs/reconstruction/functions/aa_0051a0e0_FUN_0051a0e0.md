...
Human name: `Named_CalleeOf_CVOGReaction_CompleteObjective_0051a0e0` (callee of `CVOGReaction_CompleteObjective`)
...
- Annotated: `docs/reconstruction/raw/aa_0051a0e0_FUN_0051a0e0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0051a0e0.cpp`
