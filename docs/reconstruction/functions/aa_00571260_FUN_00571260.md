...
Human name: `Named_CalleeOf_Named_CalleeOf_Client_RefreshOpenMissionUiWindow_00571260` (callee of `Named_CalleeOf_Client_RefreshOpenMissionUiWindows`)
