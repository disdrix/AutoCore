# Function record: FUN_0063f4d0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0063f4d0` |
| **Canonical name** | `FUN_0063f4d0` |
| **Address** | `0x0063f4d0` |
...
- Raw: `docs/reconstruction/raw/aa_0063f4d0_FUN_0063f4d0.md`
- Annotated: `docs/reconstruction/raw/aa_0063f4d0_FUN_0063f4d0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0063f4d0.cpp`
