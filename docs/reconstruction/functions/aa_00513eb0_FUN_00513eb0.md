...
Human name: `Named_CalleeOf_Client_RecvInventoryDropResponse_00513eb0` (callee of `Client_RecvInventoryDropResponse`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00513eb0.cpp`
