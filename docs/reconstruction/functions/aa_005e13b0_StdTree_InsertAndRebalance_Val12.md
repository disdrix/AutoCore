# Function record: StdTree_InsertAndRebalance_Val12 (VA `0x005e13b0`)
...
| **Address** | `0x005e13b0` |
| **Body range** | `0x005e13b0`–`0x005e159B` exclusive (**491** B / `0x1EB`) |
...
| **Dual A/B** | `reviews/A_aa_005e13b0_StdTree_InsertAndRebalance_Val12.md`, `reviews/B_aa_005e13b0_StdTree_InsertAndRebalance_Val12.md` (2026-08-04 W37-K) |
| **Last reviewed** | `2026-08-04` |

## Alias

- `FUN_005e13b0`
- `Named_CalleeOf_Named_CalleeOf_Named_CalleeOf_Mission_after_CVOG_005e13b0` (legacy scaffold — **narrow** / reject as product)
- Peer clones: `0x00539210`, `0x0051c1c0`, `0x005ae4e0` — **do not merge VAs**

## Purpose

Allocate and link a Val12 red-black tree node (`StdTree_Buynode_Val12`), update size / extremities / root, rebalance while parent is red, paint root black, write `*outIt = newNode`. Throw if size exceeds `0x15555553`. **No key compare** — parent owns uniqueness.
...
- Scaffold: `docs/reconstruction/reconstructed-exact/FUN_005e13b0.cpp`
- Review A/B: as above
...
| **Callers** | `FUN_005e18d0` only (2 xrefs) |
...
| Always-insert (no key walk) | **High** |
...
- Parent insert-or-find: `aa_005e18d0` (W30-L) — left this dual open
- Peer insert: `aa_00539210` (W27-Q), `aa_0051c1c0` (W25-G)
