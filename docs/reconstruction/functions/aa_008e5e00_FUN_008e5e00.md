...
Human name: `Named_CalleeOf_Client_RefreshOpenMissionUiWindows_008e5e00` (callee of `Client_RefreshOpenMissionUiWindows`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_008e5e00.cpp`
