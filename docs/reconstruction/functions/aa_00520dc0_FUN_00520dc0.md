...
Human name: `CVOGCharacter_CleanupDraggingObject` (from plate string `CVOGCharacter::CleanupDraggingObject`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00520dc0.cpp`
