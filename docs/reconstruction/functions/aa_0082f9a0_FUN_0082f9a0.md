...
Human name: `UI_int_btn_generic_0082f9a0` (from plate string `i_m_int_2d_btn_generic.xml`)
...
- Raw: `docs/reconstruction/raw/aa_0082f9a0_FUN_0082f9a0.md`
- Annotated: `docs/reconstruction/raw/aa_0082f9a0_FUN_0082f9a0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0082f9a0.cpp`
