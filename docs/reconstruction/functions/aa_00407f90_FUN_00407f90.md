...
```c
uint32_t /* width from decompiler */ * FUN_00407f90(uint32_t /* width from decompiler */ *param_1,int *param_2,int *param_3)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_00407f90_FUN_00407f90.md`
- Annotated: `docs/reconstruction/raw/aa_00407f90_FUN_00407f90.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_00407f90.cpp`
