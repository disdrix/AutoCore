...
```c
uint32_t /* width from decompiler */ FUN_0092adf0(float *param_1,uint32_t /* width from decompiler */ *param_2,float *param_3)
```
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_0092adf0.cpp`
