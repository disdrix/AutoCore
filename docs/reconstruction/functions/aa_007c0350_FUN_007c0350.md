...
Human name: `Mission_bActiveObjectiveOverride` (from `bActiveObjectiveOverride`)

## Alias

Human name: `Mission_DbLoadQuestsAndObjectives` (manual plate; evidence `//vQuests/row`)
...
- Annotated: `docs/reconstruction/raw/aa_007c0350_FUN_007c0350.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_007c0350.cpp`
