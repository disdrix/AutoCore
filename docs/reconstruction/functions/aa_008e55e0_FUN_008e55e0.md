...
Human name: `Named_CalleeOf_Client_RefreshOpenMissionUiWindows_008e55e0` (callee of `Client_RefreshOpenMissionUiWindows`)
...
- Clean: `docs/reconstruction/reconstructed-exact/FUN_008e55e0.cpp`
