...
```c
uint32_t /* width from decompiler */ FUN_007fbab0(void)
```

## Artifacts

- Raw: `docs/reconstruction/raw/aa_007fbab0_FUN_007fbab0.md`
- Annotated: `docs/reconstruction/raw/aa_007fbab0_FUN_007fbab0.annotated.md`
- Clean: `docs/reconstruction/reconstructed-exact/FUN_007fbab0.cpp`
