# Function record: FUN_0040ddd0

| Field | Value |
|---|---|
| **Stable ID** | `aa_0040ddd0` |
| **Canonical name** | `FUN_0040ddd0` |
| **Address** | `0x0040ddd0` |
...
Human name: `Named_CalleeOf_Skill_Combat_Fighting_and_driving_ability_Affect_0040ddd0` (callee of `Skill_Combat_Fighting_and_driving_ability_Affects_Weap`)
...
```c
int __fastcall FUN_0040ddd0(int param_1)
```
