# Annotated low-level: FUN_004e39d0
...
- Source: raw capture for `aa_004e39d0`.
...
```c
void __thiscall FUN_004e39d0(int param_1,void *param_2,uint param_3,undefined4 *param_4)
