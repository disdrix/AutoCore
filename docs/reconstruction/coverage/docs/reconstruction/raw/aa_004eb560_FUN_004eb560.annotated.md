# Annotated low-level: FUN_004eb560
...
- Source: raw capture for `aa_004eb560`.
...

{
  ...
  if (pvVar15 != (void *)0x0) {
    ...
    puVar2 = (undefined4 *)(auStack_218 + 3);
    do {
      puVar12 = puVar2;
      puVar2 = (undefined4 *)((int)puVar12 + 1);
    } while (*(char *)((int)puVar12 + 1) != '\0');
    *(undefined4 *)((int)puVar12 + 1) = DAT_009cccf0;
    *(undefined2 *)((int)puVar12 + 5) = DAT_009cccf4;
    *(undefined1 *)((int)puVar12 + 7) = DAT_009cccf6;
    ...
    for (uVar13 = uVar6 >> 2; uVar13 != 0; uVar13 = uVar13 - 1) {
      *(undefined4 *)pcVar5 = *(undefined4 *)pcVar16;
      pcVar16 = pcVar16 + 4;
      pcVar5 = pcVar5 + 4;
    }
        ...
        *(undefined4 *)((int)pvVar15 + 0x34) = 0;
        ...
        if (puStack_23c == (undefined4 *)0x0) {
          ...
          *puStack_23c = &PTR_FUN_009cb228;
          ...
          fVar3 = DAT_00aaa668;
          puStack_23c[0xe] = 8;
          *(undefined2 *)(puStack_23c + 0xf) = 0;
          *(undefined2 *)((int)puStack_23c + 0x3e) = 0;
          puStack_23c[0x10] = 0;
        ...
        *(short *)(puStack_23c + 0xf) = sVar4;
        if (*(uint *)((int)pvVar15 + 0x58) <= *(uint *)((int)pvVar15 + 0x54)) {
          ...
          if (uVar13 < uVar6) {
            ...
            puVar2 = *(undefined4 **)((int)pvVar15 + 0x54);
            puVar12 = *(undefined4 **)((int)pvVar15 + 0x50);
            puVar14 = puVar11;
            ...
            iVar7 = *(int *)((int)pvVar15 + 0x50);
            *(undefined4 **)((int)pvVar15 + 0x58) = puVar11 + uVar6;
            *(undefined4 **)((int)pvVar15 + 0x50) = puVar11;
            *(undefined4 **)((int)pvVar15 + 0x54) =
                 puVar11 + (*(int *)((int)pvVar15 + 0x54) - iVar7 >> 2);
          }
        }
        iVar7 = 0;
        **(undefined4 **)((int)pvVar15 + 0x54) = puStack_23c;
