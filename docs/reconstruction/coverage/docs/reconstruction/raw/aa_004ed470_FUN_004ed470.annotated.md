# Annotated low-level: FUN_004ed470
...
- Source: raw capture for `aa_004ed470`.
...
```c
int FUN_004ed470(int param_1,float param_2,undefined4 param_3,undefined4 param_4,char param_5,
...

{
  ...
  if ((*(int *)(param_1 + 4) == 0) || (iVar7 = *(int *)(param_1 + 0xc), iVar7 == 0)) {
    ...
    if (iVar9 == 4) {
      ...
      *(undefined2 *)(iVar9 + 4) = 0x10;
      pvStack_2c._0_1_ = 5;
      puVar4 = (undefined4 *)FUN_006c7fa0(param_2);
  ...
  if (3 < iVar3) {
    ...
    local_1b4 = (undefined4 *)(-8 - (int)local_244);
    iVar7 = (iVar3 - 4U >> 2) + 1;
    local_284 = 8;
    iVar9 = iVar7 * 4;
    do {
  ...
  if (0 < *(int *)(param_1 + 0x14)) {
    do {
      local_260 = *(undefined4 *)(*(int *)(param_1 + 0x10) + iVar9);
      iVar3 = *(int *)(param_1 + 0x10) + iVar9;
      local_25c = *(undefined4 *)(iVar3 + 4);
      local_258 = *(undefined4 *)(iVar3 + 8);
      local_254 = *(float *)(iVar3 + 0xc) * param_2;
      if (local_278 == (local_274 & 0x7fffffff)) {
        FUN_005b3370(&local_27c,0x10);
      }
      puVar4 = (undefined4 *)(local_278 * 0x10 + local_27c);
  ...
  pvVar2 = pvStack_24c;
  *(undefined2 *)(iVar9 + 4) = 0xe0;
  pvStack_1c._0_1_ = 1;
  puVar4 = (undefined4 *)FUN_006c90d0(pvStack_24c,uStack_f0,0x10,&local_284);
  pvStack_1c._0_1_ = 0;
