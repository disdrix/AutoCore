# Annotated low-level: FUN_004e7a30
...
- Source: raw capture for `aa_004e7a30`.
...
```c
undefined4 __thiscall FUN_004e7a30(void *param_1,uint param_2,int param_3,char param_4)
