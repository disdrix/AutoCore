...

{
  ...
  uint32_t /* width from decompiler */ auStack_50 [2];
  ...
  do {
    ...
    local_5c = *(uint32_t /* width from decompiler */ *)
                (*(int *)(*(int *)(*(int *)(iVar10 + 4) + 0xac + param_1) + 0x3c) + 0x4e8 + local_e4
                );
    local_58 = *(uint32_t /* width from decompiler */ *)
                (*(int *)(*(int *)(*(int *)(iVar10 + 4) + 0xac + param_1) + 0x3c) + 0x4ec + local_e4
                );
    local_54 = *(uint32_t /* width from decompiler */ *)
    ...
    if ((cVar5 < '\0') || ('\x01' < cVar5)) {
      uVar12 = *(uint32_t /* width from decompiler */ *)(param_1 + 0x158);
    }
    else {
      uVar12 = 0;
    }
    ...
    if ((iVar10 != 0) && (*(int **)(iVar10 + 8) != (int *)0x0)) {
      ...
      if (*(int *)(param_1 + 8) == 0) {
        ...
        puVar7 = (uint32_t /* width from decompiler */ *)(*(int *)(*(int *)(param_1 + 8) + 0x3c) + 0x40);
      }
